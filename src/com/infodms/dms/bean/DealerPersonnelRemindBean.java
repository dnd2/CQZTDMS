...
public class DealerPersonnelRemindBean {
	...
	public String getPlannedDatePre() {
		return plannedDatePre;
	}
	public void setPlannedDatePre(String plannedDatePre) {
		this.plannedDatePre = plannedDatePre;
	}
