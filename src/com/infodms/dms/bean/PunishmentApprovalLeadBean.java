 ...
 * 奖惩审批轿车厂审批
 */
public class PunishmentApprovalLeadBean extends PO {
	private static final long serialVersionUID = -6023065128591237980L;
	private String dealerId;//ID
