...
public class MiscManagerDAO1 extends BaseDao<PO> {
    public static Logger logger = Logger.getLogger(MiscManagerDAO1.class);
    private static final MiscManagerDAO1 dao = new MiscManagerDAO1();

    private MiscManagerDAO1() {
    }

    public static final MiscManagerDAO1 getInstance() {
        return dao;
    }
     ...
     * @LastDate : 2013-7-1
     */
    public PageResult<Map<String, Object>> getMainList(RequestWrapper request, String orgId, int pageSize, int curPage) {
