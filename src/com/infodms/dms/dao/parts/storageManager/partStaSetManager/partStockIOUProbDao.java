 ...
 * @ClassName : partStockIOUProbDao
 */
public class partStockIOUProbDao extends BaseDao {
    ...
    public static Logger logger = Logger.getLogger(partStockIOUProbDao.class);
    private static final partStockIOUProbDao dao = new partStockIOUProbDao();

    private partStockIOUProbDao() {
    }

    public static final partStockIOUProbDao getInstance() {
        return dao;
    }
