 ...
 * @ClassName : partStockQuaProbDao
 */
public class partStockQuaProbDao extends BaseDao {
    public static Logger logger = Logger.getLogger(partStockQuaProbDao.class);
    private static final partStockQuaProbDao dao = new partStockQuaProbDao();

    private partStockQuaProbDao() {
    }

    public static final partStockQuaProbDao getInstance() {
        return dao;
    }

    private static final Integer bzType = Constant.PART_STOCK_STATUS_BUSINESS_TYPE_05;
