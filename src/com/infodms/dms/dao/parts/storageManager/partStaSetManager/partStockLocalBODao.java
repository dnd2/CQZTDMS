 ...
 * @ClassName : partStockLocalBODao
 */
public class partStockLocalBODao extends BaseDao {
    public static Logger logger = Logger.getLogger(partStockLocalBODao.class);
    private static final partStockLocalBODao dao = new partStockLocalBODao();

    private partStockLocalBODao() {
    }

    public static final partStockLocalBODao getInstance() {
        return dao;
    }

    private static final Integer bzType = Constant.PART_STOCK_STATUS_BUSINESS_TYPE_07;
