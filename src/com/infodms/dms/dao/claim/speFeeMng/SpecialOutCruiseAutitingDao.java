...
***********************************************************************/
/**
 * $Id: SpecialOutCruiseAutitingDao.java,v 1.1 2010/08/16 01:43:33 yuch Exp $
 */
...
public class SpecialOutCruiseAutitingDao extends BaseDao{
	public static Logger logger = Logger.getLogger(SpecialOutCruiseAutitingDao.class);
	private static final SpecialOutCruiseAutitingDao dao = new SpecialOutCruiseAutitingDao ();
	public  static final SpecialOutCruiseAutitingDao getInstance() {
		return dao;
	}
	 ...
	 * @throws          : Exception
	 * LastUpdate       : 巡航服务线路审核单
	 */
	public  PageResult<Map<String, Object>>  getSpecialBalancleQuery(TtAsWrSpeoutfeeBean feeBean,String whereSql,List<Object> params, int curPage,int pageSize) throws Exception {
		StringBuffer sql = new StringBuffer();
		sql.append("	select c.ID,c.CR_NO,d.DEALER_CODE,d.DEALER_SHORTNAME,  \n");
		sql.append("    to_char(MAKE_DATE,'yyyy-MM-dd') as  MAKE_DATE ,c.CR_WHITHER,c.CR_PRINCIPAL    \n");
		sql.append("     from  TT_AS_WR_CRUISE c , TM_DEALER d    where 1=1  and c.DEALER_ID =d.DEALER_ID and c.STATUS="+Constant.CURI_SERVICE_STATUS_02+" \n");//已上报
		...
		if(!"".equals(whereSql)&&null!=whereSql.trim()){//经销商代码不为空
			sql.append("		"+whereSql+" \n");
		}
	 ...
	 */
	public  TtAsWrSpeoutfeeBean  SpecialAutitingQueryInit(String id){
	 ...
	 * LastUpdate     :  2010-07-15
	 */
	public  List<TtAsWrSpeoutfeeBean>  SpecialAutitingQueryList(String id){
		List<Object> params = new LinkedList();
		StringBuilder sql = new StringBuilder();
	 ...
	 * LastUpdate     :  2010-07-15
	 */
	public static void  SpecialAutiting(TtAsWrCruiseAuditingPO AuditingPOContent){
	 ...
	 * LastUpdate     :  2010-07-15
	 */
	public static void  SpecialAutitingUpdate(TtAsWrCruisePO CruisePO, TtAsWrCruisePO CruisePOContent){
