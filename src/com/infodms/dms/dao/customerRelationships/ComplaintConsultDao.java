...
public class ComplaintConsultDao extends BaseDao{

	private static final ComplaintConsultDao dao = new ComplaintConsultDao();
	
	public static final ComplaintConsultDao getInstance() {
		return dao;
	}
	...
	public Map<String, Object> queryComplaintConsult(String cpid,
		...
		// 艾春 9.18 修改
			...
			sql.append("                                   FROM TT_CRM_COMPLAINT_RETURN_RECORD CRR\r\n");
			...
			sql.append("      FROM TT_CRM_COMPLAINT_DEAL_RECORD DRD where DRD.cp_status = "+Constant.COMPLAINT_STATUS_DOING_ALREADY+"  GROUP BY DRD.CP_ID) Z ON Z.CP_ID = COMPLAINT.CP_ID");
