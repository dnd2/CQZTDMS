/**********************************************************************
* <pre>
* FILE : BackChangeApplyQueryDao.java
* CLASS : BackChangeApplyQueryDao
* 
* AUTHOR : WangJinBao
*
* FUNCTION : 退换车申请书大区和技术支持室查询DAO.
*
*
*======================================================================
* CHANGE HISTORY LOG
 ...
 * @version       :  0.1
 */
public class BackChangeApplyQueryDao extends BaseDao {
	public static Logger logger = Logger.getLogger(BackChangeApplyQueryDao.class);
	private static final BackChangeApplyQueryDao dao = new BackChangeApplyQueryDao ();
	public static final BackChangeApplyQueryDao getInstance() {
		return dao;
	}
	/**
	 * 退换车申请书大区审核查询：
	...
	public   PageResult<Map<String, Object>> backChangeApplyQuery(Long orgId,int pageSize, int curPage, String whereSql,List<Object> params) throws Exception {
		...
		sb.append(" where t.is_del = 0 and t.ex_status <> 10141001");
