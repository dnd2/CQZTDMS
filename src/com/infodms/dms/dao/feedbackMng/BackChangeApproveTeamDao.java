/**********************************************************************
* <pre>
* FILE : BackChangeApproveTeamDao.java
* CLASS : BackChangeApproveTeamDao
* 
* AUTHOR : WangJinBao
*
* FUNCTION : 退换车申请书大区审核DAO.
*
*
*======================================================================
* CHANGE HISTORY LOG
 ...
 * @version       :  0.1
 */
public class BackChangeApproveTeamDao extends BaseDao {
	public static Logger logger = Logger.getLogger(BackChangeApproveTeamDao.class);
	private static final BackChangeApproveTeamDao dao = new BackChangeApproveTeamDao ();
	public static final BackChangeApproveTeamDao getInstance() {
		return dao;
	}
	/**
	 * 退换车申请书大区审核查询：
	...
	public   PageResult<Map<String, Object>> backChangeApproveTeamQuery(int pageSize, int curPage, String whereSql,List<Object> params) throws Exception {
		...
		sb.append(" where t.is_del = 0 and t.ex_status = 10141002 ");
		if(whereSql != null && !"".equals(whereSql.trim())){
			sb.append(whereSql);
		}
		
		sb.append(" order by ex_date desc");
		result = (PageResult<Map<String, Object>>) pageQuery(sb.toString(), params, "com.infodms.dms.dao.feedbackMng.BackChangeApproveTeamDao.backChangeApproveTeamQuery", pageSize, curPage);
		return result;
	}
