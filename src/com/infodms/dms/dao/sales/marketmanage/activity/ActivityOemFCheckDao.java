...
public class ActivityOemFCheckDao  extends BaseDao{

	public Logger logger = Logger.getLogger(UserManageDao.class);
	
	private static final ActivityOemFCheckDao dao = new ActivityOemFCheckDao();

	public static final ActivityOemFCheckDao getInstance() {
		return dao;
	}
	@Override
	 ...
	 * @return
	 */
	public PageResult<Map<String,Object>> activityOemCheckQuery(Map<String,String> param,int curPage,int pageSize){
		PageResult<Map<String,Object>> list=null;
		...
		sql.append(" WHERE 1 = 1");
		sql.append(" AND  TPA.STATUS IN(91921013)\n");
