...
public class ActivityDealerDao  extends BaseDao{

	public Logger logger = Logger.getLogger(UserManageDao.class);
	
	private static final ActivityDealerDao dao = new ActivityDealerDao();

	public static final ActivityDealerDao getInstance() {
		return dao;
	}
	@Override
	 ...
	 * @return
	 */
	public PageResult<Map<String,Object>> activityDealerQuery(Map<String,String> param,int curPage,int pageSize){
		PageResult<Map<String,Object>> list=null;
		...
		sql.append(" WHERE TPA.DEALER_ID = "+dealerId+"\n");
		sql.append(" AND   TPA.DEALER_ID=TD.DEALER_ID\n");
		sql.append(" AND  TPA.STATUS IN(91921001 )\n");
