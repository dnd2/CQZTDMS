...
public class ActivityOemCheckDao  extends BaseDao{

	public Logger logger = Logger.getLogger(UserManageDao.class);
	
	private static final ActivityOemCheckDao dao = new ActivityOemCheckDao();

	public static final ActivityOemCheckDao getInstance() {
		return dao;
	}
	@Override
	...
	public PageResult<Map<String,Object>> activityOemCheckQuery(Map<String,String> param,int curPage,int pageSize){
		...
		sql.append(" WHERE 1 = 1");
		sql.append(" AND  TPA.STATUS IN(91921003)\n");
