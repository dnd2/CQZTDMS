...
public class ActivityAreaPriceDao  extends BaseDao{

	public Logger logger = Logger.getLogger(UserManageDao.class);
	
	private static final ActivityAreaPriceDao dao = new ActivityAreaPriceDao();

	public static final ActivityAreaPriceDao getInstance() {
		return dao;
	}
	@Override
	 ...
	 * @return
	 */
	public PageResult<Map<String,Object>> activityAreaPriceQuery(Map<String,String> param,int curPage,int pageSize){
		PageResult<Map<String,Object>> list=null;
		...
		sql.append(" WHERE 1 = 1");
		sql.append(" AND  TPA.STATUS IN(91921004,91921005)\n");
