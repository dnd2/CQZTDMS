...
public class ActivityCancelDao  extends BaseDao{

	public Logger logger = Logger.getLogger(UserManageDao.class);
	
	private static final ActivityCancelDao dao = new ActivityCancelDao();

	public static final ActivityCancelDao getInstance() {
		return dao;
	}
	@Override
	 ...
	 * @return
	 */
	public PageResult<Map<String,Object>> activityCancelQuery(Map<String,String> param,int curPage,int pageSize){
		PageResult<Map<String,Object>> list=null;
