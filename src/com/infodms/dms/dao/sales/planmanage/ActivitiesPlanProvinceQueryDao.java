...
public class ActivitiesPlanProvinceQueryDao extends BaseDao{
	public static Logger logger = Logger.getLogger(ActivitiesPlanProvinceQueryDao.class);
	private static final ActivitiesPlanProvinceQueryDao dao = new ActivitiesPlanProvinceQueryDao();
	public static final ActivitiesPlanProvinceQueryDao getInstance() {
		return dao;
	}
	...
	public PageResult<Map<String, Object>> activitiesQuery(Map<String,String> map,int curPage,int pageSize) throws Exception{
        ...
        sql.append("   AND TCP.CHECK_STATUS = "+Constant.CAMPAIGN_CHECK_STATUS_14+"\n");
