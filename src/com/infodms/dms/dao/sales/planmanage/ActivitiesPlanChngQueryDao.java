...
public class ActivitiesPlanChngQueryDao extends BaseDao{
	public static Logger logger = Logger.getLogger(ActivitiesPlanChngQueryDao.class);
	private static final ActivitiesPlanChngQueryDao dao = new ActivitiesPlanChngQueryDao();
	public static final ActivitiesPlanChngQueryDao getInstance() {
		return dao;
	}
	...
	public PageResult<Map<String, Object>> activitiesQuery(Map<String,String> map,int curPage,int pageSize) throws Exception{
        ...
        sql.append("       TCPR.CHECK_STATUS REQ_STATUS,\n" );
        ...
        sql.append("  FROM TT_CAMPAIGN_PLAN TCP, TT_CAMPAIGN TC,TT_CAMPAIGN_PLAN_REQ TCPR,TT_CAMPAIGN_SUMMERY TCS\n" );
        sql.append(" WHERE TCP.CAMPAIGN_ID = TC.CAMPAIGN_ID\n" );
        sql.append(" AND TCP.CAMPAIGN_ID = TCPR.CAMPAIGN_ID\n" );
        ...
        sql.append("   AND TCPR.CHECK_STATUS NOT IN("+ Constant.CAMPAIGN_CHECK_STATUS_16+")\n" );
