...
public class ActivitiesPlanDealerQueryDao extends BaseDao{
	public static Logger logger = Logger.getLogger(ActivitiesPlanDealerQueryDao.class);
	private static final ActivitiesPlanDealerQueryDao dao = new ActivitiesPlanDealerQueryDao();
	public static final ActivitiesPlanDealerQueryDao getInstance() {
		return dao;
	}
