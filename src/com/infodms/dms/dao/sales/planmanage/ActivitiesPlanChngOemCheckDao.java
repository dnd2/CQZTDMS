...
public class ActivitiesPlanChngOemCheckDao extends BaseDao{
	public static Logger logger = Logger.getLogger(ActivitiesPlanChngOemCheckDao.class);
	private static final ActivitiesPlanChngOemCheckDao dao = new ActivitiesPlanChngOemCheckDao();
	public static final ActivitiesPlanChngOemCheckDao getInstance() {
		return dao;
	}
	...
	public PageResult<Map<String, Object>> activitiesChngQuery(Map<String,String> map,int curPage,int pageSize) throws Exception{
        ...
        sql.append("AND TCPR.CHECK_STATUS IN("+ Constant.CAMPAIGN_CHECK_STATUS_20+",")
