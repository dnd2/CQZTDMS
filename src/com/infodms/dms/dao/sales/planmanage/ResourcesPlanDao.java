...
public class ResourcesPlanDao extends BaseDao{

	public static Logger logger = Logger.getLogger(YearPlanDao.class);
	private static final ResourcesPlanDao dao = new ResourcesPlanDao ();
	public static final ResourcesPlanDao getInstance() {
		return dao;
	}
	 ...
	 * 月度任务校验车系是否存在
	 */
	public  List<Map<String, Object>> oemResourcesPlanCheckGroup(Map<String, Object> map){
	 ...
	 * 月度任务校验车系是否与业务范围一致
	 */
	public  List<Map<String, Object>> oemResourcesPlanCheckGroupArea(Map<String, Object> map){
		String year=map.get("year").toString();
		String month=map.get("month").toString();
		String userId=map.get("userId").toString();
	 ...
	 * 插入主表数据
	 */
	public int insertResourcesPlan(Map<String, Object> map) {
		String year=map.get("year").toString();
		String month=map.get("month").toString();
		String userId=map.get("userId").toString();
		...
		sql.append("merge into TT_VS_RESOURCES_PLAN tp\n");
	 ...
	 * 插入明细表数据
	 */
	public int insertResourcesPlanDetail(Map<String, Object> map) {
		String year=map.get("year").toString();
		String month=map.get("month").toString();
		String userId=map.get("userId").toString();
		String areaId=map.get("areaId").toString();
		...
		sql.append("MERGE into TT_VS_RESOURCES_PLAN_DETAIL a\n");
		sql.append("using (select tpp.PLAN_ID, tvmg.GROUP_ID, tmpp.PLAN_AMT\n");  
		sql.append("         from TT_VS_RESOURCES_PLAN  tpp,\n");  
		sql.append("              TMP_VS_RESOURCES tmpp,\n");  
	 ...
	 */
	public boolean isDateDump(TmpVsResourcesPO paraPo){
		List<Object> params = new LinkedList<Object>();
		StringBuffer sql=new StringBuffer("");
		boolean bl=true;
	 ...
	 */
	//SQL1
	public List<Map<String, Object>> selectPlanWeekList(TmpVsResourcesPO conPo){
		List<Object> params = new LinkedList<Object>();
		StringBuffer sql=new StringBuffer("");
	 ...
	 * 查询未确认生产计划
	 */
	public List<Map<String, Object>> selectUnconfirmResourcesPlan(String posId,String companyId){
		List<Object> params = new LinkedList<Object>();
		StringBuffer sql=new StringBuffer("");
		...
		sql.append("          from TT_VS_RESOURCES_PLAN tp\n");  
		...
		sql.append("          from TT_VS_RESOURCES_PLAN        p,\n");  
		sql.append("               TT_VS_RESOURCES_PLAN_DETAIL d,\n");  
	 ...
	 * 查询未确认生产计划
	 */
	public List<Map<String, Object>> selectUnconfirmResourcesPlanDetail(String year,String month,String areaId,List<Map<String, Object>> weekList,String companyId){
		List<Object> params = new LinkedList<Object>();
		StringBuffer sql=new StringBuffer("");
	...
	public PageResult<Map<String, Object>> selectWeeklyProPlanConfig(Map<String, Object> map, int curPage, int pageSize){
		...
		sql.append(" from TT_VS_RESOURCES_PLAN tvpp,TT_VS_RESOURCES_PLAN_DETAIL tvppd\n");  
		...
		sql.append(" where tvwpp.plan_year=2010 and tvwpp.plan_month=9\n");  
		...
		sql.append("\n");  
		sql.append("        select 1\n");  
		sql.append("          from TT_VS_RESOURCES_PLAN_DETAIL d, TT_VS_RESOURCES_PLAN p\n");  
		sql.append("         where p.PLAN_ID = d.PLAN_ID\n");  
		sql.append("           and d.group_id=g.group_id\n");  
		sql.append("           and p.PLAN_YEAR = "+year+"\n"); 
		sql.append("           and p.PLAN_MONTH = "+month+"\n");  
	 ...
	 * 生产计划查询
	 */
	public PageResult<Map<String, Object>> ResourcesPlanSearch(Map<String, Object> conMap,List<Map<String, Object>> weekList, int pageSize,int curPage){
	 ...
	 * 生产计划查询
	 */
	public List<Map<String, Object>> ResourcesPlanDownLoadSearch(Map<String, Object> conMap,List<Map<String, Object>> weekList){
		String year=CommonUtils.checkNull(conMap.get("year"));
		String month=CommonUtils.checkNull(conMap.get("month"));
		String areaId=CommonUtils.checkNull(conMap.get("areaId"));
		String groupCode=CommonUtils.checkNull(conMap.get("groupCode"));
