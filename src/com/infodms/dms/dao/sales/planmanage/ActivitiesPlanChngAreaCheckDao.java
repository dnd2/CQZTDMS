...
public class ActivitiesPlanChngAreaCheckDao extends BaseDao{
	public static Logger logger = Logger.getLogger(ActivitiesPlanChngAreaCheckDao.class);
	private static final ActivitiesPlanChngAreaCheckDao dao = new ActivitiesPlanChngAreaCheckDao();
	public static final ActivitiesPlanChngAreaCheckDao getInstance() {
		return dao;
	}
	...
	public PageResult<Map<String, Object>> activitiesChngQuery(Map<String,String> map,int curPage,int pageSize) throws Exception{
        ...
        sql.append("AND TCPR.CHECK_STATUS IN("+ Constant.CAMPAIGN_CHECK_STATUS_18+",")
