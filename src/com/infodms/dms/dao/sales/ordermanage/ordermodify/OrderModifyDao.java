 ...
 * </pre>
 ***********************************************************************/
package com.infodms.dms.dao.sales.ordermanage.ordermodify;
 ...
 * @remark
 */
public class OrderModifyDao extends BaseDao<PO> {

	public static Logger logger = Logger.getLogger(OrderDeliveryDao.class);
	private static final OrderModifyDao dao = new OrderModifyDao();

	public static final OrderModifyDao getInstance() {
		return dao;
	}
	 ...
	 * @throws Exception
	 */
	public PageResult<Map<String, Object>> getOrderResourceModifyQuery(Map<String, Object> map, int curPage, int pageSize) throws Exception {
		...
		String dlvryReqNo = (String) map.get("dlvryReqNo");
		...
		sql.append("                TVDR.DLVRY_REQ_NO,\n" );
		sql.append("                TVOD.ORDER_AMOUNT ORDER_AMOUNT,\n" );
		sql.append("                TVDRD.RESERVE_AMOUNT RESERVE_AMOUNT,\n" );
		sql.append("                TOD.ORDER_NO TOD_ID\n" );
		sql.append("  FROM TT_VS_ORDER TVO,\n" );
		sql.append("       (SELECT TVODS.ORDER_ID, SUM(TVODS.ORDER_AMOUNT) ORDER_AMOUNT\n" );
		sql.append("          FROM TT_VS_ORDER_DETAIL TVODS\n" );
		sql.append("         GROUP BY TVODS.ORDER_ID) TVOD,\n" );
		sql.append("       TT_VS_DLVRY_REQ TVDR,\n" );
		sql.append("       (SELECT T.REQ_ID, SUM(T.RESERVE_AMOUNT) RESERVE_AMOUNT\n" );
		sql.append("          FROM TT_VS_DLVRY_REQ_DTL T\n" );
		...
		sql.append("   AND TC2.CODE_ID = TVDR.REQ_STATUS\n" );
		sql.append("   AND TVDR.REQ_ID = TVDRD.REQ_ID\n" );
		sql.append("   AND TVO.BILLING_ORG_ID = TMD.DEALER_ID\n" );
		...
		if (dlvryReqNo != null && !"".equals(dlvryReqNo)) {
			sql.append("   AND TVDR.DLVRY_REQ_NO LIKE '%" + dlvryReqNo + "%'\n");
		}
	 ...
	 * @throws Exception
	 */
	public PageResult<Map<String, Object>> getOrderResourceModifyLoadQuery(Map<String, Object> map, int curPage, int pageSize) throws Exception {
...
//		sql.append("           AND TV.LIFE_CYCLE = " + Constant.VEHICLE_LIFE_02 + " --车厂库存\n");
	...
	public Map<String, Object> getMaterialInfo(String materialCode, String year, String week, String priceId, String companyId, String entityCode,String dealerCode,String orderType,String orderId) {
