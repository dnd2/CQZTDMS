 ...
 * @remark
 */
public class PcGroupDao extends BaseDao<PO>{
	
	private static final PcGroupDao dao = new PcGroupDao();
	
	public static final PcGroupDao getInstance() {
		return dao;
	}
	@Override
	...
	public int checkGroupName(Map<String, String> map) {
		...
		sql.append("  from t_pc_group tpc\n" );
		sql.append(" where tpc.dealer_id = "+dealerId+" and tpc.group_name = '"+groupName+"'");
		if(groupId!=null&&!"".equals(groupId)){
			sql.append(" and tpc.group_id!="+groupId);
		}
