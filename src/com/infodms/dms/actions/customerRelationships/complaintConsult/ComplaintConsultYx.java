 ...
 */
public class ComplaintConsultYx {
	private static Logger logger = Logger.getLogger(ComplaintConsultYx.class);
	//投拆咨询查看页面
	private final String ComplaintConsultWatchUrl = "/jsp/customerRelationships/complaintConsult/complaintConsultWatchYx.jsp";
