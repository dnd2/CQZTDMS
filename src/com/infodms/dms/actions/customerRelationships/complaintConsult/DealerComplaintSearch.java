 ...
 * CreateDate     : 2013-5-7
 */
public class DealerComplaintSearch {
	private static Logger logger = Logger.getLogger(DealerComplaintSearch.class);
	//投诉查询页面
	private final String ComplaintSearch = "/jsp/customerRelationships/complaintConsult/dealerComplaintSearch.jsp";
	ActionContext act = ActionContext.getContext();
	AclUserBean logonUser = (AclUserBean)act.getSession().get(Constant.LOGON_USER);
	RequestWrapper request = act.getRequest();
	
	//投诉受理初始化
	public void dealerComplaintSearchInit(){
		try{
	...
	public void queryDealerComplaintSearch(){
		...
		try{
			...
			PageResult<Map<String,Object>> complaintAcceptData = dao.queryComplaintDealerSearch(vin,name,tele,level,dealUser,accUser,biztype,
					status,dealStart,dealEnd,dateStart,dateEnd,region,pro,checkStart,checklEnd,logonUser.getDealerId(),Constant.PAGE_SIZE,curPage);
	...
	public void dealerComplaintSearchDownExcel(){
		try{
			...
			List<Map<String, Object>> complaintAcceptData =  dao.queryComplaintDealerSearchList(vin,name,tele,level,dealUser,accUser,biztype,
					status,dealStart,dealEnd,dateStart,dateEnd,region,pro,checkStart,checklEnd,logonUser.getDealerId());
