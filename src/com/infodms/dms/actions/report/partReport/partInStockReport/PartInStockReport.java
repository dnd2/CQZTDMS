...
public class PartInStockReport extends BaseImport {
    public Logger logger = Logger.getLogger(PartDlrOrderCheck.class);
    String init = "/jsp/report/partSalesReport/partInStockRepMain.jsp";
...
//                        detail[6] = CommonUtils.checkNull(map.get("PART_CODE"));
                        ...
                        detail[9] = CommonUtils.checkNull(map.get("IN_PRICE"));
