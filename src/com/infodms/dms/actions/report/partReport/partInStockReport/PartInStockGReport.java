package com.infodms.dms.actions.report.partReport.partInStockReport;
...
import com.infodms.dms.dao.report.partSalesReport.PartInStockRepDao;
 ...
 * @ClassName : PartInStockGReport
 * @Description : 供应中心报表>入库明细(供应中心)
 */
public class PartInStockGReport extends BaseImport {
    public Logger logger = Logger.getLogger(PartDlrOrderCheck.class);
    String init = "/jsp/report/partSalesReport/partInStockGRepMain.jsp";
    ...
    public void query() {
        ...
        PartInStockRepDao dao = PartInStockRepDao.getInstance();
        try {
            Integer curPage = request.getParamValue("curPage") != null ? Integer
                    .parseInt(request.getParamValue("curPage"))
                    : 1; // 处理当前页
            PageResult<Map<String, Object>> ps = null;
            ps = dao.queryGRep(request, curPage, Constant.PAGE_SIZE, loginUser);
            ...
            if (null != list && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (map != null && map.size() != 0) {
                        ...
                        detail[10] = CommonUtils.checkNull(map.get("IN_PRICE"));
                        detail[11] = CommonUtils.checkNull(map.get("IN_AMOUNT"));
