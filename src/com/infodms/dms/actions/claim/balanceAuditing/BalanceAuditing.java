...
***********************************************************************/
/**
 * $Id: BalanceAuditing.java,v 1.12 2010/12/24 06:39:38 xiaob Exp $
 */
 ...
 * @author XZM
 */
public class BalanceAuditing implements Runnable{
	
	private Logger logger = Logger.getLogger(BalanceAuditing.class);
	/** 索赔申请单ID */
	private String claimId = "";
	/** 结算单ID */
	private String balanceId = "";
	
	public BalanceAuditing(String claimId,String balanceId){
	...
	public void run() {
		...
		try{	
			 ...
			 * 满足以上规则的不再进行审核
			 */
			if(orderVO.getClaimPO()==null || this.balanceId==null){
