...
***********************************************************************/
/**
 * $Id: ClaimAuditingNewJC.java,v 1.1 2011/06/07 07:08:55 yx Exp $
 */
 ...
 * @author XZM
 */
public class ClaimAuditingNewJC{
...
//	private String balanceId = "";
	...
	public ClaimAuditingNewJC(String claimId){
...
//								(Constant.CLA_TYPE_06.toString().equals(orderVO.getClaimPO().getClaimType().toString())||Constant.CLA_TYPE_02.toString().equals(orderVO.getClaimPO().getClaimType().toString())))){
				if((Constant.CLA_TYPE_06.toString().equals(orderVO.getClaimPO().getClaimType().toString())||Constant.CLA_TYPE_02.toString().equals(orderVO.getClaimPO().getClaimType().toString()))){
