...
/**
 * 
* @ClassName: ServiceActivityApplyServiceAudit 
* @Description: TODO 服务活动申请表售后服务部审批 
* @author wangchao 
* @date May 24, 2010 4:28:38 PM 
*
 */
public class ServiceActivityApplyServiceAudit {
	public Logger logger = Logger.getLogger(ServiceActivityApplyServiceAudit.class);
	...
	private final String serviceActivityApplyTeamAuditURL = "/jsp/feedbackMng/approve/serviceActivityApplyServiceAudit.jsp";// 主页面
	...
	* @Description: TODO 服务活动申请表售后服务部首页跳转
	* @param     
	* @return void    返回类型 
	* @throws
	 */
	public void serviceActivityApplyServiceAuditForward() {
		...
		try {
			...
			BizException e1 = new BizException(act, e,
					ErrorCodeConstant.ACTION_NAME_ERROR_CODE, "服务活动申请表售后服务部审核");
	...
	* @throws
	...
	public void applyQuery() {
		...
		try {
			...
			BizException e1 = new BizException(act,e,ErrorCodeConstant.QUERY_FAILURE_CODE,"服务活动申请表售后服务部审核");
			logger.error(logonUser,e1);
			act.setException(e1);
		}
	}
	...
	* @throws
	...
	public void passOrRefuse() {
		...
		try {
			...
			BizException e1 = new BizException(act, e,
					ErrorCodeConstant.UPDATE_FAILURE_CODE, "服务活动申请表售后服务部审核");
			logger.error(logonUser, e1);
			act.setException(e1);
		}
	}
