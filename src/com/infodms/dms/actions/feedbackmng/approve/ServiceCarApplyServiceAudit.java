...
/**
 * 
* @ClassName: ServiceCarApplyServiceAudit 
* @Description: TODO 服务车申请表售后服务部审批 
* @author wangchao 
* @date May 24, 2010 4:28:38 PM 
*
 */
public class ServiceCarApplyServiceAudit {
	public Logger logger = Logger.getLogger(ServiceCarApplyServiceAudit.class);
	...
	private final String serviceCarApplyTeamAuditURL = "/jsp/feedbackMng/approve/serviceCarApplyServiceAudit.jsp";// 主页面
	private final String serviceCarApplyAuditURL = "/jsp/feedbackMng/approve/serviceCarApplyAudit.jsp";// 审批页面
	/**
	 * 
	* @Title: serviceCarApplyServiceAuditForward 
	* @Description: TODO 服务车申请表售后服务部首页跳转
	* @param     
	* @return void    返回类型 
	* @throws
	 */
	public void serviceCarApplyServiceAuditForward() {
		...
		try {
			...
			BizException e1 = new BizException(act, e,
					ErrorCodeConstant.ACTION_NAME_ERROR_CODE, "服务车申请表售后服务部审核");
	...
	public void applyQuery() {
		...
		try {
			...
			if (endDate!=null&&!"".equals(endDate)) {
				con.append(" and t.app_date <= to_date('"+endDate+" 23:59:59', 'yyyy-mm-dd hh24:mi:ss') ");
			}
			//经销商代码
...
//				con.append(" and D.DEALER_CODE='"+dealerCode+"' ");
			...
			BizException e1 = new BizException(act,e,ErrorCodeConstant.QUERY_FAILURE_CODE,"服务车申请表售后服务部审核");
			logger.error(logonUser,e1);
			act.setException(e1);
		}
	}
...
//			act.setForword(serviceCarApplyTeamAuditURL);
			serviceCarApplyServiceAuditForward();
		} catch (Exception e) {
			BizException e1 = new BizException(act, e,
					ErrorCodeConstant.UPDATE_FAILURE_CODE, "服务车申请表售后服务部审核");
			logger.error(logonUser, e1);
			act.setException(e1);
		}
	}
