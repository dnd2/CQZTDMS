...
/**
 * @Title: QueryDealerStandardVipManage.java
 *
 ...
 * @remark 
 */
public class QueryDealerStandardVipManage {
	
	public Logger logger = Logger.getLogger(StandardVipApplyManager.class);   
	private ActionContext act = ActionContext.getContext();
	RequestWrapper request = act.getRequest();
	
	private final String initUrl = "/jsp/feedbackMng/query/queryDealerStanderVip.jsp";
	
	/**
	 * 合格证/VIP卡申请表查询初始化（经销商）
	 */
	public void queryDealerStandardVipInit(){
	...
	public void queryStandardVip(){
		...
		try {
			...
			Integer curPage = request.getParamValue("curPage") != null ? Integer
					...
					: 1; // 处理当前页	
			PageResult<Map<String, Object>> ps = smDao.queryDealerStandardVip(smb,curPage,Constant.PAGE_SIZE);
			//分页方法 end
