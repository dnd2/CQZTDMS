...
public class UnCheckVehicle extends BaseDao {
	public Logger logger = Logger.getLogger(UnCheckVehicle.class);
	...
	private final String UnCheckVehicleInitUrl = "/jsp/sales/storageManage/unCheckVehicleInit.jsp";
	 ...
	 */
	public void unCheckVehicleInit() {
		...
		try {
			...
			List<Map<String,Object>> list=CheckVehicleDAO.getCheckLists(poseId, dealerIds, null, null,null, Constant.PAGE_SIZE, 1);;
			act.setOutData("list", list);
			act.setForword(UnCheckVehicleInitUrl);
		} catch (Exception e) {
	...
	public void unCheckList() {
		...
		try {
			...
			PageResult<Map<String, Object>> ps = CheckVehicleDAO.getUnCheckList(dutyType,orgId,poseId, dealerIds, vin, dlvNo,dlvryNo, Constant.PAGE_SIZE, curPage);
