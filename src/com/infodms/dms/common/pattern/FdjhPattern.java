...
public class FdjhPattern extends MyPattern
{
	public void compile(ErrorMsgContainer container, Object... parms) throws BizException
	{
		...
		if(value.length() == 0 && minLength != 0) {
			...
			if (!ValidateUtil.isFdjh(value,minLength, maxLength))
			{
				container.addErrorMsg(actionKey + "发动机号格式错误");
			}
		}
	}
