...
public class CheckUtil {
	...
	private static final String SEQUENCE_FORMAT_STR5 = "^[0-9]+\\.{0,1}[0-9]{0,2}$";
	...
	private static final String SEQUECNE_FORMAT_STR5="^[-]?\\d+\\.?\\d*$";
	/**
	...
	/**
	 * 判断输入的字符必须是正整数或者1.1111的格式, 而且第一位不能为0；
	 * @param source
	 * @return 如果符合规则则返回true,否则返回false
	 */
	public static boolean checkFormatNumber1(String source){
	...
	public static void main(String[] args) {
		System.out.println(checkFormatNumber1("11.11111"));
	}
}
