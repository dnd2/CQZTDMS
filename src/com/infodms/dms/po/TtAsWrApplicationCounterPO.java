...
public class TtAsWrApplicationCounterPO extends PO{
	...
	public void setWinterMoney(Double winterMoney){
		this.winterMoney=winterMoney;
	}

	public Double getWinterMoney(){
		return this.winterMoney;
	}
