...
*
* CreateDate : 2013-05-15 09:28:01
...
public class TmVehicleRetreatHistoryPO extends PO{
	...
	private String retreatdes;
	private String remark;
	private Date retreatDate;
	private String vn;
	
	/*2015.8.31 艾春 添加退回生产线类型*/
	...
	public void setRetreatBy(Long retreatBy){
		this.retreatBy=retreatBy;
	}

	public Long getRetreatBy(){
		return this.retreatBy;
	}
	...
	public void setRetreatdes(String retreatdes){
		this.retreatdes=retreatdes;
	}

	public String getRetreatdes(){
		return this.retreatdes;
	}
