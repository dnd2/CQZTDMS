...
public class TtAsWrPartsitemCounterPO extends PO{
	...
	public void setIsCliams(Integer isCliams){
		this.isCliams=isCliams;
	}

	public Integer getIsCliams(){
		return this.isCliams;
	}
