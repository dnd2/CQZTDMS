...
public class TrRolePosePO extends PO{
	...
	public void setRolePoseType(Integer rolePoseType){
		this.rolePoseType=rolePoseType;
	}

	public Integer getRolePoseType(){
		return this.rolePoseType;
	}
