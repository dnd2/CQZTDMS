...
public class TiSUsersRecordPO extends PO{
	...
	public void setMaintGuideNo(String maintGuideNo){
		this.maintGuideNo=maintGuideNo;
	}

	public String getMaintGuideNo(){
		return this.maintGuideNo;
	}
