...
public class CustomerComplaintVO extends BaseVO {
	...
	//下发的list
	private HashMap<Integer, BaseVO> dealVoList; //下端：处理信息列表    上端：  
	...
	public HashMap<Integer, BaseVO> getDealVoList() {
		return dealVoList;
	}
	public void setDealVoList(HashMap<Integer, BaseVO> dealVoList) {
