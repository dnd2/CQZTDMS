...
/**
 * @ClassName     : PtAllocationOutDetailVo 
 * @Description   : 下发配件出库明细VO
 * @author        : luole
 * CreateDate     : 2013-5-28
 */
@SuppressWarnings("serial")
public class PtAllocationOutDetailVO extends BaseVO{
	...
	private Double inPrice;// 上端：调拨不含税单价	NUMERIC(12,4)  下端：
