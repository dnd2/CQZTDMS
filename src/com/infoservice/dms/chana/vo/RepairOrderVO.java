 ...
 *
 * @File name:  com.infoservice.dms.dc.vo.GmsRepairOrderVO.java
 * @Create on:  2009-4-2
 * @Author   :  zhangdongjie
 *
 * @ChangeList
...
public class RepairOrderVO extends BaseVO {
	...
	private String delivererAddress; //送修人地址
	...
	private LinkedList labourVoList; //下端：维修项目列表    上端：  
	private LinkedList repairPartVoList; //下端：维修配件列表    上端：  
	private LinkedList salesPartVoList; //下端：销售配件列表    上端： 现在上端不需要
	private LinkedList addItemVoList; //下端：附加项目列表    上端：  
	private LinkedList manageVoList; //下端：辅料管理费列表    上端：  
	...
	public LinkedList getSalesPartVoList() {
		return salesPartVoList;
	}
	public void setSalesPartVoList(LinkedList salesPartVoList) {
	...
	public LinkedList getManageVoList() {
		return manageVoList;
	}
	public void setManageVoList(LinkedList manageVoList) {
