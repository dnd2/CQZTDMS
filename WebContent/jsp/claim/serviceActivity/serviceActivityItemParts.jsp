...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageItem/serviceActivityManageItemPartsQuery.json";
	var title = null;
	var columns = [
				...
				{id:'action',header: "数量",sortable: false,dataIndex: 'PART_QUANTITY' ,align:'center',renderer:partsQuantity},
...
function sures(str,st){
	makeNomalFormCall('<%=request.getContextPath()%>/claim/serviceActivity/ServiceActivityManageItem/serviceActivityManageItemPartsOption.json?partsId='+str+'&PART_QUANTITY='+st,delBack,'fm','queryBtn');
}
