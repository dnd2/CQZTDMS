...
<body>
<div class="wbox">
  <div class="navigation"><img src="<%=contextPath%>/img/nav.gif" alt=""/>&nbsp;当前位置： 售后服务管理&gt;服务活动管理&gt;服务活动查询</div>
    <!-- 查询条件 begin -->
	           ...
	           <tr>
	              <td style="text-align:right">服务站：</td>
					<td >
      				...
      				<input name="DealerName" type="text" id="DealerName" readonly onclick="showOrgDealer('DealerCode','','false', '', 'true','','','DealerName');" class="middle_txt" value="" />
                    <!-- <input name="dlbtn" type="button" class="mini_btn" onclick="showOrgDealer('DealerCode','','false', '', 'true','','10771001','DealerName');" value="..." /> -->
                ...
                <tr>
				  <td colspan="4" style="text-align:center">
	                <input class="normal_btn" type="button" value="查 询" name="recommit" name="queryBtn" onclick="__extQuery__(1);" />
	              </td>
		       </tr>
  </table>
  </div>
