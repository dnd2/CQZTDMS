...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummarySearch/serviceActivityManageSummaryEvaluateQueryChaxun.json";
	...
	function mySelect(value,meta,record){
         ...
         "<a href=\"#\" onclick='sel(\""+record.data.SUBJECT_ID+"\")'>[查看]</a><a href=\"#\" onclick='print(\""+record.data.SUBJECT_ID+"\")'>[打印]</a>");
	}
	//详细页面
	function sel(value){
	     fm.action = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummarySearch/serviceActivityEvaluateQueryChaxun.do?subject_id="+value ;
		fm.submit();
	}
	
	//print页面
	function print(value){
	     window.open("<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummarySearch/serviceActivityEvaluateQueryPrint.do?subject_id="+value,"","toolbar,menubar,scrollbars,resizable,status,location,directories,copyhistory,height=600,width=500");
	}
</script>
<!--页面列表 end -->
</body>
