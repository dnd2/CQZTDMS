...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummaryDealerSearch/serviceActivityManageSummaryDealerSearchQuery.json";
	...
	function mySelect(value,meta,record){
         ...
         "<a href=\"#\" onclick='sel(\""+record.data.SUBJECT_ID+"\")'>[查看]</a>");
	}
	//详细页面
	function sel(value){
	    fm.action = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummaryDealerSearch/serviceActivitySummaryQuery.do?subject_id="+value ;
		fm.submit();
	}
</script>
<!--页面列表 end -->
