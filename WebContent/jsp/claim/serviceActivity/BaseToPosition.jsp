...
<script type="text/javascript" >
var myPage;
	var url = "<%=request.getContextPath()%>/claim/serviceActivity/ServiceActivityManage/open_part.json";
	var title = null;
	...
	function myCheckBox(value,metaDate,record){
		...
		if(check==1){
		    if('${is_add}' == '1')
		    {
		    	input2='<input type="checkbox" disabled="disabled" id="checkId" name="checkId"  value="'+value+'" checked/>';
		    }else
		    {
	...
	function add()
	{
		makeNomalFormCall('<%=request.getContextPath()%>/claim/serviceActivity/ServiceActivityManage/add_part.json',updateBack,'fm','');
	}
