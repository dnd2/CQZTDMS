...
<body>
	<div class="navigation">
		<img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;服务活动管理&gt;服务活动评估技术室确认
	</div>
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummarySearch/serviceActivityManageSummaryEvaluateQueryZR.json";
	...
	function mySelect(value,meta,record){
         ...
         "<a href=\"#\" onclick='sel(\""+record.data.SUBJECT_ID+"\")'>[确认]</a>");
	}
	//详细页面
	function sel(value){
	     fm.action = "<%=contextPath%>/claim/serviceActivity/ServiceActivityManageSummarySearch/serviceActivityEvaluateQueryZR.do?subject_id="+value ;
		fm.submit();
	}
</script>
<!--页面列表 end -->
