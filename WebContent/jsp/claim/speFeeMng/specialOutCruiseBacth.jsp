...
<script type="text/javascript" >
	...
	var myPage;
//查询路径
	var url = "<%=contextPath%>/claim/speFeeMng/SpecialOutCruiseBacth/specialBacthQuery.json";
	...
	function approveDetail(value){
		var submit_url="<%=contextPath%>/claim/speFeeMng/SpecialOutCruiseBacth/specialBacthQueryInit.do?id="+ value;
