       ...
       <tr>
          <td align="right" nowrap="true">经销商代码：</td>
			<td align="left" nowrap="true">
                <textarea rows="3" cols="25" id="dealerCode"  name="dealerCode"></textarea>
...
<script type="text/javascript">
   ...
   //查询路径
   var url = "<%=contextPath%>/claim/speFeeMng/CruiServicePathVehicleQueryManager/queryCruiInfoOrdList.json";
