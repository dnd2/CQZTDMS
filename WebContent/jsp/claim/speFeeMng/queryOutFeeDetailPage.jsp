 ...
 <form method="post" name ="fm" id="fm">
  ...
  <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="91908E"  class="table_edit">
     ...
     <tr bgcolor="F3F4F8">
       ...
       <td>
          <%=CommonUtils.checkNull(detailSpeBean.getPerson_num())%>人
       </td>
     ...
     <tr bgcolor="F3F4F8">
       ...
       <td>
          <%=CommonUtils.checkNull(detailSpeBean.getSingle_mileage())%>km
       </td>
       <td align="right">过路过桥费：</td>
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getPass_fee())%>')+'元'));
          </script>
       </td>
     </tr>
     <tr bgcolor="F3F4F8">
       ...
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getTraffic_fee())%>')+'元'));
          </script>
       </td>
       <td align="right">住宿费：</td>
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getQuarter_fee())%>')+'元'));
          </script>
       </td>
     </tr>
     <tr bgcolor="F3F4F8">
       ...
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getEat_fee())%>')+'元'));
          </script>
       </td>
       <td align="right">人员补助：</td>
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getPerson_subside())%>')+'元'));
          </script>
       </td>
     </tr>
     <tr bgcolor="F3F4F8">
       ...
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<%=CommonUtils.checkNull(detailSpeBean.getTotal_fee())%>')+'元'));
          </script>
       </td>
  ...
  <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="91908E"  class="table_edit">
     <tr>
       <th colspan="12"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />车辆信息</th>
     </tr>
     <tr bgcolor="F3F4F8">
  ...
  <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="91908E"  class="table_edit">
     <tr>
       <th colspan="12"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />审批明细</th>
     </tr>
     <tr bgcolor="F3F4F8">
...
function doInit(){
	var start_day='<%=CommonUtils.checkNull(detailSpeBean.getStart_date())%>';
	var end_day='<%=CommonUtils.checkNull(detailSpeBean.getEnd_date())%>';
	if(start_day==''||end_day==''){
		document.getElementById("cal_out_days").innerHTML="0 天";
	}else{
		calBetweenDays(start_day,end_day);
	}
}
