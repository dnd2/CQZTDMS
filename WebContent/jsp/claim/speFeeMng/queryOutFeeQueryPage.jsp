...
<script type="text/javascript">
   ...
   //查询路径
   var url = "<%=contextPath%>/claim/speFeeMng/OutFeeQueryManager/queryOutFeeInfoOrdList.json";
   ...
   function queryTSDetail(id){
	   var submit_url="<%=contextPath%>/claim/speFeeMng/OutFeeQueryManager/queryOrdDetailInfoPage.do?ord_id="+ id;
	   OpenHtmlWindow(submit_url,900,500);
   }
</script>
</BODY>
