...
<title>巡航服务线路批复单审核</title>
<script type="text/javascript">
    var isApproveFlag="unApproved";
	function specialBacth(flag){
		...
		var submit_url= "<%=contextPath%>/claim/speFeeMng/SpecialOutCruiseBacth/specialBacth.json";
...
<div class="navigation">
	<img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;特殊费用管理&gt;巡航服务线路批复单
</div>
<form name="fm" id="fm" method="post"> 
          ...
          <tr> 
            ...
            <td align=left>
	            <span class="tbwhite">
		            ...
		            <input type="button"  class="normal_btn" style="width=8%" value="通过" id="passBtn" name="passBtn" onclick="specialBacth(4);"/>
		            <input type="button"  class="normal_btn" style="width=8%" value="退回" id="backBtn" name="backBtn" onclick="specialBacth(8);"/>
		            <input type="button"  class="normal_btn" style="width=8%" value="中止" id="stopBtn" name="stopBtn" onclick="specialBacth(5);"/>
		            <input type="button"  class="normal_btn" style="width=8%" value="关闭" onclick="closeMe();"/>
	            </span>
            </td>
          </tr>
	 </table>
	...
	<table align=center width="95%" class="table_edit" >	
	    ...
	    <tr>
	          ...
	          <input type="hidden" value="<%=feeBean.getId() %>" name="id" id="id" /> 
	   ...
	   <tr>
			 ...
			 <td colspan="3"><%=feeBean.getCrCause()==null?"":feeBean.getCrCause() %></td>
	   </tr>
	</table>
    <br/>
