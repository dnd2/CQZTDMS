...
<body >
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">当前位置&gt;售后服务管理&gt;索赔基础数据&gt;辅料费维护导入</div>
...
<table class="table_query">  
  <tr>
	...
	<tr> 
		<td class="table_query_label" width="65%">3、选择好文件后, 点“<font color="#FF0000">确定</font>”按钮完成导入，导入格式:<font color="#FF0000">工时代码,工时名称,金额,状态 为必填</font>。</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	function upload(){
		btnDisable();
		fm.action = "<%=request.getContextPath()%>/claim/basicData/AccPriceMaintainMain/excelOperate.do";
		fm.submit();
	}
	...
	function downloadFile(){
		fm.action = '<%=request.getContextPath()%>/claim/basicData/AccPriceMaintainMain/download.do';
	    fm.submit();
	}
