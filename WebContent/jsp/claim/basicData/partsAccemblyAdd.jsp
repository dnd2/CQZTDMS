  ...
  <img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;索赔基本数据&gt;总成维护</div>
   ...
   <table  class="table_query">
          <tr>
          	...
          	<td>
          		<input  name="parts_accembly_code" type="text" id="parts_accembly_code" value="" datatype="0,is_null,30"  class="middle_txt" />
          	</td>
          </tr>
          <tr>
          	<td style="text-align:right">总成名称：</td>
          	<td><input name="parts_accembly_name" type="text" id="parts_accembly_name" value=""  datatype="0,is_null,100"  class="middle_txt"/>
          	</td>
          </tr>      
          <tr>
...
function save(){	
	if(submitForm('fm')){
		var url="<%=request.getContextPath()%>/claim/basicData/PartsAssembly/addSavePartsAssembly.json";
