...
<title>索赔工时维护导入</title>

</head>
<body >
<div class="wbox">
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">当前位置&gt;售后服务管理&gt;索赔基础数据&gt;索赔工时维护导入</div>
...
<table class="table_query">  
  <tr>
	...
	<tr> 
		<td class="table_query_label" width="65%">3、选择好文件后, 点“<font color="#FF0000">确定</font>”按钮完成导入，导入格式:<font color="#FF0000">所有例 为必填</font>。</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	function upload(){
		btnDisable();
		fm.action = "<%=request.getContextPath()%>/claim/basicData/ClaimLaborMain/excelOperate.do";
		fm.submit();
	}
