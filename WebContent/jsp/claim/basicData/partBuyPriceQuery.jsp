...
<div class="navigation">
  <img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;索赔基础数据&gt;供应商索赔价格维护</div>
...
<script type="text/javascript">
	var myPage;
		var url = "<%=contextPath%>/claim/basicData/ClaimVenderPrice/claimVenderPriceQuery.json";
		var title = null;
		...
		var columns = [
					...
					{header: "供应索赔单价",dataIndex: 'CLAIM_PRICE'},
...
function checkPri(str){
	 fm.action="<%=contextPath%>/claim/basicData/ClaimVenderPrice/ExchangPrice.do?id="+str;
 	fm.submit();
}
