...
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />
         当前位置：售后服务管理&gt;索赔结算管理&gt;营销结算室审核(室主任)
</div>
...
<table align="center" class="table_query" border='0'>
	<tr>
		...
		<td align="left" nowrap="true">
			<script type="text/javascript">
				genSelBoxExp("claimStatus",1079,"10791007",false,"short_sel","","false",'10791001,10791002,10791003,10791004,10791005,10791006,10791008,10791009,10791010,10791012,10791013,10791014,10791015,10791016');
			</script>
		</td>
...
<script type="text/javascript"><!--
	...
	function claimdetail(id,subject_id){
		...
		fm.action = '<%=contextPath%>/claim/application/ClaimManualAuditing/balancetoalYX.do?dealer_id='+id+"&subject_id="+subject_id+"&admin="+0;
		fm.submit();
	}
