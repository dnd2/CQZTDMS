...
var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/application/BalanceDealerQuery/balanceQuery.json";
...
<img src="../../../img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;索赔申请&gt;结算请单查询（经销商）</div>
  ...
  <TABLE align="center" class="table_query" >
          <tr>
            <td   class="table_query_2Col_label_5Letter">结算单号：</td>
            <td >
            	<input name="BALANCE_NO" id="BALANCE_NO" value="" type="text" class="middle_txt" datatype="1,is_digit_letter,20" />
 		    </td> 
            <td  class="table_query_2Col_label_5Letter">截止日期：</td>
            <td colspan="3">
            	<input name="CON_LAST_DAY" type="text" id="CON_LAST_DAY"  class="short_txt"  datatype="1,is_date,10"  hasbtn="true" callFunction="showcalendar(event, 'CON_LAST_DAY', false);" />
      		</td> 
			</tr>
			<tr>
