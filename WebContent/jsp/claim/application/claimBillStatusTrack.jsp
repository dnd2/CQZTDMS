...
var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/application/ClaimBillStatusTrack/applicationQuery2.json";
	...
	var columns = [
					...
					{header: "车型", width:'7%', dataIndex: 'groupName'},
					...
					{header: "是否扣件", width:'15%', dataIndex: 'kouJian'},
					{header: '索赔总金额',dataIndex:'balanceAmount'},
					{header: "审核人", width:'15%', dataIndex: 'foreAuthPerson'},
					{header:'审核时间',width:'10%',dataIndex:'auditDate',renderer:formatDate2}
...
<div class="navigation"><img src="../../../img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;索赔申请&gt;索赔单查询</div>
...
class="middle_txt"/></td>      
          ...
          <td class="table_query_2Col_label_6Letter" >申请时间：</td>
           <td align="left" nowrap="true">
			...
			<input value=" " type="button" class="time_ico" onclick="showcalendar(event, 'RO_STARTDATE', false);" />  	
             &nbsp;至&nbsp; <input name="RO_ENDDATE" type="text" class="short_time_txt" id="RO_ENDDATE" readonly="readonly"/> 
			<input value=" " type="button" class="time_ico" onclick="showcalendar(event, 'RO_ENDDATE', false);" /> 
		</td>	
	    ...
	    <tr>
			...
			<input value=" " type="button" class="time_ico" onclick="showcalendar(event, 'approve_date', false);" />  	
             &nbsp;至&nbsp; <input name="approve_date2" type="text" class="short_time_txt" id="approve_date2" readonly="readonly"/> 
			<input value=" " type="button" class="time_ico" onclick="showcalendar(event, 'approve_date2', false);" /> 
		</td>
	    </tr>
	    <tr>
