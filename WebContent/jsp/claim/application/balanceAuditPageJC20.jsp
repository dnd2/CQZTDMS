...
<form method="post" name="fm" id="fm">
	...
	<tr><td>
			     ...
			     >
				    ...
				    <%} %>
		     	 	...
		     	 	<%} %>
								...
								<td><input type="text" onblur="isdiscount(<%=j%>,this)" value="<%=mainPartPO.getDeductAmount() %>"  name="DISCOUNT" />  </td>
								<td> 
								<script type="">
		...
		<table class="table_edit" id="amountTabId"  style="">
			<tr>
	...
	<input style="width:150px;color:#1E3988;
		...
		<input class="normal_btn"	type="button" value="驳回" name="bt_back2" onclick="confirmCustom01('${ClaimType1}','fm',this);"/>
...
<script type="text/javascript">
	...
	function backC()
	{
	  ...
	  function showResult(json){
	       ...
	       {
	       	 var fm = document.getElementById("fm");
			 fm.action = '<%=contextPath%>/claim/application/ClaimManualAuditing/balanceAuditingPageJC02.do?isAudit=true';
			 fm.submit();
	       }else
	       {
	       	  var fm = document.getElementById("fm");
