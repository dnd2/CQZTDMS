...
<script type="text/javascript">
		var myPage;
		var url = "<%=contextPath%>/claim/application/DealerNewKpUpdate/viewDealerNewKp.json";
		var title = null;
		...
		{ 
			...
			if(status==<%=Constant.CHANGE_STATUS_1 %>){
				return String.format("<a href='#' onclick='queryInfo(\""+ value +"\")'>[修改]</a><a href='#' onclick='queryPrint(\""+ value +"\")'>[提报]</a>");
			}else{
