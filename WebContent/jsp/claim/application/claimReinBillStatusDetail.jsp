...
<form method="post" name="fm" id="fm">
	<table width="100%">
	 <tr><td>
		...
		<table class="table_edit" id="baseTabId">
			...
			<tr>
				<td align="right" nowrap="true">单据保养次数:</td>
				<td align="left" nowrap="true"><%=CommonUtils.checkNull(tawep.getFreeMAmount()) %>&nbsp;</td>
				<td align="right" nowrap="true">活动代码:</td>
				<td align="left"  nowrap="true"><%=CommonUtils.checkNull(tawep.getCampaignCode()) %>&nbsp;</td>
			...
			<tr>
				...
				<td align="right" nowrap="true">工单结算时间:</td>
	...
	<tr><td>
				    ...
				    -->
				     <td><%=CommonUtils.checkNull(mainPartPO.getDownPartName()) %>&nbsp;
							    ...
							    <td>
							     ...
							     <td>
							     	<script type="">
							    		document.write(getItemValue(<%=CommonUtils.checkNull(mainPartPO.getPartUseType()) %>));

							    	</script>
							     </td>
							     <td><%=mainPartPO.getProducerName()%></td>
							    <td><a href="#" onclick="showText(this);"><%=mainPartPO.getRemark()%></a></td>
							    <!--  <td><%=CommonUtils.checkNull(mainPartPO.getAuthRemark()) %>&nbsp;</td>--> 
				 </tr>
							    <%}}}%>
			<%} %>
		...
		<table class="table_edit" id="compensationMoney" style="">
            ...
            <tr>
                ...
                <td><input name="pass_price" id="pass_price" value="${compensationMoneyList.PASS_PRICE}" type="text" class="middle_txt" readonly></td>
		...
		<table class="table_edit" id="accessories" style="">
            ...
            <tr>
	            ...
	            <td align="left">
					<td >辅料主因件： <input id="accessoriesOutMainPart" name="accessoriesOutMainPart"  value="${accessoryDtlList.MAIN_PART_CODE}" readonly="readonly" class="middle_txt" /></td>
				</td>
		...
		<table class="table_edit">
			<tr>
				<th colspan="10">
					<img src="<%=contextPath%>/img/subNav.gif" alt="" class="nav" />
					&nbsp;<a href="#" onclick="tabDisplayControl('amountTabId')">结算费用</a>
				</th>
			</tr>
		</table>
		...
		<table class="table_edit" id="amountTabId" style="display:none">
			...
			<tr>
				...
				<td align="right" nowrap="true">辅料金额：</td>
			...
			<tr>
				...
				<td align="left" ><%=CommonUtils.currencyFormat(tawep.getLabourDown(),minFractionDigits,defaultValue)%>&nbsp;</td>
				<td align="right" nowrap="true">补偿金额：</td>
	...
	<tr>
		<td>
	    	...
	    	<table class="table_edit" style="border-bottom: 1px solid #DAE0EE;" id="outTable">
				<tr>
					...
					<td width="10%" align="right">出差目的地：</td>
					<td width="25%" align="left">${outInfo.outSite}</td>
				</tr>
				<tr>
					<td width="10%" align="right">开始时间：</td>
					<td width="15%" align="left"><fmt:formatDate value='${outInfo.startTime}' pattern='yyyy-MM-dd hh:mm:ss'/></td>
					<td width="10%" align="right">结束时间：</td>
					<td width="25%" align="left"><fmt:formatDate value='${outInfo.endTime}' pattern='yyyy-MM-dd hh:mm:ss'/></td>
				</tr>
				<tr>
					<td width="10%" align="right">派车车牌号：</td>
					<td width="15%" align="left">${outInfo.outLicenseno}</td>
					<td width="10%" align="right">单程里程：</td>
		...
		<table class="table_edit" id="amountTabId" style="display:none">
			...
			<tr>
				...
				<td align="left"><%=CommonUtils.checkNull(tawep.getPartDown())%>&nbsp;</td>
				<td align="right" nowrap="true">工时费打折金额：</td>
				<td align="left" colspan="5"><%=CommonUtils.currencyFormat(tawep.getLabourDown(),minFractionDigits,defaultValue)%>&nbsp;</td>
		   </tr>
		</table>
		</td>
	</tr>
	...
	<br/>
		<div align="center">
		<div align="center"> <input  style="display: none" class="long_btn" type="button" value="质量信息跟踪卡" onclick="openWindowDialog('<%=contextPath%>/claim/dealerClaimMng/ClaimBillMaintainMain/getQualityCard.do?claimId=<%=tawep.getId() %>');"/> 
