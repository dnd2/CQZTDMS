...
<script type="text/javascript">
		...
		var myPage;
		var url = "<%=contextPath%>/claim/application/ClaimManualAuditing/balance_detailyx.json?COMMAND=1";
		var title = null;
   ...
   loadcalendar(); 
	...
	function claimdetail(id,balance_yieldly,report_date,claim_type){
		...
		fm.action = '<%=contextPath%>/claim/application/DealerBalance/balancetoalyx.do?dealer_id='+id+"&report_date="+report_date;
		fm.submit();
	}
