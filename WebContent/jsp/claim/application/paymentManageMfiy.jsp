...
<table align="center"   width="80%" class="tab_edit" border='0'>
	<tr>
		...
		<td>
			<script type="text/javascript">
   				genSelBoxExp("PAYMENT_TYPE",<%=Constant.PAY_MENT%>,"${paymentPO.paymentType}",false,"short_sel","","true",'');
  		    </script>
		</td>	
	</tr>
	<tr>
	   ...
	   <td>
	       ...
	       <input type="hidden" id="TAX_RATE" name="TAX_RATE" value="${paymentPO.taxRate}"  />
	   </td>
	</tr>
	<tr>
	 <td>结算单号:</td>
	...
	<tr>
	 <td>劳务费发票</td>
	 <td><input type="text" maxlength="20" value="${paymentPO.labourReceipt}" id="labour_receipt" name="labour_receipt" /></td>
	 <td>材料费发票</td>
	 <td><input type="text" maxlength="20" value="${paymentPO.partReceipt}" id="part_receipt" name="part_receipt"  /></td>
	 <td>签收人</td>
...
<table align="center" id="tab" width="80%" class="tab_edit" border='0'>
	<tr>
