...
var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/application/ClaimManualAuditing/claimManualAuditingForQuery.json";
	...
	var columns = [
		 ...
		 function claimAuditing(value,meta,record){
	    	return String.format("<a href=\"#\" onclick=auditingClaim("+value+",this) >[撤销审核]</a>");
	    }      
			...
			var tarUrl = '<%=contextPath%>/claim/application/ClaimManualAuditing/claimAuditingPage.do?ID='+ value+'&type=1';
           	fm.action=tarUrl;
	    	fm.method="post";
	    	fm.submit();
		}
