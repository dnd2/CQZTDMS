...
<input type="hidden" name="verson" value="${verson}" />
	...
	<input style="width:150px;color:#1E3988;
        ...
        <input class="normal_btn" type="button" value="返回" onclick="javascript:history.go(-1)"/>
        &nbsp;&nbsp;&nbsp;
...
var APPEND = document.getElementById("APPEND_LABOUR_ID").value;
	  ...
	  function jsonSubmit01(statusValue,frmName,btn){
		  createTip();
		  var turl = '<%=contextPath%>'+'/claim/application/ClaimManualAuditing/balanceAuditingJC.json?status='+statusValue+'&bohui=0';
		  setTimeout("closeBalance()",3000);
		  makeNomalFormCall(turl,showResult01,frmName);
		  disableLink(btn,false);
	  }
