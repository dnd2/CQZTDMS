		...
		<form method="post" name="fm" id="fm">
			<table   class="table_query">
				...
				<tr>
					...
					<td align="left" nowrap="nowrap">
						<input type="hidden" class="middle_txt" name="BALANCE_NO"  value ="${list.BALANCE_NO}" id="BALANCE_NO" />
						<input type="text" class="middle_txt"  value ="${list.BALANCE_NO}" disabled/>
				...
				<tr>
					...
					<td align="left" >
					<input type="text" name="dealerC" id="dealerC" value="${list.NEW_INVOICE_CODE }" readonly
							class="middle_txt" disabled/>	
					</td>
				    ...
				    <td class="table_edit_2Col_label_7Letter" nowrap>
			 		...
			 		<td align="left" nowrap="nowrap">
					<input class="middle_txt"   type="text" value ="${list.NEW_INVOICE_MARK }" disabled/>
					<input class="middle_txt" id="dealerCodeNew"  name="dealerCodeNew" type="hidden" value="${list.NEW_INVOICE_MARK }"/>
			...
			<table class="table_query">
				<tr>
					...
					<td>
						<textarea rows="6" cols="70" id="auditingRemark" name="auditingRemark" ></textarea>
					</td>
				</tr>
			...
			<tr>
	  		...
	  		<%} %>
				...
				<tr>
					...
					<td align="center">
							<input type="button" onClick="agreeSubmit();" class="normal_btn"
							style="" value="同意" />
								<input type="button" onClick="outSubmit();" class="normal_btn"
							style="" value="退回" />
								<input type="button" onClick="returnFoward();" class="normal_btn"
							style="" value="返回" />
					</td>
...
function agreeSubmit(){
	...
	var id = $('id').value;
	fm.action="<%=contextPath%>/claim/application/DealerNewKpUpdate/auditingDealerNewKP.do?flag=1&ID="+id;
	fm.submit();
}
function outSubmit(){

	var id = $('id').value;
	fm.action="<%=contextPath%>/claim/application/DealerNewKpUpdate/auditingDealerNewKP.do?flag=2&ID="+id;
	fm.submit();
}
function returnFoward(){

	var id = $('id').value;
	fm.action="<%=contextPath%>/claim/application/DealerNewKpUpdate/auditingDealerNewKP.do?flag=3&ID="+id;
	fm.submit();
}
