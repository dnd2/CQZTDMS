...
<form method="post" name="fm" id="fm">
	...
	<div align="center"> 
		...
		<input class="long_btn"	type="button" value="同意并跳转下条" name="bt_back2" onclick="confirmCustom('<%=Constant.CLAIM_APPLY_ORD_TYPE_04%>','fm',this);"/>
...
<script type="text/javascript">
	  ...
	  function jsonSubmit(statusValue,frmName,btn){
		  ...
		  var turl = '<%=contextPath%>'+'/claim/application/ClaimManualAuditing/balanceAuditing.do?isContinue=true&status='+statusValue;;
		  frm.action = turl;
	  ...
	  function skipCurr()
	  {
		  ...
		  var turl = '<%=contextPath%>' + '/claim/application/ClaimManualAuditing/auditingSkip.do?id='+'<%=request.getAttribute("BALANCE_ID")%>';
		  frm.action = turl;
		  frm.submit();
	  }
	  ...
	  function closeWindow(){
		  var frm = document.getElementById("fm");
		  var turl = '<%=contextPath%>' + '/claim/application/ClaimManualAuditing/auditClaimInit.do?id='+'<%=request.getAttribute("BALANCE_ID")%>';
		  frm.action = turl;
		  frm.submit();
	  }
