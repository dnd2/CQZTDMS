			...
			<table id="otherTableId" align="center" cellpadding="0"
				...
				<tbody id="otherTable">
					...
					<tr class="table_list_row1" >
						...
						<td>
						  <input type="text"  class="little_txt" name="Amount" id="Amount<%=otherLs.get(i).getItemCode()%>" 
...
function salesInfoFwd(){
	...
	OpenHtmlWindow('<%=contextPath%>/sales/customerInfoManage/SalesReport/customerInfoQuery.do?ctm_id='+c_id+'&vehicle_id='+v_id,700,500);
}
