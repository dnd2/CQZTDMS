...
<body onload="init();">
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">当前位置&gt;售后服务管理&gt;索赔申请&gt;索赔单导入</div>
...
<table class="table_query">  
  <tr>
	...
	<tr> 
		<td class="table_query_label" width="65%">3、选择好文件后, 点“<font color="#FF0000">确定</font>”按钮完成导入，导入格式:<font color="#FF0000"></font>。</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	function upload(){
		btnDisable();
		fm.action = "<%=contextPath%>/claim/application/ClaimBillOemImport/excelOperateRerRule.do";
		fm.submit();
	}
	...
	function downloadFile(){
		fm.action = '<%=contextPath%>/claim/application/ClaimBillOemImport/downloadClaimBillModel.do';
	    fm.submit();
	}
