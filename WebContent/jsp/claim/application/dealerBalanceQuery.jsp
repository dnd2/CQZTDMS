...
<table align="center" class="table_query">
	...
	<tr>
		<td colspan="4" align="center">
			...
			<input class="normal_btn" type="button" name="addBtn" id="addBtn" value="新增" 
				onclick="forwordToAddPage('fm','<%=contextPath%>/claim/application/DealerBalance/addDealerBalanceInit.do','_self');"/>
		</td>
	</tr>
</table>
</form>
	...
	<script type="text/javascript">
			var myPage;
			var url = "<%=contextPath%>/claim/application/DealerBalance/dealerBalanceOrderQuery.json";
			var title = null;
