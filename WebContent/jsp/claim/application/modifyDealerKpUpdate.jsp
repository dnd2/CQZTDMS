			...
			<table   class="table_query">
				...
				<tr>
					...
					<td align="left" nowrap="nowrap">
						<input type="text" class="middle_txt" name="BALANCE_NO"  value ="${list.BALANCE_NO}" id="BALANCE_NO" readOnly/>
					...
					<td align="left" >
						<input type="text" name="dealerCode" id="dealerCode" value="${list.DEALERCODE }"  
							class="middle_txt" />
					</td>
						<td class="table_edit_2Col_label_7Letter" nowrap="nowrap">
						经销商名称：
				...
				<tr>
					...
					<td><input class="middle_txt" id="dealerC"  name="dealerC" type="text"  value="${list.NEW_INVOICE_CODE }" readonly/></td>
				    ...
				    <td class="table_edit_2Col_label_7Letter">
			 		...
			 		<td align="left" nowrap="nowrap">
					<input class="middle_txt" id="dealerCodeNew"  name="dealerCodeNew" type="text" value ="${list.NEW_INVOICE_MARK }" readonly="readonly"/>
				...
				<tr>
					...
					<td>
						<textarea rows="6" cols="70" id="remark" name="remark">${list.REMARK }</textarea>
					</td>
				</tr>
