...
<table align="center" id="otherTableId"  class="table_query" border='1'>
	<tr>
		...
		<td align="center"  nowrap="true">
			<input class="middle_txt" size="200px" readonly="readonly" id="sumcarriage" datatype="0,is_double" decimal="2"    name="sumcarriage"  type="text"/>
...
function numapplent(val,n)
{
        ...
        {
        	num = n;
	 		var url='<%=contextPath%>/claim/application/ClaimManualAuditing/numapplentda.json?goolname='+val.value;
...
function returnBack(json)
{
	...
	}else
	{
	    if(num == 1)
	    {
			...
			document.getElementById('carriage').value = json.carriage;
			document.getElementById('dacarriage').value = json.dacarriage;
			document.getElementById('sumcarriage').value = json.sumcarriage;
			document.getElementById('startDate').value = json.startDate;
			document.getElementById('endDate').value = json.endDate;
