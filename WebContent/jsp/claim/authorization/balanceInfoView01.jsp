...
<form id="fm" name="fm" method="post">
			...
			<div style="font-size: 20px;">服务站结算费用汇总单（明细）</div>
			<div>
		...
		<table class="table_edit">
			<tr style="text-align: center;">
				<td>
				<div id="buttontype">
				    <input type="button" class="normal_btn" id="btn1" name="backBtn" onclick="AppprintAll('${ps.BALANCE_NO}')" value="一键打印"/>
...
function AppprintAll(BALANCE_NO) {
	   window.open('<%=contextPath%>/claim/application/DealerNewKp/queryFinancialInfoView07.do?flag=print&BALANCE_NO='+BALANCE_NO,"开票通知单索赔数据打印", "height=700, width=1024, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no");
}
function Back(){
