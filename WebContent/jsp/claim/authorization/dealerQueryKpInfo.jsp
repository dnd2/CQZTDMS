...
<input type="hidden" name="id" value="<c:out value="${map.ID}"/>"/>
	...
	<table class="table_edit">
		...
		<tr>
			<td align="right" nowrap="nowrap">转结扣款(元)：</td>
			<td align="left" nowrap="nowrap">
				<script>
			...
			<td align="right" nowrap="nowrap">开票起日期：</td>
			<td align="left" nowrap="nowrap">
			   <fmt:formatDate value='${map.START_DATE}' pattern='yyyy-MM-dd'/>
			</td>
			<td align="right" nowrap="nowrap">开票止日期：</td>
			<td align="left" nowrap="nowrap">
	...
	<table class="table_edit">
		<tr>
			<td colspan="6" align="center">
				...
				%>
				<input type="button" class="normal_btn" name="checkBtn" onclick="checkBalance()" value="确认"/>
				<%
					}
				%>
...
<script type="text/javascript">
	...
	{
		fm.action = "<%=contextPath%>/claim/application/DealerNewKp/checkBalanceFor.do";
		fm.submit();
	}
</script>
</body>
