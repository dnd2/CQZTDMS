...
<body onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />当前位置：售后服务管理&gt;索赔结算管理&gt;查询经销商结算开票明细
</div>
...
<table align="center" class="table_query">
	...
	<tr>
		...
		<td><input type="text" name="balance" id="balance" class="middle_txt"/></td>
	</tr>
	<tr>
...
<script type="text/javascript">
		var myPage;
		var url = '<%=contextPath%>/claim/authorization/BalanceMain/queryDealerBalanceDetailQuery.json';
		var title = null;
		...
		var columns = [
					...
					{header: "金额",dataIndex: 'INVOICE_AMOUNT',align:'center'},
	...
	function printExport(){
		fm.action = '<%=contextPath%>/claim/authorization/BalanceMain/exportExcel2.do' ;
		fm.submit();
