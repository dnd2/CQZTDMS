...
<BODY onload="doInit();">
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 售后服务管理&gt;索赔旧件管理&gt;索赔旧件审核</div>
  <form id="fm" name="fm">
    ...
    <TABLE class="table_query">
       ...
       <tr>
          ...
          <td >
            <script type="text/javascript">
             genSelBoxExp("back_type",<%=Constant.BACK_LIST_STATUS%>,"",true,"","","false",'<%=Constant.BACK_LIST_STATUS_01%>,<%=Constant.BACK_LIST_STATUS_02%>');
            </script>
          </td>         
