	...
	<tr>
		...
		<td>
			<script type="text/javascript">
				 genSelBoxExp("YIELDLY",<%=Constant.YIELDLY_TYPE%>,"",true,"short_sel","","true",'');
		    </script>
		</td>
...
<script type="text/javascript">
    ...
    var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/oldPart/ClaimOldPartDeductBalance/queryDeductBalance.json";		
	var title = null;
	var columns = [
	...
	function subFrm(frmName){
		 var turl = '<%=contextPath%>'+'/claim/oldPart/ClaimOldPartDeductBalance/blance.json';
