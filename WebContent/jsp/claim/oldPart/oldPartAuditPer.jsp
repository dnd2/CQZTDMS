...
<BODY onload="doInit();">
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 售后服务管理&gt;索赔旧件管理&gt;旧件审核查询</div>
  <form id="fm" name="fm">
    ...
    <TABLE class="table_query">
       <tr>
         ...
         <td  nowrap="nowrap"><input id="dealerName" name="dealerName" value="${dealerName }" type="text" class="middle_txt" datatype="1,is_name,15" callFunction="javascript:MyAlert();"></td>
       </tr>
       <tr>
          <td class="right" nowrap="nowrap" >旧件回运清单号：</td>
          <td  nowrap="nowrap"><input id="back_order_no" name="back_order_no" value="${back_order_no }" type="text" class="middle_txt"></td>
       	  <td class="right" nowrap="nowrap" >货运单号：</td>
          <td  nowrap="nowrap"><input id="trans_no" name="trans_no" value="${trans_no }" type="text" class="middle_txt">
          </td>         
       </tr>
       <tr>
          <td class="right" nowrap="nowrap" >旧件回运清单状态：</td>
          <td  nowrap="nowrap">
            <script type="text/javascript">
             genSelBoxExp("back_type",<%=Constant.BACK_LIST_STATUS%>,"${back_type }",true,"","","false",'<%=Constant.BACK_LIST_STATUS_01%>,<%=Constant.BACK_LIST_STATUS_02%>,<%=Constant.BACK_LIST_STATUS_06%>');
            </script>
          </td> 
       ...
       <tr>
		 ...
		 <td class="right" nowrap="nowrap" >审核时间： </td>
         <td  nowrap="true">
			<input name="create_start_date" type="text" class="middle_txt" id="create_start_date" readonly="readonly" style="width: 80px;"/> 
			<input name="button" value=" " type="button" class="time_ico" onclick="showcalendar(event, 'create_start_date', false);" />  	
             &nbsp;至&nbsp; <input name="create_end_date" type="text" class="middle_txt" id="create_end_date" readonly="readonly" style="width: 80px;"/> 
			<input name="button" value=" " type="button" class="time_ico" onclick="showcalendar(event, 'create_end_date', false);" /> 
		</td>	 
		</tr>
       <tr>
         	<td class="right" nowrap="nowrap" >审核人：</td>
         	<td  nowrap="nowrap">
         		<input id="in_warhouse_name" name="in_warhouse_name" type="text" class="middle_txt" datatype="1,is_name,15">
         	</td>
...
<script type="text/javascript">
   var myPage;
   //查询路径
   var url = "<%=contextPath%>/claim/oldPart/ClaimOldPartApporoveStorageManager/oldPartSignAuditQuery.json";
   ...
   var columns = [
				...
				{id:'action',header: "操作",sortable: false,dataIndex: 'id',renderer:myLink,align:'center'},
  				...
  				{header: "审核流水号", dataIndex: 'audit_no', align:'center'},
