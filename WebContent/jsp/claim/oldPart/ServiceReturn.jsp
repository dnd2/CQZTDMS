		...
		<form id="fm" name="fm">
		   <input type="hidden" name="dealer_id" id="dealer_id"  />
            ...
            genSelBoxExp("ord_status",<%=Constant.BACK_LIST_STATUS%>,"",true,"short_sel","","false",'');
					...
					<td>
						<input id="back_order_no" name="back_order_no" value=""
							type="text" maxlength="20" class="middle_txt"
							datatype="1,is_null,50" callFunction="javascript:MyAlert();">
					</td>
				</tr>
				<tr>
					<td align="right" nowrap="nowrap">
					...
					<td align="left" nowrap="true">
						<input name="create_start_date" type="text" class="short_time_txt"
							id="create_start_date" readonly="readonly" />
						<input name="button" type="button" value=" " class="time_ico"
							onclick="showcalendar(event, 'create_start_date', false);" />
						&nbsp;至&nbsp;
						<input name="create_end_date" type="text" class="short_time_txt"
							id="create_end_date" readonly="readonly" />
						<input name="button" type="button" value=" " class="time_ico"
							onclick="showcalendar(event, 'create_end_date', false);" />
					</td>
					<td align="right" nowrap="nowrap">
						提报时间：
					</td>
					<td align="left" nowrap="true">
						<input name="report_start_date" type="text" class="short_time_txt"
							id="report_start_date" readonly="readonly" />
						<input name="button" type="button" value=" " class="time_ico"
							onclick="showcalendar(event, 'report_start_date', false);" />
						&nbsp;至&nbsp;
						<input name="report_end_date" type="text" class="short_time_txt"
							id="report_end_date" readonly="readonly" />
						<input name="button" type="button" value=" " class="time_ico"
							onclick="showcalendar(event, 'report_end_date', false);" />
					</td>
				</tr>
				<tr>
					<td align="center" colspan="8">
						<input class="normal_btn" type="button" name="qryButton"
							value="查询" onClick="__extQuery__(1);">
						<input class="normal_btn" type="button" id="addButton"
							name="addButton" value="新增" onClick="addBackOrd();">
						服务站代码：<input type="text" name="dealer_code"  id="dealer_code"  > <span style="color: red;">*</span>
					</td>
				</tr>
			</table>
			<!--分页 begin -->
...
function isReports(json){
  if(json.SUCCESS=='true'){
   ...
   function addBackOrd()
   {
     ...
     if(dealer_code.length == 0 )
     {
        MyAlert('请输入服务站代码');
     }else
     {
         var turl = "<%=contextPath%>/claim/oldPart/ClaimBackPieceBackListOrdManager/addBackOrddealerCode.json";
    	 makeNomalFormCall(turl,addBackOrddealer,'fm');
     }
   
   }
   function  addBackOrddealer(json)
   {
     if(json.dealer_id == '请输入正确的服务站代码')
     {
        MyAlert('请输入正确的服务站代码');
     }else
     {
