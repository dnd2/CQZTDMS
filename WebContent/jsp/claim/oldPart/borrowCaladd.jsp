	 ...
	 <tr>
       ...
       <tr>
         <td align="center" nowrap="nowrap" colspan="4">
           ...
           &nbsp;&nbsp;
           &nbsp;&nbsp;
           <input class="normal_btn" type="button" id="qryButton1" name="qryButton" value="调出"  onClick="call_out(this);">
         </td>
       </tr>
  </table>
...
<script type="text/javascript">
   ...
   var myPage;
   //查询路径
   var url = "<%=contextPath%>/claim/oldPart/ClaimOldPartStorageManager/queryListBorrowCallOutTempData.json";
   var obj="";
   var title = null;
   ...
   function checkBoxShow(value,meta,record){//value='" + + "'
	...
	function checkDate(obj,value){
   	...
   	function getPerson(value){
  		...
  		if(ids!=""){
  			var url="<%=contextPath%>/claim/oldPart/ClaimOldPartStorageManager/callOutById.json";
  			$("fm1").action=url;
	  	//	makeCall(url,backSucc,null);
	  		$("ids").value=ids;
	  		$("bm").value=borrowMan;
...
//   	    }
//   		ui.prompt('请输入你的名字',function(z){
// 	        if(z){
// 	            ui.MyAlert('你输入的信息是：'+z); 
// 	        }else{
// 	            ui.MyAlert('你没有输入信息！');   
// 	        }
// 	 	});
