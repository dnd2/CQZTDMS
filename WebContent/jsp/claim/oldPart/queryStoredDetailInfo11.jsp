  ...
  <table class="table_edit">
    ...
    <tr bgcolor="F3F4F8">
     ...
     <tr bgcolor="F3F4F8">
       ...
       <td>
         <%=detailBean.getReturn_date()==null?"":detailBean.getReturn_date()%>
       </td>
     ...
     <tr bgcolor="F3F4F8">
       ...
       <td>
         <%=detailBean.getTransport_desc()==null?"":detailBean.getTransport_desc()%>
       </td>
     ...
     <tr bgcolor="F3F4F8">
       ...
       <td>
         <%=detailBean.getTran_no()==null?"":detailBean.getTran_no()%>
       </td>
       <td align="right">申报运费：</td>
       <td><%=detailBean.getPrice() %></td>
     </tr>
     <tr bgcolor="F3F4F8">
       <td align="right">结算运费：</td>
       <td>
         <%=detailBean.getNewPrice()%>
       </td>
       <td align="right">运费备注：</td>
       <td colspan="3">
     ...
     <tr>
       ...
       <td colspan="5">
         <%=CommonUtils.checkNull(detailBean.getSend_time()) %>
       </td>
     </tr>
     ...
     <tr>
			...
			<tr>
    			<td>备注：<textarea disabled="disabled" rows="5" cols="100" name="info"><%=CommonUtils.checkNull(detailBean.getRemark()) %></textarea></td>
  			</tr>
			</table> 
	      	</td>
	      </tr>
