...
function returnPrint(id){
	...
	//if(boxNo==''){
		//MyAlert('请选择装箱单号!');
	//}else{
		window.open('<%=contextPath%>/claim/oldPart/ClaimOldPartApporoveStorageManager/roMainPrint.do?boxNo='+boxNo+'&id='+id,"旧件审核清单打印", "height=700, width=1024, top=0, left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no");
	//}
}
</script>
</html>