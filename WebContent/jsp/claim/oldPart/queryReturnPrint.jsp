...
<table width="800px"; align="center"  border="0" class="bigTable">
    ...
    <tr>
      <td height="20" colspan="8" align="center"><table class="tab_printsep" width="800px">
          ...
          <tr>
            <td width="16%">服务站代码：</td>
            <td width="16%" >${list.DEALER_CODE}</td>
            <td width="16%" >服务站名称：</td>
            <td width="16%" >${list.DDEALER_SHORTNAME}</td>
            <td width="15%" >服务站电话：</td>
            <td width="15%" >${list.PHONE}</td>
          </tr>
          <tr style="display: none;">
            <td >三包员电话：</td>
    ...
    <tr>
      ...
      <table class="tab_printsep" align="center" width="800px">
          <tr align="center">
            ...
            <td width="5%" align="center">责任件</td>
            <td width="10%" align="center">VIN</td>
            <td width="5%" align="center">箱号</td>
            <td width="7%" align="center">旧件序号</td>
          </tr>
            ...
            <c:forEach var="dList" items="${detailList}" varStatus="status">
              <tr   align="center">
                ...
                <td align="center">${dList.MODEL_NAME}</td>
                ...
                <td align="center">${dList.IS_MAIN_CODE=="10041001"?"主因件":"次因件"}</td>
                <td align="center">${dList.VIN}</td>
