...
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 售后服务管理&gt;索赔旧件管理 &gt;二次抵扣旧件批量出库</div>
  <form id="fm" name="fm">
...
function sel(){
   ...
   var myPage;
   //查询路径
   var url = "<%=contextPath%>/claim/oldPart/ClaimOldPartOutStorageManager/addOffsetStockListQuery.json";
   ...
   function goToStock(){
	   ...
	   fm.action="<%=contextPath%>/claim/oldPart/ClaimOldPartOutStorageManager/offsetStockInfo.do?stock_no="+stock_no+"&out_start_date="+out_start_date+"&out_end_date="+out_end_date;;
	   fm.method="post";
       fm.submit();
