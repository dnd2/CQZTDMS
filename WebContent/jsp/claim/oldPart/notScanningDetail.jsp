...
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 售后服务管理&gt;索赔旧件管理 &gt;没有匹配</div>
  <form id="fm" name="fm">
    ...
    <TABLE class="table_query">
       ...
       <c:forEach items="${ls}" var="ls">
        ...
        <td class="table_query_2Col_label_5Letter">	${ls.BARCODE_NO}  </td>
...
<script type="text/javascript">
  ...
  function queryDetail(id,partCode){
	  fm.action="<%=contextPath%>/claim/oldPart/ClaimOldPartOutStorageManager/ScanningDetails.do?stockId="+id+"&partCode="+partCode;
	   fm.method="post";
	   fm.submit();
