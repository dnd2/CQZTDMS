...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/claim/oldPart/EmergencyDevice/queryCarType.json";
	var title = null;
	var columns = [
		{header: "选择", dataIndex: 'GROUP_CODE', align:'center',renderer:myCheckBox},
		{header: "车型", dataIndex: 'GROUP_NAME', align:'center'}
	];
	
	
	function myCheckBox(value,metaDate,record){
		return String.format("<input name='check' type='checkbox' value='"+record.data.GROUP_CODE+","+record.data.GROUP_NAME+"'/>");
	}
	//返回的数据 更新页面数据
	function commit(){
