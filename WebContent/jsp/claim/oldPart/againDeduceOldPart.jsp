...
<%@page import="com.infodms.dms.bean.ClaimOldPartAgainDeductListBean"%>
...
<% 
   ...
   //获得抵扣配件列表
   List<ClaimOldPartAgainDeductListBean> deductPartList = (List)request.getAttribute("deductPartList");
   //获得抵扣工时列表
 ...
 <form method="post" name ="fm" id="fm">
  ...
  <table width=100% border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="91908E"  class="table_edit">
     ...
     <tr bgcolor="F3F4F8">
       ...
       <th align="center">需回运数量</th>
       <th align="center">已回运数量</th>
     ...
     <c:forEach var="deductPartList" items="${deductPartList}" varStatus="num">
      <tr class="table_list_row1">
       ...
       <td>
          <c:out value='${deductPartList.quantity}'/>
       </td>
       <td>
          <c:out value='${deductPartList.return_num}'/>
       </td>
       <td>
          <c:out value='${deductPartList.price}'/>
       </td>
       <td>
       ...
       <td>
          <script type="text/javascript">
             document.write(String.format(amountFormat('<c:out value='${deductPartList.deduct_amount}'/>')));
          </script>
       ...
       <td>
          <input type="text" id="deduct_part_money<c:out value='${deductPartList.part_id}'/>"
           name="deduct_part_money<c:out value='${deductPartList.part_id}'/>" class="short_txt" value="0" datatype="1,isMoney,10" blurback="true"
       ...
       <td>
        <script type="text/javascript">
          ...
          genSelBoxExp("back_type"+id,<%=Constant.OLDPART_DEDUCT_TYPE%>,"",true,"","","true",'');
        </script>
       </td>
       <td>
  ...
  <table width=100% border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="91908E"  class="table_edit">
     <tr>
	   <th colspan="10"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />索赔抵扣维修项目列表</th>
     </tr>
     <tr bgcolor="F3F4F8">
       <th align="center">标志</th>
     ...
     <c:forEach var="deductHourList" items="${deductHourList}" varStatus="num">
      <tr class="table_list_row1">
       ...
       <td>
          <c:out value='${deductHourList.labour_price}'/>
       </td>
       <td>
          <c:out value='${deductHourList.labour_amount}'/>
       </td>
       <td>
          <script type="text/javascript">
       ...
       <td>
        ...
        <td>
          <input type="text" id="deduct_hour_money<c:out value='${deductHourList.labour_id}'/>"
           name="deduct_hour_money<c:out value='${deductHourList.labour_id}'/>" class="short_txt" value="0" datatype="1,isMoney,10" blurback="true"
  ...
  <table width=100% border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="91908E"  class="table_edit">
     <tr>
	   <th colspan="8"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />索赔抵扣其他项目列表</th>
     </tr>
     <tr bgcolor="F3F4F8">
       <th align="center">标志</th>
       ...
       <td>
        ...
        <td>
          <input type="text" id="deduct_other_money<c:out value='${deductOtherList.netitem_id}'/>"
           name="deduct_other_money<c:out value='${deductOtherList.netitem_id}'/>" class="short_txt" value="0" datatype="1,isMoney,10" blurback="true"
...
function deduct(){
	...
	var url="<%=contextPath%>/claim/oldPart/ClaimOldPartAgainDeduceManager/againDeductOper.json";
	var url_params="?claim_dealer_id="+'<%=claimInfoBean.getDealer_id()%>'
	               +"&claim_id="+'<%=claimInfoBean.getClaim_id()%>'
	               +"&claim_no="+'<%=claimInfoBean.getClaim_no()%>';
...
function goSearchPage(){
	fm.action = "<%=contextPath%>/claim/oldPart/ClaimOldPartAgainDeduceManager/queryListPage.do";
	fm.submit();
}
//获得抵扣参数，拼成串返回
