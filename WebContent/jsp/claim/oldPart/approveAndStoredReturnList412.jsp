...
<script type="text/javascript">
	...
	function backTo(){
		...
		fm.action="<%=contextPath%>/claim/oldPart/ClaimOldPartApporoveStorageManager/queryOverdueList.do?isReturn=1";
	    fm.method="post";
	    fm.submit();
	}
	...
	function queryBox(box_id,id){
		...
		fm.action="<%=contextPath%>/claim/oldPart/ClaimOldPartApporoveStorageManager/boxNoDetail1.do?box_id="+box_id+"&id="+id;
	    fm.method="post";
	    fm.submit();
		}
...
<body >
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;索赔旧件管理&gt;索赔旧件审批入库查询</div>
