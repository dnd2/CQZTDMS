...
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<TITLE>索赔单预授权审核</TITLE>
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/preAuthorization/Authorization/authorizationAuditQuery.json";
	...
	function myLink1(value,meta,record){
		...
		if('<%=Constant.RO_FORE_01%>'==record.data.REPORT_STATUS){
				var url1 = "<a href=\"<%=contextPath%>/claim/preAuthorization/Authorization/authorizationDetailInit.do?operType=2&foId="
					+ value +"&vin="+VIN+"&FO_NO="+foNo+ "\">[审核]</a>";
...
<BODY onload="doInit()">
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;索赔预授权&gt;索赔单预授权审核</div>
