...
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/preAuthorization/Authorization/authorizationQuery.json";
	...
	function myLink1(value,meta,record){
		...
		if('<%=Constant.RO_FORE_03%>'==record.data.REPORT_STATUS || '<%=Constant.RO_FORE_02%>'==record.data.REPORT_STATUS ||'<%=Constant.RO_FORE_05%>'==record.data.REPORT_STATUS ||'<%=Constant.RO_FORE_06%>'==record.data.REPORT_STATUS){
