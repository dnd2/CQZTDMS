...
<body>
	...
	<table class="table_query">
		<tr>
			...
			<td colspan="1">
<%--				<input class="middle_txt" id="dealerCode" style="cursor: pointer;" name="dealerCode" type="text" datatype="1,is_null,100"/>--%>
	         ...
	         <td><input name="DEALER_NAME" id="DEALER_NAME" datatype="1,is_null,50"  type="text" class="middle_txt"/></td>
		</tr>
		<tr>
	         <td class="table_query_2Col_label_5Letter" align="right" rowspan="2">VIN：</td>
			 <td colspan="1" rowspan="2"><textarea name="VIN" cols="18" rows="3" ></textarea></td>
	         <td class="table_query_2Col_label_5Letter">维修工单号：</td>
		...
		<tr>
	         ...
	         <td><input name="F_ID" id="F_ID" datatype="1,is_null,30"  type="text" class="middle_txt"/></td>				 			
		</tr>		
		<tr>
			<td class="table_query_2Col_label_5Letter">项目代码：</td>
			<td><input type="text" name="ITEMCODE" id="ITEMCODE" datatype="1,is_null,30"  class="middle_txt"/></td>
         	<td class="table_query_2Col_label_5Letter">项目类型：</td>
         	<td>
       ...
       <tr>
         ...
         <td>
       	...
       	<td class="table_query_2Col_label_5Letter" align="right">处理状态：</td>
       	<td>
        	<script type="text/javascript">
...
<script type="text/javascript" >
var myPage;
	var url = "<%=request.getContextPath()%>/claim/preAuthorization/PreclaimPreQuery/preclaimPreQuery.json?COMMAND=1";
...
<%--				{header: "序号",sortable: false,dataIndex: 'ID',renderer:getIndex ,align:'center'},--%>
				...
				{header: "经销商简称",sortable: false,dataIndex: 'DEALER_SHORTNAME',align:'center'},
...
//设置超链接  begin      
	...
	function showDetail(value){
		OpenHtmlWindow('<%=contextPath%>/claim/preAuthorization/PreclaimPreQuery/preclaimDetail.do?ID='+value,900,500);
	}	
