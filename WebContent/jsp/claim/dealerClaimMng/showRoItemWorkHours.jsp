...
<body>
	<div class="navigation">
		<img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;经销商索赔管理&gt;索赔单编辑&gt;工单工时选择
	</div> 
  <form name="fm" id="fm" >
...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillMaintainMain/roItemWorkHoursQuery.json";
	var title = null;
	var columns = [
...
function sures(str){
	makeNomalFormCall('<%=request.getContextPath()%>/claim/dealerClaimMng/ClaimBillMaintainMain/roItemWorkHoursOption.json?labourId='+str,delBack,'fm','queryBtn');
}
//新增回调方法：
