...
<script language="JavaScript" >
	...
	var url = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillMaintainMain/queryPartCode2.json";
	...
	var columns = [
				...
				{header: "旧件供应商代码", dataIndex: 'supplierCode', align:'center'},
				{header: "旧件供应商名称", dataIndex: 'supplierName', align:'center'}
				//{header: "预授权", dataIndex: 'partLevel', align:'center'}
		      ];
		      
	function mySelect(value,metaDate,record){
		 return String.format("<input type='radio' name='rd' onclick='setMainPartCode(\""+record.data.partCode+"\",\""+record.data.partName+"\",\""+record.data.supplierCode+"\",\""+record.data.supplierName+"\")' />");
	}
