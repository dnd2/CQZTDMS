...
<center>
  ...
  <br>
    <p class="Noprint">
		...
		<input type=button name= button_print class="normal_btn" value="返回" onclick ="goBackTo();">
    </p>
</center>
</form>
<script language="javascript">    
  function goBackTo(){
 	 fm.action = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillTrack/dealerCoverPrint.do";
			fm.submit();
  }
	function printsetup()
	{       
