...
<!--				</script>-->
			...
			<tr>
				<td class="tdp" colspan="2">项目名称：</td>
				<td class="tdp" colspan="2">金额：</td>
				<td class="tdp" colspan="2">备注：</td>
			</tr>
			<c:forEach items="${seriesList}" var="seriesList" >
			<c:if test="${seriesList.AMOUNT>0 }">
			<tr>
				<td class="tdp" colspan="2">${seriesList.ITEM_DESC }：</td>
				<td class="tdp" colspan="2">${seriesList.AMOUNT }</td>
		...
		<table class="tabp2"  align="center">
			...
			<tr>
				...
				<td  class="tdp" colspan="5" style="word-break:break-all">
				<c:out value="${tawep.authContent }"/>
				</td>
			</tr>
			<tr>
			...
			<table class="tabp2"  align="center">
			 <tr>
			 	...
			 	<td class="tdp" nowrap><b>行号</b></td>
		      	...
		      	<td class="tdp" width="30px" nowrap><b>换件数量</b></td>
		      	<td class="tdp" width="50px" nowrap><b>工时代码</b></td>
