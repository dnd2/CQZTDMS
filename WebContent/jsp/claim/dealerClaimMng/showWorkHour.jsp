   ...
   <!--查询条件begin-->
    <table class="table_query" border="0" >
      <tr>
        ...
        <td align="left">
            <input name="WORK_CODE" id="WORK_CODE" type="text" class="middle_txt" size="20" />
        </td>
      <td class="table_query_2Col_label_5Letter">辅料名称：</td>
        <td align="left">
            <input name="WORK_NAME" id="WORK_NAME" type="text" class="middle_txt" size="20" />
       </td>
...
<script language="JavaScript" >
	...
	var url = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillMaintainMain/queryworkHour.json";
	...
	function setMainWork(v1,v2,v3){
 		...
 		if (parent.$('inIframe')) {
 			parentContainer.setMainWork(v1,v2,v3);
 		} else {
			parent.setMainWork(v1,v2,v3);
		}
	 			//关闭弹出页面
	 			parent._hide();
	}
