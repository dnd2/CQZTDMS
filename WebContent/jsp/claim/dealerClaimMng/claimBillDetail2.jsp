		...
		<form method="post" name="fm" id="fm">
			...
			<table border="0" align="center" cellpadding="1" cellspacing="1"
				...
				<tr>
					...
					<td>
						<%=CommonUtils.checkNull(tawep.getServeAdvisor())%>
					</td>
					<td class="table_edit_2Col_label_7Letter">
						索赔主管电话：
					</td>
					...
					<tr class="table_list_row1">
						<td>
						 <%=CommonUtils.checkNull(tl.getDownPartCode())%> 
						  <input type="hidden" name="DOWN_PART_CODE" id="DOWN_PART_CODE<%=tl.getPartId().toString()%>" value="<%=CommonUtils.checkNull(tl.getDownPartCode())%>" />
						</td>
						<td>
