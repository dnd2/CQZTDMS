...
var myPage;
	//查询路径
	var url = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillTrack/applicationSelectQuery.json";
...
// 					{HEADER: "车型", WIDTH:'15%', DATAINDEX: 'MODEL'},
					...
					{header: "操作人员", width:'15%', dataIndex: 'username'},
					{header: "操作时间", width:'15%', dataIndex: 'updateDate'},
	...
	function myLink(value,meta,record){
		...
		var id = record.data.id;
		 return String.format("<a href='#' onclick=\"counter('"+id+"','"+roNo+"','"+claimType+"')\">["+value+"]</a>");
    }
	function counter(id,roNo,claimType)
	{
		var detailUrl = globalContextPath + '/claim/dealerClaimMng/ClaimBillTrack/claimSystemDetailForward.do?id='+id
				+'&claim_type='+claimType+'&roNo='+roNo+'&opType=query';
...
<div class="navigation"><img src="../../../img/nav.gif" />&nbsp;当前位置：索赔结算管理&gt;反索赔查询&gt;反索赔未开票查询</div>
    ...
    <TABLE  class="table_query">
          ...
          <tr>
           ...
           <tr>
			...
			<input name="button" type="button" value=" " class="time_ico" onclick="showcalendar(event, 'balance_approve_date', false);" />  	
             &nbsp;至&nbsp; <input name="balance_approve_date2" type="text" class="short_time_txt" id="balance_approve_date2" readonly="readonly"/> 
			<input name="button" type="button" value=" " class="time_ico" onclick="showcalendar(event, 'balance_approve_date2', false);" /> 
		</td>
