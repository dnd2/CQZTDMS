...
<script type="text/javascript">
	...
	function addSpecia(val)
	{
		$('btn1').disabled = true ;
		$('btn2').disabled = true ;
		makeNomalFormCall("<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/reauditSpeciaExpenses01WC.json?auditFlag="+val,addSpeciaBack,'fm','queryBtn'); 
	}
	...
	function addSpeciaBack(json)
	{
		...
		{
			parent.MyAlert("操作成功！");
			fm.action = "<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/reauditMainInitWC.do";
			fm.submit();
		}
		else
		{
