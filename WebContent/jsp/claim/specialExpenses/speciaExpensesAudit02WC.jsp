...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理 &gt; 特殊费用审核 &gt; 市场工单费用审核(结算室)</div>
...
<script type="text/javascript">
	...
	function addSpeciaBack(json)
	{
		...
		{
			parent.MyAlert("操作成功！");
			fm.action = "<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/auditQuerySpeciaExpensesWC.do";
			fm.submit();
		}
		else
		{
