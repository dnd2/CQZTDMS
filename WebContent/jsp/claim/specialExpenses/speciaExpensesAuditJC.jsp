...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/auditQuerySpeciaExpensesJC.json";
	...
	var columns = [
				...
				{header: "特殊费用编号", dataIndex: 'FEE_NO', align:'center'},
				...
				{header: "操作",sortable: false,dataIndex: 'AID',renderer:myLink ,align:'center'}
		      ];
...
//设置超链接  begin      
	...
	function createCheckbox(value,meta,record){
				...
				"<input type='hidden' name='feeChannel' value='"+record.data.FEE_CHANNEL+"'/>"+
