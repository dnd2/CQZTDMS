       ...
       <tr > 
         <th height="12" align=center>
           <div id="a1">
	           ...
	           <input type="button" onclick="javascript:window.location.href='<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/auditQuerySpeciaExpensesWC.do'" class="normal_btn" value="返回" /> 
           </div>
       </tr>
     </table>    
</form>
<script type="text/javascript">
	...
	function addSpecia(val)
	{
		$('btn1').disabled = true ;
		$('btn2').disabled = true ;
		makeNomalFormCall("<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/auditSpeciaExpenses01WC.json?auditFlag="+val,addSpeciaBack,'fm','queryBtn'); 
	}
	...
	function addSpeciaBack(json)
	{
		...
		{
			parent.MyAlert("操作成功！");
			fm.action = "<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/auditSpecialExpensesInfoByOneWC.do";
