       ...
       <tr > 
         <th height="12" align=center>
           <div id="a1">
	           ...
	           <input type="button" onclick="javascript:window.location.href='<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/specialExaminesForJC.do'" class="normal_btn" value="返回" /> 
           </div>
       </tr>
     </table>    
</form>
