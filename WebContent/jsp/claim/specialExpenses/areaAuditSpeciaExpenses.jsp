    ...
    <table class="table_query" >
		<tr>
          ...
          <tr>
            ...
            <td colspan="6" nowrap="nowrap">
              	<script type="text/javascript">
 					 genSelBoxExp("feeType",<%=Constant.FEE_TYPE%>,"",false,"short_sel","","false",'<%=Constant.FEE_TYPE_01%>');
			  	</script>
            </td>
          </tr>
          <tr>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/areaAuditQuerySpeciaExpenses.json";
...
//设置超链接  begin      
	...
	{
		fm.action = '<%=contextPath%>/claim/specialExpenses/SpecialExpensesManage/areaAuditSpecialExpenses.do?id=' + val1 + "&feeType=" + val2;
	 	fm.submit();
	}
