...
function myHandler(value,meta,record){
	if(record.data.AUTH_STATUS==<%=Constant.TAXABLE_SERVICE_SUM_FANCE%>){
		return res = "<a href='#' onclick=\"window.open('<%=contextPath%>/claim/laborlist/LaborListSummaryReport/showDetailOem22.do?id="+record.data.SUM_PARAMETER_ID+"','','left=0,top=0,width="+screen.availWidth +"- 10,height="+screen.availHeight+"-50,toolbar=no,menubar=no,scrollbars=no,location=no');\">[明细]</a>";
	}
	else{
