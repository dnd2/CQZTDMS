...
<input type="hidden" name="id" value="${labor.reportId}">
	...
	<table class="table_list">
		<tr class="table_list_row2">
			<td>备注：</td>
			<td align="left"><textarea name="remark" id="remark" rows="10" cols="130"></textarea></td>
		</tr>
	</table>
	<br />
	<table class="table_edit">
		<tr>
			<td colspan="4" align="center">
				<input type="button" value="取消暂停" class="normal_btn" onclick="doStopQx();"/>&nbsp;&nbsp;
...
function doStopQx(){
	if(confirm('确认操作？')){
		var url = '<%=contextPath%>/claim/laborlist/LaborListAction/doStopQx.json' ;
