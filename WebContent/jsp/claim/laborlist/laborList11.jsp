...
<script type="text/javascript">
var url = '<%=contextPath%>/claim/laborlist/LaborListAction/mainQuery11.json' ;
var title = null ;
var columns = [
              ...
              //{header:'接收时间',dataIndex:'RECEIVE_DATE',width:'6%',align:'center'},
               ...
               {header:'发票金额',dataIndex:'REPORT_AMOUNT',width:'6%',align:'center'},
...
function myHandler(value,meta,record){
	return '<a href="<%=contextPath%>/claim/laborlist/LaborListAction/showDetail11.do?id='+record.data.REPORT_ID+'">[明细]</a><a href="<%=contextPath%>/claim/laborlist/LaborListAction/showDetailBulu.do?id='+record.data.REPORT_ID+'">[补录]</a>' ;
}
function goAdd(){
	location = '<%=contextPath%>/claim/laborlist/LaborListAction/addUrlInit11.do' ;
}
</script>
</BODY>
</html>