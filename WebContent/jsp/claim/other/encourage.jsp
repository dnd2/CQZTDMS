...
<div class="navigation">
  <img src="../../../img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;特殊费用&gt;特殊费用管理&gt;正负激励&gt;罚款处理</div>
...
<table border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	...
	<tr>
	<td class="table_add_2Col_label_5Letter" style="text-align:right;width:125px;">扣款日期：</td>
		<td align="left" style="width:245px">
			${encourageDate }
		</td>
		<td class="table_add_2Col_label_5Letter" style="text-align:right;width:125px;">扣款金额：</td>
		<td align="left" style="width:245px">
		...
		<td class="table_add_2Col_label_5Letter" style="text-align:right;width:125px;">扣款人：</td>
		<td align="left" style="width:245px">
			${encourageMan }
		</td>
	</tr>
	<tr>
		<td class="table_add_2Col_label_5Letter" style="text-align:right;width:125px;">罚款原因：<input type="hidden"
    ...
    <tr>
      <td colspan="6">
    	...
    	<tr>
			<td colspan="6" style="text-align: center;"><input type="button"  name="button" onclick="confirmAdd()" value="确定" class="normal_btn" />
			<input type="button" name="Submit3" value="返回" onClick="Back();"class="normal_btn"></td>
		</tr>
      </table>
</form>
...
function confirmAdd0() {
		var url=globalContextPath+"/claim/other/Bonus/punish.json?fine_type=80641001";
