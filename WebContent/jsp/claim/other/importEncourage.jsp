...
<body >
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">当前位置&gt;售后服务管理&gt;其他功能&gt;正负激励导入</div>
...
<table class="table_query">  
  <tr>
	...
	<tr> 
		<td class="table_query_label" width="65%">3、选择好文件后, 点“<font color="#FF0000">确定</font>”按钮完成导入，导入格式:<font color="#FF0000">产地--经销商代码--奖惩类型(奖励/扣款)--奖惩劳务费--奖惩材料费--奖惩原因--备注</font>。</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	...
	function upload(){
		btnDisable();
		fm.action = "<%=contextPath%>/claim/other/Bonus/exceloadDealerByDlr.do";
		fm.submit();
	}
	...
	function downloadFile(){
		fm.action = '<%=contextPath%>/claim/other/Bonus/downloadDealerByDlr.do';
	    fm.submit();
	}
