...
var myPage;
	//查询路径
	var url = "";
	url = "<%=contextPath%>/claim/dealerClaimMng/ApplicationClaim/applicationClaimTwo.json?flag=t";				
	var num;
	var title = null;
...
<BODY>
<div class="navigation"><img src="../../../img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;索赔审核管理&gt;索赔审核查询</div>
