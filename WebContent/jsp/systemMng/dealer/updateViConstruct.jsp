...
<input type="hidden"  name="vehicle_series_flag1" id="vehicle_series_flag1" value="2014032694231206"/>
        ...
        <td colspan="5"><textarea name="REMARK" id="textarea"  cols="80" rows="4"
		 ...
		 <form action="" method="post" id="fm1" name="fm1">
				  ...
				  <input type="hidden"  name="VI_CONFIRM_DATE1" id="VI_CONFIRM_DATE_n"  value=""/>
				   ...
				   <input type="hidden"  name="vehicle_series_flag" id="vehicle_series_flag" value="2014032694231206"/>
		 </form>
