...
<!-- 			</table> -->
		 ...
		 <td align="right">VI形象验收日期：</td>
             <td align="left">
             	<input name="VI_CONFRIM_DATE" readonly="readonly" cn_name="VI形象验收日期"  type="text"  class="short_time_txt" id="VI_CONFRIM_DATE"   value="<fmt:formatDate value="${dmap.CHECKED_DATE}" pattern="yyyy-MM-dd"/>"/>
             </td>
           
             <td align="right">申请形象等级：</td>
             <td align="left">
             	<script type="text/javascript">
					genSelBoxExp("IMAGE_LEVEL",<%=Constant.IMAGE_LEVEL%>,"${dmap.IMAGE_LEVEL}",true,"short_sel",'disabled=true',"false",'');
				</script>
             </td>
             </tr>
             <tr>
             ...
             <td align="left">
             	<script type="text/javascript">
					genSelBoxExp("IMAGE_COMFIRM_LEVEL",<%=Constant.IMAGE_LEVEL%>,"${dmap.CHECKED_IMAGE_LEVEL}",true,"short_sel",'disabled=true',"false",'');
				</script>
             </td>
             <td align="right">验收形象店形式：</td>
             <td align="left">
             	<script type="text/javascript">
					genSelBoxExp("VI_CONSTRUCT_TYPE",<%=Constant.VI_CONSTRUCT_TYPE%>,"${dmap.CHECKED_TYPE}",false,"short_sel",'disabled=true',"false",'');
				</script>
             </td>             
		 	</tr>
