...
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 系统管理 &gt; 经销商管理 &gt;二级销售经销商查询</div>
...
<table class="table_query" border="0">
	<c:if test="${isDealer!='no'}"><tr>
		<td class="table_query_3Col_label_6Letter" nowrap="nowrap">一级经销商代码：</td>
		<td class="table_query_4Col_input" nowrap="nowrap"><input
			name="FIRST_DEALER_CODE" maxlength="30" datatype="1,is_noquotation,30" id="DEALER_CODE" type="text" class="middle_txt" /></td>
		<td class="table_query_3Col_label_6Letter" nowrap="nowrap">一级经销商简称：</td>
		<td class="table_query_4Col_input" nowrap="nowrap"><input
			name="FIRST_DEALER_NAME" maxlength="30" datatype="1,is_noquotation,75" id="DEALER_NAME" type="text" class="middle_txt" /></td>
	</tr></c:if>
	<c:if test="${isDealer!='no'}"><tr>
		<td class="table_query_3Col_label_6Letter" nowrap="nowrap">二级经销商代码：</td>
		<td class="table_query_4Col_input" nowrap="nowrap"><input
			name="DEALER_CODE" maxlength="30" datatype="1,is_noquotation,30" id="DEALER_CODE" type="text" class="middle_txt" /></td>
		<td class="table_query_3Col_label_6Letter" nowrap="nowrap">二级经销商简称：</td>
		<td class="table_query_4Col_input" nowrap="nowrap"><input
	...
	<tr>
		...
		<td class="table_query_4Col_input" nowrap="nowrap">
			...
			<td align="left" bgcolor="#FFFFFF">
				<script type="text/javascript">
					genSelBox("status",<%=Constant.DEALER_SECEND_STATUS %>,"-1",true,"short_sel",'',"false",'');
				</script>
			</td>
	</tr>
   ...
   <td align=right>选择大区：</td>
	...
	<tr>
			...
			<td>
				<div align="left">
					<input name="CstartDate" id="t1" value="" type="text" class="short_txt" datatype="1,is_date,10" group="t1,t2" hasbtn="true" callFunction="showcalendar(event, 't1', false);" />
					&nbsp;至&nbsp; <input name="CendDate" id="t2" value="" type="text" class="short_txt" datatype="1,is_date,10" group="t1,t2" hasbtn="true"
			...
			<td>
				<div align="left">
					<input name="UstartDate" id="t3" value="" type="text" class="short_txt" datatype="1,is_date,10" group="t3,t4" hasbtn="true" callFunction="showcalendar(event, 't3', false);" />
					&nbsp;至&nbsp; <input name="UendDate" id="t4" value="" type="text" class="short_txt" datatype="1,is_date,10" group="t3,t4" hasbtn="true"
						callFunction="showcalendar(event, 't4', false);" />
				</div>
			</td>
			</tr>
			<tr align="center">
...
var columns = [
				...
				{header: "提报时间", width:'10%', dataIndex: 'CREATE_DATE'},
...
function downloadFunc() {
    var url = "<%=contextPath%>/sysmng/dealer/DealerInfo/dealerInfoDownloadNew2nd.json" ;
    document.fm.action = url ;
    document.fm.submit() ;
}
function exportFunc() {
	var url = "<%=contextPath%>/sysmng/dealer/DealerInfoQuery/dealerInfoDownloadNew2nd.do?DEALER_TYPE=<%=Constant.DEALER_TYPE_DVS%>" ;
	document.fm.action = url ;
	document.fm.submit() ;
}
