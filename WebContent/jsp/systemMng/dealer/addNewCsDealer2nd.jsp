	...
	<form method="post" name="fm" id="fm">
		...
		<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
			...
			<tr>
				...
				<td align="left"><input class="middle_txt" datatype="0,is_null,75" id="COMPANY_NAME" style="cursor: pointer;" name="COMPANY_NAME" type="text" readonly="readonly"
			...
			<tr>
				...
				<td align="left"><input type="text" name="orgCode" size="15" value="${dMap.ORG_CODE}" id="orgCode" class="middle_txt" readonly="readonly" datatype="0,is_null,150" /> <input
					name="orgbu" id="orgbu" type="button" class="mark_btn" onclick="showOrg('orgCode','DEALER_ORG_ID','false')" value="&hellip;" /> <input type="hidden" id="DEALER_ORG_ID"
					name="DEALER_ORG_ID" datatype="0,is_null,150" /></td>
			...
			<tr>
				...
				<td align="left"><input name="SITEDATE" type="text" class="short_time_txt" id="SITEDATE" readonly="readonly" value="${dMap.SITEDATE}" /> <input name="button5"
					type="button" class="time_ico" value=" " onclick="showcalendar(event, 'SITEDATE', false);" /></td>
				<td align="right">撤站时间：</td>
				<td align="left"><input name="DESTROYDATE" type="text" class="short_time_txt" id="DESTROYDATE" readonly="readonly" value="${dMap.DESTROYDATE}" /> <input name="button7"
					type="button" class="time_ico" value=" " onclick="showcalendar(event, 'DESTROYDATE', false);" /></td>
			</tr>
			<tr>
 ...
 <tr>
 	<td colspan="5">
 		...
 		<input type="button" class="normal_btn"  onclick="showNewsUpload('<%=contextPath%>')" value ='添加附件'/>
			...
			<tr>
				...
				<td align="left"><input name="AUTHORIZATION_DATE" type="text" class="short_time_txt" id="AUTHORIZATION_DATE" readonly="readonly" value="${dMap.AUTHORIZATION_DATE}" /> <input
					name="button9" type="button" class="time_ico" value=" " onclick="showcalendar(event, 'AUTHORIZATION_DATE', false);" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="table_query_4Col_input" nowrap="nowrap"><input type="text" class="middle_txt" id="ERP_CODE" name="ERP_CODE" value="${dMap.ERP_CODE}" /></td>
			...
			<tr>
				...
				<td class="table_query_4Col_input" nowrap="nowrap"><input type="text" class="middle_txt" id="BEGIN_BANK" name="BEGIN_BANK" value="${dMap.BEGIN_BANK}" /></td>
			...
			<tr>
				...
				<td class="table_query_4Col_input" nowrap="nowrap"><input type="text" class="middle_txt" id="INVOICE_ADD" name="INVOICE_ADD" value="${dMap.INVOICE_ADD}" /></td>
			...
			<tr>
				...
				<td class="table_query_4Col_input" nowrap="nowrap"><select id="TAXPAYER_NATURE" name="TAXPAYER_NATURE">
			...
			<tr>
				...
				<td class="table_query_4Col_input" nowrap="nowrap"><script type="text/javascript">
					genSelBoxExp("TAX_INVOICE",<%=Constant.IF_TYPE%>,"${dMap.TAX_INVOICE}",true,"short_sel",'',"false",'');
				</script></td>
				<td align="right" nowrap="nowrap" class="table_query_4Col_input">开票税率：</td>
				<td class="table_query_4Col_input" nowrap="nowrap"><input type="text" class="middle_txt" id="TAX_DISRATE" name="TAX_DISRATE" value="${dMap.TAX_DISRATE}" /></td>
			</tr>
			<tr>
		...
		<table class=table_query>
			<tr>
				<td align="center"><input type="button" value="上报" name="saveBtn" class="normal_btn" onclick="saveDealerInfo()" /> &nbsp;&nbsp; <input type="button" value="返回"
...
function saveDealerInfo(){
	...
	makeNomalFormCall('<%=contextPath%>/sysmng/dealer/DealerInfo/checkDealerCode2nd.json',showResultCodeCheck,'fm');
}
function showResultCodeCheck(obj){
	...
	if(msg=='true'){
		...
		{
			var url = "<%=contextPath%>/sysmng/dealer/DealerInfo/saveDealerInfo2nd.json";
