...
<title>售后经销商信息导入</title>
</head>

<body>
	<div class="wbox">
	<div class="navigation"><img src="<%=contentPath %>/img/nav.gif" />&nbsp;当前位置 >系统管理>经销商管理>售后经销商维护>导入
	</div>
...
<script type="text/javascript">
	function upload(){
		...
		$('fm').action = "<%=contentPath %>/sysmng/dealer/ShDealerImport/shImportOperate.do";
    	$("fm").submit();
	}
	
	function downloadFile(){
	    fm.action = "<%=contentPath %>/sysmng/dealer/ShDealerImport/downloadTempleSh.do";
	    fm.submit();
	}
	function goBack(){
