...
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 系统管理 &gt; 经销商管理 &gt;售后经销商查询</div>
...
<!--                     <input class="time_ico" onclick="showcalendar(event, 'SCREATE_DATE', false);" type="button"/> -->
<!--                     至 -->
...
<!--                     <input class="time_ico" onclick="showcalendar(event, 'ECREATE_DATE', false);" type="button"/> -->
<!--                 </td> -->
...
<script>
var myPage;
var url = "<%=contextPath%>/sysmng/dealer/DealerInfo/queryServiceDealerInfo.json";
var title= null;
var columns = [
