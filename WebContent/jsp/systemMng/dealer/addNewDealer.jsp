...
function showCompanyA(path){ 
	OpenHtmlWindow(path+'/common/OrgMng/queryCompanyA.do',800,450, '查询信息');
}
function doInit() {   
	var CITY_ID = '${CITY_ID}';
...
<body onload=""> <!-- onunload='javascript:destoryPrototype()' -->
<div class="wbox">
		...
		<div class="form-panel">
			...
			<div class="form-body">
				<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
					<TR>
						<TH colSpan=4 align=left><IMG class="panel-icon nav" src="<%=contextPath%>/img/subNav.gif"> 经销商基础信息</TH>
					<tr>
					<tr>
						...
						<td align="left">
							<select id="SHOP_TYPE" class="u-select" name="SHOP_TYPE">
					...
					<tr>
						<td class="right" align="right">经销商公司：</td>
						<td align="left">
						...
						<td class="right" align="right" width="15%">经销商简称：</td>
						<td align="left">
					...
					<tr>
						<td class="right" align="right" width="15%">经销商代码：</td>
						...
						<td class="right" align="right" width="15%">经销商全称：</td>
						<td align="left">
					...
					<tr>
						<td class="right" align="right" width="15%">经销商等级：</td>
						<td  align="left">
							<label>
								<script type="text/javascript">
						...
						<td class="right" align="right" width="15%">上级经销商：</td>
						<td align="left">
			...
			<!-- 		        	</select> -->
				...
				<tr>
						<td class="right" align="right">经销企业注册资金：</td>
						<td align="left" >
						...
						<tr>
						<td class="right" align="right">销售展厅地址：</td>
					...
					<tr>
						<td class="right" align="right" width="15%">经销商类型：</td>
						<td align="left">
						<label>
						...
						<td class="right" align="right" width="15%">经销商状态：</td>
						<td align="left">
								<script type="text/javascript">
										genSelBoxExp("SERVICE_STATUS",'<%=Constant.DLR_SERVICE_STATUS%>',"${dMap.SERVICE_STATUS}",'',"short_sel u-select",'',"false",'');
								</script>
								<font color="red">*</font>
						</td>
					</tr>
					<tr>
						<td class="right" align="right" width="15%">单位性质：</td>
						<td>
							<select id="UNION_TYPE" class="u-select" name="UNION_TYPE">
						...
						<td class="right" align="right" width="15%">经销商传真：</td>
						<td>
					...
					<tr id="zcxs">
						...
						<tr>
						<th class="right" colSpan=4 align=left><img class="panel-icon nav" src="<%=contextPath%>/img/subNav.gif"> <span id="up_name_00">整车销售信息</span></th>
						</tr>
						<tr >
						<td class="right" align="right">总经理：</td>
						<td align="left"><input type='text'  class="middle_txt" name="WEBMASTER_NAME"  id="WEBMASTER_NAME"   value="${dMap.WEBMASTER_NAME}" /></td>
						<td class="right" width="15%" align="right">总经理办公电话：</td>
						...
						<tr >
						<td class="right" align="right">总经理手机：</td>
						...
						<tr >
						<td class="right" align="right">市场经理手机：</td>
						...
						<td class="right" align="right">市场经理邮箱：</td>
						...
						<tr >
						<td class="right" align="right">财务经理手机：</td>
						...
						<td class="right" align="right">财务经理邮箱：</td>
						...
						<tr >
						<td class="right" align="right">信息员手机：</td>
						...
						<td class="right" align="right">信息员QQ：</td>
						<td align="left"><input type='text'  class="middle_txt" name="MESSAGER_QQ"  id="MESSAGER_QQ"   value="${dMap.MESSAGER_QQ}" /></td>
						</tr>
						<tr >
						<td class="right" align="right">信息员邮箱：</td>
						<td align="left"><input type='text'  class="middle_txt" name="MESSAGER_EMAIL"  id="MESSAGER_EMAIL"  value="${dMap.MESSAGER_EMAIL}" /></td>
						<td class="right" align="right">销售热线：</td>
						<td align="left"><input type='text'  class="middle_txt" name="HOTLINE"  id="HOTLINE"   value="${dMap.HOTLINE}" /></td>
						</tr>
						<tr >
						<td class="right" align="right">VI建设申请日期：</td>
						<td align="left">
							<input name="VI_APPLAY_DATE" type="text" class="short_time_txt middle_txt" id="VI_APPLAY_DATE" readonly="readonly" value="${dMap.VI_APPLAY_DATE}"/> 
							<input name="button" value=" " type="button" class="time_ico" />
						</td>
						<td class="right" align="right">VI建设开工日期：</td>
						<td align="left">
							<input name="VI_BEGIN_DATE" type="text" class="short_time_txt middle_txt" id="VI_BEGIN_DATE" readonly="readonly" value="${dMap.VI_BEGIN_DATE}"/>
							<input name="button3" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr >
						<td class="right" align="right">VI建设竣工日期：</td>
						<td align="left">
							<input name="VI_COMPLETED_DATE" type="text" class="short_time_txt middle_txt" id="VI_COMPLETED_DATE" readonly="readonly" value="${dMap.VI_COMPLETED_DATE}"/>
							<input name="button2" value=" " type="button" class="time_ico" />
						</td>
						<td class="right" align="right">VI形象验收日期：</td>
						<td align="left">
							<input name="VI_CONFRIM_DATE" type="text" class="short_time_txt middle_txt" id="VI_CONFRIM_DATE" readonly="readonly" value="${dMap.VI_CONFRIM_DATE}"/>
							<input name="button4" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr >
						<td class="right" align="right">形象等级：</td>
						<td align="left">
							<script type="text/javascript">
					...
					<tr >
						<td class="right" align="right">VI支持总金额：</td>
						...
						<td class="right" align="right">VI支持首批比例：</td>
					...
					<tr >
						<td class="right" align="right">VI支持后续支持方式：</td>
						...
						<td class="right" align="right">VI支持起始时间：</td>
						<td align="left"><input name="VI_SUPPORT_DATE" type="text" class="short_time_txt middle_txt" id="VI_SUPPORT_DATE" readonly="readonly" value="${dMap.VI_SUPPORT_DATE}"/>
						<input name="button16" value=" " type="button" class="time_ico" /></td>
					</tr>
					<tr >
						<td class="right" align="right">VI支持截止时间：</td>
						<td align="left"><input name="VI_SUPPORT_END_DATE" type="text" class="short_time_txt middle_txt" id="VI_SUPPORT_END_DATE" readonly="readonly" value="${dMap.VI_SUPPORT_END_DATE}"/>
						<input name="button5" value=" " type="button" class="time_ico" /></td>
						<td class="right" align="right">首次提车时间：</td>
						<td align="left"><input name="FIRST_SUB_DATE" type="text" class="short_time_txt middle_txt" id="FIRST_SUB_DATE" readonly="readonly" value="${dMap.FIRST_SUB_DATE}"/>
						<input name="button7" value=" " type="button" class="time_ico" /></td>
					</tr>
					<tr >
						<td class="right" align="right">首次到车日期：</td>
						<td align="left">
							<input name="FIRST_GETCAR_DATE" type="text" class="short_time_txt middle_txt" id="FIRST_GETCAR_DATE" readonly="readonly" value="${dMap.FIRST_GETCAR_DATE}"/>
							<input name="button6" value=" " type="button" class="time_ico" />
						</td>
						<td class="right" align="right">首次销售时间：</td>
						<td align="left">
							<input name="FIRST_SAELS_DATE" type="text" class="short_time_txt middle_txt" id="FIRST_SAELS_DATE" readonly="readonly" value="${dMap.FIRST_SAELS_DATE}"/>
							<input name="button8" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr >
						<td class="right" align="right">企业授权类型：</td>
							<td align="left"><select name="AUTHORIZATION_TYPE" class="u-select" id="AUTHORIZATION_TYPE">
						...
						<td align="left"><input name="AUTHORIZATION_DATE" type="text" class="short_time_txt  middle_txt" id="AUTHORIZATION_DATE" readonly="readonly" value="${dMap.AUTHORIZATION_DATE}"/>
					...
					<tr>
						...
						<td align="left" colspan="3">
							<textarea name="REMARK" id="REMARK" class="form-control remark align" rows="2" datatype="1,is_textarea,1000"></textarea>
						</td>
					</tr>
						</table>
						</td>
					...
					<tr id="kpxx" >
						...
						<table  width=100% border="0" align="center" cellpadding="1" cellspacing="1"> 
					<tr>
						<th class="right" colSpan=4 align=left><IMG class="panel-icon nav" src="<%=contextPath%>/img/subNav.gif"> 开票信息</th>
					<tr>
					<tr>
					...
					<tr>
						<td class="right" align="right" width="15%">开票地址：</td>
						<td class="table_query_4Col_input" nowrap="nowrap"> 
					...
					<td align="right" nowrap="nowrap" class="table_query_4Col_input right">开票联系人手机：</td>
					...
					<table  width=100% border="0" align="center" cellpadding="1" cellspacing="1"> 
					<tr>
						<th colSpan=4 align=left><IMG class="panel-icon nav" src="<%=contextPath%>/img/subNav.gif">国家品牌</th>
					<tr>
						<td class="right" align="right" width="15%">国家品牌授权城市：</td>
						<td class="table_query_4Col_input" nowrap="nowrap"> 
							<script type="text/javascript">
								genSelBoxExp("IS_AUTHORIZE_CITY",<%=Constant.IF_TYPE%>,"${dMap.IS_AUTHORIZE_CITY}",true,"short_sel u-select",'',"false",'');
							</script>
						</td>
						<td class="right" align="right" width="15%">国家品牌授权区县：</td>
						<td class="table_query_4Col_input" nowrap="nowrap"> 
							<script type="text/javascript">
								genSelBoxExp("IS_AUTHORIZE_COUNTY",<%=Constant.IF_TYPE%>,"${dMap.IS_AUTHORIZE_COUNTY}",true,"short_sel u-select",'',"false",'');
							</script>
						</td>
					</tr>
					<tr>
						<td class="right" align="right">国家品牌授权：</td>
						...
						<td class="right" align="right">国家品牌授权信息收集时间：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="AUTHORIZE_GET_DATE" type="text" class="short_time_txt middle_txt" id="AUTHORIZE_GET_DATE" readonly="readonly" value="${dMap.AUTHORIZE_GET_DATE}"/>
							<input name="button14" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr>
						<td class="right" align="right">国家品牌授权提交时间：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="AUTHORIZE_SUB_DATE" type="text" class="short_time_txt middle_txt" id="AUTHORIZE_SUB_DATE" readonly="readonly" value="${dMap.AUTHORIZE_SUB_DATE}"/>
							<input name="button10" value=" " type="button" class="time_ico" />
						</td>
						<td class="right" align="right">国家品牌授权起始时间：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="AUTHORIZE_EFFECT_DATE" type="text" class="short_time_txt middle_txt" id="AUTHORIZE_EFFECT_DATE" readonly="readonly" value="${dMap.AUTHORIZE_EFFECT_DATE}"/>
							<input name="button13" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr>
						<td class="right" align="right">工商总局公告号：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="ANNOUNCEMENT_NO " type="text" class="short_time_txt middle_txt" id="ANNOUNCEMENT_NO " value="${dMap.ANNOUNCEMENT_NO}"/>
						</td>
						<td class="right" align="right">工商总局公布日期：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="ANNOUNCEMENT_DATE" type="text" class="short_time_txt middle_txt" id="ANNOUNCEMENT_DATE" readonly="readonly" value="${dMap.ANNOUNCEMENT_DATE}"/>
							<input name="button15" value=" " type="button" class="time_ico" />
						</td>
					</tr>
					<tr>
						<td class="right" align="right">国家品牌授权截止时间：</td>
						<td class="table_query_4Col_input" nowrap="nowrap">
							<input name="ANNOUNCEMENT_END_DATE" type="text" class="short_time_txt middle_txt" id="ANNOUNCEMENT_END_DATE" readonly="readonly" value="${dMap.ANNOUNCEMENT_END_DATE}"/>
							<input name="button12" value=" " type="button" class="time_ico" />
						</td>
						<td align="right">&nbsp;</td>
				...
				<table class=table_query width="100%">
					<tr>
						...
						<input type="button" value="保存" name="saveBtn" class="u-button" onclick="saveDealerInfo()"/>	&nbsp;&nbsp;
						<input type="button" value="返回" name="cancelBtn"  class="u-button u-cancel" onclick="history.back();" /></td>
					</tr>
				</table>
			</div>
		</div>
