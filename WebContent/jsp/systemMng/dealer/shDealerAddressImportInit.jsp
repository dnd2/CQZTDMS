...
<title>售后经销商地址批量导入</title>
</head>

<body>
	<div class="wbox">
	<div class="navigation"><img src="<%=contentPath %>/img/nav.gif" />&nbsp;当前位置 >系统管理>经销商管理>售后经销商维护>售后经销商地址批量导入
	</div>
...
<table class="table_query">
	<tr>
	    <td class="table_query_input" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp; 
	    	备注：<font color="#FF0000">请按模板填写售后经销商地址信息</font> 
	    </td>
    </tr>
	<tr> 
...
<script type="text/javascript">
	function upload(){
		...
		$('fm').action = "<%=contentPath %>/sysmng/dealer/ShDealerImport/shImportAddressOperate.do";
    	$("fm").submit();
	}
	
	function downloadFile(){
	    fm.action = "<%=contentPath %>/sysmng/dealer/ShDealerImport/downloadTempleShAddress.do";
	    fm.submit();
	}
	function goBack(){
		fm.action = "<%=contentPath %>/sysmng/dealer/DealerInfo/queryDealerCsInfoInit.do";
	    fm.submit();
	}
</script>
</body>
