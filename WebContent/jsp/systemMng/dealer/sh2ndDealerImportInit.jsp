...
<body>
	<div class="wbox">
	<div class="navigation"><img src="<%=contentPath %>/img/nav.gif" />&nbsp;当前位置 >系统管理>经销商管理>二级销售经销商维护>导入
	</div>
...
<script type="text/javascript">
	function upload(){
		...
		$('fm').action = "<%=contentPath %>/sysmng/dealer/XsDealerImport/xsImportOperate2nd.do";
    	$("fm").submit();
	}
	
	function downloadFile(){
	    fm.action = "<%=contentPath %>/sysmng/dealer/XsDealerImport/downloadTempleXs2nd.do";
	    fm.submit();
	}
	function goBack(){
		fm.action = "<%=contentPath %>/sysmng/dealer/DealerInfo/query2ndDealerCsInfoInit.do";
	    fm.submit();
	}
</script>
</body>
