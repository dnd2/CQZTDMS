...
<!-- 		</td> -->
	...
	<tr>
		...
		<td class="table_query_4Col_input" nowrap="nowrap">
			<label>
					<script type="text/javascript">
						genSelBoxExp("ADDRESS_TYPE",<%=Constant.SH_ADDRESS_TYPE%>,"-1",'true',"short_sel","onchange='changeAddressType(this)'","false",'');
					</script>
			</label>
		</td>
		...
		<td class="table_query_4Col_input" nowrap="nowrap">
			<label>
					<script type="text/javascript">
						genSelBoxExp("STATUS",<%=Constant.STATUS%>,"-1",'true',"short_sel",'',"false",'');
					</script>
			</label>
		</td>
	</tr>
...
<script>
var myPage;
var url = "<%=contextPath%>/sysmng/dealer/DealerAddressInfo/queryDealerAddressInfo.json";
