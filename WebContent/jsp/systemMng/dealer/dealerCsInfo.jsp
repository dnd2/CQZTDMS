...
<title>经销商维护</title>
<style>table.table_query td.query-bottom{padding-top: 15px}</style>
...
function dialogAddressUpdateLink(dealer_id) {
	return OpenHtmlWindow("<%=contextPath%>/jsp/systemMng/dealer/dealerCsAddressVindicate.jsp?DEALER_ID="+dealer_id,700,500);
}
</script>
</head>
...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 系统管理 &gt; 经销商管理 &gt;售后经销商维护</div>
			...
			<div class="form-body">
				<table class="table_query" border="0">
					...
					<tr>
						...
						<td class="table_query_4Col_input" nowrap="nowrap">
							<select name="AUTHORIZATION_TYPE" class="u-select" id="AUTHORIZATION_TYPE">
						...
						<tr>
								...
								<td align="left">
									<select id="WORK_TYPE" class="u-select" name="WORK_TYPE">
									<option value="">-请选择-</option>
						...
						<td class="table_query_3Col_label_6Letter right" nowrap="nowrap">经销商状态：</td>
							...
							<tr>
								...
								<td align=left>
									<select id="orgId" class="u-select" name="orgId">
										<option value="">-- 请选择 --</option>
						...
						<td class="table_query_3Col_label_6Letter right" nowrap="nowrap">选择省份：</td>
							...
							<tr>
								...
								<input class="time_txt middle_txt" id="AUTHORIZATION_SCREATE_DATE" name="AUTHORIZATION_SCREATE_DATE" datatype="1,is_date,10" maxlength="10" value="" style="width:65px" group="AUTHORIZATION_SCREATE_DATE,AUTHORIZATION_ECREATE_DATE"/>
									<input class="time_ico" value=" " type="button"/>
									至
									<input class="time_txt middle_txt" id="AUTHORIZATION_ECREATE_DATE" name="AUTHORIZATION_ECREATE_DATE" datatype="1,is_date,10" value="" style="width:65px" maxlength="10" group="AUTHORIZATION_ECREATE_DATE,AUTHORIZATION_ECREATE_DATE"/>
									<input class="time_ico" value=" " type="button"/>
								</td>
					</tr>
					<tr align="center">
						<td colspan="4" class="table_query_4Col_input center query-bottom">
							...
							<input name="button2" type="button" class="u-button" onclick="add()" value="添 加" /> &nbsp;
...
function myLink(value,meta,record){
	var link = "<a href=\"<%=contextPath%>/sysmng/dealer/DealerInfo/queryDealerInfoDetail.do?DEALER_ID="+value+"\">[修改]</a>"; 
...
function add()
{
	window.location.href='<%=contextPath%>/sysmng/dealer/DealerInfo/addNewCsDealer.do';
}
...
function importDealer(){
	window.location.href='<%=contextPath%>/sysmng/dealer/ShDealerImport/shImportInit.do';	
}
function importDealerAddress(){
	window.location.href='<%=contextPath%>/sysmng/dealer/ShDealerImport/shImportAddressInit.do';	
}
