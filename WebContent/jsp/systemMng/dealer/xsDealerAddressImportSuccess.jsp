...
<title>销售经销商地址导入确认</title>
</head>
<body onunload='javascript:destoryPrototype()'>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置 >系统管理>经销商管理>销售经销商维护>地址导入确认</div>	 
<form  name="fm" id="fm">
...
var myPage;
//查询路径           
var url = "<%=contextPath%>/sysmng/dealer/XsDealerImport/xsImportAddressOperateQuery.json";
var title = null;
var columns = [
...
function importSave() {
	if(submitForm('fm')){
			fm.action = "<%=contextPath %>/sysmng/dealer/XsDealerImport/importExcelForAddress.do";
			fm.submit();
		}
}
</script>
