...
<script type="text/javascript">
	...
	function doSavetAction(){				
		var url = "<%=contextPath%>/sysmng/orgmng/WareHouseMng/wareHouseDoSave.json";
...
<table class="table_query table_list" class="center" id="ctm_table_id_2">
	<tr>
		...
		<td class="left"><input id="company_man" name="company_man" value="" type="text" class="middle_txt" size="20" 
			 /> <font color="red">*</font> </td>
		<td class="right">联系电话：</td>
		<td class="left"><input id="company_tel" value="" name="company_tel" type="text" class="middle_txt" size="20" datatype="1,is_digit,15"
			maxlength="11" /><font color="red">*</font> </td>
	</tr>
	
	<tr>
		<td class="right">仓库名：</td>
		<td class="left"><input id="house_name" name="house_name" value="" type="text" class="middle_txt" size="20" 
			 /><font color="red">*</font></td>
		<td class="right">仓库代码：</td>
		<td class="left"><input id="house_code" value="" name="house_code" type="text" class="middle_txt" size="20" 
			maxlength="15" /><font color="red">*</font></td>
	</tr>
	...
	<tr>
		...
		<td colspan="3" class="left">
			<input id="address" class="middle_txt input-long-txt" name="address" type="text" size="80" value="" datatype="0,is_textarea,200" maxlength="200" />
			<font color="red">*</font>
		</td>
	</tr>
</table>
