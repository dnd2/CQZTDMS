				...
				<div class="form-body">
					<table class="table_query">
						...
						<td class="table_query_2Col_label_5Letter" nowrap="nowrap" >公司类型：</td>
							<td class="table_query_2Col_input" nowrap="nowrap">
							<script type="text/javascript"> genSelBox("COMPANY_TYPE",<%=Constant.COMPANY_TYPE%>,"",false,"","");</script>
...
<script type="text/javascript" >
	...
	function alignLft(v,m,r){
		return "<div align='left'>"+v+"</div>";
	}
	//设置超链接
	function myLink(value){
        return String.format(
               "<a href=\"<%=contextPath%>/sysmng/orgmng/DlrInfoMng/getCompanyInfo.do?companyId="+value+"\">[维护]</a>");
    }
	function addDlrInfo(){
		/* var form = $("fm");
		form.action = '<%=request.getContextPath()%>/sysmng/orgmng/DlrInfoMng/queryDlrBrand.do';
		form.submit(); */
		document.location.href = '<%=request.getContextPath()%>/sysmng/orgmng/DlrInfoMng/queryDlrBrand.do';
	}
</script>
</body>
</html>
