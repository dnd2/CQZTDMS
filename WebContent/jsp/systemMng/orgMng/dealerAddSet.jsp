...
<body onload="__extQuery__(1)">
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 系统管理 > 经销商管理 >经销商地址维护</div>
	<form method="post" name = "fm" id="fm">
		<table  border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
			<th colspan="4"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />经销商地址维护管理</th>
...
<script type="text/javascript">
	//类型新增
	function addType(){
		window.location.href='<%=contextPath%>/customerRelationships/baseSetting/typeSet/dealerAddSetAddOrUpdateTypeSet.do';
	}
	...
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/customerRelationships/baseSetting/typeSet/queryTypeSetForAddSet.json";
	...
	function viewDetail(value){		
		window.location.href='<%=contextPath%>/customerRelationships/baseSetting/typeSet/UpdateTypeSet.do?id='+value ;
	}
	//页面跳转：
		function sendPage(){
