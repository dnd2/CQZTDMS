...
<body onload="doInit()">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理 &gt; 信息反馈提报 &gt; 维修回访新增(经销商端)</div>
...
<table class="table_query" border="0"> 
	<tr>
	  <td class="table_query_2Col_label_4Letter" nowrap="nowrap">客户名称：</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
			<input class="middle_txt" type="text" datatype="0,is_letter_cn,300" maxlength="300"   id="CUSTOMER_NAME" name="CUSTOMER_NAME"/>
		</td>	 
	...
	<tr>
		  ...
		  <td class="table_query_2Col_input" nowrap="nowrap">
		  <input class="middle_txt"   maxlength="30" type="text" id="PHONE" name="PHONE" />
		   <font color="red">*</font>
		  </td> 
		  <td class="table_query_2Col_label_4Letter" nowrap="nowrap">三包内外：</td>
		  <td class="table_query_2Col_input" nowrap="nowrap">
            <script type="text/javascript"> genSelBox("THREE_GUARANTEES",<%=Constant.IF_TYPE%>,"",false,"","");</script>
             <font color="red">*</font>
        </td>  
	</tr>
	<tr>
	  <td class="table_query_2Col_label_4Letter" nowrap="nowrap">选择车型：</td>
       ...
       <td class="table_query_2Col_label_4Letter" nowrap="nowrap">车牌号码：</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
           		  <input class="middle_txt"   maxlength="30" type="text" id="LICENSE_NO" name="LICENSE_NO" /> <font color="red">*</font>   
        </td>  
     </tr>
	<tr>
	 <td class="table_query_2Col_label_4Letter" nowrap="nowrap">维修项目：</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
		  <script type="text/javascript">genSelBoxExp("REPAIR_ITEM",<%=Constant.REPAIR_ITEM%>,"",true,"short_sel","","false",'');</script>
		   <font color="red">*</font>
        </td>
      <td class="table_query_2Col_label_4Letter" nowrap="nowrap">回访结果：</td>
	  <td class="table_query_2Col_input" nowrap="nowrap">
	   <script type="text/javascript">genSelBoxExp("NO_VISIT_REASON",<%=Constant.NO_VISIT_REASON%>,"",true,"short_sel","onchange='changeNoVisitReason(this.value)'","false",'');</script>
	    <font color="red">*</font>
	  </td>
	</tr>
</table>
<table id="table_NO_VISIT_REASON" class="table_query" border="0">
     <tr>
	   <td class="table_query_2Col_label_4Letter" nowrap="nowrap">是否满意：</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
            <script type="text/javascript">genSelBoxExp("SATISFIED",<%=Constant.IF_TYPE%>,"",true,"normal_sel","","false",'');</script>
        </td>
         <td class="table_query_2Col_label_4Letter" nowrap="nowrap">是否推荐:</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
            <script type="text/javascript">genSelBoxExp("IS_RECOMMEND",<%=Constant.IF_TYPE%>,"",true,"short_sel","","false",'');</script>
        </td> 
	</tr>
...
<tr>
	  <td class="table_query_2Col_label_4Letter" nowrap="nowrap">不满意项：</td>
		<td class="table_query_2Col_input" nowrap="nowrap"><script>genSelBoxExp("NO_SATISFIED",<%=Constant.NO_SATISFIED%>,"",true,"short_sel","","false",'');</script>	 	  
        </td> 
        <td class="table_query_2Col_label_5Letter" nowrap="nowrap">不满意内容:</td>
		<td class="table_query_2Col_input" nowrap="nowrap">
		 	  <textarea name='NO_SATISFIED_REASON' id='NO_SATISFIED_REASON'	  rows='2' cols='28'></textarea> 
        </td>
	</tr>
</table>
<table class="table_query" border="0">
...
<script>
function save(){
   if(null == $('GROUP_CODE').value || '0' == $('GROUP_CODE').value){
      MyAlert('车型不能为空！');
   }else if(null == $('PHONE').value || '' == $('PHONE').value){
     MyAlert('联系电话不能为空！');
   }else if(null == $('LICENSE_NO').value || '' == $('LICENSE_NO').value){
     MyAlert('车牌不能为空！');
   }else if(null == $('REPAIR_ITEM').value || '' == $('REPAIR_ITEM').value){
     MyAlert('维修项目不能为空！');
   }else if(null == $('NO_VISIT_REASON').value || '' == $('NO_VISIT_REASON').value){
     MyAlert('回访结果不能为空！');
   }else {
...
function insert(){
  makeNomalFormCall('<%=contextPath%>/sysmng/usemng/RepairCustomerVisit/add.json',insertCall,'fm','');  
}
