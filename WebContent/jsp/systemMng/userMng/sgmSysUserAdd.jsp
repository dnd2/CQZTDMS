	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr >
			<td align="center">
				...
				<input name="button2" type="button" class="normal_btn" onclick="sub('<%=contextPath%>/sysmng/usemng/SgmSysUser/addSgmSysUser.json')" value="保 存"/>&nbsp;
...
function addPose(path) {
	setPoseIds();
	OpenHtmlWindow(path+"/sysmng/usemng/SgmSysUser/addPoseQueryInit.do?POSE_IDS="+$('#POSE_IDS')[0].value,800,500);
}
