...
<table class="table_query" border="0">
	<tr>
		<td class="table_query_3Col_label_4Letter right" nowrap="nowrap">职位代码：</td>
		...
		<td class="table_query_3Col_label_4Letter right" nowrap="nowrap">职位名称：</td>
...
<script>
	var url = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/addPoseQuery.json";
	var dels = 2;
	var mypose = null;
	...
	function add() {
		if($('#selectAll')[0].checked == true) {
			if(mypose != null) {
				for(var i=0; i<mypose.length; i++) {
					objarr.push(mypose[i]);
				}
			}
	...
	{	
		...
		addTable.rows[length].cells[0].innerHTML =  "<td nowrap='nowrap'><input type='checkbox' id="+poseId+" name='selectAll' onclick='checkselectAllBox(this)'/></td>";
