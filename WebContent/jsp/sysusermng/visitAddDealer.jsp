    ...
    <TABLE  class="table_query">
           <tr>  
	        <td align="right" class="table_query_2Col_label_7Letter" id="deId">选择经销商：</td>
	 		<td align="left">
				<input class="middle_txt" id="dealerCode" readonly="readonly"  name="dealerCode" type="text"/>
				<input class="middle_txt" id="dealerId"  name="dealerId" type="hidden"/>
	            <input name="showBtn" type="button" class="mini_btn" style="cursor: pointer;" onClick="showOrgDealerZWcon('dealerCode','dealerId','false','',true);" value="..." />        
