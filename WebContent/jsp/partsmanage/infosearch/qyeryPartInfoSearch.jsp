...
<body>
<img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 配件管理&gt;基本信息查询&gt;配件基本信息查询
<form name="fm" id="fm">
<!-- 查询条件 begin -->
...
//设置超链接  begin      
	...
	{
  		return String.format("<a href=\"#\" onclick='sel(\""+value+"\")'>[明细]</a>");
	}
	
	//详细页面
	function sel(value)
	{
		OpenHtmlWindow('<%=contextPath%>/partsmanage/infoSearch/PartInfoSearch/queryPartDetail.do?partId='+value,800,500);
	}
