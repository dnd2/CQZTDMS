...
<form method="post" name="fm" id="fm">
 <table class="table_query"> 
    <tr>
 		<th colspan="6" align="left"><img src="<%=contextPath%>/img/subNav.gif" alt="" class="nav" />经销商选择</th>
 	</tr>
    <tr>
        <td class="table_query_2Col_label_6Letter">经销商选择：</td>
        <td class="table_query_2Col_input">
           <input id="dealerId" name="dealerId" value="" type="hidden"/>
      	   <input class="long_txt" id="dealerCode" name="dealerCode" value="" type="text" datatype="0,is_null,500" readonly="readonly"/>
  ...
  <table class="table_query">
    ...
    <tr>
        <td class="table_query_3Col_label_6Letter">订单最大行数：</td>
	    <td><input type="text" name="orderMaxLines" id="orderMaxLines" datatype="0,is_digit,4" class="short_txt"  /></td>
	    <td class="table_query_3Col_label_9Letter">周期内允许上报次数：</td>
	    <td><input type="text" name="allowSubmitTimes" id="allowSubmitTimes" datatype="0,is_digit,4" class="short_txt" value="" /></td>
        <td class="table_query_3Col_label_3Letter">折扣：</td>
        <td><input type="text" name="discountRate" id="discountRate" datatype="0,is_double,6" decimal="2" class="short_txt" value="" /> (0.XX)</td>
      </tr>
   </table>  
  <table class="table_query">
  <tbody id="editRule">
    <tr>
      <td class="table_query_2Col_label_6Letter">选择周期类型：</td>
	  <td class="table_query_2Col_input">
  ...
  function addItem()
	{
		isChanged = true;
		var reason = "";
		var td1 = '<input name=\"START_DATE\" type=\"text\" class=\"short_txt\" size=\"5\"><font color=\"red\">*</font>';
		var td2 = '<input name=\"END_DATE\" type=\"text\" class=\"short_txt\" size=\"5\"><font color=\"red\">*</font>';
		var td3 = '<input name=\"HANDLE_DATE\" type=\"text\" class=\"short_txt\" size=\"5\"><font color=\"red\">*</font>';
	...
	function SubmitForm()
	{
		...
		MyConfirm("确定新增配件订单业务参数信息?", formSub);
	}
	
	function formSub(){
	    fm.action = "<%=contextPath%>/partsmanage/infoSearch/PartsmanageOrderParamInfo/insertRule.do";
		fm.submit();
	}
