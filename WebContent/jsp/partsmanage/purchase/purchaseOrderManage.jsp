...
<body>
<img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 配件管理&gt;经销商配件采购&gt;配件采购订单管理
    ...
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
      ...
      <tr>
        ...
        <td><script type="text/javascript">     
 				  genSelBoxExp("orderStatus",<%=Constant.PART_ORDER_STATUS%>,"",true,"short_sel","","false",'<%=Constant.PART_ORDER_STATUS_02%>,<%=Constant.PART_ORDER_STATUS_03%>,<%=Constant.PART_ORDER_STATUS_04%>,<%=Constant.PART_ORDER_STATUS_06%>');
			</script>	
        </td>
      </tr>
      <tr>
...
<script type="text/javascript" >
	...
	var url = "<%=contextPath%>/partsmanage/purchase/PurchaseOrderSearch/queryOrderList.json";
	...
	var columns = [
				...
				{header: "上一操作部门", dataIndex: 'OPERACTION_NAME', align:'center'},
...
//设置超链接  begin
	...
	function myLink(value,meta,record){
		return String.format("<a href='#' onclick='updateOrderPart(\""+ value +"\")'>[修改]</a><a href='#' onclick='delOrderPart(\""+ value +"\")'>[删除]</a>");
	}
	
	//删除操作
	function delOrderPart(value){
		$("orderId").value = value;
		makeNomalFormCall("<%=contextPath%>/partsmanage/purchase/PurchaseOrderSearch/delOrderPart.json",showForwordValue,'fm','queryBtn'); 
	}
	...
	//修改操作
	function updateOrderPart(value){
		$("orderId").value = value;
		fm.action = "<%=contextPath%>/partsmanage/purchase/PurchaseOrderSearch/updateOrderPartInit.do";
		fm.submit();
	}
