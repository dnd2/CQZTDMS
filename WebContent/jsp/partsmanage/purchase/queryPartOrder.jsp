...
<!-- created by lishuai103@yahoo.com.cn 20100603 配件采购订单查询 -->
...
<body>
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 配件管理&gt;配件销售&gt;采购订单状态查询
	...
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
     <tr>
      ...
      <td>
        ...
        <input type="button" value="清空" onclick="clearDealer()" class="normal_btn"/>     
      </td>
