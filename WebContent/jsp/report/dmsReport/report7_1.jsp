...
var Options = {
	...
	function expotData(){
	   fm.action="<%=contextPath%>/report/dmsReport/Application/expotData7.do";
       fm.submit();
	}
</script>
</head>
...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;售后报表管理&gt;品质情报报表
</div>
<form name="fm" id="fm">
<!-- 查询条件 begin -->
...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/report/dmsReport/Application/report7.json?query=true";
	var title = null;
	var columns = [
