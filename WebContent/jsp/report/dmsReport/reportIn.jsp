...
<script type="text/javascript">
	function expotData(){
		fm.action="<%=contextPath%>/report/dmsReport/Application/expotReportIn.do";
		fm.submit();
...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;售后报表管理&gt;查询入库明细
</div>
<form name="fm" id="fm">
...
<script type="text/javascript" >
	...
	var url = "<%=contextPath%>/report/dmsReport/Application/reportIn.json";
	var title = null;
	var columns = [
		       		{header: "序号",sortable: false,align:'center',renderer:getIndex},
		       		{header: "索赔单号", dataIndex: 'CLAIM_NO', align:'center'},
		       		{header: "入库数", dataIndex: 'SIGN_AMOUNT', align:'center'},
