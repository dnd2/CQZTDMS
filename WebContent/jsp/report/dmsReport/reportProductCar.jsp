...
<script type="text/javascript">
	function expotData(){
		fm.action="<%=contextPath%>/report/dmsReport/Application/exportReportProductCar.do";
		fm.submit();
...
<script type="text/javascript" >
	...
	var url = "<%=contextPath%>/report/dmsReport/Application/queryReportproductCar.json?date=${date}&N=${N}";
	var title = null;
	var columns = [
