...
var Options = {
	...
	function expotData(){
		fm.action="<%=contextPath%>/report/dmsReport/Application/expotReport14.do";
		fm.submit();
...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;售后报表管理&gt;无价和暂估二次索赔明细报表
</div>
<form name="fm" id="fm">
...
<script type="text/javascript" >
	...
	var url = "<%=contextPath%>/report/dmsReport/Application/queryReport14.json";
	var title = null;
	var columns = [
