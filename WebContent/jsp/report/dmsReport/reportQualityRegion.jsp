...
<script type="text/javascript">
	function expotData(){
		fm.action="<%=contextPath%>/report/dmsReport/Application/exportQualityRegion.do";
		fm.submit();
...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;售后报表管理&gt;品质情报通过率（大区）报表
</div>
<form name="fm" id="fm">
...
<script type="text/javascript" >
	...
	var url = "<%=contextPath%>/report/dmsReport/Application/queryQualityRegion.json";
	var title = null;
	var columns = [
