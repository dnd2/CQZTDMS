...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>&nbsp;
    当前位置：报表管理&gt;配件报表&gt;本部计划报表&gt;领用单查询及统计
</div>
<form method="post" name="fm" id="fm" enctype="multipart/form-data">
    ...
    <table id="queryAll" class="table_query" width=100% border="0" align="center" cellpadding="1" cellspacing="1" >
		...
		<tr >
	       ...
	       <td width="25%" ><input class="middle_txt" type="text" name="balanceCode" id="balanceCode"/></td>
        </tr>
	 <tr>
	       ...
	       <td width="25%">
	            <input name="CheckSDate" id="CheckSDate" value="${old}" type="text" class="short_txt" datatype="1,is_date,10" group="CheckSDate,CheckEDate">
           		<input name='button3' type='button' class='time_ico' value=" " title="点击选择时间" onclick="showcalendar(event, 'CheckSDate', false);"/>
           		&nbsp;至&nbsp;
           		<input name="CheckEDate" id="CheckEDate" value="${now}" type="text" class="short_txt" datatype="1,is_date,10" group="CheckSDate,CheckEDate">
           		<input name='button3' type='button' class='time_ico' value=" " title="点击选择时间" onclick="showcalendar(event, 'CheckEDate', false);"/>
	       </td>
       ...
       <tr>
        ...
        <tr>
            ...
            <td width="25%">
                <input class="long_txt" type="text" value="0" id="dtlCount" style="background-color: #99D775;" readonly="readonly"/>
            </td>
            <td width="10%" align="right">总数量：</td>
            <td width="20%">
                <input class="long_txt" type="text" value="0" id="qtyCount" style="background-color: #99D775;" readonly="readonly"/>
            </td>
         ...
         <tr>
                ...
                <input type="radio" name="RADIO_SELECT" value="2"/>查询领件单
                </td>
            </tr>
...
var myPage;
var url = "<%=contextPath%>/report/partReport/partPlanReport/recvOrderReport/queryPurOrderBalance.json";
...
function callBack(json){
	...
	if(Object.keys(json).length>0){
		...
		$("qtyCount").value = json.qtyCount;
		$("dtlCount").value = json.dtlCount;
	}
...
function view(value) {
	OpenHtmlWindow("<%=contextPath%>/report/partReport/partPlanReport/recvOrderReport/queryInfoByCodeInit.do?balanceCode="+value,1100,400);
}
...
function expPurOrderBalanceExcel() {
    fm.action = "<%=contextPath%>/report/partReport/partPlanReport/recvOrderReport/expPurOrderBalanceExcel.do";
    fm.target = "_self";
    fm.submit();
}
