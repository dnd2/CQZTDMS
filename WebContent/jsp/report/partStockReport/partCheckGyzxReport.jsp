...
<div class="wbox">
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>&nbsp;当前位置： 报表管理&gt;配件报表&gt;供应中心报表&gt;库存盘点(供应中心)
</div>
<form method="post" name="fm" id="fm" enctype="multipart/form-data">
    <input type="hidden" name="expFlag" value="1"/>
    <table class="table_query" width=100% border="0" align="center" cellpadding="1" cellspacing="1" >
		...
		<tr>
		    <c:if test="${flag eq 0 }">
		        <td width="10%" align="right">供应中心编码：</td>
	            <td width="20%"><input name="venderCode" type="text" class="middle_txt" id="venderCode"/></td>
	            <td width="10%" align="right">供应中心名称：</td>
	            <td width="20%"><input name="venderName" type="text" class="middle_txt" id="venderName"/></td>
		    </c:if>
		    <c:if test="${flag eq 1 }">
		        <td width="10%" align="right">供应中心编码：</td>
	            <td width="20%">
	            <input name="venderCode" type="text" class="middle_txt" id="venderCode" readonly="readonly" value="${venderCode }"/>
	            <input type="hidden" name="venderId" value="${venderId }"/>
	            </td>
	            <td width="10%" align="right">供应中心名称：</td>
	            <td width="20%"><input name="venderName" type="text" class="middle_txt" id="venderName" readonly="readonly" value="${venderName }"/></td>
		    </c:if>
...
var myPage;
var url = "<%=contextPath%>/report/partReport/partStockReport/PartCheckReport/queryPartCheckGyzx.json";

var title = null;

var columns = [
    {header: "序号", align:'center',renderer:getIndex},
    {header: "供应中心编码", dataIndex: 'CHGORG_CODE', style: 'text-align:left'},
    {header: "供应中心名称", dataIndex: 'CHGORG_CNAME', style: 'text-align:left'},
