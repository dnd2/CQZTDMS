...
<script language="javaScript">
	<%-- function submitFRM(){
		...
		if(sysTime < endTime){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/reportOne/SalesReport/getDelaySummaryDownload.do';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售管理 > 整车销售管理 > 常规订单资源延时满足汇总表</div>
