...
function submitFRM(){
	...
	if(b<a){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/BillTicketAllReport/getBillTicketAllReport.do';
...
function downloadFRM(){
	...
	if(b<a){
		...
		document.getElementById("t2").value=b;
		document.FRM.action='<%=request.getContextPath()%>/report/BillTicketAllReport/BillTicketAllReportDownload.json';
...
function download(){
	...
	if(b<a){
		...
		document.getElementById("t2").value=b;
		document.FRM.action='<%=request.getContextPath()%>/report/BillTicketAllReport/download.json';
		document.FRM.target="_self";
		document.FRM.submit();
	}else{
		document.FRM.action='<%=request.getContextPath()%>/report/BillTicketAllReport/download.json';
