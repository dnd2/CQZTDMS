...
<SCRIPT LANGUAGE="JavaScript">
	...
	var myPage;
	//查询路径           
 	var url = "<%=contextPath%>/report/service/BaseReport/TwoClaimInvoiceTotalQueryData.json";
	var title = null;
	var columns = [
				...
				{header: "索赔数量", dataIndex: 'OUT_NUM', align:'center'},
				...
				{header: "金额总计", dataIndex: 'AMOUNT', align:'center'}
...
<BODY onload='doInit()'>
<div class="navigation"><img src="../../../img/nav.gif" />&nbsp;当前位置：报表管理&gt;售后服务报表&gt;二次索赔开票汇总查询</div>
...
function goImport(){
    ...
    fm.action = '<%=contextPath%>/report/service/BaseReport/TwoClaimInvoiceTotalQueryExport.do';
    fm.submit();
}
</script>
