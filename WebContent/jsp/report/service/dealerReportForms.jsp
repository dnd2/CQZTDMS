			...
			<tr>
				...
				<td align="left" nowrap="true">
					<select id="tmOrgSmall" name="tmOrgSmall" class="short_sel">
						...
						<tr>
				<td align="right" nowrap="true">索赔上报日期：</td>
				<td align="left" nowrap="true">
				...
				<td align="right" nowrap="true">开工单日期：</td>
				<td align="left" nowrap="true">
...
<script type="text/javascript">
	function downExcelQuery(){
		fm.action = '<%=contextPath%>/report/service/DealerReportForms/dealerReportFormsExcel.do';
		fm.submit();
	}
	...
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/report/service/DealerReportForms/queryDealerReportForms.json";
	...
	var columns = [
				...
				{header: "一级站名称", dataIndex: 'ROOT_DEALER_NAME', align:'center'},
				{header: "强保费用", dataIndex: 'FREE_AMOUNT',align:'center'},
				{header: "维修材料费",dataIndex: 'PART_AMOUNT',align:'center'},
				{header: "强保台数",dataIndex: 'FREE_TIMES',align:'center'},
				{header: "定保次数", dataIndex: 'CHECK_TIMES',align:'center'},
				{header: "结算台次",dataIndex: 'BALANCE_TIMES',align:'center'},
				{header: "维修台次",dataIndex: 'REPAIR_TIMES',align:'center'}
		      ];
