...
<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<span style="color: red">备注：鼠标移入表头可以查看统计规则！</span>
	</strong>
</div>
...
<table border="0" cellpadding="3" cellspacing="0" width="100%" class="scrollTable">
	...
	<tr class="scrollColThead">
		<th>产地</th>
		<th>车型</th>
		<th title="入库/日统计规则:某一天【选择统计日期或默认不选日期（当天）】入库的数量">入库/日</th>
		<th title="分派/日统计规则:某一天【选择统计日期或默认不选日期（当天）】分派的数量">分派/日</th>
		<th title="组板/日统计规则:某一天【选择统计日期或默认不选日期（当天）】组板的数量">组板/日</th>
		<th title="出库/日统计规则:某一天【选择统计日期或默认不选日期（当天）】出库的数量">出库/日</th>
		<th title="运输/日统计规则:某一天【选择统计日期或默认不选日期（当天）】运输的数量">运输/日</th>
		<th title="月末遗留统计规则：选择时间上一个月第一天到上一个月最后一天遗留（不选择时间代表当前时间上一个月第一天到上一个月最后一天遗留）">月末遗留</th>
		<th title="入库/月统计规则:某一个月【选择统计日期或默认不选日期（当月）】入库的数量">入库/月</th>
		<th title="分派/月统计规则:某一个月【选择统计日期或默认不选日期（当月）】分派的数量">分派/月</th>
		<th title="组板/月统计规则:某一个月【选择统计日期或默认不选日期（当月）】组板的数量">组板/月</th>
		<th title="出库/月统计规则:某一个月【选择统计日期或默认不选日期（当月）】出库的数量">出库/月</th>
		<th title="运输/月统计规则:某一个月【选择统计日期或默认不选日期（当月）】运输的数量">运输/月</th>
		<th title="未组板统计规则:某一天【选择统计日期或默认不选日期（当天）】以前未组板的数量（包括选中的日期）">未组板</th>
		<th title="年末遗留统计规则：选择时间上一年12月1日到12月31日遗留（不选择时间代表当前时间上一年12月1日到12月31日遗留）">年末遗留</th>
		<th title="入库/年统计规则:某一个年【选择统计日期或默认不选日期（当年）】入库的数量">入库/年</th>
		<th title="分派/年统计规则:某一个年【选择统计日期或默认不选日期（当年）】分派的数量">分派/年</th>
		<th title="组板/年统计规则:某一个年【选择统计日期或默认不选日期（当年）】组板的数量">组板/年</th>
		<th title="出库/年统计规则:某一个年【选择统计日期或默认不选日期（当年）】出库的数量">出库/年</th>
		<th title="运输/年统计规则:某一个年【选择统计日期或默认不选日期（当年）】运输的数量">运输/年</th>
		<th title="实时库存统计规则:某一个时间点【选择统计日期或默认不选日期（当前时间点）】在库的车辆数量">实时库存</th>
	</tr>
	<%
