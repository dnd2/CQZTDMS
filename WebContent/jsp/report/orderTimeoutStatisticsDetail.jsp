...
<script language="javaScript">
	...
	function download(){
		...
		if(startYear > endYear) {
			...
			document.FRM.action='<%=request.getContextPath()%>/report/reportOne/SalesReport/getTimeoutStatisticsDetailDownload.do';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售管理 > 整车销售管理 > 常规订单超时统计明细表</div>
