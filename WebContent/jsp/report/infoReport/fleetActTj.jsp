	...
	<table class="table_query" >
		...
		<tr>
			...
			<td align="left">
				...
				<input class="time_ico" value=" " type="button" onClick="showcalendar(event, 't1', false);" value="&nbsp;" />&nbsp;至&nbsp;
				<input class="short_txt"  type="text" id="t2" name="endDate" datatype="1,is_date,10" group="t1,t2" value="" />
				<input class="time_ico" value=" " type="button" onClick="showcalendar(event, 't2', false);" value="&nbsp;" />
			</td>
		...
		<tr>
			...
			<td align="right">&nbsp;</td>
			<td align="left">&nbsp;</td>
			<td width="15%" align="left"><input name="button2" type="button" id="queryBtn" class="cssbutton" onClick="submitFRM();" value="查询">
			</td>
		</tr>
	</table>
	</form>
