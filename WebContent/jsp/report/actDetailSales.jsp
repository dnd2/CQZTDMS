...
function submitFRM(){
	...
	if(b<a){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/ActDetailSalesReport/getActDetailSalesReport.do';
...
function downloadFRM(){
	...
	if(b<a){
		...
		document.getElementById("t2").value=b;
		document.FRM.action='<%=request.getContextPath()%>/report/ActDetailSalesReport/download.json';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售报表 > 整车销售报表> 销售明细表</div>
