...
function submitFRM(){
	document.FRM.action='<%=request.getContextPath()%>/report/FollowPrepareReport/getFollowPrepareReport.do';
	document.FRM.target="_blank";
	document.FRM.submit();
}
function downloadFRM(){
	document.FRM.action='<%=request.getContextPath()%>/report/FollowPrepareReport/FollowPrepareReportDownload.json';
...
function download(){
	document.FRM.action='<%=request.getContextPath()%>/report/FollowPrepareReport/download.json';
	document.FRM.target="_self";
	document.FRM.submit();
}
...
<tr>
	    ...
	    <input type="hidden" name="aaa" size="15" id="aaa" value="" />
       		<input name="followDate1" id="t1"  readonly="readonly" value="${date2}" type="text" class="short_txt" datatype="1,is_date,10" group="t1,t2" hasbtn="true" callFunction="showcalendar(event, 't1', false);">
       		&nbsp;至&nbsp;
       		<input name="followDate2" id="t2"   readonly="readonly" value="${date}" type="text" class="short_txt" datatype="1,is_date,10" group="t1,t2" hasbtn="true" callFunction="showcalendar(event, 't2', false);">
        </td>
	    <td></td>
    </tr>
	<tr>
