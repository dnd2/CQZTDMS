...
<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;
	<strong>经销商销售汇总表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
</div>
<div id="scrollDiv" class="scrollDiv"> 
<table border="0" cellpadding="3" cellspacing="0" width="100%" class="scrolltable">

	<tr class="scrollColThead">
		<td colspan="13" class="scrollRowThead scrollCR"><strong>经销商销售汇总表</strong></td>
	</tr>
	<tr class="scrollColThead" align="left">
		<td colspan="13" class="scrollRowThead scrollCR" align="left"><div align="left">开始日期：${beginTime}--截止日期${endTime}</div></td>
	</tr>
			...
			if(i==0){
				...
				<tr>
					...
					for(int j=0; j<len_name;j++){
						...
						%>
						<td><%=list_all.get(i).get("ACTAMOUNT"+j)==null?"":list_all.get(i).get("ACTAMOUNT"+j).toString() %>&nbsp;
						</td>
						<% 
					}
					%>
	...
	%>
		...
		%>
			<tr>
				...
				%>
					<th class="scrollRowThead"><span id="ACTAMOUNT_<%=i %>"><%=total_all[i] %></span>&nbsp;</th>
				<%
					myTotal += total_all[i];
				}
				%>
