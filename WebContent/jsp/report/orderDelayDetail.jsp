...
<script language="javaScript">
	function submitFRM(){
		...
		if(sysTime < endTime){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/reportOne/SalesReport/getDelayDetailDownload.do';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售管理 > 整车销售管理 > 常规订单资源延时满足明细表</div>
...
<table class="table_edit">
	...
	<tr>
		<td  align="right">&nbsp;</td>
		<td align="right">常规订单号：</td>
		<td class="table_list_th">
			<input name="orderNo" id="orderNo"  type="text" class="middle_txt" datatype="1,is_digit_letter,30" />
		</td>
		<td>
			&nbsp;
		</td>
	...
	<tr>
		...
		<td class="table_list_th">
			<input name="deliveryNo" id="deliveryNo"  type="text" class="middle_txt" datatype="1,is_digit_letter,30" />
		</td>
		<td>
			<input name="downloadBtn" type=button class="cssbutton" onClick="download();" value="下载">
		</td>
