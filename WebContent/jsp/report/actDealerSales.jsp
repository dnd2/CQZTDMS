...
function submitFRM(){
	...
	if(b<a){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/ActSalesAllReports/getActSalesAllReport.do';
...
function downloadFRM(){
	...
	if(b<a){
		...
		document.getElementById("t2").value=b;
		document.FRM.action='<%=request.getContextPath()%>/report/ActSalesAllReports/download.json';
