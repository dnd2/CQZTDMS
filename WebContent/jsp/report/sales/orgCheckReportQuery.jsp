...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;整车销售报表&gt;各大区开票报表</div>
...
function firstQuery(){
	var fm = document.getElementById("fm");
		fm.target="_blank";
		fm.action = "<%=contextPath%>/report/reportOne/OrgCheckReport/getOrgCheckReportInfo.do";
		fm.submit();
}
</script>
<!--页面列表 end -->
