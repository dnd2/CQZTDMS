...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;整车销售报表&gt;大区开票实销</div>
...
function exportExcel(){
	var fm =  document.getElementById("fm");
		fm.action = "<%=contextPath%>/report/reportOne/OrgSalesCheckReport/toExcel.json";
		fm.submit();
}
...
function firstQuery(){
	var fm = document.getElementById("fm");
		fm.target="_blank";
		fm.action = "<%=contextPath%>/report/reportOne/OrgSalesCheckReport/getOrgSalesCheckReportInfo.do";
		fm.submit();
}
</script>
<!--页面列表 end -->
