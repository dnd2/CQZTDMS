...
function submitFRM(){
	...
	//}else if(a=='' && c==''){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/ActSalesAllReport/getActSalesAllReport.do';
...
function downloadFRM(){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/ActSalesAllReport/ActSalesAllReportDownload.json';
...
function download(){
	...
	document.FRM.action='<%=request.getContextPath()%>/report/ActSalesAllReport/download.json';
	document.FRM.target="_self";
	document.FRM.submit();
