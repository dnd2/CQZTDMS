...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/PreserveVehicleChangeCountReport/queryPreserveVehicleChangeCountReport.json";
...
//设置超链接  begin      
	...
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/PreserveVehicleChangeCountReport/preserveVehicleChangeCountReportExcel.do";
		fm.submit();
	}
