...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;轿车售后索赔报表&gt;轿车维修车辆数</div>
  ...
  <table class="table_query">
 		<tr>
          ...
          <tr>
			...
			<td width="19%" align="right" nowrap>省份：</td>
            <td colspan="2" align="left" >
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/PreserveVehicleReport/queryPreserveVehicleReport.json";
	...
	var columns = [
				...
				{header: "维修车辆数", dataIndex: 'CON', align:'center'}
				
				//{header: "一级经销商名称", dataIndex: 'DEALER_SHORTNAME', align:'center'},
...
//设置超链接  begin      
	...
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/PreserveVehicleReport/preserveVehicleReportExcel.do";
		fm.submit();
	}
