...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;轿车售后索赔报表&gt;保养次数统计查询</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/DealerKeepAmountReport/queryKeepAmountReport.json";
	...
	var columns = [
				...
				{header: "首保次数", dataIndex: 'SOUBAO', align:'center'},
				{header: "例保次数", dataIndex: 'LIBAO', align:'center'},
				{header: "首保结算次数", dataIndex: 'SOUBAOJIESUAN', align:'center'},
				{header: "例保结算次数", dataIndex: 'LIBAOJIESUAN', align:'center'},
				{header: "保养次数合计", dataIndex: 'QUANBU', align:'center'}				
		      ];
		      
//设置超链接  begin      
	function exportExcel()
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/DealerKeepAmountReport/getKeepAmountReportExcel.do";
		fm.submit();
	}
