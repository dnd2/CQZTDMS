...
<script type="text/javascript">
	...
	var url = "<%=contextPath%>/report/jcafterservicereport/BalanceTracking/query4JC.json";
	...
	function exportExcel(){
		fm.action = "<%=contextPath%>/report/jcafterservicereport/BalanceTracking/excel4JC.do";
		fm.submit();
	}
