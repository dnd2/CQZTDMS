...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;轿车售后索赔报表&gt;车辆保养记录</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/VehicleGoodRepairReport/vehicleGoodRepairReportReport.json";
	...
	var columns = [
				...
				{header: "用户姓名", dataIndex: 'OWNER_NAME', align:'center'},
				{header: "维修站", dataIndex: 'DEALER_SHORTNAME', align:'center'},
				{header: "购车日期", dataIndex: 'PURCHASED_DATE', align:'center'},
				{header: "保养时间", dataIndex: 'RO_CREATE_DATE', align:'center'},
				{header: "行驶里程", dataIndex: 'MILEAGE', align:'center'},
...
//设置超链接  begin      
	...
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/VehicleGoodRepairReport/queryVehicleGoodRepairReportExcel.do";
		fm.submit();
	}
