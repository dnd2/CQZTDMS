...
<title>VIN码查车辆信息</title>
<% String contextPath = request.getContextPath(); %>
</head>
<body>
<div id="loader" style='position:absolute;z-index:200;background:#FFCC00;padding:1px;top:4px;display:none;display: none;'></div>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;轿车售后索赔报表&gt;VIN码查车辆信息</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/QueryVehicleByVinReport/queryVehicleByVinReport.json";
	...
	var columns = [
				...
				{header: "车型",sortable: false,dataIndex: 'MODEL_CODE' ,align:'center'},
				{header: "发动机", dataIndex: 'ENGINE_NO', align:'center'},
				{header: "系统最大里程", dataIndex: 'MILEAGE', align:'center'},
				...
				{header: "三包规则", dataIndex: 'GAME_NAME', align:'center'},
				{header: "状态", dataIndex: 'LIFE_CYCLE', align:'center',renderer:getItemValue},
...
//设置超链接  begin      
	...
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/QueryVehicleByVinReport/queryVehicleByVinReportExcel.do";
		fm.submit();
	}
