...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理&gt;轿车售后索赔报表&gt;轿车保养VIN报表</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/report/jcafterservicereport/MainteranceVinReport/queryMainteranceVinReport.json";
	...
	var columns = [
				...
				{header: "服务中心名称",sortable: false,dataIndex: 'DEALER_SHORTNAME' ,align:'center'},
				{header: "一级服务商", dataIndex: 'DEALER_NAME1', align:'center'},
...
//设置超链接  begin      
	...
	{
		fm.action = "<%=contextPath%>/report/jcafterservicereport/MainteranceVinReport/mainteranceVinReportExcel.json";
		fm.submit();
	}
