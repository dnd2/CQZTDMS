...
function submitFRM(){
	document.FRM.action='<%=request.getContextPath()%>/report/reportOne/SalesReport/getFleetSalesLogReport.do';
...
function download(){
	...
	if(startTime > endTime){
		...
		document.FRM.action='<%=request.getContextPath()%>/report/reportOne/SalesReport/fleetSalesLogReportdownload.json';
