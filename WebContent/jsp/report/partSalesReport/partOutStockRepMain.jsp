...
<head>
    <script type="text/javascript">
        jQuery.noConflict();
        var baseUrl = "<%=contextPath%>/report/partReport/partOutStockReport/PartOutStockReport/";
        var myPage;
        var url = baseUrl + "query.json";
        var title = null;
        var columns = [
            {header: "序号", align: "center", renderer: getIndex},
            {header: "出库单号", dataIndex: "RETAIL_CODE", align: "center"},
            {header: "服务商编码", dataIndex: "DEALER_CODE", align: "center"},
            {header: "服务商名称", dataIndex: "DEALER_NAME", style: 'text-align:left'},
            {header: "出库类型", dataIndex: "IN_TYPE", align: "center"},
...
//            {header: "配件件号", dataIndex: "PART_CODE", style: 'text-align:left'},
            ...
            {header: "出库数量", dataIndex: "OUT_QTY", align: "center"},
            {header: "单价", dataIndex: "SALE_PRICE", align: "center"},
            {header: "金额", dataIndex: "SALE_AMOUNT", style: 'text-align:right'},
...
//                jQuery('#orgCode').attr('disabled', 'disabled');
//                jQuery('#org').attr('disabled', 'disabled');
//                jQuery('#orgBtn').attr('disabled', 'disabled');
...
<form name="fm" id="fm" method="post">
    ...
    <div id="div1" class="wbox">
        <div class="navigation"><img src="<%=contextPath %>/img/nav.gif" alt=""/>&nbsp;当前位置: 报告管理&gt;配件报表&gt;服务商报表&gt;出库明细（服务商）
        </div>
        <table border="0" class="table_query">
            ...
            <tr>
                ...
                <td>
                    <input name="partOldCode" id="partOldCode" type="text" class="middle_txt"/>
                </td>
                <td align="right">
                    配件名称:
                </td>
                <td>
                    <input name="partCName" id="partCName" type="text" class="middle_txt"/>
                </td>
                <td align="right">
                    出库日期:
                </td>
                <td>
                    ...
                    至
                    <input class="time_txt" id="ECREATE_DATE" name="ECREATE_DATE" datatype="1,is_date,10"
                           value="${toDay}"
                           style="width:65px"
            ...
            <tr>
                ...
                <td>
                    ...
                    <input onclick="showChildOrg('','org','','','');" type="button" value="..." id="orgBtn"
                           class="mini_btn">
                </td>
                <td align="right">
                    服务商代码:
                ...
                <td>
                    <input name="orgCode" id="orgCode" type="text" class="middle_txt"/>
                </td>
                <td align="right"></td>
                <td></td>
            </tr>
            <tr>
                <td colspan="6" align="center">
                    ...
                    <input name="exportBtn" id="exportBtn" class="normal_btn" type="button" value="导 出"/>
                </td>
            </tr>
        </table>
    </div>
