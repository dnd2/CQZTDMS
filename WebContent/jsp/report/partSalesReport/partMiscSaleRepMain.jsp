...
<head>
    <script type="text/javascript">
        jQuery.noConflict();
        var baseUrl = "<%=contextPath%>/report/partReport/partMiscSaleReport/PartMiscSaleReport/";
        var myPage;
        ...
        var columns = [
            ...
            {header: "购货人", dataIndex: "LINKMAN", style: 'text-align:left'},
            {header: "用途", dataIndex: "PURPOSE", style: 'text-align:left'},
...
//        	{header: "配件件号", dataIndex: "PART_CODE", style: 'text-align:left'},
            ...
            {header: "零售数量", dataIndex: "OUT_QTY", align: "center"},
            {header: "零售金额", dataIndex: "SALE_AMOUNT", style: 'text-align:right'},
...
<form name="fm" id="fm" method="post">
    ...
    <div id="div1" class="wbox">
        <div class="navigation"><img src="<%=contextPath %>/img/nav.gif" alt=""/>&nbsp;当前位置: 报告管理&gt;配件报表&gt服务商报表&gt;零售明细（服务商）
        </div>
        <table border="0" class="table_query">
            ...
            <tr>
                <td> 服务商代码:</td>
                <td><input name="orgCode" id="orgCode" type="text" class="middle_txt"/></td>
                <td> 服务商名称:</td>
                <td><input name="org" id="org" type="text"/>
