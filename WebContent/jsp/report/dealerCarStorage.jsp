...
<script language="javaScript">
	function submitFRM(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerCarStrorgeReport/getDealerCarStrorgeReport.do';
	...
	function downloadFRM(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerCarStrorgeReport/DealerCarStrorgeReportDownload.json';
	...
	function download(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerCarStrorgeReport/download.json';
			document.FRM.target="_self";
			document.FRM.submit();
		}
	}
