...
function submitFRM(){
		document.FRM.action='<%=request.getContextPath()%>/report/FleetSalesAllReport/getFleetSalesAllReport.do';
		document.FRM.target="_blank";
		document.FRM.submit();
}

function downloadFRM(){
	document.FRM.action='<%=request.getContextPath()%>/report/FleetSalesAllReport/FleetSalesAllReportDownload.json';
...
function download(){
	document.FRM.action='<%=request.getContextPath()%>/report/FleetSalesAllReport/download.json';
	document.FRM.target="_self";
	document.FRM.submit();
}
...
<table class="table_edit">
  <tr>
	    ...
	    <input type="hidden" name="aaa" size="15" id="aaa" value="" />
       		<input name="insertBeginTime" id="t5"  readonly="readonly" value="${date2}" type="text" class="short_txt" datatype="1,is_date,10" group="t5,t6" hasbtn="true" callFunction="showcalendar(event, 't5', false);">
       		&nbsp;至&nbsp;
       		<input name="insertEndTime" id="t6"   readonly="readonly" value="${date}" type="text" class="short_txt" datatype="1,is_date,10" group="t5,t6" hasbtn="true" callFunction="showcalendar(event, 't6', false);">
        </td>
	    <td></td>
    </tr>
  <tr>
