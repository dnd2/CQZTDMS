...
<script language="javaScript">
	function submitFRM(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerStrorgeReport/getDealerStrorgeReport.do';
	...
	function downloadFRM(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerStrorgeReport/DealerStrorgeReportDownload.json';
	...
	function download(){
		if(document.getElementById("dealerCode").value!=""&&document.getElementById("orgCode").value!=""){
			...
			document.FRM.action='<%=request.getContextPath()%>/report/DealerStrorgeReport/download.json';
			document.FRM.target="_self";
			document.FRM.submit();
		}
	}
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售报表 > 整车销售报表  > 经销商库龄查询</div>
<form method="POST" name="FRM" id="FRM">
<input type="hidden" name="file" value="commonXml/dealerStrorge.xml"></input>
