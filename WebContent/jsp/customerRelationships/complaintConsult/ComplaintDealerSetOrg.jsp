...
<script type="text/javascript">
	...
	function setComplaintPerson(){
    	if(confirm("确定分派吗？")){
			...
			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ComplaintAcceptOrg/complaintOrgSet.json?cpId='+cpId+'&vehicleCompany='+vehic,setBack,'fm','');
				}
    	}
	}
