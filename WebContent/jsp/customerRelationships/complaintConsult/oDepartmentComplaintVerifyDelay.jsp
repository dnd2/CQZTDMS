...
<div class="wbox">
<div class="navigation"><img src="../../../img/nav.gif" width="11" height="11" />&nbsp;当前位置：  投诉咨询管理 &gt;大区延期车厂审核</div>
</div>
      ...
      <tr>
        <td><table id="Table2" width="100%" class="tab_edit">
          <tbody>
			...
			<tr>
				<td align="center" colspan="2">审核状态</td>
			...
			<tr>
				...
				<td align="left" colspan="5">
					...
					<font color="red">*</font>
					<input type="hidden" id="clstatus" name="clstatus" value="${clstatus}"/>
				</td>
			</tr>
          </tbody>
        </table></td>
...
<script type="text/javascript">
	...
	function save(cpid){
		if(check()){
   			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ODepartmentComplaintVerify/verifyDelaySubmit.json?cpid='+cpid,saveBack,'fm','');
		}
	}
	...
	//页面跳转：
	function sendPage(){
		//window.location.href = "<%=contextPath%>/customerRelationships/complaintConsult/ODepartmentComplaintVerify/oDepartmentComplaintVerifyInit.do";
