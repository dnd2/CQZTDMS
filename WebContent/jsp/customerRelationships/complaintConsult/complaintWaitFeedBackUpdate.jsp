    ...
    <tbody>
      <tr>
        <td><table id="Table2" width="100%" class="tab_edit">
          <tbody>
          	<tr>
	          <th align="center" colspan="6" style="font-size: 14px;">抱怨咨询详细信息 </th>
	        </tr>
            <tr>
              <td rowspan="9" width="2%" align="center">1 </td>
              <td rowspan="9" width="2%" align="center">受理抱怨咨询 </td>
            ...
            <tr>
              ...
              <td ><input type="text" id="txtTel" value="<%=CommonUtils.getDataFromMap(tempMap,"CPPHONE")%>" name="incomeTep"/></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="center" colspan="2" rowspan="1">客户反馈 </td>
              <td colspan="4">
              	<textarea rows="5" style="width: 95%" id="crContent" name="crContent"></textarea>
              	<font color="red">*</font>
              </td>
            </tr>	
			<tr id="dealuserTr">
				<td align="center" rowspan="1" colspan="2">处理部门</td>
      ...
      <tr>
        <td align="center">
        	<input name="button" type="button" class="long_btn" id="saveButton" onclick="save(<%=CommonUtils.getDataFromMap(tempMap,"CPID")%>);" value="保存" />
...
<script type="text/javascript">
	function check(){
		var msg ="";
		if(""==document.getElementById('crContent').value){
			msg+="客户反馈不能为空!</br>"
		}else if(!WidthCheck(document.getElementById('crContent').value,1000)){
				msg+="客户反馈太长!</br>"
		}
	...
	function save(cpid){
		if(check()){
   			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/SeatsReturnComplaint/seatsReturnComplaintUpdateSubmit.json?id=feedBack&cpid='+cpid,saveBack,'fm','');
		}
	}
	...
	{
        opener.AT_Command01(strCmd,$("txtTel").value);
     }
