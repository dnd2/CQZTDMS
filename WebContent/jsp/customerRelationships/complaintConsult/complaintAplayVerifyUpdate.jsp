...
<div class="wbox">
<div class="navigation"><img src="../../../img/nav.gif" width="11" height="11" />&nbsp;当前位置：  客户信息 &gt;管理员延期审核处理界面 </div>
</div>
      ...
      <tr>
        <td><table id="Table2" width="100%" class="tab_edit">
          <tbody>
            ...
            <tr>
              <td align="center" rowspan="1" colspan="2">审核</td>
              <td colspan="5">
...
<script type="text/javascript">
	...
	function save(cpid){
		if(check()){
   			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ComplaintSearch/ComplaintSearchUpdateSubmit.json?id=aplayVerify&cpid='+cpid,saveBack,'fm','');
		}
	}
