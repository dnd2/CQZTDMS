...
<div class="wbox">
<div class="navigation"><img src="../../../img/nav.gif" width="11" height="11" />&nbsp;当前位置：  客户信息 &gt;大区处理完审核</div>
</div>
        ...
        <td><table id="Table2" width="100%" class="tab_edit">
          <tbody>
            ...
            <tr>
              ...
              <td width="80%" colspan="3"><%=CommonUtils.getDataFromMap(tempMap,"CPNO")%></td>
            ...
            <tr>
              ...
              <td align="left"><%=CommonUtils.getDataFromMap(tempMap,"TUCOMP")%> </td>
              			...
              			<tr>
              				...
              				<c:choose>
								<c:when test="${logonUserID == dealR.USERID}">
									<td align="center"><textarea name="crm_deal_content" id="crm_deal_content" style="width: 95%" >${dealR.CDCONT}</textarea></td>
								</c:when>
								<c:otherwise>
            ...
            <tr id="huifang">
              ...
              <td valign="top" colspan="4" width="96%">
              	<table width="100%" class="tab_edit">
              		<tr>
	              		<th width="20%">回访时间</th>
	              		<th width="50%">回访内容</th>
           ...
           <!-- <tr id="huifang">
            ...
            <tr>
              <td align="center"  rowspan="2" colspan="2">审核</td>
              <td align="left" colspan="4">
              	<input type="radio" id="verifyRadio1" name="verifyRadio" onclick="setDisplay(this.value);" value="95311001"/>通过
              	<input type="radio" id="verifyRadio2" name="verifyRadio" onclick="setDisplay(this.value);" value="95311002"/>不通过
              </td>
             </tr>
             <tr >
				 <td align="left" colspan="4">处理部门：
					<select id="orgObj" name="orgObj" class="short_sel" onchange="changeOrgUserEvent(this.value,'',false)" style="display: none" >
			...
			<tr id="ccontTr">
				...
				<td align="left" colspan="4">
					<textarea id="ccont" name="ccont" rows="5" datatype="0,is_null" style="width: 95%"></textarea>
				</td>
			</tr>
          </tbody>
        </table></td>
...
function setDisplay(value){
	...
	function check(){
		var msg ="";
		if(!(document.getElementById('verifyRadio1').checked || document.getElementById('verifyRadio2').checked)){
			msg+="审核不能为空!</br>"
		}
		if(document.getElementById('verifyRadio1').checked){
		...
		if(document.getElementById('verifyRadio2').checked){
	...
	function save(cpid){
		if(check()){
   			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ComplaintSearch/ComplaintSearchUpdateSubmit.json?id=doingAlready&cpid='+cpid,saveBack,'fm','');
		}
	}
