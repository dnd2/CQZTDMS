...
<script type="text/javascript">
	function check(){
		var msg ="";
		if(!(document.getElementById('crResult1').checked || document.getElementById('crResult2').checked)){
			msg+="回访结果不能为空!</br>"
		}
	...
	function save(cpid){
		if(check()){
   			makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/WaitComplaintSearch/waitComplaintSearchUpdateSubmit.json?id=waitClose&cpid='+cpid,saveBack,'fm','');
		}
	}
