...
<script type="text/javascript">
	...
	function myLink(value,metaDate,record){
			return String.format("<a href=\"<%=contextPath%>/customerRelationships/complaintConsult/WaitComplaintSearchYx/colesdAuditDetail.do?type=2&id="+value+"\">[审核]</a>");
    }
...
<script type="text/javascript">
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/customerRelationships/complaintConsult/WaitComplaintSearchYx/queryColesdAudit1.json";
