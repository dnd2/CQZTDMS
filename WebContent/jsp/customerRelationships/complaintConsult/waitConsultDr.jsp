...
<script type="text/javascript">
		...
		function save(){
			...
			if(check()){
				...
				makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ComplaintAcceptDr/adviceUpdateSubmit.json',saveBack,'fm','');
			}
		}
		...
		//页面跳转：
		function goBack(){
			window.location.href = "<%=contextPath%>/customerRelationships/complaintConsult/ComplaintAcceptDr/getComplaintAcceptDrInit.do";
		}
