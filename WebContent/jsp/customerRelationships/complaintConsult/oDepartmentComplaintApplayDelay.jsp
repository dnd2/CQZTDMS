...
<body>
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 客户关系管理 &gt; 投诉咨询管理 &gt;大区延期申请</div>
	...
	<script type="text/javascript">
		function save(){
			...
			if(check()){
				...
				makeNomalFormCall('<%=contextPath%>/customerRelationships/complaintConsult/ODepartmentComplaintDeal/applayDelaySubmit.json',saveBack,'fm','');
			}
		}
