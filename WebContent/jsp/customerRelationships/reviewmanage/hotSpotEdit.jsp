...
<body>
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 客户关系管理 &gt; 回访管理 &gt;热线抽查管理</div>
		...
		<table width="100%" class="tab_edit">
			...
			<tr>
				...
				<td width="30%" align="left" >
					<input class="middle_txt" type="text" id="ctmname" name="ctmname" value='${queryCustomerInforData.CTMNAME}' datatype="0,is_null,25" maxlength="25" readonly/>
				...
				<td width="30%" align="left">
					<input class="middle_txt" type="text" id="tele" name="rvPhone" maxlength="40" datatype="0,is_null,25"/>
				</td>
			</tr>
			<tr>
	...
	<script type="text/javascript">
		...
		function changeData(ctmName,phone,vinStr,salesaddress,seriesid,modelid,pudate,pdate,mileage,mileageRange,province,city,ctmId){
