...
<body>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 客户关系管理 &gt; 客户投诉管理 &gt;客户投诉查询(区域)</div>
 ...
 <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  ...
		  <tr>
		    ...
		    <td>
		    	<input class="middle_txt" id="compDealer" name="compDealer" value="" type="text"/>
            	<input class="mark_btn" type="button" value="&hellip;" onclick="showOrgDealer('compDealer','compDealerId','','false',true)"/> 
          ...
          <tr>
            ...
            <td>
            	<script type="text/javascript">
            	genSelBoxExp("compStatus",<%=Constant.COMP_STATUS_TYPE%>,"",true,"min_sel","onchange='selectAction()'","true",'<%=Constant.COMP_STATUS_TYPE_01%>,<%=Constant.COMP_STATUS_TYPE_03%>');
                </script>
                  处理中状态：
                <span id="statuschng">
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/customerRelationships/search/ComplaintSearch/queryComplaintArea.json";
