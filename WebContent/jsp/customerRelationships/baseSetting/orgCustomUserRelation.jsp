...
<input type="hidden" name="tree_root_id" id="tree_root_id" value=""/>
	<table  border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		<th colspan="5"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />部门人员维护</th>
...
<script>
	...
	var url = "<%=request.getContextPath()%>/customerRelationships/baseSetting/OrgCustomUserRelation/queryOrgCustomUserRelation.json";
	...
	var columns = [
				...
				{header: "部门", dataIndex: 'ORGNAME', align:'center'},
				{id:'action',header: "操作",sortable: false,dataIndex: 'USERID',renderer:myLink}
		      ];
	...
	function updateEvent(userid){
		window.location.href='<%=contextPath%>/customerRelationships/baseSetting/OrgCustomUserRelation/orgCustomUserRelationUpdate.do?userid='+userid ;
	}
