...
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：客户关系管理&gt;基础设定&gt;坐席排班(修改)</div>
<form name="fm" id="fm" method="post" enctype="multipart/form-data">
<input type="hidden" id="SS_ID" name="SS_ID" value="<c:out value="${dataMap.SS_ID}"/>" jset="maindata"/>
<table id="tb1" class="table_query">
    <tr>
        ...
        <td width="20%" align="left" bgcolor="#FFFFFF">&nbsp;
            <input id="DUTY_DATE" class="short_txt" name="DUTY_DATE" value="${dataMap.DUTY_DATE}" readonly datatype="1,is_date,10" maxlength="10" group="DUTY_DATE" jset="maindata"/>
        ...
        <td width="20%" align="left" bgcolor="#FFFFFF">&nbsp;
            <input name="NAME" class="SearchInput" id="NAME" value="${dataMap.NAME}" type="text" size="20" readonly jset="maindata"/>
            <input name="ACNT" id="ACNT" value="${dataMap.ACNT}" type="hidden" jset="maindata"/>
            <input name="USER_ID" id="USER_ID" value="${dataMap.USER_ID}" type="hidden" jset="maindata"/>
        ...
        <td width="20%" bgcolor="#ffffff">
            ...
            <c:forEach items="${wtTypeList}" var="varType">
                <option value="${varType.WT_TYPE_ID}" <c:if test="${varType.WT_TYPE_ID==dataMap.WT_TYPE}">selected</c:if> >${varType.WT_TYPE}</option>
            </c:forEach>
            </select>
            <font color="RED">*</font>
        </td>
    ...
    <tr>  
        ...
        <td width="20%" align="left" bgcolor="#FFFFFF">&nbsp;
            <input name="SHIFT_KIND_DESC" class="SearchInput" id="SHIFT_KIND_DESC" value="${dataMap.SHIFT_KIND_DESC}" type="text" size="20" readonly jset="maindata"/>
            <input name="SHIFT_KIND" id="SHIFT_KIND" value="${dataMap.SHIFT_KIND}" type="hidden" jset="maindata"/>
