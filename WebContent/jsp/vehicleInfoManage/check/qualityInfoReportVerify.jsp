...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/vehicleInfoManage/check/QualityInfoReportVerify/queryQualityInfoReportVerify.json";
	var title = null;
	var columns = [
	...
	function myLink(value,meta,record){
		if(record.data.VERIFY_STATUS == 95531003){
	...
	function verifyDetail(value){		
		window.location.href='<%=contextPath%>/vehicleInfoManage/check/QualityInfoReportVerify/verifyQualityInfoReport.do?qualityReportId='+value ;
	}
