...
<form name="fm" id="fm">
	<table class="table_edit" id="vehicleInfo">
		...
		<tr>
			...
			<td><c:out value="${map.OLD_CTM_NAME }"/></td><!-- ${map.CTM_NAME} -->
			<td width="10%" align="right">车主电话：</td>
			<td><c:out value="${map.OLD_CTM_PHONE }"/></td><!-- ${map.MAIN_PHONE} -->
			<td width="12%" align="right">三包策略代码：</td>
			<td><c:out value="${map.GAME_CODE}"/></td>
		</tr>
		<tr>
			<td width="10%" align="right" nowrap="nowrap">三包规则代码：</td>
			<td><c:out value="${map.RULE_CODE}"/></td>
		</tr>
		<tr>
			<td width="10%" align="right">车主地址：</td>
			<td><c:out value="${map.OLD_CTM_ADDRESS }"/></td><!-- ${map.ADDRESS} -->
		</tr>
	</table>
