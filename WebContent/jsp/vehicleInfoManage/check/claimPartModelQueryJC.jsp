...
<body onbeforeunload="returnBefore();">
  ...
  <table class="table_query">
       <tr>            
        <td class="table_query_2Col_label_4Letter">配件代码：
...
function selbyid(obj){
	$('PART_CODE').value=obj.value;
	$('PART_NAME').value = document.getElementById(obj.value).value;
	_hide();
}
...
{   
	...
	if(code && code.length > 0)
		parent.$(partCode).value = code;
	if(name && name.length > 0)
	   	parent.$(partName).value = name;	
}
</script> 
</form>
</body>
