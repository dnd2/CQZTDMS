...
<script type="text/javascript" >
	...
	function verify(state){
		if(state == 'pass'){
			makeNomalFormCall('<%=contextPath%>/vehicleInfoManage/check/QualityInfoReportVerify/verifyQualityInfoReportSubmit.json?state='+state,verifyQualityInfoReportSubmitBack,'fm','');
	...
	//页面跳转：
	function sendPage(){
		window.location.href = "<%=contextPath%>/vehicleInfoManage/check/QualityInfoReportVerify/qualityInfoReportVerifyInit.do";
	}
