...
<script language="JavaScript" >
	...
	var url = "<%=contextPath%>/claim/dealerClaimMng/ClaimBillMaintainMain/queryPartCodeFromBaseForRule.json";
	...
	function mySelect(value,metaDate,record){
		 ...
		 return String.format("<input type='radio' name='rd' onclick='queryRulePart(\""+record.data.partCode+"\",\""+vin+"\")' />");
	}

	function setMainPartCode(v1,v2,v3,v4,v5,v6){
		 //调用父页面方法
		 if(v2==null||v2=="null"){
		 	v2 = "";
		 }
 		...
 		if (parent.$('inIframe')) {
			...
			parent.setMainPartCode(v1,v2,v3,v4,v5,v6);
		}
	...
	function queryPartResult(json){
		...
		setMainPartCode(part.PART_CODE,part.PART_NAME,part.WR_MONTH,part.WR_MELIEAGE,part.LISTID,'');
	}
