...
<center>
<div  style="font-size: 18px; font-weight: bold;"><h4>品质情报上报</h4></div>
...
<table border="1" cellpadding="1" cellspacing="1"  class="tab_printsep" width="800px" align="center">
    ...
    <tr >
     ...
     <tr height="80px;" style="display: none">
    	...
    	<td colspan="7">
    		<textarea  style="width: 100%;height: 80px;"readonly="readonly" id="technicalAuditAdvice" name="technicalAuditAdvice">${po.technicalAuditAdvice }</textarea>
    	</td>
    </tr>
     <tr height="80px;" style="display: none">
     ...
     <c:if test="${po.verifyStatus>=95451003}">
	 <tr height="80px;">
     	<td nowrap="true" class="applyNews">
     		市场质量部回复
    	</td>
    	<td colspan="7">
    		<textarea  style="width: 100%;height: 80px;" readonly="readonly" id="applyNews" name="applyNews">${po.applyNews }</textarea>
    	</td>
    </tr>
    </c:if>
</table>
