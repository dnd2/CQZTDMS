...
<div class="wbox">
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;车辆信息管理&gt;一级质量信息审核
</div>
<form name="fm" id="fm">
     ...
     <tr>
     	...
     	<td>
     		<script type="text/javascript">
        		genSelBoxExp("status",<%=Constant.Quality_Verify%>,"<%=Constant.Quality_Verify_02%>",true,"","","false",'<%=Constant.Quality_Verify_01%>');
       		</script>
     	</td>
...
<script type="text/javascript" >
	...
	function myLink(value,meta,record){
		if(record.data.VERIFY_STATUS == 95531002 && record.data.ISEND!="isend" ){
