...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置:售后服务管理&gt;车辆信息管理&gt;三包凭证补办审核
</div>
<form name="fm" id="fm">
<!-- 查询条件 begin -->
...
<!--     		<input type="button"  name="BtnAdd" id="queryBtn"  value="批量打印"  class="normal_btn" onClick="viewprint2()" >
 -->    		<input type="hidden"  name="BtnAdd" id="queryBtn"  value="导出"  class="normal_btn" onClick="exportExcel();" >
    	</td>
    </tr>
</table>
<!-- 查询条件 end -->
...
function checkDate(obj,value){
	...
	function viewAudit(id) {
		fm.method = 'post';
		fm.action = '<%=contextPath%>/vehicleInfoManage/apply/VehicleInfoChangeApply/barCodeApplyAdd.do?type=5&id='+id;
		fm.submit();
	}	
	//详细信息查看页面
