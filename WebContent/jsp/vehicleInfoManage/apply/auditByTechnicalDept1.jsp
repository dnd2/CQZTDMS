	...
	<table border="1" cellpadding="1" cellspacing="1" class="tab_edit" width="100%" align="center">
		...
		<tr>
			<td nowrap="true">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系方式:<input type="text" class="middle_txt" name="contactType" id="contactType" maxlength="15" readonly="readonly" value="${po.contactType }" />
			</td>
		</tr>
	</table>
</div>
<table border="1"   class="tab_edit" width="100%">
    ...
    <tr>
     ...
     <tr >
    	...
    	<td colspan="5">
    		<textarea readonly="readonly"  style="width: 100%;height: 80px;" name="theme" >${po.theme }</textarea>
    	</td>
    </tr>
     <tr >
     	<td nowrap="true">
...
$("#pass").live("click",function(){
	...
	$("#verifyStatus").val("95451004");
	MyConfirm("是否确认通过并结束流程？",passMsg,"");
});
function passMsg(){
	var url="<%=contextPath%>/vehicleInfoManage/apply/QualityReportInfo/auditPassByQualityDept1.do";
	sendDo(url);
}
function refuseMsg(){
	var url="<%=contextPath%>/vehicleInfoManage/apply/QualityReportInfo/auditRefuseByQualityDept1.do";
	sendDo(url);
}
//驳回
$("#refuse").live("click",function(){
	...
	$("#verifyStatus").val("95451003");
	MyConfirm("是否确认驳回给技术部？",refuseMsg,"");
