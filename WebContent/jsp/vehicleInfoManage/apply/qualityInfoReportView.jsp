...
<form name="fm" id="fm">
	...
	<table class="tab_edit" width="100%" align="center">
		...
		<tr>
			...
			<td><input name="claimNo" id="claimNo" type="text" readonly="readonly" value="${ttSalesQualityInfoReportPO.claimNo}" class="long_txt" />
		</tr>
		<tr>
...
<!-- 				<input type="button" value="..." class="mini_btn" onclick="selectPart()"> -->
		...
		<c:if test="${ttSalesQualityInfoReportPO.verifyStatus == 95531006}">
		<tr>
	    		...
	    		<tr>
	        		<th>
						...
						<font color="red">
			     		...
			     		<input type="button" class="normal_btn" align="right" id="addfile" onclick="showUpload('<%=contextPath%>')" disabled="disabled" value ='添加附件'/><font color="red">*</font>
					</th>
				</tr>
				<tr>
