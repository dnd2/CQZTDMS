...
<table width=100% border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="12" align=left width="33%">&nbsp;</td>
             	...
             	<c:if test="${type=='hide'}">
					<input type="button" onClick="_hide();" id="normal_btn" class="normal_btn"  style="width=8%" value="返回"/>
             	</c:if>
               	    <input class="normal_btn" type="button" id="btn4" value="导出wrod" onclick="exportWord()"/>
...
function exportWord() {
      ...
      try {
           var fileName = myDate.getYear() + (myDate.getMonth() + 1) + myDate.getDate() + myDate.getMinutes() + myDate.getSeconds();  //文件名
          var areaRes = document.getElementById("table2");  //指定要输入区域
          ...
          // docObj.saveAs("D://" + fileName + ".doc")  //导出文件到指定目录
      }
       catch (e) {
           MyAlert("保存失败，请刷新本页面重新尝试！");
       }
       finally {
