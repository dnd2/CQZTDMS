...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置:售后服务管理&gt;车辆信息管理&gt;三包凭证补办大区审核
</div>
<form name="fm" id="fm">
 ...
 <table class="table_edit" id="auditDetail" style="display: " >
	    ...
	    <table   width="100%" class="table_info" id="audit" border="0"  >
	        		<th colspan="6"><img class="nav" src="../../../img/subNav.gif"/> 审核备注：</th>
       		<tr>
          		<td align="right">审核备注：</td>
 				<td colspan="5" align="left"><textarea id="audit_remark" onkeyup="check(this);" name="audit_remark" cols="120"  rows="5" ></textarea><font color="red">*</font></td>
        	</tr>
        	<tr>
          		<td align="right">审核费用：</td>
 				<td colspan="5" align="left">
 				<input type="text" name="auditAcount" value="<%=bean.getAuditAcount()==null?"":bean.getAuditAcount() %>" onblur="checks(this)" id="auditAcount" class="middle_txt"/>
	 ...
	 <!-- 添加附件 开始  -->
        <table id="add_file"  width="100%" class="table_info" border="0" id="file">
	    		...
	    		<tr>
	        		<th onclick="tabDisplayControl('fileId');">
 ...
 <table class="table_edit" id="fileId" style="display: " >
				<tr>
			...
			<tr>
				<td height="12" align=left width="33%">&nbsp;</td>
             	<td height="12" align=center width="33%">
                	...
                	<input type="button" onClick="doSave2('agree');" class="normal_btn" id="saveBtn2"     value="同意"/>
                	<input type="button" onClick="doSave2('disagree');" class="normal_btn" id="saveBtn3"      value="驳回"/>
...
function showVehicle(json) {
	...
	vehicleInfo.rows[4].cells[5].innerText = checkNull(vehicle.CODE_DESC);
