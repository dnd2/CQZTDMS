...
<script type="text/javascript" >
	...
	var myPage; 
	var auditingUrl = "<%=contextPath%>/OutMaintainAction/auditingh.json";
	...
	function agreeAuditingDo(){
		var tUrl = auditingUrl+"?s=1";
		makeNomalFormCall(tUrl, message, 'fm');
	}

	function returnAuditing() {
		var ministerAuditingReamrk = document.getElementById("ministerAuditingReamrk").value;
		if(ministerAuditingReamrk!=""){
	...
	function bz(){
		var ministerAuditingReamrk=document.getElementById("ministerAuditingReamrk").value;
		if(ministerAuditingReamrk.length>200){	
			ministerAuditingReamrk=ministerAuditingReamrk.substr(0,200);
			document.getElementById("ministerAuditingReamrk").value=ministerAuditingReamrk;
     ...
     <tr >
      ...
      <tr >
        ...
        <td align="left" colspan="5">
      	...
      	<tr >
	        <td class="table_add_2Col_label_5Letter" style="text-align:right;width:125px;"> 审核意见：</td>
	        <td align="left" colspan="5">
	        	<textarea style="width: 800px;height: 80px" onblur="bz();" name="ministerAuditingReamrk" id="ministerAuditingReamrk"></textarea>
	        </td>
	      </tr>
    </tbody>
    </table>
    	<br />  
		 	<div align="center">
				<input class="normal_btn" type="button" name="button1"  id="backBtn" value="同意" onclick="agreeAuditing();"/>
				<input class="normal_btn" type="button" name="button1"  id="backBtn" value="退回" onclick="returnAuditing();"/>
				<input class="normal_btn" type="button" name="button1"  id="backBtn" value="拒绝" onclick="refuseAuditing();"/>
