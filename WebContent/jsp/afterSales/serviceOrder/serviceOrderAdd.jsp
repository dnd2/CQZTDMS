...
function servicePartAdd(){
  ...
  if(msg == ""){
    var url = "<%=contextPath%>/afterSales/ServiceOrderAction/servicePartWin.do?&mileage="+mileage
    		+ "&arrivalDate="+arrivalDate+"&purchasedDate="+purchasedDate+"&partFareRate="+partFareRate
    		+ "&ruleId="+ruleId;
    OpenHtmlWindow(url,900,500);
  }else{
    MyAlert(msg);
