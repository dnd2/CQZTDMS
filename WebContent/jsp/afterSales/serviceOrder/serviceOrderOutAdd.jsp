  ...
  **/
  ...
  if(vinValid.value=="false"){
	...
	if(purchasedDate.value==""){
      count++;
      msg = msg + "<div>" + count + "、该车辆购车时间为空,无法做外出维修!</div>\n";
	}
  ...
  <h2>维修配件</h2>
	...
	<tbody id="servicePartTable">
	  ...
	  <td style="background-color:#FFFFFF;">
        ...
        <input id="partPrice" name="partPrice" maxlength="30" value="" type="text" class="middle_txt" style="width:40px" onchange="changePartPrice(this)"/>
      </td>
	  <td style="background-color:#FFFFFF;">
