...
function servicePartAdd(){
  ...
  if(msg == ""){
    var url = "<%=contextPath%>/afterSales/ServiceOrderAction/servicePartWin.do?&repairType="+repairType
    		...
    		+ "&purchasedDate="+purchasedDate+"&partFareRate="+partFareRate+"&_isThreeGuarantee="+_isThreeGuarantee;
    OpenHtmlWindow(url,900,500);
  }else{
    MyAlert(msg);
    return;
...
<form method="post" name="fm" id="fm">
  ...
  <input type="hidden" name="_isThreeGuarantee" id="_isThreeGuarantee" value="10041002"/><!--非三包-->
  <!-- 基本信息 -->
