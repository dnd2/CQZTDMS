...
<form method="post" name="fm" id="fm">
  ...
  <h2>维修配件</h2>
	...
	<c:if test="${serviceOrderPartList!=null}">
	  ...
	  <td style="background-color:#FFFFFF;">
	    ${serviceOrderPartList.RELATION_MAIN_PART_CODE}
	  </td>
	  <td style="background-color:#FFFFFF;">
	    ${serviceOrderPartList.RELATION_LABOUR_CODE}
	  </td>
	  </tr>
	  </c:forEach>
	</c:if>
  ...
  <br /><br /><br /><br /><br /><br /><br /><br />
  <!-- 预授权信息 -->
  <div style="position:fixed;bottom:0;left:10;height:255px;width:99%;
             box-shadow:0 0 0 , /*-3px 0 3px ,左边阴影*/  
                        0 0 0 , /*3px 0 3px , 右边阴影*/  
                        0 -3px 3px , /*顶部阴影*/  
                        0 -3px 3px ; /*底边阴影*/  ">
    <div class="form-body" style="height:100%;background-color:#CCCCCC;">
