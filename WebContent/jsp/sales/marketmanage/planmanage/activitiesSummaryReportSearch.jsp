...
<script type="text/javascript" >
	var myPage;
	//查询路径 
	var url = "<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesSummaryReport/activitiesSummaryReportQuery.json";
	var title = null;
	var columns = [
    ...
    function toSummarize(value1,value2){
    	...
    	$('fm').action= '<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesSummaryReport/showActivitiesSummaryReportPage.do';
	 	$('fm').submit();
    }
 	//新增链接
	function toAdd(){
