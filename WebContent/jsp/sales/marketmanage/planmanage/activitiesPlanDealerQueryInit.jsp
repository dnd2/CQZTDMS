...
<title>市场活动方案查询(经销商)</title>
<% String contextPath = request.getContextPath();  %>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动方案查询(经销商)</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanDealerQuery/doSearch.json";
	var title = null;
	var columns = [
    ...
    function makePlan(campaignId,spaceId,planId){
        document.fm.action= '<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanDealerQuery/detailPre.do?campaignId='+campaignId+'&spaceId='+spaceId+'&planId='+planId;
        document.fm.submit();
    }
    //初始化
    function doInit(){
