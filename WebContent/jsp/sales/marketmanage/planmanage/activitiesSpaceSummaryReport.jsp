...
function toSubmit() {
	MyConfirm("确认上报？",toConfirm) ;
}
//提报提交
function toConfirm(){
	setDisTrue('button5','button4') ;
...
function toBack(){
	setDisTrue('button5','button4') ;
	$('fm').action='<%=request.getContextPath()%>/sales/marketmanage/planmanage/ActivitiesSpaceSummaryReport/ActivitiesSpaceSummaryReportInit.do';
	$('fm').submit();
}
//回调方法
...
<title>活动总结提报(区域)</title>
<% String contextPath = request.getContextPath();  %>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 活动总结提报(区域)</div>
<form method="post" name="fm" id="fm">
	...
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		...
		<tr>
			...
			<td align="left"><strong><span id="totalPrice11"></span></strong></td>
		</tr>
	</table>
	...
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		...
		<tr>
			...
			<td align="left"><strong><span id="totalPrice21"></span></strong></td>
		</tr>
	</table>
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		<tr>
	...
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		...
		<tr>
			<td colspan="4" align="center">
				...
				<input type="button" class="cssbutton" name="button5" id="button5" onClick="toSubmit();" value="上报"/>
				<input type="button" class="cssbutton" name="button4" id="button4" onClick="toBack();" value="返回"/>
			</td>
		</tr>
	</table>
</form>
