        ...
        <tbody>
            <c:forEach items="${checkRecords}" var="list">
                <tr class="table_list_row">
                    ...
                    <td>
                        <a href="#" onclick="OpenHtmlWindow('<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanChngApply/openCheckDesc.do?checkDesc='+encodeURI('${list.CHECK_DESC}'),600,400)">
                            <script type="text/javascript">
                                var checkDesc='${list.CHECK_DESC}';
                                document.write(checkDesc.length>5?checkDesc.substr(0,5)+'...':checkDesc);
                            </script>
                        </a>
                    </td>
                </tr>
