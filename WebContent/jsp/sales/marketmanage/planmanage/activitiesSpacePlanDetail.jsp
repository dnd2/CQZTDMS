...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript"
			src="getJs.do?fileName=activitiesSpacePlanDetail"></script>

	</head>
	<body>
		<div class="navigation">
			<img src="<%=request.getContextPath()%>/img/nav.gif" />
			&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动方案制定(事业部)
		</div>
		...
		<%} %>
			...
			<table width=100% border="0" align="center" cellpadding="1"
                ...
                <tr class="table_list_row2">
					...
					<td align="center">
						<input type="text" name="toTelStoreCount" id="toTelStoreCount"
							readonly="readonly" datatype=”1,is_digit,6”
				...
				<tr class="table_list_row2">
					...
					<td align="center">
						<input type="text" name="createCardsCount" id="createCardsCount"
							readonly="readonly" datatype=”1,is_digit,6”
				...
				<tr class="table_list_row2">
					...
					<td align="center">
						<input type="text" name="turnCarCount" id="turnCarCount"
							readonly="readonly" datatype=”1,is_digit,6”
			...
			<table width=100% border="0" align="center" cellpadding="1"
				...
				<tr>
					<th colspan="15" align="left">
						...
						<input name="orgbu" id="orgbu" type="button" class="cssbutton"
							onclick="showAllOrgs3('orgId','orgCode','true','${orgId}','${areaId}')"
							value="新增" />
					</th>
				</tr>
				<tr>
				...
				<tbody id="dealerTable">
					...
					<tr class="table_list_row" id="${item.ORG_ID}">
						...
						<td>
							<input type="text" group="executionTimeB${item.ORG_ID},executionTimeE${item.ORG_ID}"
						...
						<td>
							<script>
						    		genSelBoxExp("costType" + ${item.ORG_ID}, 3004, "${item.COST_TYPE}", false, "", '', "false", '')
						    </script>
						</td>
						<td>
				...
				<tr>
					<td colspan="4" align="center">
						...
						<input type="button" class="cssbutton" name="button6"
							onClick="userValidate('1');" value="保存" />
						<input type="button" class="cssbutton" name="button5"
							onClick="userValidate('0');" value="提报" />
