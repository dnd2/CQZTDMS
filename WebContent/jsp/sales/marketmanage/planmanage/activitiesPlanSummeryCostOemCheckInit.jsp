...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动总结费用审核(车厂)</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanSummeryCostOemCheck/doSearch.json";
	var title = null;
	var columns = [
    ...
    function myLink(value,meta,record){
        if (record.data.STATUS==13291003) {
    ...
    function makePlan(campaignId,spaceId,planId){
        document.fm.action= '<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanSummeryCostOemCheck/detailPre.do?campaignId='+campaignId+'&spaceId='+spaceId+'&planId='+planId;
        document.fm.submit();
    }
    //初始化
    function doInit(){
