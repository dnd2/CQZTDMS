...
<head>
    ...
    <script type="text/javascript">
        ...
        function goBack() {
            document.fm.action = '<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanChngAreaCheck/doInit.do';
            document.fm.submit();
        }
...
//操作提交
        function toConfirm(value){
            ...
            makeNomalFormCall(g_webAppName + '/sales/marketmanage/planmanage/ActivitiesPlanChngAreaCheck/doMod.json', showResult, 'fm');
        }
//回调方法
        function showResult(json){
            if (json.returnValue == '1') {
                window.parent.MyAlert("操作成功！");
                $('fm').action = g_webAppName + '/sales/marketmanage/planmanage/ActivitiesPlanChngAreaCheck/doInit.do';
                $('fm').submit();
            }
            else {
...
<div class="navigation">
    ...
    &nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动变更/取消审核(事业部)
</div>
...
<table width=100% border="0" align="center" cellpadding="1"
    ...
    <tr>
        <td colspan="4" align="center">
            ...
            <%--如果不是等待小区审核通过 则屏蔽以下两个按钮--%>
            <c:if test="${repPO.checkStatus==11261018}">
