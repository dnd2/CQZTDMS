...
//操作提交
        function toConfirm(value){
            ...
            makeNomalFormCall(g_webAppName + '/sales/marketmanage/planmanage/ActivitiesPlanSummeryCostApply/doMod.json', showResult, 'fm');
        }
//回调方法
        function showResult(json){
            if (json.returnValue == '1') {
                window.parent.MyAlert("操作成功！");
                $('fm').action = g_webAppName + '/sales/marketmanage/planmanage/ActivitiesPlanSummeryCostApply/doInit.do';
                $('fm').submit();
            }
            else {
...
<table  width=100% border="0" align="center"
    ...
    <tr>
        ...
        <td>
            <script>
                genSelBoxExp("summeryCostType",1328, "${summeryPO.summeryCostType}", false, "", "", "false", '')
            </script>
        </td>
        <td width="60%"></td>
    </tr>
			...
			<table width=100% border="0" align="center" cellpadding="1"
				...
				<tbody>
					<tr class="table_list_row">
						...
						<td>
							<script>
						    		genSelBoxExp("planType", 1160, "${summeryPO.planType}", false, "", '', "false", '')
						    </script>
						</td>
						<td>
						...
						<td>
							<script>
                                genSelBoxExp("costType", 3004, "${summeryPO.costType}", false, "", '', "false", '')
						    </script>
						</td>
						<td>
			...
			<table class="table_query">
                <tr>
                    ...
                    <td>
                        <textarea cols="50" rows="5" id="remark" name="remark">${summeryPO.remark}</textarea>
                    </td>
                </tr>
            </table>
