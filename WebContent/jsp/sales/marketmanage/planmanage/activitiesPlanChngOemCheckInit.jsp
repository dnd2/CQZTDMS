...
<title>市场活动变更/取消审核(车厂)</title>
<% String contextPath = request.getContextPath();  %>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动变更/取消审核(车厂)</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanChngOemCheck/doSearch.json";
	var title = null;
	var columns = [
    ...
    function myLink(value,meta,record){
    	if (record.data.CHECK_STATUS==11261020) {
    ...
    function makePlan(campaignId,spaceId,planId,reqId){
        document.fm.action= '<%=contextPath%>/sales/marketmanage/planmanage/ActivitiesPlanChngOemCheck/detailPre.do?campaignId='+campaignId+'&spaceId='+spaceId+'&planId='+planId+'&reqId='+reqId;
        document.fm.submit();
    }
    //初始化
    function doInit(){
