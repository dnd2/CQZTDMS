...
<tr>
<td align="left" height="40" width="12%" rowspan="2"><strong>运营大区</strong></td>
<td width="16%" align="left">市场专员/主管</td>
<td width="9%">${map2.NAME}　</td>
<td width="50%" align="left">${map2.REMARK}　</td>
<td width="11%">${map2.SUBMITS_DATE}　</td>
</tr>
<tr>
<td align="left">大区经理</td>
<td>${mapC0.NAME}　</td>
<td align="left">${mapC0.CHECK_DESC}　</td>
<td>${mapC0.CHECK_DATE}　</td>
</tr>
<tr>
<td align="left" height="80" rowspan="3"><strong>市场推广部</strong></td>
<!--td align="left">分管副总意见</td>
<td>${mapC1.NAME}　</td>
<td align="left">${mapC1.CHECK_DESC}　</td>
<td>${mapC1.CHECK_DATE}　</td>
</tr>
<tr-->
<td align="left">市场推广室</td>
<td>${mapC1.NAME}　</td>
<td align="left">${mapC1.CHECK_DESC}　</td>
<td>${mapC1.CHECK_DATE}　</td>
</tr>
<tr>
<td align="left">市场管理室</td>
<td>${mapC2.NAME}　</td>
<td align="left">${mapC2.CHECK_DESC}　</td>
<td>${mapC2.CHECK_DATE}　</td>
</tr>
<tr>
<td align="left">经理</td>
<td>${mapC3.NAME}　</td>
<td align="left">${mapC3.CHECK_DESC}　</td>
<td>${mapC3.CHECK_DATE}　</td>
</tr>
<tr>
<td height="40" align="left" rowspan="2"><strong>事业部领导</strong></td>
<td height="20" align="left">大区分管副总意见</td>
<!--td colspan="3">　</td-->
<td>${mapC4.NAME}　</td>
<td align="left">${mapC4.CHECK_DESC}　</td>
<td>${mapC4.CHECK_DATE}　</td>
</tr>
<tr>
<td height="20" align="left">市场分管副总意见</td>
<!--td colspan="3">　</td-->
<td>${mapC5.NAME}　</td>
<td align="left">${mapC5.CHECK_DESC}　</td>
<td>${mapC5.CHECK_DATE}　</td>
</tr>
</table>
</div>
<br />
