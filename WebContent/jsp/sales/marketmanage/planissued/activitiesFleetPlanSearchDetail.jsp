...
-->
<tr>
<td align="left" height="20" rowspan="1"><strong>运营大区</strong></td>
...
<tr>
<td align="left" height="60" rowspan="3"><strong>市场推广部</strong></td>
<td align="left">大客户部市场专员</td>
<td>${mapC1.NAME}　</td>
<td align="left">${mapC1.CHECK_DESC}　</td>
<td>${mapC1.CHECK_DATE}　</td>
</tr>
<tr>
<td align="left">市场部结算室</td>
<td>${mapC2.NAME}　</td>
<td align="left">${mapC2.CHECK_DESC}　</td>
<td>${mapC2.CHECK_DATE}　</td>
</tr>
<tr>
<td align="left">大客户经理</td>
<td>${mapC3.NAME}　</td>
