...
function toConfirm(value){
   makeNomalFormCall(g_webAppName + '/sales/marketmanage/activity/ActivityDealer/doUpdate.json?operateFlag='+value, showResult, 'fm');
}
//回调方法
function showResult(json){
    if (json.returnValue == '1') {
        window.parent.MyAlert("操作成功！");
        $('fm').action = g_webAppName + '/sales/marketmanage/activity/ActivityDealer/doInit.do';
        $('fm').submit();
...
function delAttach(value){
    ...
    document.getElementById("delAttachs").value = delAttachs;
        ...
        function goBack(){
            document.fm.action= '<%=contextPath%>/sales/marketmanage/activity/ActivityDealer/doInit.do';
            document.fm.submit();
        }
	...
	<body>
		<div class="navigation">
			...
			&nbsp;当前位置： 市场活动管理 &gt; 市场活动管理 &gt; 市场活动填报（经销商）修改
		</div>
		...
		<input type="hidden" name="activityId" id="activityId" value="${ttcp.activityId}" />
			<table width=100% border="0" align="center" cellpadding="1"
				...
				<td class="table_query_2Col_label_6Letter">
					...
					<td>
					<select  id="activityWeek" name="activityWeek">
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
				...
				<tr>
					...
					<td>
						<input type="text" class="long_txt" name="chargeMan"
							...
							maxlength="50" value="${ttcp.chargeMan}" />
					</td>
					<td class="table_query_2Col_label_6Letter">
						活动地点：
					</td>
					<td colspan="4">
						<input type="text" class="long_txt" name="address"
							id="address" datatype="0,is_textarea,50" size="30"
							maxlength="50" value="${ttcp.address}" />
					</td>
					...
					<tr class="table_list_row2">
						...
						<td align="center">
							<input name="fTotal" id="fTotal" type="text"
								value='${ttcp.totalFclient}' datatype="0,is_double,8" decimal="0" />
						</td>
						<td align="center">
							<input name="actfTotal" id="actfTotal" type="text"
								value='${ttcp.actTotalFclient}' datatype="0,is_double,8" decimal="0" />
						</td>
					</tr>
					<tr class="table_list_row2">
						<td align="center">
						...
						<td align="center">
							<input name="mixTotal" id="mixTotal" type="text"
								value='${ttcp.totalMclient}' datatype="0,is_double,8" decimal="0" />
						</td>
						<td align="center">
							<input name="actmixTotal" id="actmixTotal" type="text"
								value='${ttcp.actTotalMclient}' datatype="0,is_double,8" decimal="0"  />
						</td>
					</tr>
					<tr class="table_list_row2">
						<td align="center">
						...
						<td align="center">
							<input name="cardTotal" id="cardTotal" type="text"
								value='${ttcp.totalAimcard}'datatype="0,is_double,8" decimal="0"  />
						</td>
						<td align="center">
							<input name="actcardTotal" id="actcardTotal" type="text"
								value='${ttcp.actTotalAimcard}' datatype="0,is_double,8" decimal="0"  />
						</td>
					...
					<tr class="table_list_row2">
						...
						<td align="center">
							<input name="orderTotal" id="orderTotal" type="text" value='${ttcp.totalAimorder}'
								datatype="0,is_double,8" decimal="0"  />
						</td>
						<td align="center">
							<input name="actorderTotal" id="actorderTotal" type="text" value='${ttcp.actTotalAimorder}'
								datatype="0,is_double,8" decimal="0"  />
						</td>
					</tr>
				</tbody>
