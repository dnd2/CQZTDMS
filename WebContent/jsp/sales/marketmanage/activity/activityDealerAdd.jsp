...
function toConfirm(value){
    ...
    makeNomalFormCall(g_webAppName + '/sales/marketmanage/activity/ActivityDealer/doSave.json?operateFlag='+value, showResult, 'fm');
 ...
 function goBack(){
	...
	<body>
		<div class="navigation">
			...
			&nbsp;当前位置： 市场活动管理 &gt; 市场活动管理 &gt; 市场活动填报（经销商）新增
		</div>
			...
			<table class="table_query" align="center" border="0" cellpadding="1"
				...
				<tbody>
					...
					<tr class="table_list_row2">
						...
						<td align="center">
							<input name="fTotal" id="fTotal" type="text"
								value='0' datatype="0,is_double,8" decimal="0" />
						</td>
						<td align="center">
					...
					<tr class="table_list_row2">
						...
						<td align="center">
							<input name="actorderTotal" id="actorderTotal" type="text" value='0'
								datatype="0,is_double,8" decimal="0"  />
						</td>
					</tr>
				</tbody>
