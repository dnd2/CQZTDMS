...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理   &gt; 市场活动管理  &gt; 市场活动报表</div>
...
<script type="text/javascript" >
    ...
    function doSearch(){
        document.fm.action='<%=contextPath%>/sales/marketmanage/activity/ActivityReport/doSearch.do';
		document.fm.target="_blank";
		document.fm.submit();
    }
function download(){
	document.fm.action='<%=contextPath%>/sales/marketmanage/activity/ActivityReport/doDownload.json';
