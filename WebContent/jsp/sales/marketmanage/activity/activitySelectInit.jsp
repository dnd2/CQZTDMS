...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 市场活动管理 &gt; 市场活动查询</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/sales/marketmanage/activity/ActivitySelect/doSearch.json";
	var title = null;
	var columns = [
   ...
   //设置超链接
    ...
    function makePlan(activityId){
        document.fm.action= '<%=contextPath%>/sales/marketmanage/activity/ActivitySelect/dtlPre.do?activityId='+activityId;
        document.fm.submit();
    }
    //初始化
    function doInit(){
	...
	function downLoad(){
		document.fm.action='<%=contextPath%>/sales/marketmanage/activity/ActivitySelect/doDownload.json';
