...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车管理 > 市场活动管理 > 项目执行方维护</div>
<form method="POST" name="fm" id="fm">
<input name="makerId" datatype="0,is_null,30" id="makerId" type="hidden" class="middle_txt"  value="${tm.makerId}"/>
	...
	<input type="hidden" value="<%=request.getContextPath()%>" name="contextPaths" id="contextPaths"/>
  	<table class="table_query" border="0">
	    ...
	    <td class="table_query_4Col_input" nowrap="nowrap">
	    	<input name="makerCode" datatype="0,is_null,30" id="makerCode" type="text" class="middle_txt"  value="${tm.makerCode}"/>
	    </td>
	    <td class="table_query_2Col_label_8Letter" nowrap="nowrap">执行方名称：</td>
	    <td class="table_query_2Col_input" nowrap="nowrap">
	    	<input name="makerName" datatype="0,is_null,30" id="makerName" type="text" class="middle_txt"  value="${tm.makerName}"/>
	    </td>
	  </tr>
	  <tr>
	  <td class="table_query_2Col_label_8Letter" nowrap="nowrap">联系人：</td>
	    <td class="table_query_2Col_input" nowrap="nowrap">
	    	<input name="linkMan" datatype="0,is_null,30" id="linkMan" type="text" class="middle_txt" value="${tm.linkMan}" />
	    </td>
	     <td class="table_query_2Col_label_8Letter" nowrap="nowrap">联系电话：</td>
	    <td class="table_query_2Col_input" nowrap="nowrap">
	    	<input name="phone" datatype="0,is_null,30" id="phone" type="text" class="middle_txt" value="${tm.phone}" />
	    </td>
	  </tr>
		...
		<tr>
		    <td colspan="4" align="center">
		    	...
		    	<input name="button2" type="button" class="normal_btn" onclick="confirmUpdate();" value="修改"/>
