...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动方案管理 &gt; 市场活动申请查询</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/sales/marketmanage/activity/ActivityApply/doSearch.json";
	var title = null;
	var columns = [
    ...
    function makePlan(activityId){
        document.fm.action= '<%=contextPath%>/sales/marketmanage/activity/ActivityApply/modPre.do?activityId='+activityId;
        document.fm.submit();
    }
    //初始化
    function doInit(){
	...
	function activityApplyAdd(){
	 document.fm.action= '<%=contextPath%>/sales/marketmanage/activity/ActivityApply/addPre.do';
     document.fm.submit();
	}
</script>
<!--页面列表 end -->
