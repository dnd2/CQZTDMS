...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/marketmanage/costmanage/ActivitiesCostImport/activitiesCostImportInit.do';
		location=url;
...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置： 市场活动管理 &gt; 活动费用管理&gt;活动费用导入
	</div>
<table class="table_query">
  <tr>
    <td align = left class="zi01">经销商活动费用导入已完成。</td>
  </tr>
</table>
<table class=table_query>
  <tr>
