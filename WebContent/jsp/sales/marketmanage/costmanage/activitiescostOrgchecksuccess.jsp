...
<table class="table_list" width="85%" align="center" border="0">		
	   <tr>
            ...
            <th><div align="center">费用金额</div></th>
  	   </tr>
  	<c:forEach items="${planList}" var="planList"
		...
		<tr class="table_list_row${steps.index%2+1 }">
			...
			<td><div align="center">${planList.DEALER_AMOUNT }</div></td>
		</tr>
	</c:forEach>
...
function importSave() {
		...
		frm.action = "<%=contextPath %>/sales/marketmanage/costmanage/ActivitiesCostImport/importExcel.do";
		frm.submit();
}
</script>
</body>
