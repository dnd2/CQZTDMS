...
<tr>
	...
	<tr> 
		<td class="table_query_label" colspan="2">
			2、点“<font color="#FF0000">浏览</font>”按钮，找到您所要导入的的活动费用导入目标文件,请确定文件的格式为“<strong>组织代码—组织名称—费用类型编码—费用类型-资金数量</strong>”：&nbsp;&nbsp;&nbsp;</td>
    </tr>
	<tr>
...
<script type="text/javascript">
	...
	function upload(){
		...
		$('fm').action = "<%=contentPath %>/sales/marketmanage/costmanage/ActivitiesOrgCostImport/activitiesCostExcelOperate.do";
    	$("fm").submit();
	}
	
	function downloadFile(){
	    $('fm').action= "<%=contentPath %>/sales/marketmanage/costmanage/ActivitiesOrgCostImport/downloadTemple.do";
	    $('fm').submit();
	}
