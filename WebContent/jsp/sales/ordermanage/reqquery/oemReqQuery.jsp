...
<form method="POST" name="fm" id="fm">
	<table class="table_query" align=center width="95%">
		...
		<tr>
        	...
        	<td align="right" nowrap>订货单位：</td>
			<td align="left" nowrap>
				<input type="text"  name="oDlr" class="middle_txt" value="" id="oDlr"/>
				<input name="button3" type="button" class="mini_btn" onclick="showOrgDealer('oDlr','','true', '${orgId}','true')" value="..." />
            	<input class="cssbutton" type="button" value="清空" onclick="clrTxt('oDlr');"/>
            </td>
		</tr>
		<tr>
			<td nowrap align="right">大客户代车：</td>
			<td nowrap>
				<script type="text/javascript">
	      			genSelBoxExp("isFleet",<%=Constant.IF_TYPE%>,"",true,"short_sel","","false", '');
	      		</script>
        	</td>
        	<td align="right" nowrap>开票单位：</td>
			<td align="left" nowrap>
				<input type="text"  name="bDlr" class="middle_txt" value="" id="bDlr"/>
				<input name="button3" type="button" class="mini_btn" onclick="showOrgDealer('bDlr','','true', '${orgId}')" value="..." />
            	<input class="cssbutton" type="button" value="清空" onclick="clrTxt('bDlr');"/>
            </td>
		</tr>
		<tr>
        	...
        	<td align="right" nowrap>收车单位：</td>
			<td align="left" nowrap>
				<input type="text"  name="rDlr" class="middle_txt" value="" id="rDlr"/>
				<input name="button3" type="button" class="mini_btn" onclick="showOrgDealer('rDlr','','true', '${orgId}','true')" value="..." />
            	<input class="cssbutton" type="button" value="清空" onclick="clrTxt('rDlr');"/>
            </td>
		</tr>
		<tr>
...
<script type="text/javascript">
	...
	function searchServiceInfo(value,value2){
		$('fm').action= "<%=request.getContextPath()%>/sales/ordermanage/delivery/OrderCommandQuery/commandQueryInfo.do?reqId="+value+"&orderType="+value2;
		$('fm').submit();
	}
	// 设置开票信息超链
	...
	function dlvDtlInfo(value1, value2) {
		$('fm').action= "<%=request.getContextPath()%>/sales/ordermanage/delivery/OrderCommandQuery/commandQueryInfo.do?reqId=" + value1 + "&orderType=" + value2;
		$('fm').submit();
	}
