...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;订单车辆明细</div>
	<table class=table_list style="border-bottom:1px solid #DAE0EE">
  	<tr align=center class="">
	    ...
	    <th  nowrap="nowrap">当前节点</th>
	    <th  nowrap="nowrap">节点更新时间</th>
  	</tr>
  	<c:forEach items="${matchList}" var="po" varStatus="step">
	  	<tr class="table_list_row1">
		    ...
		    <TD align="center">${po.NODE_CODE}</TD>
		    <TD align="center">${po.NODE_DATE}</TD>
	  	</tr>
  	</c:forEach>
</table>
 <table class=table_query align=center width="85%">
   <tr>
  <td align="left"><input type="button" value="关闭" class="button" onClick="_hide();;" >
    <td>
  </tr> 
</table>
</body>
