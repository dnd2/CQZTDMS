...
<script type="text/javascript">
	...
	function myLink(value,meta,record){
		...
		var str="";
		str+="<a href='#' onclick='respondInit("+record.data.ORDER_ID+")'>[终审]</a>";
	...
	function respondInit(order_id){
		...
		var url="<%=contextPath%>/sales/ordermanage/orderdetail/OrderOperation/respondEndInit.do?orderId="+order_id+"&week="+week;
		location.href=url;
	...
	function executeQuery(){
		...
		url = "<%=contextPath%>/sales/ordermanage/orderdetail/OrderOperation/orderResEndQuery.json?&orderNO="+orderNO;
		__extQuery__(1);
	}
	//清除数据
	function clrTxt(id){
...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 销售订单管理 &gt; 订单发运 &gt;常规订单免责终审</div>
...
<!--				  <input name="button2" type="button" class="mini_btn" onclick="showOrgDealer('dealerCodes','','true');" value="..." />-->
		...
		<tr>
			...
			<td ><input name="downLoad"  class="cssbutton" type="hidden" onClick="downLoadData();" value="下载"></td>
