...
<title>电商合作经销商维护</title>

</head>
<body onunload='javascript:destoryPrototype();' onload="__extQuery__(1);"> 
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：  整车销售 &gt;  销售订单管理  &gt;订单提报 &gt; 电商合作经销商查询</div>
	...
	<table class="table_query" border="0">
		<tr>
	     ...
	     <td align="right">关系名称：</td>
	     <td ><input type="text" name="coopName" id="coopName"/></td>
		</tr>
	    <tr>
	    	<td> &nbsp;</td>
			<td  colspan="2" align="center" >
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        			<input name="addBtn" type="button" class="normal_btn" onclick="addCoop()" value="新增" />
			</td>
	        <td align="right" >
