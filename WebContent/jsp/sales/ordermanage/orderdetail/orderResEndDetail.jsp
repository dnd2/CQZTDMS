...
<title>常规订单免责终审</title>
<% String contextPath = request.getContextPath(); %>
<script type="text/javascript">
	//免责审核
	function updateRespond(flag){
		var order_id=$("orderId").value;
		var url="<%=contextPath%>/sales/ordermanage/orderdetail/OrderOperation/respondEnd.json?order_id="+order_id+"&flag="+flag;
	...
	function resResult(json){
		if(json.flag=='1'){
			var week=$("week").value;
			MyAlert("操作成功！！！");
			location.href="<%=contextPath%>/sales/ordermanage/orderdetail/OrderOperation/doRespondEndInit.do?week="+week;
		}else{
			MyAlert("未知错误，请联系管理员！！！")
		}
	}
