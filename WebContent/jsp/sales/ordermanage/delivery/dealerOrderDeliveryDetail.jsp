...
<input type="hidden" name="ver" value="<c:out value="${map.VER}"/>"/>
  ...
  <tr class="cssTable" >
    ...
    <td align="right" valign="top" nowrap="nowrap" class="table_info_3col_label_6Letter">同步后余额：</td>
    <td align="left" valign="top" nowrap="nowrap" class="table_info_3col_input">
    	<c:out value="${map.AVAILABLE_AMOUNT}"/>
    </td>
    <td align="right" valign="top" nowrap="nowrap" class="table_info_3col_label_6Letter">同步后折让：</td>
    <td align="left" valign="top" nowrap="nowrap" class="table_info_3col_input">
