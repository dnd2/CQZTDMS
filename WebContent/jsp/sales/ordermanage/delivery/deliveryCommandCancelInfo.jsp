...
<form  name="fm" id="fm" method="post">
 ...
 <td align="right" valign="top" nowrap="nowrap" class="table_info_3col_label_6Letter">库存组织：</td>
    ...
    </td>    <td align="right" valign="top" nowrap="nowrap" class="table_info_3col_label_6Letter">&nbsp;</td>
    <td align="left" valign="top" nowrap="nowrap" class="table_info_3col_input">&nbsp;</td>
    </tr>
</table>
<br>
...
<br>
  ...
  <table class="table_query">
    <tr class="cssTable" align="center" >
      <td>
      	  <input type="hidden" name="deliveryId" value="${map.DELIVERY_ID}">
      	  <input type="hidden" name="reqId" value="${map.REQ_ID}">
      	  <input type="hidden" name="orderId" value="${map.ORDER_ID}">
      	  <input type="hidden" name="orderType" value="${map.ORDER_TYPE}">
      	  <input type="hidden" name="reqVer" value="${map.VER}">
      	  <input class="normal_btn" name="add232" type="button" onclick="toCancelCheck();" value ="取消" />
...
<script language="javascript">
	...
	function cancelForword(){
		makeNomalFormCall("<%=request.getContextPath()%>/sales/ordermanage/delivery/DeliveryCommandCancel/checkCancel.json",showCancelValue,'fm');
	}
