...
<script type="text/javascript">
	...
	//提交
	function toAdd(){
		makeNomalFormCall('<%=request.getContextPath()%>/sales/ordermanage/orderaudit/SpecialNeedProductCheck/specialNeedProductDetailCheckLever.json',showResult,'fm');
	}
	//返回
	function toBack(){
		_hide();
