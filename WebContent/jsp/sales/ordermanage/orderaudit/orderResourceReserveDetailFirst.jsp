	 ...
	 <tbody id="dealerTr">
	  ...
	  <tr class="cssTable" >
	   <td align="right" valign="top" nowrap="nowrap" ><div align="right">资金类型：</div></td>
	    ...
	    <td align="right" valign="top" nowrap="nowrap" ><div align="right">可用余额：</div></td>
	    <td align="left" valign="top" nowrap="nowrap" class="table_info_3col_input">
			...
			<c:forEach items="${list1}" var="list1" varStatus="vstatus">
				<tr align="center" class="table_list_row1">
					...
					<td>
						...
						<input type="text" class="mini_txt" id="reserveAmount${list1.MATERIAL_ID}" name="reserveAmount" value="${list1.RESERVE_AMOUNT}" onchange="reserveAmount1();" datatype='0,is_digit,6'>
						<%-- <a href="#" onclick="patchNoSelect('${list1.MATERIAL_ID}','${list1.RESERVE_AMOUNT}');">[审核]</a> --%>
					</td>
					<td><input type="text" id="singlePrice${list1.MATERIAL_ID}" name="singlePrice" size="8" readonly style="text-align:right" value="${list1.SINGLE_PRICE}" onchange="priceTotal();" datatype='0,isMoney,10'/><span id="priceDesc${list1.MATERIAL_ID}"></span></td>
