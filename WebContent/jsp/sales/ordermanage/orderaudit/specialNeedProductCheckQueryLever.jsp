...
<script type="text/javascript" >
	var myPage;
	//查询路径           
	var url = "<%=contextPath%>/sales/ordermanage/orderaudit/SpecialNeedProductCheck/specialNeedProductCheckQueryLever.json";
	var title = null;
	var columns = [
	...
	function toDetailCheck(value,ver){
		...
		OpenHtmlWindow('<%=contextPath%>/sales/ordermanage/orderaudit/SpecialNeedProductCheck/specialNeedProductDetailCheckInitLever.do?&reqId='+value+'&ver='+ver,700,500);
	}
	//初始化    
	function doInit(){
