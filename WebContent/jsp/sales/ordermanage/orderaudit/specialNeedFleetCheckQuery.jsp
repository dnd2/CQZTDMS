...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 销售订单管理 &gt; 订做车订单管理 &gt;订做车大客户审核</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径           
	var url = "<%=contextPath%>/sales/ordermanage/orderaudit/SpecialNeedFleetCheck/specialNeedFleetCheckQuery.json";
	var title = null;
	var columns = [
	...
	function toDetailCheck(value,ver){
		...
		OpenHtmlWindow('<%=contextPath%>/sales/ordermanage/orderaudit/SpecialNeedFleetCheck/specialNeedFleetDetailCheckInit.do?&reqId='+value+'&ver='+ver,700,500);
	}
	//初始化    
	function doInit(){
