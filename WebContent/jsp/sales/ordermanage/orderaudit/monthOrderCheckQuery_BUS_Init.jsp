...
<form method="POST" name="fm" id="fm">
  <table class="table_query" align=center width="95%">
    ...
    <tr>
		...
		<td align="left"><input type="text" name="orderNo"  value="" size="22"/></td>
...
<script type="text/javascript">
	...
	function detailQuery(){
		calculateConfig = {};
	    url = "<%=request.getContextPath()%>/sales/ordermanage/orderaudit/MonthOrderCheckQuery/monthOrderCheckQuery_BUS_Query.json";
		columns = [
	...
	function sumQuery(){
	    ...
	    url = "<%=request.getContextPath()%>/sales/ordermanage/orderaudit/MonthOrderCheckQuery/monthOrderCheckQuery_BUS_Query_Sum.json";
		columns = [
	...
	function toDetail(check_id,orderId){
		OpenHtmlWindow('<%=request.getContextPath()%>/sales/ordermanage/orderaudit/MonthOrderCheckQuery/monthOrderCheckQuery_BUS_Query_Detail.do?orderId='+orderId+'&check_id='+check_id,700,550);
	}
