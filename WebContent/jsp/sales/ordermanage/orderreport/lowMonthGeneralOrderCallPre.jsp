...
<script type="text/javascript">
	...
	function toQuery(){
		...
		ss.src = "<%=contextPath%>/sales/ordermanage/orderreport/LowMonthGeneralOrderCall/applyQuery.do?&orderYearMonth="+orderYearMonth+"&areaId="+areaId+"&dealerId="+dealerId+"&orderNo="+orderNo;
		document.getElementById('tablelist').style.display="inline";
	}
</script>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 销售订单管理 &gt; 订单提报 &gt;下级经销商月度常规订单启票</div>
