...
<script type="text/javascript" >
	...
	//申请发运
	function putForword(){
		makeNomalFormCall("<%=contextPath%>/sales/ordermanage/orderreport/LowMonthGeneralOrderCall/applySubmit.json",showForwordValue,'fm','queryBtn');
	}
	//回调函数
