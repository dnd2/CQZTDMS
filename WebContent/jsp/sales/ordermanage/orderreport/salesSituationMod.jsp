...
function addRow(json){	
			...
			newCell.align = "center";
			newCell.innerHTML = "<span id='POOR_AMOUNT"+ timeValue+"' name='POOR_AMOUNT"+ timeValue+"' type='text' class='SearchInput' datatype='0,is_digit,10' value='0' maxlength='10'  ></span><input id='POOR_AMOUNTS"+ timeValue+"' name='POOR_AMOUNT"+ timeValue+"' type='hidden' class='SearchInput' datatype='0,is_digit,10' value='0' maxlength='10' readonly='readonly' />";
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售 > 销售订单管理 > 订单提报 > 预售车辆修改</div>
  ...
  <TABLE class=table_list style="border-bottom:1px solid #DAE0EE" >  
    ...
    <c:forEach var="i" items="${list}">
    	  <tr class="table_list_row2">
    	  	...
    	  	<td align="center"><input id="ORDER_AMOUNT${i.MATERIAL_ID}" name="ORDER_AMOUNT${i.MATERIAL_ID}" class="SearchInput" datatype="0,is_digit,10" value="${i.ORDER_AMOUNT}" maxlength="10" onchange="totalCou(${i.MATERIAL_ID});" type="text"></td>
    	  	<td align="center"><input id="RET_AMOUNT${i.MATERIAL_ID}" name="RET_AMOUNT${i.MATERIAL_ID}" class="SearchInput" datatype="0,is_digit,10" value="${i.RET_AMOUNT}" maxlength="10" onchange="totalCou(${i.MATERIAL_ID});" type="text"></td>
    	  	<td align="center"><span id="POOR_AMOUNT${i.MATERIAL_ID}" name="POOR_AMOUNT${i.MATERIAL_ID}" class="SearchInput" datatype="0,is_digit,10"  maxlength="10" readonly="readonly" >${i.POOR_AMOUNT}</span><input id="POOR_AMOUNTS${i.MATERIAL_ID}" name="POOR_AMOUNT${i.MATERIAL_ID}" class="SearchInput" datatype="0,is_digit,10" value="${i.POOR_AMOUNT}" maxlength="10" readonly="readonly" type="hidden"></td>
    	  	<td align="center"><a href="#" onclick="delMaterial();">[删除]</a><input id="materialId" name="materialId" value="${i.MATERIAL_ID}" type="hidden"/></td>
    	  </tr>
    </c:forEach>
    </tbody>
  </table>	
