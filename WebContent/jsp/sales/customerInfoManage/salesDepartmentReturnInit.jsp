...
<script type="text/javascript">
	...
	var myPage;
	var url = "<%=contextPath%>/sales/customerInfoManage/SalesVehicleReturn/salesDepartmentQueryToReturnVehicleList.json?COMMAND=1";
	var title = null;
	var columns = [
				{header: "选择",dataIndex: 'ORDER_ID',align:'center',renderer:myLinkOp},
				{id:'action',header: "操作", walign:'center',idth:70,sortable: false,dataIndex: 'ORDER_ID',renderer:myLink},
				...
				{header: "所属经销商", dataIndex: 'DEALER_SHORTNAME', align:'center'},
				{header: "实销时间", dataIndex: 'SALES_DATE', align:'center'},
				{header: "退车申请时间", dataIndex: 'REQ_DATE', align:'center'}
		      ];
	function myLink(value,metaDate,record){
        ...
        return String.format(
        		 "<a id=\"chk\" href=\"#\" class='u-anchor' onclick=\"chkSales(" + order_id + "," + vehicleId + ", " + returnId + ");\">[审核]</a>");
    }
    function chkSales(order_id,vId, rId) {
		...
		fsm.action= "<%=contextPath%>/sales/customerInfoManage/SalesVehicleReturn/toCheckSalesDepartmentReturnVehicle.do?order_id="+order_id+"&vehicle_id=" + vId + "&return_id=" + rId  ;
		fsm.submit();
    }
	...
	<form id="fm" name="fm" method="post">
		...
		<div class="form-body">
			...
			<tr>
	    			...
	    			<td colspan="4" align="left"  width="30%"  >选择经销商：
	    			<input type="text" class="middle_txt" name="dealerCode" id="dealerCode" size="15" value=""
