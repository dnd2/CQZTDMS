...
<table class="table_edit" align=center id="vehicleInfo">
	...
	<tr>
		...
		<td align="left"><label> 
			<script type="text/javascript">
					genSelBoxExp("carCharactor",<%=Constant.SERVICEACTIVITY_CHARACTOR%>,'<%=Constant.SERVICEACTIVITY_CHARACTOR_01%>',false,"short_sel",'',"false",'');
	...
	<td align="right">付款方式：</td>
		<td align="left"><label> <script type="text/javascript">
					genSelBoxExp("payment",<%=Constant.PAYMENT%>,"<%=Constant.PAYMENT_02%>",false,"short_sel","onchange='changeMortgageType(this.value)'","false",'<%=Constant.PAYMENT_01%>');
...
<table class="table_edit" align="center" id="company_table" style="display: none;">
	...
	<tr>
		...
		<td colspan="3" align="left">
			省份： <select class="min_sel" id="txt1" name="province" onchange="_genCity(this,'txt2')"></select> 
			地级市： <select class="min_sel" id="txt2" name="city" onchange="_genCity(this,'txt3')"></select> 
			区、县 <select class="min_sel" id="txt3" name="district"></select><font color="red">*</font>
		</td>
	</tr>
</table>
...
<table class="table_edit" align="center" id="ctm_table_id_2">
	...
	<tr>
		<td align="right">所在地：</td>
		<td colspan="3" align="left">
			省份： <select class="min_sel" id="txt4" name="province1" onchange="_genCity(this,'txt5')"></select> 
			地级市： <select class="min_sel" id="txt5" name="city1" onchange="_genCity(this,'txt6')"></select> 
			区、县 <select class="min_sel" id="txt6" name="district1"></select><font color="red">*</font>
		</td>
	</tr>
	<tr>
		<td align="right">详细地址：</td>
		<td colspan="3" align="left">
			<input id="address" name="address" type="text" size="80" value="" datatype="0,is_textarea,200" maxlength="200" />
		</td>
	</tr>
</table>
</div>
...
<script type="text/javascript">
	...
	function is_fleet_Sel(value){
		...
		if(<%=Constant.IF_TYPE_YES %> == value){
			document.getElementById("is_fleet_yes").value = "<%=Constant.IF_TYPE_YES %>" ;
			...
			document.getElementById("is_fleet_yes").value = "<%=Constant.IF_TYPE_NO %>" ;
	...
	function doReport(){
		if(submitForm('fm')){
			...
			var ccar = document.getElementById("carCharactor").value;
			if(ccar==null||ccar=="")
			{
				MyAlert("请选择车辆性质！");
				return;
			...
			var myctm_form = document.getElementById("myctm_form").value;
	...
	function doReportAction(){
		//$('fm').action= "<%=request.getContextPath()%>/sales/customerInfoManage/SalesReport/doReportAction.do";
		//$('fm').submit();
