...
function checkSubmit(value){
	...
	function checkSubmitAction(value){
		...
		fsm.action= "<%=request.getContextPath()%>/sales/customerInfoManage/SalesVehicleReturn/returnVehicleSubmit.do?isPass="+value+"&entity="+value1;
		fsm.submit();
	}
</script>
...
<!-- 添加附件start -->
	...
	<table id="attachTab" class="table_info" style="display: none;">
...
<table class="table_query table_list" class="center" >
	...
	<tr class="cssTable">
		 ...
		 <td class="datadetail" class="left" colspan="3">
		 	<textarea id="returnReason" name="returnReason" rows="3"   disabled="disabled" class="form-control" style="width: 500px;">${returnReason.RETURN_REASON }</textarea>
		</td>
	</tr>
	<tr>
	...
	<tr class="cssTable">
		 ...
		 <td class="datadetail" class="left" colspan="3">
		 	<textarea id="chk_remark" name="chk_remark" rows="3"  class="form-control" style="width: 500px;"></textarea>
		</td>
	</tr>
</table>
<br/>
<table class="table_list">
		<tr  class="tabletitle center">
            ...
            <c:forEach items="${checkRecords}" var="list">
                <tr class="table_list_row center">
                    <td>
                       ${list.ORG_NAME}
                    </td>
                    <td>
...
<table  class="table_query table_list" class="center" >
	<tr class="cssTable">
		<td class="center" colspan="6">
			...
			<input type="button"  class="u-button u-submit" value="驳回" onclick="checkSubmit(0);" />
