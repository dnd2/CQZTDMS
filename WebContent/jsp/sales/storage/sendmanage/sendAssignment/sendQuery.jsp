...
<body>
<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置：储运管理>发运管理>发运分派查询</div>
<form name="fm" method="post" id="fm">
<div class="form-panel">
	<h2><img src="<%=request.getContextPath()%>/jmstyle/img/search-ico.png" style="margin-bottom: -13px;"/>发运分派查询</h2>
<div class="form-body">
<!-- 查询条件 begin -->
<table class="table_query" id="subtab">
<tr class="csstr" align="center">	
	<td class="right" width="15%">申请发运仓库：</td> 
	<td align="left">
 ...
 <tr class="csstr" align="center"> 	
  ...
  <tr class="csstr" align="center"> 		  
	<td class="right" width="15%">承运商：</td> 
		<td align="left">
  ...
  <tr align="center">
 	 <td colspan="4" class="table_query_4Col_input" style="text-align: center">
    	...
    	<input type="button" id="queryBtn" class="normal_btn"  value="导出" onclick="_function();" />   
    </td>
  </tr>
</table>
</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径 
	var url = "<%=contextPath%>/sales/storage/sendmanage/SendAssignment/sendQueryList.json";
	var title = null;
	var columns = [
