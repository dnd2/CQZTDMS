...
<table class="table_query" style="margin-top: 1px; margin-bottom: 1px;" id="subtab1">
	...
	<td align=left width="15%">${sendBoardMap.LOADS }</td> -->
		<td noWrap class="right">领票车队:</td>
		<td align=left width="15%">${sendBoardMap.CAR_TEAM }</td>
	</tr>
	<tr>
		<td noWrap class="right">计划装车日期:</td>
		<td align=left width="15%">${sendBoardMap.PLAN_LOAD_DATE}</td>
		<td noWrap class="right">最晚发运日期:</td>
		<td align=left width="15%">${sendBoardMap.DLV_FY_DATE}</td>
		<td noWrap class="right">最晚到货日期:</td>
		<td align=left width="15%">${sendBoardMap.DLV_JJ_DATE}</td>
	</tr>
</table>
</div>
</div>
