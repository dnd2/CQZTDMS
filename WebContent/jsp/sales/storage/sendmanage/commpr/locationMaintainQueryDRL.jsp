...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：储运管理>发运管理> 在途位置查询(DRL)</div>
...
<!-- 查询条件 begin -->
	<table class="table_query" >
		<tr>
			...
			<td align="left">
				<input type="text" maxlength="20"  name="shipNo" id="shipNo" class="middle_txt"/>
				<input type="hidden" name="dealerCode" id="dealerCode" class="middle_txt" value="${dealerCode}"/>
			</td>
		<td class="right">承运商：</td>
			...
			<td align="left">
				<input class="short_txt"  type="text" maxlength="20"  id="t1" name="startDate" datatype="1,is_date,10" group="t1,t2"  value="" />
				<input class="time_ico" type="button" onClick="showcalendar(event, 't1', false);" value="&nbsp;" />&nbsp;至&nbsp;
				<input class="short_txt"  type="text" maxlength="20"  id="t2" name="endDate" datatype="1,is_date,10" group="t1,t2" value="" />
...
<script type="text/javascript" >
	...
	function toDetailCheck(value){
		...
		window.location.href = '<%=contextPath%>/sales/storage/sendmanage/CommprManage/locationMaintainDetailInit.do?billId='+value+'&COMMO=2';
	}
