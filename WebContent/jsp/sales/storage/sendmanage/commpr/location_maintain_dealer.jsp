...
<div class="form-panel">
	<h2><img src="<%=request.getContextPath()%>/jmstyle/img/search-ico.png" style="margin-bottom: -13px;"/>途位置查询</h2>
<div class="form-body">
<!-- 查询条件 begin -->
	<table class="table_query" >
		...
		<tr>
			...
			<td align="left">
				...
				<input class="short_txt" readonly="readonly"  type="text" id="driver_bind_date_e" name="driver_bind_date_e" onFocus="WdatePicker({el:$dp.$('endDate'), minDate:'#F{$dp.$D(\'driver_bind_date_e\')}'})"  style="cursor: pointer;width: 80px;"/>
			</td>
			</td>
		</tr>
		 <tr>
