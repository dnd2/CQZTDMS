...
<body onload="doInit();">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置：储运管理>发运管理>发运交接单管理
	</div>
<form name="fm" method="post" id="fm">
<div class="form-panel">
	<h2><img src="<%=request.getContextPath()%>/jmstyle/img/search-ico.png" style="margin-bottom: -13px;"/>发运交接单管理</h2>
<div class="form-body">
<!-- 查询条件 begin -->
<table class="table_query" id="subtab">
	...
	<tr align="center">
	  <td colspan="6" class="table_query_4Col_input" style="text-align: center">
    	  ...
    	  <input type="button" id="saveButton" class="normal_btn"  value="交接单导入" onclick="doImport();" />
	  </td>
	</tr>
</table>
</div>
...
<script type="text/javascript" >
   ...
   function myLink(value,meta,record){
        var link="<a href='javascript:void(0);' class='u-anchor' onclick='printAction(\""+value+"\")'>打印</a>";
       
  		return String.format(link);
    }
    //交接单打印
    function printAction(val){
    	var tarUrl = "<%=contextPath%>/sales/storage/sendmanage/DlvWayBillManage/dlvBillPrint.do?billId="+val;
	...
	//交接单导入
	function doImport(){
		fm.action = "<%=contextPath%>/sales/storage/sendmanage/DlvWayBillManage/toImportWayBillInit.do";
		fm.submit();
	}
