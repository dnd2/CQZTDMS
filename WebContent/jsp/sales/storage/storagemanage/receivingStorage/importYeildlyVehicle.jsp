...
<title>基地车辆入库管理</title>
</head>
 
<body>
	<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置：储运管理>仓库管理>基地车辆入库管理</div>
...
<script type="text/javascript"> 
	function upload(){
		...
		document.getElementById('fm').action = "<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/YeildlyExcelOperate.do";
    	document.getElementById("fm").submit();
	}
	
	function downloadFile(){
		
	    fm.action ="<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/downloadTemplateYeildly.do";
	    fm.submit();
	}
