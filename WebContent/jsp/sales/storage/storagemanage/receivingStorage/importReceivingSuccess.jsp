...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：储运管理>仓库管理>基地车辆导入确认
...
<script type="text/javascript">
	...
	var myPage;
	//查询路径
	var url = "<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/expressResultSelectY.json";
	var title = null;
	...
	columns = [
				...
				{header: "物料编码", dataIndex: 'MATERIAL_NAME', align:'center'},
