...
<title>车辆信息导入确认</title>
</head>
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>整车物流管理>仓库管理>接车入库>车辆信息导入确认</div>
...
function importSave() {
	...
	if(importFlag=='1'){
		...
		window.location.href="<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/storageImportInit.do";
	}
}
</script>
</body>
