...
<body>
	<div class="wbox">
<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置：储运管理>仓库管理>车辆出库管理</div>
...
<script type="text/javascript"> 
	function upload(){
		...
		document.getElementById('fm').action = "<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/recivingExcelOperate.do";
    	document.getElementById("fm").submit();
	}
	
	function downloadFile(){
	    fm.action ="<%=request.getContextPath()%>/sales/storage/storagemanage/RecievingStorageImport/downloadTemplate.do";
	    fm.submit();
	}
</script>
</body>
