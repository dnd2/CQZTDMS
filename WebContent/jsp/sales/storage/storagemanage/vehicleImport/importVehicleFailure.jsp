...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>整车物流管理>仓储管理>车辆导入</div>
...
function importSave() {
	if(submitForm('frm')){
		    var url='<%=contextPath %>/sales/storage/storagemanage/VehicleImport/importInit.do';
			frm.action = url;
			frm.submit();
		}
}
