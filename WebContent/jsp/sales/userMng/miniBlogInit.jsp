...
<body>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 经销商实销管理 &gt; 微博管理 &gt; 微博申请</div>
...
<input type="hidden" name="contextPaths" id="curPaths" value="<%=request.getContextPath()%>"/>
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  ...
		  <tr>
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td ><center >
        	<input name="searchBtn" type="button" id="queryBtn" class="normal_btn" onclick="appQuery();" value="查询" />
        	<c:if test="${fn:contains(funcStr, 1019160101)}">
        	<input name="addBtn" type="button" class="normal_btn" onclick="addBlogInfo()" value="新增" />
        	</c:if>
      		</center></td>
	      </tr>
     </table> 
