...
<body >
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 经销商实销管理&gt;微博积分管理&gt;微博积分审核</div>
 <form method="post" name = "fm" id="fm">
  ...
  <input type="hidden" name="blogId" id="blogId" value="${blog.blogId}"/>
	...
	<tr>
		...
		<td colspan="3">
			<textarea rows="5" cols="50" name="auditRemark" id="remark"  datatype="0,is_textarea,200"></textarea>
		</td>
	</tr>
    <tr>
    	<td colspan="4">
	    <table class=table_query>
		 <tr>
		 <td>
		<input type="button" value="审核通过" name="saveBtn" class="normal_btn" onclick="saveBlogInfo()"/>
		<input type="button" value="驳回" name="submitBtn" class="normal_btn" onclick="submission()">	
