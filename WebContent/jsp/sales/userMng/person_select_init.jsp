...
<script type="text/javascript">
	...
	function myLink(value,meta,record){
		return String.format("<a href='#' onclick='personSelect("+record.data.PERSON_ID+")'>[查看]</a>");
	}
	
	function personSelect(person_id){
			window.location.href="<%=contextPath%>/sales/usermng/UserManage/personSelectLoad.do?personId="+person_id;
	}
