...
<body >
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 经销商实销管理 &gt; 微博管理 &gt; 微博审核</div>
...
<input type="hidden" name="contextPaths" id="curPaths" value="<%=request.getContextPath()%>"/>
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  ...
		  <tr>
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td ><center >
        	<input name="searchBtn" type="button" id="queryBtn" class="normal_btn" onclick="auditQuery();" value="查询" />
      		</center></td>
	      </tr>
     </table> 
  <!--分页 begin -->
