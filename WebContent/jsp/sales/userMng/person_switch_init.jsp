...
<script type="text/javascript">
	...
	function myLink(value,meta,record){
		return String.format("<a href='#' onclick='personSwitch("+record.data.PERSON_ID+")'>[进入]</a>");
	}
	
	function personSwitch(person_id){
			window.location.href="<%=contextPath%>/sales/usermng/UserManage/personSwitchLoad.do?personId="+person_id;
	}
...
<div class="wbox">
<div class="navigation"><img src="/dms/img/nav.gif" />&nbsp;当前位置： 经销商实销管理 &gt; 人员管理 &gt; 机构人员转换查询</div>
...
<input type="hidden" name="curPage" id="curPage" value="1" />
	<table class="table_query" border="0">
		...
		<tr>
		  ...
		  <td align="left"><script type="text/javascript">
	                genSelBoxExp("bank",9997,"",true,"mini_sel","","false",'');
	            </script>
	       </td>
