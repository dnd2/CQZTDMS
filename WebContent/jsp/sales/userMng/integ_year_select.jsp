...
<script type="text/javascript">
	var myPage;
	//查询路径           
	var url = "<%=contextPath%>/sales/usermng/IntegationManage/integYearSelect.json";
	var title = null;
	var columns = [
				...
				{header: "本年业绩积分", dataIndex: 'YEAR_PERFORMANCE_INTEG', align:'center'},
				{header: "本年认证积分", dataIndex: 'YEAR_AUTHENTICATION_INTEG', align:'center'},
				{header: "任职年限积分", dataIndex: 'POSITION_YEAR_INTEG', align:'center'},
				{header: "本年综合评价积分", dataIndex: 'YEAR_INTEG_MIXTURETOATL', align:'center'},
				{header: "本年积分", dataIndex: 'YEAR_INTEG_TOATL', align:'center'},
				{header: "第一次应兑业绩", dataIndex: 'FIRST_AGAINST_PERFORMANCE', align:'center'},
				{header: "第二次应兑业绩", dataIndex: 'SECOND_AGAINST_PERFORMANCE', align:'center'},
				{header: "第三次应兑业绩", dataIndex: 'THIRD_AGAINST_PERFORMANCE', align:'center'},
				{header: "第一次应兑认证", dataIndex: 'FIRST_AGAINST_AUTHENTICATION', align:'center'},
				{header: "第二次应兑认证", dataIndex: 'SECOND_AGAINST_AUTHENTICATION', align:'center'},
				{header: "第三次应兑认证", dataIndex: 'THIRD_AGAINST_AUTHENTICATION', align:'center'},
				{header: "第一次应兑年限", dataIndex: 'FIRST_AGAINST_YEAR', align:'center'},
				{header: "第二次应兑年限", dataIndex: 'SECOND_AGAINST_YEAR', align:'center'},
				{header: "第三次应兑年限", dataIndex: 'THIRD_AGAINST_YEAR', align:'center'},
				{header: "连续三月业绩为0", dataIndex: 'THREE_MONTH_ZERO', align:'center',renderer:getItemValue}
		      ];
	function executeQuery(){
		url= "<%=contextPath%>/sales/usermng/IntegationManage/integYearSelect.json";
		__extQuery__(1);
	}
...
<div class="wbox">
<div class="navigation"><img src="/dms/img/nav.gif" />&nbsp;当前位置： 经销商实销管理 &gt; 积分管理 &gt; 年度积分查询</div>
...
<input type="hidden" name="curPage" id="curPage" value="1" />
	<table class="table_query" border="0">
	  ...
	  <tr>
		  ...
		  <td align="left">
		 		 <input  type="text" name="bankCardNo" id="bankCardNo" class="middle_txt"/>
	       </td>
	  </tr>
	  <tr>
