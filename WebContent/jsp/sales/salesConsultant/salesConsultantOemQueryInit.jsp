...
function downloadIt() {
	var url = "<%=contextPath%>/sales/salesConsultant/SalesConsultant/oemDownload.json" ;
	$('fm').action= url ;
	$('fm').submit();
}
...
<script type="text/javascript" ><!--
	var myPage;
	//查询路径           
	var url = "<%=contextPath%>/sales/salesConsultant/SalesConsultant/oemQuery.json";
	var title = null;
	var columns = [
				{header: "组织名称",dataIndex: 'ROOT_ORG_NAME',align:'center'},
