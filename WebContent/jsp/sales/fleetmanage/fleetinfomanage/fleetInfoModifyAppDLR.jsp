...
<body>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 集团客户管理 &gt; 集团客户信息管理 &gt;集团客户信息更改申请</div>
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoModifyApp/queryFleetInfoForModify.json";
...
//设置超链接  begin      
	...
	function updateInfo(value){
		$('fm').action= '<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoModifyApp/modifyFleetInfo.do?fleetId=' + value;
	 	$('fm').submit();
	}
