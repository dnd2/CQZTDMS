...
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 集团客户管理 &gt; 集团客户信息管理 &gt;集团客户报备更改查询</div>
 <form method="post" name = "fm" >
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  <tr>
		    <td class="table_query_3Col_label_4Letter">客户名称：</td>
		    <td><input type='text'  class="middle_txt" name="fleetName"  id="fleetName" value=""/></td>
		    <td class="table_query_3Col_label_4Letter">客户类型：</td>
		    <td><script type="text/javascript">
            	genSelBoxExp("fleetType",<%=Constant.FLEET_TYPE%>,"",true,"short_sel","","true",'');
                </script></td>
		    <td class="table_query_3Col_label_4Letter">审核状态：</td>
		    <td><script type="text/javascript">
		  ...
		  <tr>
		    ...
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td><input name="queryBtn" type="button" class="normal_btn" onclick="__extQuery__(1);" value="查询" /></td>
	      </tr>
     </table> 
  <!-- 查询条件 end -->
  <!--分页 begin -->
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoModifySearchForDealer/queryFleetInfoModify.json";
	...
	var columns = [
				...
				{header: "申请日期", dataIndex: 'CREATE_DATE', align:'center'},
				...
				{header: "操作",sortable: false,dataIndex: 'EDIT_ID',renderer:myLink ,align:'center'}
		      ];
