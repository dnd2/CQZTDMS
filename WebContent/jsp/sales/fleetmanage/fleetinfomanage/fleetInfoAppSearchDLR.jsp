...
<!--<jsp:include page="${contextPath}/common/jsp_head_tab.jsp" />-->
 ...
 <form method="post" name = "fm" >
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  <tr>
		    ...
		    <td class="table_query_3Col_label_4Letter">报备状态：</td>
		    <td><script type="text/javascript">
            	genSelBoxExp("appStatus",<%=Constant.FLEET_INFO_TYPE%>,"",true,"short_sel","","true",'');
                </script></td>
	      </tr>
		  <tr>
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoSearchForDealer/queryFleetInfo.json";
