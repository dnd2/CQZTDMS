...
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 集团客户管理 &gt; 集团客户信息管理 &gt;集团客户报备更改审核</div>
 <form method="post" name = "fm" >
    <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		  ...
		  <tr>
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td align="right"><input name="searchBtn" type="button" id="queryBtn" class="normal_btn" onclick="__extQuery__(1);" value="查询" /></td>
		    <td>&nbsp;&nbsp;&nbsp;</td>
		    <td>&nbsp;&nbsp;&nbsp;</td>
	      </tr>
     </table> 
...
<script type="text/javascript" >
	var myPage;
    //查询路径
	var url = "<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoModifyCheck/queryInfoForModify.json";
...
//设置超链接  begin      
	...
	function myLink(value,meta,record){
  		return String.format("<a href='#' onclick='checkModify(\""+ value +"\")'>[审核]</a>");
	}
	
	//审核的ACTION设置，进行集团客户报备审核
	function checkModify(value){
		$('fm').action= '<%=contextPath%>/sales/fleetmanage/fleetInfoManage/FleetInfoModifyCheck/checkModifyInfo.do?editId=' + value;
	 	$('fm').submit();
	}
