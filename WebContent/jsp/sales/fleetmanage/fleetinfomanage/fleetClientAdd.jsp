	...
	<body onload="showPactPart() ;">
		...
		<form method="post" name="fm">
			<table width=100% border="0" align="center" cellpadding="1"
				...
				<table width=100% border="0" align="center" cellpadding="1"
					...
					<tr>
						...
						<td>
							<input type='text' class="middle_txt" name="pactManage"
								id="pactManage" datatype="0,is_name,25" />
						</td>
						<td class="table_query_2Col_label_7Letter">
							批售经理手机：
						</td>
						<td>
							<input type='text' class="middle_txt" name="pactManagePhone"
								id="pactManagePhone" datatype="0,is_name,18" />
					</tr>
					<tr>
						<td class="table_query_2Col_label_7Letter">
							批售经理邮箱：
						...
						<td>
							<input type='text' class="middle_txt" name="pactManageEmail"
								id="pactManageEmail" datatype="1,is_email,35"
								value="${fleetMap.PACT_MANAGE_EMAIL }" />
						<td class="table_query_2Col_label_7Letter">
							经销商选择：
						</td>
						<td>
							<input id="dealerCode" name="dealerCode" type="text"
								class="middle_txt" size="15" readonly="readonly"
								datatype="0,is_name,25" />
					...
					<tr>
						...
						<td>
							<input type='text' class="middle_txt" name="fleetName"
								id="fleetName" datatype="0,is_name,30" value="" />
           ...
           genSelBoxExp("staffSize",<%=Constant.COMPANY_SCOPE%>,"",true,"short_sel","","true",'');
						...
						<td>
							<input type='text' class="middle_txt" name="zipCode" id="zipCode"
								datatype="0,is_digit,6" value="" />
						</td>
					</tr>
					<tr>
						<td class="table_query_2Col_label_4Letter">
						...
						<td>
							<select class="short_sel" id="txt1" name="region"></select>
							<font color="red">*</font>
						</td>
						<td class="table_query_2Col_label_4Letter"
 				...
 				genSelBoxExp("isPact",<%=Constant.IF_TYPE%>,<%=Constant.IF_TYPE_NO%>,false,"short_sel","onchange='showPactPart();showPactType() ;'","false",'');
					...
					<tr>
						...
						<td>
							<input type='text' class="middle_txt" name="mainLinkman"
								id="mainLinkman" datatype="0,is_name,15" value="" />
						</td>
						<td class="table_query_2Col_label_4Letter">
							职务：
						</td>
						<td>
							<input type='text' class="middle_txt" name="mainJob" id="mainJob"
								value="" />
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type='text' class="middle_txt" name="mainPhone"
								id="mainPhone" datatype="0,is_null,100" value="" />
						</td>
						<td class="table_query_2Col_label_4Letter">
							电子邮件：
						</td>
						<td>
							<input type='text' class="middle_txt" name="mainEmail"
								id="mainEmail" datatype="1,is_email,35" value="" />
						</td>
					</tr>
					<tr style="display: none;">
						...
						<td>
							<input type='text' class="middle_txt" name="otherLinkman"
								id="mainLinkman" datatype="1,is_name,15" value="" />
						</td>
						<td class="table_query_2Col_label_4Letter">
							职务：
						</td>
						<td>
							<input type='text' class="middle_txt" name="otherJob"
								id="otherJob" value="" />
						</td>
					</tr>
					<tr style="display: none;">
						...
						<td>
							<input type='text' class="middle_txt" name="otherPhone"
								id="otherPhone" datatype="1,is_null,100" value="" />
						</td>
						<td class="table_query_2Col_label_4Letter">
							电子邮件：
						</td>
						<td>
							<input type='text' class="middle_txt" name="otherEmail"
								id="otherEmail" datatype="1,is_email,35" value="" />
						</td>
					</tr>
					<th colspan="4" align="left">
						<img class="nav" src="<%=contextPath%>/img/subNav.gif" />
					...
					<tr>
						...
						<td colspan="3">
							<input name="visitDate" id="t1" value="" type="text"
								class="short_txt" datatype="0,is_date,10" hasbtn="true"
								callFunction="showcalendar(event, 't1', false)">
						</td>

					</tr>
					<tr>
						<td class="table_query_2Col_label_5Letter" width="30%">
							市场信息：
						</td>
						<td colspan="3">
							<input style="width: 90%" name="marketInfo" id="marketInfo" />
						</td>
					...
					<tr>
						...
						<td colspan="3">
							<input style="width: 90%" id="configRequire" name="configRequire" />
						</td>
					...
					<tr>
						...
						<td colspan="3">
							<input style="width: 90%" id="fleetDiscount" name="fleetDiscount" />
						</td>
					...
					<tr>
						...
						<td colspan="3">
							<input style="width: 90%" id="ocandfp" name="ocandfp" />
						</td>
					...
					<tr>
						...
						<td colspan="4">
							<input type="button" class="normal_btn" name="addVehicle"
								id="addVehicle" value="添加车辆" onclick="chooseVehicle() ;" />
							&nbsp;
							<div id="showDiv" style="width: 100%;">
								<table class="table_list"
									style="width: 100%; border: 1px solid #B0C4DE" id="showTab"
									border="1" cellpadding="1" bordercolor="#B0C4DE">
									<tr>
					...
					<tr>
						...
						<td colspan="3" align="left">
							<textarea name="reqRemark" cols="70" rows="2" style="width: 90%"></textarea>
						</td>
					</tr>
					<table width=100% border="0" align="center" cellpadding="1"
						cellspacing="1" class="table_query">
						<tr>
							<th colspan="11" align="left">
								&nbsp;商务支持信息
								<input class="cssbutton" name="add22" type="button"
									onclick="addNewGroup()" value='新增' />
								<input type="text" name="materialCode" size="15"
									id="materialCode" style="display: none" />
							</th>
						</tr>
						<tr align="center">
						...
						<tbody id="tbody1">
							<c:forEach items="${supportInfoList}" var="listMap">
								<tr align="center">
									...
									<td>
										<input id="amount${listMap.SUPPORT_INFO_ID}" name="amount"
											type="text" class="SearchInput" value="${listMap.AMOUNT}"
											size="3" maxlength="6" datatype="0,is_double,10" />
									</td>
									<td>
										<input id="realprice${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="realprice" type="text" class="SearchInput"
											value="${listMap.REAL_PRICE}" size="3" maxlength="6" />
										<font color='red' size='5'> -</font>
									</td>
									<td>
										<input id="price${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="price" type="text" class="SearchInput"
											value="${listMap.PRICE}" size="3" maxlength="6" />
										<font color='red' size='3'> +</font>
									</td>
									<td>
										<input id="depotproprice${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="depotproprice" type="text" class="SearchInput"
											value="${listMap.DEPOT_PRO_PRICE}" size="3" maxlength="6" />
										<font color='red' size='5'> -</font>
									</td>
									<td>
										<input id="gandaccept${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="gandaccept" type="text" class="SearchInput"
											value="${listMap.GIVE_AND_ACCEPT}" size="3" maxlength="6" />
										<font color='red' size='5'> -</font>
									</td>
									<td>
										<input id="marketdevelop${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="marketdevelop" type="text" class="SearchInput"
											value="${listMap.MARKET_DEVELOP}" size="3" maxlength="6" />
										<font color='red' size='3'>=</font>
									</td>
									<td>
										<input id="realprofit${listMap.SUPPORT_INFO_ID}"
											onchange="changeOtherValue('${listMap.SUPPORT_INFO_ID}')"
											name="realprofit" class="SearchInput" size="3" maxlength="6"
											value="${listMap.REAL_PROFIT}" disabled="disabled" />
									</td>

									<td>
										<input id="requestsupport${listMap.SUPPORT_INFO_ID}"
											name="requestsupport" type="text" class="SearchInput"
											value="${listMap.REQUEST_SUPPORT}" size="3" maxlength="200"
											datatype="0,is_double,10" />
									</td>
									<td>
										<a href="#" onclick="delMaterial();">[删除]</a>
										<input type='hidden' id="groupId" name="groupId"
											value="${listMap.INTENT_SERIES}">
									</td>
								</tr>
							</c:forEach>
						</tbody>
						<tr align="left">
							<td colspan="11">
								备注：
								<textarea style="margin-left: 0px;" name="supportRemark"
									id="supportRemark" rows="2" cols="60">${fleetMap.SUPPORT_REMARK}</textarea>
							</td>
						</tr>
					</table>
					...
					<table width=100% border="0" align="center" cellpadding="1"
						cellspacing="1" class="table_info">
						<tr>
					...
					<table width=100% border="0" align="center" cellpadding="1"
						...
						<tr align="center">
							<td colspan="5">
								...
								<input type="hidden" name="fleetId" id="fleetId"
									value="${fleetMap.FLEET_ID}" />
								<input type="hidden" name="intentId" id="intentId"
									value="${intentId}" />
								<input class="cssbutton" name="button1" type="button"
									onclick="saveFleetInfo(0);" value="保存" />
								<input class="cssbutton" name="button3" type="button"
									onclick="saveFleetInfo(1);" value="提交" />
								<input class="cssbutton" name="button2" type="button"
