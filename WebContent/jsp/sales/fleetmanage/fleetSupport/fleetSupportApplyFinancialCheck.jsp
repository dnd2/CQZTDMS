...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 集团客户管理 &gt; 集团客户支持&gt; 集团客户支持申请财务复核</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径 
	var url = "<%=contextPath%>/sales/fleetmanage/fleetSupport/FleetSupportFinancialCheck/fleetSupportFinancialCheckQuery.json";
	var title = null;
	var columns = [
	...
	function searchServiceInfo(value1,value2){
		$('fm').action= '<%=contextPath%>/sales/fleetmanage/fleetSupport/FleetSupportFinancialCheck/fleetSupportFinancialCheckDetail.do?&fleetId='+value1+'&intentId='+value2;
	 	$('fm').submit();
	}
	//设置超链接
    ...
    function doInit(){
  	...
  	function showCompany(){
  		OpenHtmlWindow('<%=contextPath%>/sales/fleetmanage/fleetSupport/FleetSupportFinancialCheck/queryCompany.do',800,450);
  	}
  	//清除按钮
  	function toClear(){
