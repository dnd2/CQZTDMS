		...
		<form method="post" name="fm">
			<table width=100% border="0" align="center" cellpadding="1"
				...
				<tr>
					...
					<td>
						<c:out value="${fleetMap.COMPANY_SHORTNAME}" />
					</td>
					<td class="table_query_2Col_label_7Letter">
						批售经理名称：
					</td>
					<td>
						<c:out value="${fleetMap.NAME}" />
					</td>
				</tr>
				<tr>
					<td class="table_query_2Col_label_7Letter">
					...
					<td>
						<c:out value="${fleetMap.PACT_MANAGE_PHONE}" />
					</td>
					<td class="table_query_2Col_label_7Letter">
						批售经理邮箱：
					</td>
					<td>
						<c:out value="${fleetMap.PACT_MANAGE_EMAIL}" />
					</td>
				</tr>
				<tr>
					<td class="table_query_2Col_label_7Letter">
					...
					<td>
						<c:out value="${fleetMap.SUBMIT_DATE}" />
					</td>
					<td></td>
					<td></td>
				</tr>
				...
				writeItemValue('<c:out value="${fleetMap.IS_PACT}"/>');
						...
						<input type="hidden" name="isPact" id="isPact"
							value="${fleetMap.IS_PACT}" />
					</td>
					<td class="table_query_2Col_label_4Letter" id="pactPart">
						批售项目名称：
					</td>
					<td align="left">
						${fleetMap.PACT_NAME}
				...
				<tr>
					<td align="right" class="table_query_2Col_label_5Letter">
						拜访时间：
					</td>
					<td colspan="3">
						<c:out value="${fleetMap.VISIT_DATE}" />
					</td>
				</tr>
				<!--	      <tr>-->
									...
									<tr id="tr${frdMap.DETAIL_ID}">
										<td>
											<input type="hidden" name="materialIds"
												value="${frdMap.MATERIAL_ID}">
											${frdMap.MATERIAL_CODE}
										</td>
										<td>
											${frdMap.MATERIAL_NAME}
										</td>
										<td>
											${frdMap.GROUP_NAME}
										</td>
					...
					<table width=100% border="0" align="center" cellpadding="1"
						...
						<c:forEach items="${checkList}" var="checkList">
							<tr align="center">
								...
								<td>
									${checkList.AUDIT_DATE}
								</td>
								<td>
									${checkList.USER_NAME}
								</td>
								<td>
									${checkList.AUDIT_REMARK}
								</td>
								<td>
				...
				<tr align="center">
					...
					<td>
						<input type="button" value="关闭" name="backBtn" class="cssbutton"
							onclick="closeWindow();" />
					</td>
					<td>
						&nbsp;
