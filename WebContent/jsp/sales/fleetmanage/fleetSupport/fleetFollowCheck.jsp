...
<!--	      </tr>-->
	...
	<div><img class="nav" src="<%=contextPath%>/img/subNav.gif" />&nbsp;跟进信息</div>
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		<tr>
			<td class="table_query_2Col_label_6Letter">跟进时间：</td>
			<td align="left">
				<input class="short_txt"  type="text" id="t1" name="followDate" datatype="0,is_date,10" value="" />
				<input class="time_ico" type="button" onClick="showcalendar(event, 't1', false);" value="&nbsp;" />
			</td>
		</tr>
		<tr>
			<td class="table_query_2Col_label_6Letter">跟进主题：</td>
			<td align="left">
				<input name="followTheme" id="followTheme"  datatype="0,is_null,300"/>
			</td>
		</tr>
		<tr>
			<td class="table_query_2Col_label_6Letter">跟进人员：</td>
			<td align="left">
				<input name="followPerson" id="followPerson"  datatype="0,is_null,300" />
			</td>
		</tr>
		<tr>
			<td class="table_query_2Col_label_6Letter">跟进等级：</td>
			<td align="left">
			<script type="text/javascript">
	                genSelBoxExp("followRank",1995,"",false,"mini_sel","","false",'');
	            </script>
			</td>
		</tr>
		<tr>
			<td class="table_query_2Col_label_6Letter">跟进明细：</td>
			<td align="left">
				<textarea name="followRemark" id="followRemark" rows="4" cols="60" ></textarea>
			</td>
		</tr>
		<tr align="left">
			<td></td>
			<td>
				...
				<input class="cssbutton" id="queryBtn" name="button1" type="button" onclick="toSubmit('0');" value ="保存" />
...
<script type="text/javascript">
	...
	//申请提交
	function toConfirm(){
		makeNomalFormCall('<%=request.getContextPath()%>/sales/fleetmanage/fleetInfoManage/FleetFollow/fleetFollowCheckdo.json?uuFlag=2',showResult,'fm','queryBtn');
	}
	//返回
	function toBack(){
	...
	function showResult(json){
		if(json.returnValue == '1'){
			...
			$('fm').action='<%=request.getContextPath()%>/sales/fleetmanage/fleetInfoManage/FleetFollow/searchFollowInit.do';
			$('fm').submit();
		}else{
