...
<input type="hidden" name="disc" value=""/>
	...
	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
		...
		<tr>
			...
			<td>
				<input name="otherAmount" id="kk" value="${cmap.OTHER_AMOUNT}" blurback="true" type="text" class="middle_txt" datatype="0,isMoney">
			</td>
...
<!-- 附件 结束 -->
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td align="center">
				<input class="cssbutton" name="button1" type="button" onclick="toSave()" value ="审核" />
...
<script type="text/javascript">
	...
	//申请提交
	function toConfirm(){
		makeNomalFormCall('<%=request.getContextPath()%>/sales/fleetmanage/fleetSupport/FleetContractsMaintain/firstContractsUpdateConfirm.json',showResult,'fm');
	}
	//返回
	function toBack(){
	...
	function getDisCount()
	{
		...
		document.getElementById("disc").value = amountFormatNew(new Number(ff) + new Number(kk));
	}
