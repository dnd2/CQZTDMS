...
<title>集团客户合同初审</title>
<% String contextPath = request.getContextPath();  %>
<script type="text/javascript">
</script>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 集团客户管理&gt;集团客户支持&gt;集团客户合同初审</div>
...
<script type="text/javascript" >
	var myPage;
	//查询路径 
	var url = "<%=contextPath%>/sales/fleetmanage/fleetSupport/FleetContractsMaintain/firstContractsMaintainQuery.json";
	var title = null;
	var columns = [
	...
	{
		$('fm').action= '<%=contextPath%>/sales/fleetmanage/fleetSupport/FleetContractsMaintain/firstContractsUpdate.do?&fleetId='+value1+'&contractId='+value2;
	 	$('fm').submit();
	}
