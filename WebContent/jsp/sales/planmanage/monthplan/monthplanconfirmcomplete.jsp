...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/planmanage/MonthTarget/MonthTargetConfirm/monthTargetConfirmSearchInit.do';
		location=url;
...
<table class="table_query">
  <tr>
    <td align = left class="zi01"> ${year }年${month }月 月度任务确认已完成</td>
  </tr>
</table>
<table class=table_query>
  <tr>
    <td align="center"><input class="u-button" type="button" value="返回" name="button1" onclick="finish();" />
    </td>
  </tr>
</table>
</div>
