...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售 > 计划管理 > 配额调整 > 区域配额确认下发</div>
...
<script type="text/javascript">
	...
	var myPage;
	//查询路径
	var url = "<%=request.getContextPath()%>/sales/planmanage/QuotaAssign/AreaQuotaConfirmIssue/areaQuotaConfirmQuery.json";
	...
	function loginIssue(arg1, arg2, arg3){
		$('fm').action = '<%=request.getContextPath()%>/sales/planmanage/QuotaAssign/AreaQuotaConfirmIssue/areaQuotaIssuePre.do?areaId='+arg1+'&quotaYear='+arg2+'&quotaMonth='+arg3;
	 	$('fm').submit();
	}
</script>
</body>
