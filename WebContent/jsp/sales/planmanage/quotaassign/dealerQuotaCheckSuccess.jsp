...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：整车销售 > 计划管理 > 配额分配 > 经销商配额导入</div>
...
<script type="text/javascript">
	...
	var myPage;
	//查询路径
	var url = "<%=request.getContextPath()%>/sales/planmanage/QuotaAssign/DealerQuotaImport/dealerQuotaTempQuery.json";;
	...
	function importSave() {
		if(submitForm('fm')){
			$('fm').action= "<%=request.getContextPath() %>/sales/planmanage/QuotaAssign/DealerQuotaImport/importExcel.do";
			$('fm').submit();
		}
	}
</script>
