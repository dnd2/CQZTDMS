...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>计划管理>生产计划>月度生产计划导入 </div>
...
function importSave() {
	if(submitForm('frm')){
		     var url='<%=contextPath %>/sales/planmanage/ProductPlan/ProductPlanImport/productPlanImportInit.do';
			frm.action = url;
			frm.submit();
		}
}
