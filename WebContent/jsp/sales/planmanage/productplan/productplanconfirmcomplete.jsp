...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/planmanage/ProductPlan/ProductPlanConfirm/productPlanConfirmSearchInit.do';
		location=url;
...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>计划管理>生产计划> 生产计划确认
	</div>
<table class="table_query">
  <tr>
    <td align = left class="zi01"> ${year }年${month }月 生产计划确认已完成</td>
  </tr>
</table>
<table class=table_query>
  <tr>
