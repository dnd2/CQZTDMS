...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/planmanage/ProductPlan/WeeklyProPlanInput/weeklyProPlanInputSearchInit.do';
		location=url;
...
<table class="table_query">
  <tr>
    <td align = left class="zi01"> ${year }年${month }月${week } 周度滚动计划录入已完成</td>
  </tr>
</table>
<table class=table_query>
  <tr>
