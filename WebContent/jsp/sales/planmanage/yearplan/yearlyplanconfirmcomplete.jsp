...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/planmanage/YearTarget/YearTargetConfirm/yearTargetConfirmSearchInit.do';
		location=url;
...
<body>
<div class="wbox">
<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>计划管理>年度目标>年度目标确认</div>
<div class="form-panel">
<h2>职位维护</h2>
<div class="form-body">
	<table class="table_query">
	  <tr>
	    <td class = left class="zi01"> ${year } 年度目标确认已完成</td>
	  </tr>
	</table>
	<table class=table_query>
	  <tr>
