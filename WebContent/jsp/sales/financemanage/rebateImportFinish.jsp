...
<!--
	function finish(){
	    var url='<%=contextPath %>/sales/financemanage/DerlerCreditLimit/rebateTypeMaintenanceInit.do';
		location=url;
...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>财务管理>返利管理>返利任务导入
	</div>
