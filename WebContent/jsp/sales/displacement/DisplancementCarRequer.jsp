...
<script type="text/javascript">
	...
	function mySubmitFocus2(){
		var myLength=document.getElementById("NEW_VIN2");
		if(document.getElementById("NEW_VIN2").value==''){
				MyAlert('VIN底盘号输入不能为空！');
			}else if(myLength.value.len()!=17){
				MyAlert('请输入完整的17位VIN！');
				document.getElementById('NEW_VIN2').value = '';
	...
	function getCarInfo2(){
		makeNomalFormCall('<%=contextPath%>/sales/displacement/DisplacementCar/DisplacementNewCarInfo.json',showRes2,'fm');
	}
	function showRes(json){
		if(json.returnValue == 1){
			MyAlert('车辆VIN不存在当前经销商实销数据中！');
			document.getElementById('NEW_VIN').value = '';
		} else{
		    document.getElementById('CTM_NAME').value = json.newCarInfo.CTM_NAME;
			document.getElementById("NEW_SALES_DATE1").value = dateFormat('yyyy-MM-dd', json.newCarInfo.SALESDATE);
			document.getElementById("NEW_MODEL_NAME1").value = json.newCarInfo.GROUP_CODE;
		}
	...
	function showRes2(json){
		if(json.returnValue == 1){
		    ...
		    document.getElementById('CTM_NAME2').value = json.newCarInfo.CTM_NAME;
			document.getElementById("NEW_SALES_DATE2").value = dateFormat('yyyy-MM-dd', json.newCarInfo.SALESDATE);
			document.getElementById("NEW_MODEL_NAME2").value = json.newCarInfo.GROUP_CODE;
		}		
	}
...
<input type ="hidden" name="IS_CHANA" id="IS_CHANA" value="10041001"/>
...
<table class="table_edit" align="center" id="displancement_table">
	...
	<tr>
		...
		<td align="left" width="30"><input type ="text" class="middle_txt" name="OLD_BRAND_NAME" id="OLD_BRAND_NAME" value="长安汽车" readonly="readonly"/>
		</td>
	</tr>
	</table>
	<div id="newCar" style="">
	...
	<tr>
		...
		<td align="left" width="30%"><input type="text" class="middle_txt" id="NEW_VIN" name="NEW_VIN" onchange ="mySubmitFocus();" value="" />&nbsp;<font color="red">*</font></td>
		<td align="right" width="20%">旧车型号：</td>
		<td align="left" width="30"><input type="text" class="middle_txt" id="NEW_MODEL_NAME1" name="NEW_MODEL_NAME1"  readonly="readonly"/></td>
	</tr>
	<tr>
		<td align="right" width="20%">销售日期：</td>
		<td align="left" width="30%"><input type="text" class="middle_txt" id="NEW_SALES_DATE1" name="NEW_SALES_DATE1" readonly="readonly"/></td>
	...
	<tr>
		...
		<td align="left" width="30%"><input type="text" class="middle_txt" id="CTM_NAME" name="CTM_NAME" readonly="readonly"/></td>
		<td></td>
		<td></td>
	</tr>
	</table>
	...
	<tr>
	  <td align="right" width="20%">旧车VIN号：</td>
		<td align="left" width="30%"><input type="text" class="middle_txt" id="NEW_VIN2" name="NEW_VIN2" onchange ="mySubmitFocus2();" value=""  />&nbsp;<font color="red">*</font></td>
		<td align="right" width="20%">旧车型号：</td>
		<td align="left" width="30"><input type="text" class="middle_txt" id="NEW_MODEL_NAME2" name="NEW_MODEL_NAME2" readonly="readonly"/></td>
	</tr>
	<tr>
	...
	<tr>
	  <td align="right" width="20%">销售日期：</td>
	  <td align="left" width="30%"><input type="text" class="middle_txt" id="NEW_SALES_DATE2" name="NEW_SALES_DATE2" readonly="readonly"/></td>
	  <td align="right" width="20%">车主姓名：</td>
		<td align="left" width="30"><input type="text" class="middle_txt" id="CTM_NAME2" name="CTM_NAME2" readonly="readonly"/></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		<td align="right" width="20%">返利价格：</td>
		<td align="left" width="30%"><input type="text" class="middle_txt" id="feifanliPrc" name="feifanliPrc" readonly="readonly" value="" /></td>
