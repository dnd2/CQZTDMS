...
<script type="text/javascript">
	...
	function Submit(){
		...
		var url = "<%=contextPath%>/sales/displacement/DisplacementCarChk/toCheck.json" ;
...
<table class="table_query" align="center" id="displancement_table">
	...
	<td class="table_query" align="right" width="20%">审核描述：</td>
		<td align="left" width="80%" colspan="3"><textarea id="opinion" name="opinion" cols="80" rows="3"></textarea></td>
	</tr>
	</table>
<table class="table_query" align="center" >
	<tr class="cssTable">
		<td align="center" colspan="4">
			...
			<input type="button" name="mySubmit"  class="normal_btn" value="同意" onclick="isSubmit(1);" />
			<input type="button" name="mySubmit"  class="normal_btn" value="驳回" onclick="isSubmit(0);" />
