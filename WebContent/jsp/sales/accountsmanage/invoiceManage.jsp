...
<script type="text/javascript">
    ...
    function queryInvoice(value){
    	location = '<%=contextPath%>/sales/accountsmanage/InvoiceManage/queryInvoiceAndProduct.do?INVOICE_ID='+value;
    }
	//查询条件重置
	function requery() {
	...
	function openShowOrgDealer(){

		showOrgDealer('dealerCode', 'dealerId', 'true', '', '<%= Constant.DEALER_LEVEL_01 %>', 'true', '<%=Constant.DEALER_TYPE_DVS %>', 'dealerName',"");
	}
		...
		<table class="table_query" border="0">
			...
			<tr>
				...
				<td colspan="1" width="25%" class="left">
							<input type="text"  name="dealerCode" class="middle_txt" size="15"  id="dealerCode" onclick="openShowOrgDealer();" readonly="readonly"/>
			...
			<tr>
				<td class="center" colspan="6">
					...
					<input type="button" class="u-button u-submit"  value="新增" onclick="payAdd();"/>
				</td>
			</tr>
		</tbody>
	</table>
