...
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;详细车辆信息查询</div>
...
<table class="table_list">
	...
	<tr>
		...
		<th align="left">${vehicleInfo.PRODUCT_DATE }</th>
		<th class="right">出厂日期：</th>
		<th align="left">${vehicleInfo.FACTORY_DATE }</th>
	</tr>
	<tr>
		<th class="right">颜色：</th>
		<th align="left">${vehicleInfo.COLOR }</th>
		<th class="right">车身颜色：</th>
		<th align="left">${vehicleInfo.BODY_COLOR }</th>
	</tr>
