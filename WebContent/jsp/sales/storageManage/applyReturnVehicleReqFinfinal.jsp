...
<script type="text/javascript">
	...
	var myPage;
	var title = null;
	var	url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnCheckQueryFinfinal.json";
	var	columns = [
	...
	function myOpera(value,metaDate,record) {
		return String.format("<a href=\"#\" class='u-anchor' onclick=\"operaIt(" + value + ");\">[审核]</a>") ;
	}
	
	function operaIt(value) {
		url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnDtlCheckInitFinfinal.do?headId=" + value ;
	...
	function putForword(value)
	{
		...
		makeNomalFormCall("<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnHeadCheck.json",showForwordValue,'fm','queryBtn'); 
	}
	...
	<div class="form-panel">
		...
		<div class="form-body">
			<table class="table_query" border="0">
				<tr>
					<td width="20%" class="tblopt"><div class="right">退车单号：</div></td>
					<td width="39%" >
