...
<html xmlns="http://www.w3.org/1999/xhtml"><%@ page import="com.infodms.dms.common.Constant"%><%@ page import="com.infodms.dms.common.FileConstant"%><%@taglib uri="/jstl/cout" prefix="c"%>
  ...
  <head>
    ...
    <script type="text/javascript" src="getJs.do?fileName=vehicleAllocateInInit">
    </script>
    <title>退车车辆选择</title>
  </head>
  <body>
    <div class="navigation">
      <img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：  整车销售 &gt; 库存管理 &gt; 调拨入库
    </div>
      ...
      <table class="table_query" width="85%" align="center" border="0" id="roll">
        <tr>
          ...
          <td>
            ...
            </select>            <input name="button2" id="button2" type="button" class="normal_btn" onclick="AllocateIn(this);" value="调拨入库" />
