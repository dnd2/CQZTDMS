...
<script type="text/javascript">
	...
	var myPage;
	var url = "<%=contextPath%>/sales/storageManage/IntransitCheckVehicle/getLogisticsList.json?COMMAND=1";
	var title = null;
	var columns = [
			//	{id:'action',header: "操作", walign:'center',idth:70,sortable: false,dataIndex: 'SERIES_ID',renderer:myLink},
				...
				{header: "时间", dataIndex: 'RQ', align:'center'},
				{header: "物流地点", dataIndex: 'CYS_SSDD', align:'center'},
				{header: "车牌", dataIndex: 'CPH', align:'center'},
				{header: "驾驶员", dataIndex: 'JSYXX', align:'center'},
				{header: "电话", dataIndex: 'JSYDH', align:'center'}
		      ];
