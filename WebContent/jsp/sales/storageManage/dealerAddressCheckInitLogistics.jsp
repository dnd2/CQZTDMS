...
<body>
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：经销商地址更改审核(物流部)</div>
...
<script type="text/javascript">
	...
	var myPage;
	var url = "<%=contextPath%>/sales/storageManage/DealerAddressCheck/queryAddressLogistics.json?COMMAND=1";
	var title = null;
	var columns = null ;
	...
	function checkSubmitAction(flag){
		...
		makeNomalFormCall('<%=contextPath%>/sales/storageManage/DealerAddressCheck/checkSubmitLogistics.json?flag='+flag+'&idsArray='+idsArray.toString(),showResult,'form1');
    }
	...
	function myLink(value,metaDate,record){
		...
		return String.format(
			   "<a href=\"<%=contextPath%>/sales/storageManage/DealerAddressCheck/toCheckAddressLogistics.do?id="+id+"\">[审核]</a>");
	}
	...
	function itLink(value,metaDate,record) {
		var url = "<%=contextPath%>/sales/storageManage/DealerAddressCheck/toUpdateAddressLogistics.do?id=" + value ;
