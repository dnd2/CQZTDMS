...
<script type="text/javascript">
	var myPage;
	var title = null;
	var	url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnCheckQuery.json";
	var	columns = [
	...
	function operaIt(value) {
		url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnDtlCheckInit.do?headId=" + value ;
