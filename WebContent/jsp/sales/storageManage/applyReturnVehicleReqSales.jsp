...
<script type="text/javascript">
	...
	var myPage;
	var title = null;
	var	url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnCheckQuerySales.json";
	var	columns = [
	...
	function operaIt(value) {
		url = "<%=contextPath%>/sales/storageManage/ReturnVehicleReq/returnDtlCheckInitSales.do?headId=" + value ;
