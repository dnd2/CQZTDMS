...
<script type="text/javascript">
	...
	function myLink(vehicle_id,meta,record){
	    ...
	    return String.format(
	       	"<a href=\"<%=contextPath%>/sales/salesInfoManage/SalesInfoChangeCheck/topCheck.do?order_id="+data.ORDER_ID+"&vehicleId="+data.VEHICLE_ID+"&isFleet="+data.IS_FLEET+"&ctm_edit_id="+data.CTM_EDIT_ID+"&log_id="+data.LOG_ID+"\" class='u-anchor' >[审核]</a>");
	}
