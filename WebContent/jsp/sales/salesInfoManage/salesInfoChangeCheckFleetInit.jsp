...
<script type="text/javascript">
	...
	var myPage;
	var url = "<%=contextPath%>/sales/salesInfoManage/SalesInfoChangeCheck/changeListQuery1.json?COMMAND=1";
	var title = null;
	var columns = [
	...
	function myLink(vehicle_id,meta,record){
	    ...
	    return String.format(
	       	"<a href=\"<%=contextPath%>/sales/salesInfoManage/SalesInfoChangeCheck/toCheck.do?vehicleId="+data.VEHICLE_ID+"&isFleet="+data.IS_FLEET+"&ctm_edit_id="+data.CTM_EDIT_ID+"&log_id="+data.LOG_ID+"\">[审核]</a>");
	}
