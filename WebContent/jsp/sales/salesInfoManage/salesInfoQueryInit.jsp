		...
		<div class="form-panel">
			...
			<div class="form-body">	
				<table class="table_query"  class="center">
				    <tr>
				      <td class="right" width="8%">客户类型：</td>
				      <td> 
				      	<label>
							<script type="text/javascript">
				      ...
				      <td rowspan="2"><textarea class="form-control" name="vin" rows="3" cols="18"></textarea></td>
				    </tr>
				    <tr>
				    ...
				    <tr>
				      ...
				      <td> 
						<div class="left">
		            		<input name="startDate"  id="t1" value="${date }" type="text" class="short_txt"   onFocus="WdatePicker({el:$dp.$('t1'), maxDate:'#F{$dp.$D(\'t2\')}'})" style="cursor: pointer;width: 80px;"/>至<input name="endDate"  id="t2" value="${date }" type="text" class="short_txt" onFocus="WdatePicker({el:$dp.$('t2'), minDate:'#F{$dp.$D(\'t1\')}'})" style="cursor: pointer;width: 80px;"/>
		           		</div>	
					 </td>
