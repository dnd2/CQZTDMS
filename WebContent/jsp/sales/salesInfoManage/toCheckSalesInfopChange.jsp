...
<script type="text/javascript">
	...
	function backTo(){
		location.href = "<%=contextPath%>/sales/salesInfoManage/SalesInfoChangeCheck/salesInfoChangeCheckpInit.do";
	}
</script>
<title>实销信息管理</title>
</head>
...
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 整车销售 &gt; 实销信息管理 &gt; 实销信息更改审核(区域)</div>
...
<table class="table_query table_list" class=center>
	...
	<tr>
		<td colspan="4"  class="center">
			<input type="button" value="通过"  class="u-button u-submit" onclick="checkSubmit(<%=Constant.SALES_INFO_CHANGE_STATUS_02 %>);" />
...
<table class="table_query table_list"  class=center>
	...
	<table class="table_query table_list" class=center>
		...
		<tr>
			...
			<td class="left"  width="35%" >${dlrInfo.DEALER_CODE}</td>
