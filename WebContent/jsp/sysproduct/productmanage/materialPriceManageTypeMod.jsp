  	...
  	<table class="table_query" border="0">
		<tr>
		    ...
		    <td class="table_query_4Col_input" nowrap="nowrap">
		    	<input name="priceCode" datatype="0,is_null,30" id="priceCode" type="text" class="middle_txt" value="${po.priceCode}"/>
		    </td>
		    <td class="table_query_2Col_label_6Letter" nowrap="nowrap">价格描述：</td>
		    <td class="table_query_2Col_input" nowrap="nowrap">
		    	<input name="priceDesc" datatype="0,is_null,400" id="priceDesc" type="text" class="middle_txt" value="${po.priceDesc}"/>
		    </td>
	  	</tr>
		<tr>
		    <td class="table_query_2Col_label_6Letter" nowrap="nowrap">生效日期：</td>
		    <td class="table_query_4Col_input" nowrap="nowrap">
		    	<input class="short_txt"  type="text" id="startDate" name="startDate" datatype="0,is_date,10" value="${startDate}"/>
		    ...
		    <td class="table_query_2Col_input" nowrap="nowrap">
		    	<input class="short_txt"  type="text" id="endDate" name="endDate" datatype="0,is_date,10" value="${endDate}"/>
				<input class="time_ico" type="button" onClick="showcalendar(event, 'endDate', false);" value="&nbsp;" />
		    </td>
	  	</tr>
	  	<tr>
		    <td colspan="4" align="center">
		      <input type="hidden" name="priceId" value="${po.priceId}"/>
...
<script type="text/javascript">
	...
	function addSave(){
		makeNomalFormCall('<%=request.getContextPath()%>/sysproduct/productmanage/MaterialPriceManage/materialPriceManageTypeMod.json',showResult,'fm');
	}
