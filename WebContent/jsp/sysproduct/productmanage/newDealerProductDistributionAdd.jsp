...
<script type="text/javascript">
	...
	function theQuery() {
		url = "<%=contextPath%>/groups/DivideGroupsAction/getAllDealerOfPackage.json" ;
		columns = [
