...
<form method="POST" name="fm" id="fm">
  	<table class="table_query" border="0">
		...
		<tr>
			<td class="table_query_3Col_label_6Letter" nowrap="nowrap">经销商：</td>
			<td>
				<input type="text" class="middle_txt" readonly="readonly" name="dealerCode" size="15" id="dealerCode" value="" />
				<input name="button4" type="button"  class="mini_btn" onclick="showRegDealer('dealerCode', 'dealerId', 'true', '${orgId}', 'false')"; value="..." />
...
<script type="text/javascript">
	var myPage;
	//查询路径
	var url = "<%=request.getContextPath()%>/sysproduct/productmanage/MaterialGroupManage/newDealerProductDistributionQuery.json";			
	var title = null;
	var columns = [
	...
	function myLink(value){
        return String.format(
                "<a href='<%=request.getContextPath()%>/sysproduct/productmanage/MaterialGroupManage/newDealerProductDisterbutionAdd.do?ID="+value+"'>[维护]</a>"
        );
   	}
