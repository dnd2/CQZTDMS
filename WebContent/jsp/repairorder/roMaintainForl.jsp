...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	//返回
	function goBack(){
		window.location.href = "<%=request.getContextPath()%>/repairOrder/RoMaintainMain/roViewForApply.do";
	}
	...
	function confirmUpdate() {
		var boo = true;
	       ...
	       if($('REPAIR_TYPE').value==<%=Constant.REPAIR_TYPE_01%>||$('REPAIR_TYPE').value==<%=Constant.REPAIR_TYPE_03%>){
...
<!--          	<input type="text" name="OUT_SITE" id="OUT_SITE" value="<%=CommonUtils.checkNull(tawep.getOutSite()) %>" datatype="1,is_digit_letter_cn,100" class="middle_txt"/>-->
          	...
          	<tr>
					...
					<textarea name='TROUBLE_DESC' datatype="1,is_null" disabled="disabled"	id='TROUBLE_DESC' rows='2' cols='28'><%=CommonUtils.checkNull(tawep.getTroubleDescriptions()) %></textarea>
					</td>
					<%}else{ %>
					<td class="tbwhite" colspan="3">
          ...
          <tr>
			...
			<table class="table_edit">
				<tr>
					...
					<td>
					<input type="button" style="display:none" id="approve" onclick="confirmUpdate()" class="long_btn"
							value="预授权申请" />
