...
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/repairOrder/RoMaintainMain/queryRepairOrderDealer.json";
	...
	var columns = [
					...
					{header:'审核时间',width:'10%',dataIndex:'updateDate',renderer:formatDate},
...
<!--	            <input name="showBtn" type="button" class="mini_btn" style="cursor: pointer;" onClick="showOrgDealer('dealerCode','dealerId','true');" value="..." />        -->
<!--	            <input name="clrBtn" type="button" class="normal_btn" onClick="clearInput();" value="清除"/>  -->
<!--			</td>-->
<!--			  <td id="deId2" class="table_query_2Col_label_7Letter" align="right">区域：</td>-->
