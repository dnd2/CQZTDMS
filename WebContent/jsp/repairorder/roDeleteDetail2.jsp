...
　　} 
	...
	<BODY onload="doInit();" onkeydown="keyListnerResp();">
		...
		<form method="post" name="fm" id="fm">
          ...
          <table class="table_edit" style="" id="REMARKS_ID"> 
        	 <th colspan="8"  ><img src="../../img/subNav.gif" alt="" class="nav" />
          	...
          	<tr>
					...
					<td class="tbwhite" colspan="3">
						<textarea name='TROUBLE_DESC' datatype="1,is_textarea,100"	id='TROUBLE_DESC' rows='2' cols='28' disabled><%=CommonUtils.checkNull(tawep.getTroubleDescriptions()) %></textarea>
					</td>
					<td class="table_edit_2Col_label_5Letter">
						故障原因：
					</td>
					<td colspan="3" class="tbwhite">
						<textarea name='TROUBLE_REASON' id='TROUBLE_REASON'	datatype="1,is_textarea,100" rows='2' cols='28' disabled><%=CommonUtils.checkNull(tawep.getTroubleReason()) %></textarea>
				...
				<tr>
					...
					<td colspan="3" class="tbwhite">
						<textarea name='REPAIR_METHOD' datatype="1,is_textarea,100"id='REPAIR_METHOD' rows='2' cols='28' disabled><%=CommonUtils.checkNull(tawep.getRepairMethod()) %></textarea>
					</td>
					<td class="table_edit_2Col_label_5Letter">
						申请备注：
					</td>
					<td colspan="3" class="tbwhite">
						<textarea name='APP_REMARK' id='APP_REMARK'	datatype="1,is_textarea,100" rows='2' cols='28' disabled><%=CommonUtils.checkNull(tawep.getRemarks()) %></textarea>
					</td>
				</tr>
          </table>  
   ...
   if($('REPAIR_TYPE').value==<%=Constant.REPAIR_TYPE_01%>){
	...
	function deleteApply(id) {
		location="<%=contextPath%>/repairOrder/RoMaintainMain/deleteRepairOrder.do?ID="+id;
}
</script>
	</BODY>
</html>
