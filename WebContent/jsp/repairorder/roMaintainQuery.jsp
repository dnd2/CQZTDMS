...
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
	//查询路径
	var url = "<%=contextPath%>/repairOrder/RoMaintainMain/repairOrderQuery.json?action=query";
	...
	var columns = [
					...
					{header: "二级站代码", width:'11%', dataIndex: 'SECOND_DEALER_CODE'},
					{header: "二级站名称", width:'11%', dataIndex: 'SECOND_DEALER_NAME'},
					//{header: "索赔申请单号", width:'15%', dataIndex: 'claimNo'},
					{header: "工单号", width:'15%', dataIndex: 'RO_NO'},
					{header: "活动代码", width:'15%', dataIndex: 'CAM_CODE'},
					{header: "活动主题", width:'15%', dataIndex: 'SUBJECT_NO'},
					{header: "车型", width:'7%', dataIndex: 'GROUP_NAME'},
					...
					{header: "送修人手机", width:'15%', dataIndex: 'DELIVERER_MOBILE'},
					...
					{header: "单据保养次数", width:'15%', dataIndex: 'FREE_TIMES',renderer:formatNum},
...
<BODY onload="doInit()">
<div class="navigation"><img src="../../img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;车辆信息管理&gt;维修工单登记</div>
          ...
          <tr>
           ...
           <tr>
            ...
            <td align="left"><input name="ACTIVITY_MAIN" id="ACTIVITY_MAIN" value="" type="text" class="middle_txt" />
             ...
             <td  class="table_query_2Col_label_7Letter">单据状态：</td>
  			<td >
  			<script type="text/javascript">
	              genSelBoxExp("ORDER_STATUS",<%=Constant.RO_PRO_STATUS%>,"<%=Constant.RO_PRO_STATUS_01%>",false,"short_sel","","false",'');
	        </script>
  			</td>
          </tr>
          		   <tr>
	...
	var vin = $('VIN').value;
	  if((star==""||end =="")&&vin==""){
	   ...
	   var s1 = star.replace(/-/g, "/");
		...
		var time= d2.getTime() - d1.getTime();
		var days = parseInt(time / (1000 * 60 * 60 * 24));
		fm.action = "<%=request.getContextPath()%>/repairOrder/RoMaintainMain/export.do";
		fm.submit();
}
	  }
