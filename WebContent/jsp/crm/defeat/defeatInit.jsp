...
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />
		&nbsp;当前位置：  整车销售 &gt;  潜客管理  &gt;战败/失效管理 &gt;战败/失效查询
	</div>
	<form id="fm" name="fm" method="post">
		...
		<table class="table_query" border="0">
			<tr>
		      	<td width="8%" align="right" class="table_query_2Col_label_4Letter" nowrap="nowrap" >
		      		客户名称：
		      	</td>
		      	<td >
		    	...
		    	<td  align="right" nowrap="nowrap" width="12%" >
		     	...
		     	<td align="right" >战败时间起：</td>
		     	<td>
			     	<input name="defeatDate" type="text" id="defeatDate"  class="short_txt" readonly    />
		          	<input class="time_ico" type="button" onClick="showcalendar(event, 'defeatDate', false);" />止：
		          	<input name="defeatDateEnd" type="text" id="defeatDateEnd"  class="short_txt" readonly    />
		          	<input class="time_ico" type="button" onClick="showcalendar(event, 'defeatDateEnd', false);" />
	            </td>
			</tr>
			<tr>
				<td class="table_query_2Col_label_4Letter" nowrap="nowrap" align="right">意向等级：</td>
				<td>
				...
				<td  align="right" style="display: none;">类型：</td>
				<td style="display: none;">
					 <input type="hidden" id="opType" name="opType" value="" />
		            <div id="ddtopmenubar2" class="mattblackmenu">
						<ul> 
							<li>
								<a style="width:130px;" rel="ddsubmenu2" href="#" isclick="true" onclick="stree.loadtree(this, '<%= request.getContextPath() %>/crm/data/DataManage/initData.json?codeId=6039', loadType);" deftitle="--请选择--">--请选择--</a>
