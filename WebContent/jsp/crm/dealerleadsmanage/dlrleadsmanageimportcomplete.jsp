...
<!--
	function finish(){
	    var url='<%=contextPath %>/crm/dealerleadsmanage/DlrLeadsManage/leadImportInit.do';
		location=url;
...
<body>
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>潜客管理>总部线索管理>线索导入
	</div>
<table class="table_query">
  <tr>
    <td align = left class="zi01"> 销售线索导入已完成 </td>
  </tr>
</table>
<table class=table_query>
  <tr>
