...
<body onunload='javascript:destoryPrototype()' onload="loadcalendar();showSub();MyAlert(123);">
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath %>/img/nav.gif" />&nbsp;当前位置>潜客管理>经销商线索管理>线索导入</div>
...
<!--            <th><div align="center">客户所在区</div></th>-->
            ...
            <th><div align="center">客户描述</div></th>
...
<!--			<td><div align="center">${leadsList.AREA }</div></td>-->
			...
			<td><div align="center">${leadsList.CUSTOMER_DESCRIBE }&nbsp;</div></td>
			<td><div align="center">${leadsList.DEALER_CODE }</div></td>
		</tr>
	</c:forEach>
...
function importSave() {
		...
		frm.action = "<%=contextPath %>/crm/dealerleadsmanage/DlrLeadsManage/importExcel.do";
		frm.submit();
}
</script>
</body>
