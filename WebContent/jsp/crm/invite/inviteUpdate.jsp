...
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 潜客管理 &gt; 邀约管理 &gt; 邀约计划修改</div>
...
<input type="hidden" name="invite_id" id="invite_id" value="${tp.inviteId}" />
	...
	<table>
		...
		<tr style="height:20px;">
			<td align="right">主管审核意见:</td>
			<td align="left">
			<textarea rows="5" cols="70" id="invite_info" name="invite_info" readonly="readonly" style="background-color: #EEEEEE;">${tp.auditRemark}</textarea>
			</td>
			<td colspan="6"> </td>
		</tr>
