...
<table class="table_edit" align="center" id="ctm_table_id" border="1">
	<tbody>
		...
		<td colspan="2" align="left">
			省份：
			<input id="province" name="province" readonly="readonly"  value="${list.PROVINCE_NAME}" style="background-color: #EEEEEE;"  type="text" size="20" maxlength="50"/> 
		</td>
		
			<td width="right" align="right" id="tcmtd">目标市场：</td>
			<td width="left" align="left" >
				<input id="mubiao" name="mubiao" readonly="readonly" value="${list.CITY_NAME}"  style="background-color: #EEEEEE;"  type="text" size="20" maxlength="50"/> 
			</td>
			<td align="right">出差日期：</td>
			<td align="left"  colspan="2" >
				<input name="drivedate" id="drivedate" readonly="readonly" value="${list.BUSINESS_DATE}" style="background-color: #EEEEEE;"  type="text" class="short_txt"  />
			</td>
			
			<td width="right" align="right" id="tcmtd">出差人：</td>
			<td width="left" align="left"  >
				<input id="drivename" name="drivename" readonly="readonly" value="${list.BUSINESS_TRAVELLER}"  style="background-color: #EEEEEE;" type="text" size="20" maxlength="50"/> 
			</td>
		</tr>
		<tr>
			<td align="right">出差目的：</td>
			<td colspan="9" align="left">
				<input id="drivemd" name="drivemd" type="text" size="80"readonly="readonly" value="${list.BUSINESS_GOAL}"  style="background-color: #EEEEEE;"  maxlength="200"/>
			</td>
		</tr>
		<tr>
			...
			<tr>
				...
				<td colspan="9" align="left">
					<input id="amwork" name="amwork" type="text" size="80" readonly="readonly" value="${list.BUSINESS_JOBAM}"  style="background-color: #EEEEEE;"  maxlength="200"/>
				</td>
			</tr>
			<tr>
				<td align="right">下午：</td>
				<td colspan="9" align="left">
					<input id="pmwork" name="pmwork" type="text" size="80" readonly="readonly" value="${list.BUSINESS_JOBPM}"  style="background-color: #EEEEEE;"  maxlength="200"/>
				</td>
			</tr>
		<tr>
...
<table class="table_edit" align="center" id="ctm_table_id" border="1">
	<tbody>
	<c:forEach items="${operatlist }" var="oplist">
		<tr>
		...
		<tr>
			...
			<td  align="left" colspan="3">
				<input id="companyname" name="companyname" readonly="readonly" value="${oplist.COMPANY_NAME}"  style="background-color: #EEEEEE;" type="text" size="50" maxlength="50"/> 
			</td>
			
				<td align="right"  >意向等级判定/等级进阶：</td>
				<td  align="left" colspan="3">
					<input id="intent" name="intent"  readonly="readonly" value="${oplist.INTENT_LEVEL}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/> 
			   </td>
		...
		<tr>	
			<td >公司性质</td>
			<td  align="left">
				<input id="companyxz" name="companyxz"  readonly="readonly" value="${oplist.COMPANY_NATURE}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/> 
			</td>
			<td nowrap="nowrap">所在商圈</td>
			<td  align="left" colspan="5">
				<input id="shanquan" name="shanquan"  readonly="readonly" value="${oplist.LOCATION_CIRCLE}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/> 
			</td>
		</tr>
			<tr>	
			<td >现有经营汽车品牌及其他主营业务</td>
			<td  align="left" colspan="5">
				<input id="carbuesess" name="carbuesess" readonly="readonly" value="${oplist.CAR_BRAND}"  style="background-color: #EEEEEE;"  type="text" size="100" maxlength="100"/> 
			</td>
		</tr>
		...
		<tr>	
			...
			<td  align="left">
				<input id="vistname" name="vistname" readonly="readonly" value="${linklist.LINKMAN_NAME}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/> 
			</td>
			<td >职务</td>
			<td  align="left">
				<input id="vistzw" name="vistzw" readonly="readonly" value="${linklist.LINKMAN_JOB}"  style="background-color: #EEEEEE;" type="text" size="20" maxlength="20"/> 
			</td>
			<td >联系电话</td>
			<td  align="left">
				<input id="vistphone" name="vistphone" readonly="readonly" value="${linklist.LINKMAN_WAY}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/> 
			</td>
		</tr>
	 </c:if>
	</c:forEach>	
		...
		<tr>
			<td nowrap="nowrap">公司地址</td>
			<td  align="left" colspan="7">
				<input id="companyaddress" name="companyaddress" readonly="readonly" value="${oplist.COMPANY_ADDRESS}"  style="background-color: #EEEEEE;" type="text" size="100"  maxlength="100"/> 
			</td>
		</tr>
		...
		<tr>
			...
			<td>经销商洽谈情况</td>
			<td colspan="6">
			<textarea rows="10" cols="100" width="100%" id="dealertalk" name="dealertalk" readonly="readonly"  style="background-color: #EEEEEE;">${oplist.DEALER_NEGOTIATION}</textarea>
		...
		<tr>
			<td width="6%" align="right">下次跟进时间：</td>
					<td width="22%">
						<div align="left">
							<input name="next_follow_date" id="next_follow_date" readonly="readonly" value="${oplist.FOLLOW_DATE}"  style="background-color: #EEEEEE;"  type="text" class="short_txt"  group="startDate,endDate" />
					...
					<td width="22%" colspan="5">
						<input  id="follow_type" name="follow_type"  readonly="readonly" value="${oplist.FOLLOW_WAY}"  style="background-color: #EEEEEE;" type="text" size="20"  maxlength="20"/>
		...
		<tr>
			<td >谈判推进内容</td>
			<td  align="left" colspan="7">
				<input id="context" name="context" readonly="readonly" value="${oplist.NEGOTIAT_CONTENT}"  style="background-color: #EEEEEE;"  type="text" size="100" datatype="0,is_textarea,50" maxlength="100"/> 
			</td>
	...
	function save(){
		...
		var operatWay= '';
			...
			var originType = '';
				...
				var url = "<%=contextPath%>/crm/travel/NetSpeciaTravel/doSave.json?operatItem="+operatItem+"&operatWay="+operatWay;
