...
<body onunload='javascript:destoryPrototype();  '
	...
	var myPage;
	var url = "<%=contextPath%>/crm/order/OrderManage/orderCarFindQuery.json";
	var title = null;
	var columns =null;
	var type=${dutyType };
	if(type!="10431005"){	
...
function orderDetailDownload(){
	$('fm').action= "<%=request.getContextPath()%>/crm/order/OrderManage/orderDetailDownload.json";
	$('fm').submit();
}
