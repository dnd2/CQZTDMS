...
<body>
	<div class="wbox">
	<div class="navigation"><img src="<%=contentPath %>/img/nav.gif" />&nbsp;当前位置>潜客管理>总部线索管理>线索导入
	</div>
...
<script type="text/javascript">
	...
	function upload(){
		...
		$('fm').action = "<%=contentPath %>/crm/oemleadsmanage/OemLeadsManage/leadsManagePlanExcelOperate.do";
    	$("fm").submit();
	}
	
	function downloadFile(){
	    $('fm').action= "<%=contentPath %>/crm/oemleadsmanage/OemLeadsManage/downloadTemple.do";
	    $('fm').submit();
	}
