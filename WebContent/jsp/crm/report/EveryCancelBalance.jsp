...
function getDealerList(dealer_id,flag){
	...
	var openUrl='<%=contextPath%>/crm/report/RetrunVisitReport/getDealerList.do'+parameter;
...
<table border="0" cellpadding="3" cellspacing="0" width="100%" class="scrollTable">
	...
	<tr class="scrollColThead">
		...
		<th   class="scrollRowThead scrollCR" title='指定时间内、产生的未下发线索总量'>未下发线索总量</th>
		<th   class="scrollRowThead scrollCR" title='指定时间内、产生的下发线索总量' >下发线索总量</th>	
		<th   class="scrollRowThead scrollCR" title='指定时间内、产生的号码正确的线索量' >号码正确的线索量</th>	
		<th   class="scrollRowThead scrollCR" title='指定时间内、产生的号码有误的线索量' >号码有误的线索量</th>
		<th   class="scrollRowThead scrollCR" title='号码正确线索量/线索总量 *100%' >线索号码准确率</th>
	</tr>
		<c:forEach items="${balanceList}" var="list">
		 <tr >
			...
			<td nowrap >${list.WFXSCOUNT}&nbsp; </td>
			<td nowrap >${list.XFXSCOUNT}&nbsp; </td>
			<td nowrap >${list.HMZQCOUNT}&nbsp; </td>
			<td nowrap >${list.HMCWCOUNT}&nbsp; </td>
			<td nowrap >${list.HMZQRATE}&nbsp; </td>
		 </tr>
		</c:forEach>
</table>
</div>
