...
<script type="text/javascript">
	...
	function download(){
		if(submitForm('fm')){
			document.fm.action='<%=request.getContextPath()%>/crm/report/EveryCancelReport/doDownload.json';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理  &gt; 各渠道线索查询报表 &gt; 各渠道线索查询报表</div>
...
<script type="text/javascript" >
    ...
    function doSearch(){ 
        document.fm.action='<%=contextPath%>/crm/report/EveryCancelReport/doSearch.do';
