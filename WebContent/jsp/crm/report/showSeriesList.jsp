...
<script type="text/javascript" src="<%=contextPath %>/jsp/crm/report/dealerCode.js" charset="UTF-8"></script>
...
var areaId= "<%=areaId%>";
var drlurl = "<%=contextPath%>/crm/report/ClueReportTotal/getDealerCode.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType;
function doInit()
{
	$('pan').setOpacity("0");
