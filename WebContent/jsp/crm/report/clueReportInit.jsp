...
<script type="text/javascript">
	...
	function download(){
		if(submitForm('fm')){
			document.fm.action='<%=request.getContextPath()%>/crm/report/ClueReportTotal/doDownload.json';
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 报表管理  &gt; 线索来源效率分析报表 &gt; 线索来源效率分析报表   </div>
	...
	<table class="table_query" >
		<tr>
        	...
        	<c:if test="${!empty flag}" >
        	  ...
        	  <td align="right" nowrap>查看类型:</td>
      	    <td align="left" nowrap>
      		<select name="checkType"  style="width:135px;">
      			
      			
      			<option value="1">线索处理量</option>
      			<option value="2">线索总量</option>
      			<option value="3">线索未处理量</option>
...
<script type="text/javascript" >
    ...
    function doSearch(){ 
        document.fm.action='<%=contextPath%>/crm/report/ClueReportTotal/doSearch.do';
