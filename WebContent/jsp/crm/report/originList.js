 ...
 */
 ...
 var columns2 = [
				...
				{header: "选择", dataIndex: 'CODE_ID', align:'center',width: '33px' ,renderer:seled},
				{header: "线索来源代码", dataIndex: 'CODE_ID', align:'center'},
				{header: "线索来源名称", dataIndex: 'CODE_DESC', align:'center'}
		      ];
