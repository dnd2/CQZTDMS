...
<body>
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 潜客管理 &gt; 团队管理 &gt; 顾问小组添加</div>
...
<input type="hidden" name="curPage" id="curPage" value="1" />
	<table class="table_query" border="0">
		<tr>
			...
			<td align="left">
				<input type="text" class="middle_txt" name="groupName" id="name" value="" datatype="0,is_textarea,30" />	
			</td>
