...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/crm/delivery/delv.js"></script>
<title>已交车列表界面</title>
</head>
<body onload="loadcalendar();doInit();" > 
<div class="wbox">
	<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：  整车销售 &gt;  潜客管理  &gt;交车管理 &gt; 已交车列表</div>
