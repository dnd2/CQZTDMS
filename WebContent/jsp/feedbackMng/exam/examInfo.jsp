...
<script type="text/javascript">
var url = '<%=contextPath%>/feedbackmng/exam/ExamOemAction/mainQuery.json' ;
var title = null ;
var columns = [
               ...
               //{header:'附件名称',dataIndex:'FILENAME',width:'8%',align:'center'},
...
function myHandler(value,meta,record){
	...
	if(status == '<%=com.infodms.dms.common.Constant.STATUS_ENABLE%>')
		return "<a href='<%=contextPath%>/feedbackmng/exam/ExamOemAction/queryExamInfo.do?id="+examId+"&type=1'>[明细]</a>" ;
	else return "<a href='<%=contextPath%>/feedbackmng/exam/ExamOemAction/queryExamInfo.do?id="+examId+"&type=2'>[修改]</a>" ;
}
function goAdd(){
	location = '<%=contextPath%>/feedbackmng/exam/ExamOemAction/addUrlInit.do' ;
}
</script>
</BODY>
</html>