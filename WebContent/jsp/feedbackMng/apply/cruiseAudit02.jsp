    ...
    <table class="table_edit">
    	...
    	<tr>
    		<td colspan="4" align="center">
    			<input type="button" class="normal_btn" value="通过" id="btn_1" onclick="audit(3);" />
    			&nbsp;
    			<input type="button" class="normal_btn" value="拒绝" id="btn_2" onclick="audit(4);" />
    			&nbsp;
...
<script type="text/javascript">
	...
	function UOAbak(json){
		if(json.flag==3){
			location = '<%=contextPath%>/feedbackmng/apply/CruiseAction/cruiseAuditInit2.do' ;
		}else if(json.flag==4){
			location = '<%=contextPath%>/feedbackmng/apply/CruiseAction/cruiseAuditInit2.do' ;
		}else {
	...
	function myBtnSet(){
		...
		if(status!='<%=Constant.CRUISE_STATUS_04%>'){
