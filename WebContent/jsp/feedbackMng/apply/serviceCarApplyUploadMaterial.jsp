...
function doUploadMaterial(){
	submitForm(fm);
	fm.action = '<%=contextPath%>/feedbackmng/apply/ServiceCarApplyUpload/servicecarapplyUploadMaterial.do';
...
function goBack(){
	location = '<%=contextPath%>/feedbackmng/apply/ServiceCarApplyUpload/serviceInfoApplyUploadInit.do' ;
}
</script>
</head>
...
<table class="table_info" border="0" id="file">
  	...
  	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_edit">
  		<tr>
  			...
  			<td>
  				...
  				<input class="normal_btn" type="button" name="addBtn" value="上传"  onclick="doUploadMaterial();"/>
 ...
 <table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_edit">
           ...
           <tr>
             ...
             <td width="23%">
             	<%=tisp.getOrderId()==null?"":tisp.getOrderId() %>
             	<input type="hidden" name="roNo" value="<%=tisp.getOrderId()==null?"":tisp.getOrderId() %>"/>
             </td>
