...
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 信息反馈管理&gt;信息反馈提报 &gt;服务车申请</div>
<form id="fm" name="fm">
	...
	<tr>
		...
		<td colspan="2" align="center">
			<input class="normal_btn" type="button" value="查询" id="qryButton" onClick="__extQuery__(1);">&nbsp;&nbsp;
           	<input class="normal_btn" type="button" id="addButton" name="addButton" value="新增"  onClick="addServicecar();">
   		</td> 
	</tr>
</table>
...
<script type="text/javascript">
	...
	function myHandler(value,meta,rec){
		...
		if(status == <%=Constant.SERVICE_CAR_APPLY_01%> || status == <%=Constant.SERVICE_CAR_APPLY_04%>)
			return '<a href="<%=contextPath%>/feedbackmng/apply/ServiceCarWCAction/servicecarModifyInit.do?id='+id+'">[修改]</a>' ;
