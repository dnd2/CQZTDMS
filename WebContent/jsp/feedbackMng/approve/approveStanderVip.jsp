...
<script type="text/javascript">
	...
	//审批通过
	function passApply(){
		fm.action = "<%=contextPath%>/feedbackmng/approve/StandardVipApproveManager/approveStandardVip.do?flag=1";
	...
	function rejectApply(){
		...
		fm.action = "<%=contextPath%>/feedbackmng/approve/StandardVipApproveManager/approveStandardVip.do?flag=0";
		MyConfirm("确认操作?",fm.submit);
		//fm.submit();
	}
...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈提报&gt;合格证补办更换申请表大区审批</div>
