 ...
 <table class="table_edit">
  <th colspan="7"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />审核操作</th>
          <tr > 
            ...
            <input type="button" onclick="backChangeApproveTeamAudit('<%=contextPath%>/feedbackmng/approve/BackChangeApproveTeam/backChangeApproveTeamAudit.do','p');" class="normal_btn" style="width=8%" value="通过"/>
            <input type="button" onclick="backChangeApproveTeamAudit('<%=contextPath%>/feedbackmng/approve/BackChangeApproveTeam/backChangeApproveTeamAudit.do','r')" class="normal_btn" style="width=8%" value="驳回"/>
...
<script>
//验证
function backChangeApproveTeamAudit(url,type){
