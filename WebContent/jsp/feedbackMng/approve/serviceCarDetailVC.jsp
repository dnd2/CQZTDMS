...
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：信息反馈管理 &gt;信息反馈提报 &gt;服务车申请明细</div>
<form method="post" name ="fm" id="fm">
<input type="hidden" name="id" value="${map.ID}"/>
<input type="hidden" name="dealerCode" value="${map.DEALER_CODE}"/>
