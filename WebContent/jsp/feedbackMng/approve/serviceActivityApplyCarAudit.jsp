...
<body onload='doInit()'>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;服务活动申请表轿车事业部审批</div>
...
<input type="hidden" name="seriesList" id="seriesList" value="<%=request.getAttribute("seriesList")%>"/>
    <TABLE align=center width="95%" class=table_query >
          ...
          <td  class="table_query_2Col_label_6Letter"> 经销商名称：</td>
            ...
            <td ><input class="middle_txt" type="text" datatype="1,is_digit_letter_cn" id="ACT_NAME" name="ACT_NAME"   size="16" value=""/>            </td>
          </tr>
          <tr>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/approve/ServiceActivityApplyCarAudit/applyQuery.json?RIGHT=CAR";
	...
	function myLink1(value,meta,record){
  		return String.format("<a href=\"<%=contextPath%>/feedbackmng/approve/ServiceActivityApplyTeamAudit/serviceactivityapplyAuditPre.do?TYPE=CAR&ORDER_ID="
			+ value + "\">[审批]</a>");
	}
	//工单的超链接
