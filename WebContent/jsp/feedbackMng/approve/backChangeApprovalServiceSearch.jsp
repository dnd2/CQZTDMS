...
<BODY>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：信息反馈管理&gt;信息反馈审批&gt;退换车申请书技术支持室审核</div>
...
<table align="center" width="95%" class="table_query" >
      <tr>
        <td align="right" nowrap="nowrap">工单号：</td>
      ...
      <tr>
        ...
        <td colspan="6" nowrap="nowrap"><input type="text" name="DEALER_NAME" id="DEALER_NAME" datatype="1,is_digit_letter_cn,30" class="middle_txt" value=""/></td>
      ...
      <tr>
        ...
        <td>
		<textarea  cols="30" id="dealerCode" name="dealerCode"></textarea>
...
var myPage;
	var url = "<%=request.getContextPath()%>/feedbackmng/approve/BackChangeApproveService/backChangeApproveServiceQuery.json?COMMAND=1";
	var title = null;
	var columns = [
...
//设置超链接  begin      
	...
	function myLink(value,meta,record){
	    return String.format(
         "<a href=\"<%=contextPath%>/feedbackmng/approve/BackChangeApproveService/backChangeApproveServiceAuditInit.do?ORDER_ID="
			+ value + "\">[审核]</a>");
	}
	...
	//详细页面
	function sel(value){
		OpenHtmlWindow('<%=contextPath%>/feedbackmng/approve/BackChangeApproveService/detailBackChangeApply.do?ORDER_ID='+value,900,500);
	}
//清除方法
 function clr() {
