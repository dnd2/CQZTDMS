...
<body onload='doInit()'>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;服务活动申请表售后服务部审批</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/approve/ServiceActivityApplyServiceAudit/applyQuery.json?RIGHT=SERVICE";
	...
	function myLink1(value,meta,record){
  		return String.format("<a href=\"<%=contextPath%>/feedbackmng/approve/ServiceActivityApplyTeamAudit/serviceactivityapplyAuditPre.do?TYPE=SERVICE&ORDER_ID="
			+ value + "\">[审批]</a>");
	}
	//工单的超链接
