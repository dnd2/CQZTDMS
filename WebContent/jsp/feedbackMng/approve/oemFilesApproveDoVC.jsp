...
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：信息反馈管理 &gt;信息反馈审批 &gt;服务车资料审核</div>
    ...
    <table class="table_edit">
    	...
    	<tr>
    		<td colspan="4" align="center">
    			<input type="button" value="通过" id="btn_01" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_03%>)"/>&nbsp;
    			<input type="button" value="退回" id="btn_02" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_04%>)"/>&nbsp;
    			<input type="button" value="拒绝" id="btn_03" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_05%>)"/>&nbsp;
...
<script type="text/javascript">
	function approve(val){
		myBtnSet() ;
		if(val != <%=Constant.SERVICE_CAR_FILES_03%>){
