...
<body>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" alt=""/>&nbsp;当前位置：信息反馈管理&gt;信息反馈审批&gt;奖惩审批表轿车公司审核</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/approve/PunishmentApprovalLead/punishmentApprovalLeadQuery.json";
	...
	function punishmentApprovalUpdateInit(value,meta,record){
	    return String.format(
	    		"<a href=\"<%=contextPath%>/feedbackmng/approve/PunishmentApprovalLead/getOrderIdInfo.do?orderId="
	...
	//详细页面
	function sel(value){
		OpenHtmlWindow('<%=contextPath%>/feedbackmng/approve/PunishmentApprovalLead/getOrderIdInfo.do?orderId='+value,800,500);
	}
		//清除方法
 function clr() {
