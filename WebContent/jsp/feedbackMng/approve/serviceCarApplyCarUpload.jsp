...
<body onload='doInit()'>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;服务车申请表上报事业部未签收</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/approve/ServiceCarApplyDownload/serviceCarapplyDownloadQuery.json";
	...
	function myLink1(value,meta,record){
  		return String.format("<a href=\"<%=contextPath%>/feedbackmng/approve/ServiceCarApplyDownload/serviceCarapplyDownloadMaterial.do?TYPE=CAR&ORDER_ID="
			+ value + "\">[签收]</a>");
	}
	//工单的超链接
