...
function goSearchPage(){
	fm.action = "<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/techApproveOrderInit.do";
	fm.submit();
}
</script>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：信息反馈管理&gt;信息反馈审批&gt;市场问题处理工单技术支持室审核</div>
...
function marketOrderApprove(str){
	...
	if(submitForm('fm')){
		fm.action = "<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/approveMarketOrderInfo.do?audit="+str+"&ORDER_ID="+orderid+"&approveFlag=2&content="+content;
