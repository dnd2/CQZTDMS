...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;合格证补办更换申请表大区审批</div>
  ...
  <table class="table_query">
 		<tr>
          ...
          <tr>
            ...
            <td align="left" nowrap><input class="normal_btn" type="button" id="queryBtn" name="button1" value="查询"  onclick="__extQuery__(1)" /></td>
            <td>&nbsp;</td>
            <td align="right" >&nbsp;</td>
          </tr>
  </table>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/approve/StandardVipApproveManager/queryStandardVipApprove.json";
...
//设置超链接  begin      
	...
	function approveStandardVip(value){
		fm.action = '<%=contextPath%>/feedbackmng/approve/StandardVipApproveManager/approveStandardVipApply.do?orderId=' + value;
	 	fm.submit();
	}
