...
function getUploadMaterial(value){
	submitForm(fm);
	fm.action = '<%=contextPath%>/feedbackmng/approve/ServiceCarInfoApprove/serviceGetCarapplyDownloadMaterial.do?type='+value;
  	...
  	<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_edit">
  		<tr>
  			...
  			<td>
  				...
  				<input class="normal_btn" type="button" name="addBtn" value="签收"  onclick="getUploadMaterial(3);"/>
  				<input class="normal_btn" type="button" name="addBtn" value="拒签"  onclick="getUploadMaterial(4);"/>
