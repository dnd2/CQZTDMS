    ...
    <table class="table_edit">
    	...
    	<tr>
    		<td colspan="4" align="center">
    			<input type="button" value="通过" id="btn_01" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_06%>)"/>&nbsp;
    			<input type="button" value="退回" id="btn_02" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_07%>)"/>&nbsp;
    			<input type="button" value="拒绝" id="btn_03" class="normal_btn" onclick="approve(<%=Constant.SERVICE_CAR_FILES_08%>)"/>&nbsp;
...
<script type="text/javascript">
	function approve(val){
		myBtnSet() ;
		if(val != <%=Constant.SERVICE_CAR_FILES_06%>){
