...
<title>市场问题处理工单技术支持室处理</title>
<% String contextPath = request.getContextPath(); %>
</head>
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：信息反馈管理&gt;信息反馈审批&gt;市场问题处理工单技术支持室处理</div>
  <form id="fm" name="fm">
    ...
    <TABLE class="table_query">
       ...
       <tr>
       <td class="table_query_2Col_label_5Letter" width="7%">经销商代码：</td>  
        <td>
...
<script type="text/javascript">
   var myPage;
   //查询路径
   var url = "<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/queryTechApproveOrderInfo.json";
   ...
   function myLink(value,meta,record){
      return String.format(
       "<a href=\"<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/approveMarketOrderQueryDetailInfo.do?ORDER_ID="
		+ value + "&approveFlag=2\">[审批]</a>");
   }
   //前台页面解释投诉类型
 ...
 function clr() {
	document.getElementById('dealerName').value = "";
   	...
   	//详细页面
	function sel(value){
		OpenHtmlWindow('<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/queryOrderDetailInfo.do?orderId='+value,800,500);
	}
</script>
</BODY>
</html>