...
<body onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：信息反馈管理 &gt;信息反馈提报 &gt;服务车申请总审批</div>
    ...
    <table class="table_edit">
    	...
    	<tr>
    		<td colspan="4" align="center">
    			<input type="button" class="normal_btn" value="通过" id="btn_01" onclick="approve(8);" />&nbsp;
    			<input type="button" class="normal_btn" value="拒绝" id="btn_02" onclick="approve(9);" />&nbsp;
