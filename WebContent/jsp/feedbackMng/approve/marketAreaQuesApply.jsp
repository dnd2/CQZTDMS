...
<title>市场问题处理工单区域处理</title>
<% String contextPath = request.getContextPath(); %>
</head>
<BODY onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;市场问题处理工单区域处理</div>
  <form id="fm" name="fm">
    ...
    <TABLE class="table_query">
       <tr>
         ...
         <td colspan="2" align="left" ><input type="text" id="query_vin" name="query_vin"  class="middle_txt"/> </td>
       </tr>
       <tr>
       ...
       <tr>
         <td width="7%" align="right" nowrap>投诉类别：</td>
         <td colspan="6">
...
<script type="text/javascript">
   var myPage;
   //查询路径
   var url = "<%=contextPath%>/feedbackmng/approve/MarketQuestionOrderApproveManager/queryAreaApproveOrderInfo.json";
				
   var title = null;

   var columns = [
				{header: "经销商代码1", dataIndex: 'dealer_code', align:'center'},
