...
<BODY>
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：信息反馈管理&gt;信息反馈查询&gt;市场问题处理工单明细</div>
    ...
    <table class="table_list">
       <tr > 
         <th height="12" align=center>
         	<%if(Constant.MARKET_BACK_STATUS_BALANCE.equals(detailBean.getStatus())) {%>
         	<input type="button" onclick="window.print();" class="normal_btn" style="width=8%" value="打印"/>
         	<%} %>
