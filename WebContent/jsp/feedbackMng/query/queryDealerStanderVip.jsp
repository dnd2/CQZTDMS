...
<title>合格证补办更换申请表申请表查询（经销商端）</title>
...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理 &gt; 信息反馈提报 &gt;合格证补办更换申请表查询</div>
...
<script type="text/javascript">
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/query/QueryDealerStandardVipManage/queryStandardVip.json";
