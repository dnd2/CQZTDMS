...
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/query/ServiceActivityApplyDealerQuery/applyQuery.json";
	...
	var columns = [
				...
				{header: "提报时间", width:'10%', dataIndex: 'actDate',renderer:formatDate},
				{header: "申请状态", width:'10%', dataIndex: 'actStatus', renderer:getItemValue}
	      ];
...
<BODY onload='doInit()'>
<div class="navigation"><img src="../../../img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈查询&gt;服务活动申请表查询</div>
  <form method="post" name = "fm" id="fm">
    ...
    <TABLE align=center width="95%" class="table_query" >
          <tr>
            ...
            <td><input name="ACT_NAME" id="ACT_NAME" value="" type="text" class="middle_txt" >            </td>
          </tr>
          <tr>
            <td class="table_query_2Col_label_5Letter">活动类型：</td>
            <td><script type="text/javascript">
	              genSelBoxExp("ACT_TYPE",<%=Constant.ACTIVITY_TYPE%>,"",true,"short_sel","","true",'');
	            </script></td>
	            <td class="table_query_2Col_label_5Letter">工单状态：</td>
            <td ><script type="text/javascript">
