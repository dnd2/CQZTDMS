...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 信息反馈管理&gt;信息反馈审批&gt;合格证补办更换申请表查询</div>
...
<script type="text/javascript" >
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/query/QueryStandardVipManage/queryStandardVip.json";
...
//设置超链接  begin      
	...
	function sel(value){
		...
		window.open('<%=contextPath%>/feedbackmng/apply/StandardVipApplyManager/queryStandardVipApplyInfo.do?flag=2&orderId='+value);
	}
		//清除方法
 function clr() {
