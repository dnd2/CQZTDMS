...
<SCRIPT LANGUAGE="JavaScript">
	var myPage;
//查询路径
	var url = "<%=contextPath%>/feedbackmng/query/ServiceActivityApplyQuery/applyQuery.json";
  ...
  <form method="post" name = "fm" id="fm">
    ...
    <TABLE align=center width="95%" class="table_query" >
          ...
          <td class="table_query_2Col_label_6Letter">经销商名称：</td>
            ...
            <td><input name="ACT_NAME" id="ACT_NAME" value="" type="text" class="middle_txt" datatype="1,is_digit_letter_cn"/>            </td>
          </tr>
          <tr>
