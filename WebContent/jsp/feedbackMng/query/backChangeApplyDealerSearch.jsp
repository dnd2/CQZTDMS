...
<input type="hidden" name="seriesList" id="seriesList" value="<%=request.getAttribute("seriesList")%>"/>
    <TABLE align=center width="95%" class="table_query" >
          <tr>
            ...
            <td colspan="6" nowrap><input name="ORDER_ID" id = "ORDER_ID" datatype="1,is_digit_letter,18"  type="text" class="middle_txt"></td>
...
var myPage;
	var url = "<%=request.getContextPath()%>/feedbackmng/query/BackChangeApplyDealerSearch/backChangeApplyQuery.json?COMMAND=1";
...
//设置超链接  begin      
   ...
   //设置超链接
	...
	//详细页面
	function sel(value){
		OpenHtmlWindow('<%=contextPath%>/feedbackmng/query/BackChangeApplyDealerSearch/detailBackChangeApply.do?ORDER_ID='+value,900,500);
	}	
