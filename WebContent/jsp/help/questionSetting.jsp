...
function addFRM(){
	document.fm.action='<%=request.getContextPath()%>/help/questionSolve/QuestionReported/questionSetting.do';
	document.fm.submit();
}
...
<tr>
		...
		<input type="button" name="button1" disabled="disabled" id="queryBtn" onclick="__extQuery__(1) ;javascript:document.getElementById('button2').style.display='inline' ;" onchange="" class="cssbutton" value="查询"/>&nbsp;
		<input type="button" style="display:none" name="button2" id="btton2" onclick="addFRM();" class="cssbutton"   value="新增"/>&nbsp;<br/>
...
function myLink(value,meta,record){
	//<a href=\"#\" onclick='cancel(\""+value+"\")'>[作废]</a>
		return String.format(
				"<a href=\"#\" onclick='viewDetail(\""+value+"\")'>[明细]</a>"
		)
}

	function viewDetail(value){
		location="<%=contextPath%>/help/questionSolve/QuestionReported/getDetailMessages.do?comman=1&newsId="+value;
		}
</script>
</body>
</html>