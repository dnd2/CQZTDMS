...
<title>已保存问题修改详细页面（经销商）</title>
<script type="text/javascript">
function rebackFRM(){
	document.FRM.action='<%=request.getContextPath()%>/help/questionSolve/QuestionReported/saveUpdateInit.do';
	document.FRM.submit();
}
</script>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：帮助答疑 > 帮助答疑 > 已保存问题修改详细页面（经销商）</div>
