...
<title>常规问题（经销商）</title>
</head>
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置：帮助答疑 > 帮助答疑 > 常规问题（经销商）</div>
<form id="fm" name="fm">
...
<tr>
	<td nowrap="nowrap" align="right">
		...
		genSelBox("questionClass_common",<%=Constant.QUETION_TYPE%>,"","true");
		</script>
	</td>
</tr>
...
<tr>
		...
		<td align="left">
		<input type="text" id="questionDesc_common" name="questionDesc_common" value="" class="normal_txt" size="40" maxlength="30"/>&nbsp;
...
<script type="text/javascript" >
	var myPage;
	//查询路径 
	var url = "<%=contextPath%>/help/questionSolve/CommonQuestion/getCommonData.json";
	var title = null;
	var columns = [
...
function getQuesDes(value,metaDate,record){
	var sQuesDes = document.getElementById("questionDesc_common").value ;
...
function myLink(value,meta,record){
	...
	var	url="<%=contextPath%>/help/questionSolve/CommonQuestion/getCommonDetail.do?QID="+qid;
