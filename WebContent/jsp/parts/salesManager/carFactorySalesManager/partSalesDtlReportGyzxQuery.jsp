...
<div class="wbox">
    ...
    <script type="text/javascript">
        ...
        var myPage;
        var url = "<%=contextPath%>/report/partReport/partSalesReport/PartSalesDtlReport/queryPartSalesDtl4Gyzx.json";
        ...
        function expPartSalesDtlExcel() {
            fm.action = "<%=contextPath%>/report/partReport/partSalesReport/PartSalesDtlReport/expPartSalesDtl4GyzxExcel.do";
            fm.target = "_self";
            fm.submit();
        }
