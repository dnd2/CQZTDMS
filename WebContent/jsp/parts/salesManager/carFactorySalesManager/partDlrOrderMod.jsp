...
<div class="wbox">
 <div class="navigation">
 	<img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件采购管理&gt;配件常规订单提报&gt;修改
</div>
<div class="form-panel">
	...
	<table class="table_add" border="0" style="line-height:30px;" cellSpacing=1 cellPadding=1 width="100%">
	    ...
	    <tr id="tr2">
	        ...
	        <td><input id="partAmount" name="partAmount" type="text" class="middle_txt"
	                   value="0.00 " class="normal_txt" readonly="readonly"
	                   style="background-color: #ffff80;border:none"/><font
	                color="blue">元</font></td>
