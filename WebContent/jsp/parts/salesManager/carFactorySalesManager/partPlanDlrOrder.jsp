...
<script language="javascript">
    ...
    var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/queryPartDlrOrder.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_03%>;
...
//        {header: "订货单位编码", dataIndex: 'DEALER_CODE', align: 'left'},
    ...
    function modifyOrder(value) {
        disableAllClEl();
        window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/modifyDlrOrder.do?modifyFlag=plan&&orderId=" + value;
    }
    //作废
  ...
  //提交
    ...
    function submitOrd(value, parentId, dealerId, amount, orderCode) {
        disableAllClEl();
        var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/submitOrder.json?orderId=" + value + "&parentId=" + parentId
    ...
    function addOrder() {
        disableAllClEl();
        window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/addPlanOrder.do?";
...
<input id="ORDER_TYPE" name="ORDER_TYPE" type="hidden" value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_03%>" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 配件管理 &gt;配件采购管理&gt;配件计划订单提报</div>
        <table border="0" class="table_query">
            ...
            <tr>
                ...
                <td width="20%" align="left"><input class="short_txt" id="SCREATE_DATE" name="SCREATE_DATE" value="${old}" style="width:65px"
                    ...
                    至
                    <input class="short_txt" id="ECREATE_DATE" name="ECREATE_DATE" datatype="1,is_date,10" value="${now}" style="width:65px"
                ...
                <td width="20%" align="left"><input class="short_txt" id="SSUBMIT_DATE" name="SSUBMIT_DATE" style="width:65px"
                                                    datatype="1,is_date,10" maxlength="10"
                                                    group="SSUBMIT_DATE,ESUBMIT_DATE"/>
                    <input class="time_ico" value=" " onclick="showcalendar(event, 'SSUBMIT_DATE', false);" type="button"/>
                    至
                    <input class="short_txt" id="ESUBMIT_DATE" name="ESUBMIT_DATE" datatype="1,is_date,10" style="width:65px"
