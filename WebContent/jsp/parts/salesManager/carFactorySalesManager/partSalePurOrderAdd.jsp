...
function createCellsInnerHtml(id, name, onchangeEvent, style, type, value, trHFlag, trEFlag, hiddenHtml) {
    ...
    if (type == 'button') {
        inputHtml = '<input  type="button" class="u-button"  name="queryBtn" value="删除" onclick="deleteTblRow(this);" />';
    }
    if (type == 'text') {
...
//             MyAlert(document.getElementById("buyPrice1_" + cb[i].value).value+"-----");
//             if (document.getElementById("buyPrice1_" + cb[i].value).value == "" || parseFloat(document.getElementById("buyPrice1_" + cb[i].value).value) > 0) {
//                 msg += "第" + (i + 1) + "行配件【" + document.getElementById("partOldcode_" + cb[i].value).value + "】,单价必须大于0!</br>";
//                 flag = true;
//                 break;
//             }
...
//返回
function goBack1() {
	var orderType=$('#ORDER_TYPE')[0].value;
    if (orderType ==<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_02%>) {
        ...
        return;
    } else if (orderType ==<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_12%>) {//销售采购订单提报
...
<form name="fm" id="fm" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" value="<%=Constant.YIELDLY_01%>" name="produceFac" id="produceFac"/><!-- 备件品牌 -->
	<div id="div1" class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件采购管理&gt;销售采购订单提报&gt;新增</div>
        <div class="form-panel">
            <h2><img class="panel-icon nav" src="<%=contextPath%>/img/subNav.gif"/>采购订单信息</h2>
            <div class="form-body">
	        <table class="table_add" border="0" cellSpacing=1 cellPadding=1 width="100%" style="line-height:30px;">
	            <tr>
	                <td align="right" style="display: none">配件类型：</td>
	                <td style="display: none">
	                    <select id="isSpecialOrPlan" name="isSpecialOrPlan" style="width:150px">
	            ...
	            <tr>
	                ...
	                <td>
	                    <script type="text/javascript">
	                        genSelBoxExp("produceFac", <%=Constant.YIELDLY%>, "${dataMap.produceFac}", false, "u-select", "disabled", "false", '');
	                    </script>
	                </td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td>
	                    <input name="RCV_ORG" class="middle_txt" style="border: none" id="RCV_ORG" type="text"
	            ...
	            <tr id="tr3">
	                ...
	                <td>
	                	<input id="partAmount" name="partAmount" type="text" value="0.00" readonly="readonly"
	                           class="middle_txt" style="background-color: #ffff80;border:none"/>
	                    <font color="blue">元</font>
	                </td>
	            ...
	            <tr>
	                ...
	                <td colspan="5">
	                	<textarea name="textarea" cols="80" rows="4" value="${dataMap.textarea}"
	                              class="middle_txt"></textarea>
	                </td>
	            </tr>
	        </table>
	    </div>
        ...
        <table id="file" class="table_list" border="1" cellSpacing=1 cellPadding=1 width="100%">
            ...
            <c:forEach items="${detailList}" var="data">
                <tr>
                    ...
                    <td>
                        <input type="button" name="queryBtn" class="u-button"  value="删除"
