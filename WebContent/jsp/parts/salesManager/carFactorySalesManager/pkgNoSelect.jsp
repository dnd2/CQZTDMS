...
<body>
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>&nbsp;当前位置：装箱单打印&gt; 选择装箱号</div>
<form method="post" name="fm" id="fm">
    ...
    <%--<table id="file" class="table_list" style="border-bottom:1px solid #DAE0EE">
        ...
        <tr>
            ...
            <td align="left">
                <input type="checkbox" value="${po.pkgNo}" name="checkYsc" onclick="chkDtlYsc();"/>&nbsp;${po.pkgNo}&nbsp;
            </td>
...
请选择箱号
        ...
        <tr>
            ...
            <c:forEach items="${list1}" var="po" varStatus="sta" step="1">
            <td align="left">
                <input type="checkbox" value="${po.pkgNo}" name="checkWsc" onclick="chkDtlWsc();"/>&nbsp;${po.pkgNo}&nbsp;
            </td>
            <c:if test="${((sta.index+1)%10)==0}">
        </tr>
        <tr>
...
<div style="margin-top:25px;float: center" id="sel">
