...
<script type="text/javascript">
    function save() {
        ...
        //parentContainer.rebut(<%=id%>,$('reason').value);
        //_hide();
        rebut(<%=id%>, $('reason').value);
    }

    function rebut(id, reason) {
        var rebutUrl = encodeURI(encodeURI("<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrderCheck/rebutGxOrder.json?orderId=" + id + "&reason=" + reason));
        sendAjax(rebutUrl, result, 'fm');
    }
