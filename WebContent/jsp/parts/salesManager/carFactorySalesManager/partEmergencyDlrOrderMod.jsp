...
//    createCells(rowObj, 4, ("partCode_" + partId), ("partCode_" + partId), "", "", "hidden", partCode, false, false, "");
        ...
        function createCellsInnerHtml(id, name, onchangeEvent, style, type, value, trHFlag, trEFlag, hiddenHtml) {
            var tdStrHead = trHFlag ? '<tr><td align="center" >' : '<td align="center" >';
...
<form name="fm" id="fm" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="ORDER_TYPE" id="ORDER_TYPE"
           value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_01 %>">
    ...
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件采购管理&gt;配件紧急订单提报&gt;修改
        </div>
		     ...
		     <div class="form-body">
		        <table class="table_add" border="0" style="line-height:30px;" cellSpacing=1 cellPadding=1 width="100%">
		            <tr>
		                ...
		                <td><input type="hidden" value="${mainMap.ORDER_ID}" name="orderId" id="orderId"/>
		                    <input type="hidden" value="${mainMap.ORDER_CODE}" name="orderCode"
		                           id="orderCode"/>${mainMap.ORDER_CODE}
		                </td>
		            ...
		            <tr>
		                ...
		                <td><input readonly class="middle_txt" type="hidden" value="${mainMap.DEALER_NAME}" name="dealerName"
		                           id="dealerName"/>${mainMap.DEALER_NAME}</td>
		                <td align="right">订货人：</td>
		                <td><input readonly class="middle_txt" type="hidden" value="${mainMap.BUYER_NAME}" name="buyerName"
		                           id="buyerName"/>${mainMap.BUYER_NAME}</td>
		                <td align="right">订货日期：</td>
		                <td><input type="hidden" value="${mainMap.CREATE_DATE}" name="now" id="now"/>${mainMap.CREATE_DATE}</td>
		            </tr>
		            <tr>
		            ...
		            <tr>
		                ...
		                <td><input id="STATION" name="STATION" type="text" class="normal_txt" style="border: none"
		           ...
		           --%>
		                ...
		                <td id="accountSumTextTd"><input id="accountSum" name="accountSum" type="text" class="middle_txt"
		                                                 value="${dataMap.currAcountMap.ACCOUNT_SUM}" readonly
		                                                 style="border: none"/>
		                </td>
		                <td id="accountKyNameTd" align="right">可用金额：</td>
		                <td id="accountKyTextTd"><input id="accountKy" style="border:0px;background-color:#6F9;"
		                                                name="accountKy"
		                ...
		                <td id="accountDjTextTd"><input id="accountDj" name="accountDj" type="text"
		                                                value="${dataMap.currAcountMap.ACCOUNT_DJ}" class="middle_txt" readonly
		                                                style="border: none"/><font
		                        color="blue">元</font></td>
		            </tr>
		            <tr id="tr2">
		                <td id="AmountNameTd" align="right">订单总金额：</td>
		                <td id="AmountTextTd"><input id="Amount" name="Amount" type="text" value="${mainMap.ORDER_AMOUNT} "
		                                             class="middle_txt" style="background-color: #ffff80;border:none" readonly/><font
		                        color="blue">元</font></td>
		                <td align="right"><span align="right">订单金额：</span></td>
		                <td><input id="partAmount" name="partAmount" type="text" style="background-color: #ffff80;border:none" class="middle_txt"
		                           value="0.00" readonly/><font color="blue">元</font></td>
		                <td align="right"><span align="right">运费金额：</span></td>
		                <td><input id="freight" name="freight" type="text" style="background-color: #ffff80;border:none" class="middle_txt"
		                           value="${mainMap.FREIGHT}" onchange="validateFreight(this)" readonly/><font
		                        color="blue">元</font>
		                </td>
		            ...
		            <tr id="tr3">
		                ...
		                <td id="DISCOUNTTextTd"><input readonly class="middle_txt" type="hidden" value="${mainMap.DISCOUNT}"
		                                               name="DISCOUNT" id="DISCOUNT"/>${mainMap.DISCOUNT}</td>
