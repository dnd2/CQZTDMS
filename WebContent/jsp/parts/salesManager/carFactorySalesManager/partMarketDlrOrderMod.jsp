...
function showAcount(accountId, accountSum, accountKy, accountDj) {
    ...
    if (accountId != "") {
        ...
        document.getElementById("accountKyTextTd").innerHTML = '<input id="accountKy"   name="accountKy" type="text" value="' + accountKy + '" class="normal_txt" readonly /><font color="blue">元</font>';
...
function directTransport() {
    ...
    document.getElementById("accountKyNameTd").innerHTML = "可用金额：";
    document.getElementById("accountKyTextTd").innerHTML = '<input id="accountKy"   name="accountKy" type="text" value="' + ${acountMap.ACCOUNT_KY} +'" class="middle_txt" readonly /><font color="blue">元</font>';
    document.getElementById("accountDjNameTd").innerHTML = "冻结金额：";
...
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件销售管理&gt;采购订单&gt;市场升级订单修改</div>
<table class="table_add" border="0"
    ...
    <tr>
        ...
        <td style="display: none">
            <input name="SELLER_NAME" class="middle_txt" id="SELLER_NAME" type="hidden" value="${mainMap.SELLER_NAME}"
                   size="20" readonly="readonly"/>${mainMap.SELLER_NAME}
    ...
    <tr>
        ...
        <td>
            ...
            <select name="TRANS_TYPE" id="TRANS_TYPE" class="short_sel" style="display: none">
    ...
    <tr>
        ...
        <td colspan="3">
            <input name="ADDR" class="maxlong_txt" id="ADDR" type="text" size="20" value="${mainMap.ADDR}"
                   readonly="readonly" style="border: none"/>
    ...
    <tr>
        ...
        <td><input id="POST_CODE" name="POST_CODE" type="text" class="normal_txt" value="${mainMap.POST_CODE}"
   ...
   --%>
        ...
        <td id="accountSumTextTd">
            <input id="accountSum" name="accountSum"
        ...
        <td id="accountKyTextTd">
            <input id="accountKy" name="accountKy"
                   type="text" value="${dataMap.currAcountMap.ACCOUNT_KY}" class="normal_txt"
                   readonly style="border: none"/><font color="blue">元</font></td>
        <td id="accountDjNameTd" align="right"><span
                align="right">冻结金额：</span></td>
        <td id="accountDjTextTd">
            <input id="accountDj" name="accountDj" type="text"
                   value="${dataMap.currAcountMap.ACCOUNT_DJ}" class="normal_txt" readonly style="border: none"/><font
                color="blue">元</font></td>
    </tr>
    <tr id="tr2">
        <td id="AmountNameTd" align="right">订货总金额：</td>
        <td id="AmountTextTd"><input id="Amount" name="Amount" type="text"
                                     value="${mainMap.ORDER_AMOUNT} " class="normal_txt" readonly style="border: none"/><font
                color="blue">元</font></td>
        <td align="right" style="display: none">运费：</td>
        <td><input id="freight" name="freight" type="text" class="short_txt" style="display: none"
                   value="${mainMap.FREIGHT}" readonly/></td>

    </tr>
    <tr id="tr3">
        <td id="DISCOUNTNameTd" align="right" style="display: none">折扣率：</td>
        <td id="DISCOUNTTextTd" style="display: none">
            <input readonly class="middle_txt" type="text"
                   value="${mainMap.DISCOUNT}"
                   name="DISCOUNT" id="DISCOUNT"/></td>
        <td align="right"><span align="right"></span></td>
        <td></td>
        <td align="right"></td>
        <td></td>
    </tr>
