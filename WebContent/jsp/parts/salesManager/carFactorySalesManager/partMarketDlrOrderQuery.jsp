...
<head>
    ...
    <script language="javascript">
        ...
        var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrderCheck/partDlrOrderQuery.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_07%>;
