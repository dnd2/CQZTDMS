...
var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/queryPartDlrOrder.json?ORDER_TYPE=" +<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_07%>;
...
function modifyOrder(value) {
    disableAllClEl();
    window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/modifyDlrOrder.do?modifyFlag=market&&orderId=" + value;
}
//作废
...
function addOrder() {
    disableAllClEl();
    window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/addMarketOrder.do?";
...
<form name="fm" id="fm" method="post" enctype="multipart/form-data">
    <input id="ORDER_TYPE" name="ORDER_TYPE" type="hidden"
           value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_07%>"/>

    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 配件管理 &gt;配件销售管理&gt;广宣订单提报</div>
        <table border="0" class="table_query">
            ...
            <tr>
                ...
                <td width="20%" align="left"><input class="short_txt" id="SCREATE_DATE" name="SCREATE_DATE"
                ...
                <td width="20%" align="left"><input class="short_txt" id="SSUBMIT_DATE" name="SSUBMIT_DATE"
                                                    style="width:65px"
                                                    datatype="1,is_date,10" maxlength="10"
