...
<head>
    ...
    <script language="javascript">
        ...
        var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartReplacedDlrOrder/partDlrOrderQuery.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_04%>;
        ...
        function detailOrder(value, code) {
            disableAllClEl();
            window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartReplacedDlrOrder/detailDlrOrder.do?orderId=" + value + "&&orderCode=" + code;
        }
        //审核
...
<input id="planFlag" name="planFlag" value="${planFlag}" type="hidden" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath %>/img/nav.gif" alt=""/>&nbsp;当前位置： 配件管理>配件采购管理>切换订单审核
        </div>
