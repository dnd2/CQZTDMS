...
<head>
<title>常规订单提报-初始化查询</title>
</head>
<script language="javascript">
//初始化查询TABLE
var myPage;
var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/queryPartDlrOrder.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_02%>;
var title = null;
var columns = [
...
function addOrder() {
    disableAllClEl();
    window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/addOrder.do?";
...
<input id="ORDER_TYPE" name="ORDER_TYPE" type="hidden"  value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_02%>" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 配件管理 &gt;配件采购管理&gt;常规订单提报</div>
        <div class="form-panel">
	        ...
	        <table border="0" class="table_query">
	            ...
	            <td width="10%" class="right">订单状态：</td>
	                ...
	                <td width="22%" class="left"><input class="short_txt" id="SCREATE_DATE" name="SCREATE_DATE"
	                ...
	                <td width="22%" class="left">
	                	<input class="short_txt" id="SSUBMIT_DATE" name="SSUBMIT_DATE" style="width:80px"
	                           datatype="1,is_date,10" maxlength="10" group="SSUBMIT_DATE,ESUBMIT_DATE"/>
