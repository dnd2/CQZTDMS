    ...
    for (var i = 1; i < mt.rows.length; i++) {
        ...
        if (mt.rows[i].cells[1].firstChild.checked) {
            if (validateCell(partId)) {
                ...
                var partOldcode = mt.rows[i].cells[4].innerText;  //配件编码
...
function addCell(partId, partCode, partOldcode, partCname, unit, itemQty, minPackage, buyPrice, upOrgStock, isLack, isReplaced,saleQty) {
    ...
    countAll();
    if(saleQty!=""){
    	countMoney(document.getElementById("buyQty_"+partId),buyPrice,partId);
    }
}
//校验是否重复生成
...
function uploadExcel() {
    var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/uploadExcel.json";
...
<body onload="loadcalendar();autoAlertException();enableAllBtn();doInit()">
...
<input type="hidden" name="ORDER_TYPE" id="ORDER_TYPE" value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_08%>" />
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件采购管理&gt;配件促销订单提报&gt;新增</div>
<table class="table_add" border="0"
    ...
    <tr >
        ...
        <td>
            <input name="SELLER_NAME" class="middle_txt" id="SELLER_NAME" type="text"  size="20" readonly="true"/>
            <input name="SELLER_CODE" class="middle_txt" id="SELLER_CODE" type="hidden" readonly="true"/>
            <input name="SELLER_ID" class="middle_txt" id="SELLER_ID" type="hidden" readonly="true"/>
        ...
        <td  class="table_add_3Col_label_6Letter" nowrap></td>
        <td ></td>
    </tr>
    <tr>
        <td class="table_add_3Col_label_6Letter">订货单位：</td>
        <td>${dataMap.dealerName}<input readonly type="hidden" style="border:0px;background-color:#F3F4F8;" 
                                        value="${dataMap.dealerName}" name="dealerName" id="dealerName"/></td>
        <td class="table_add_3Col_label_6Letter">订货人：</td>
        <td><input readonly type="text" style="border:0px;background-color:#F3F4F8;" value="${dataMap.buyerName}"
                   name="buyerName" id="buyerName"/></td>
        <td class="table_add_3Col_label_6Letter">订货日期：</td>
    ...
    <tr>
        ...
        <td class="table_add_3Col_label_6Letter"></td>
        <td>
    ...
    <tr id="tr2" >
        <td id="accountSumNameTd" class="table_add_3Col_label_6Letter"></td>
        <td id="accountSumTextTd"></td>
        <td id="accountKyNameTd" class="table_add_3Col_label_6Letter"></td>
        <td id="accountKyTextTd"></td>
        <td id="accountDjNameTd" class="table_add_3Col_label_6Letter"><span
                class="table_add_3Col_label_6Letter"></span></td>
        <td id="accountDjTextTd"></td>
    ...
    <tr id="tr3">
        ...
        <td id="DISCOUNTTextTd"><input readonly type="text" no_border_txt
                                       value="${dataMap.discount}" name="DISCOUNT" id="DISCOUNT"/></td>
        <td class="table_add_3Col_label_6Letter" valign="middle">总金额：</td>
        <td valign="middle"><input readonly type="text" value="0.00" no_border_txt
                                   name="Amount" id="Amount"/><font color="blue">元</font></td>
        <td class="table_add_3Col_label_6Letter"><span class="table_add_3Col_label_6Letter"></span></td>
        <td></td>
    </tr>
    <tr>
        <td class="table_add_3Col_label_6Letter">备注：</td>
        <td colspan="5"><textarea name="textarea" cols="80" rows="4" class="middle_txt"></textarea></td>
    </tr>
</table>
<FIELDSET>
    <LEGEND  
    ...
    <tr align="center">
        <td>
            <input class="cssbutton" type="button" value="上传文件" name="button1"
                   onclick="showUpload();"> &nbsp;
            <input class="cssbutton" type="button" value="保存" name="button1" onclick="partReplaceValidate('save');">
            &nbsp;
