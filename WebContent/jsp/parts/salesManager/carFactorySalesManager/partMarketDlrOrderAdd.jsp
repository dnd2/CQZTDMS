...
<input type="hidden" name="ORDER_TYPE" id="ORDER_TYPE" value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_07%>" />
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件销售管理&gt;直发采购订单&gt;新增</div>
