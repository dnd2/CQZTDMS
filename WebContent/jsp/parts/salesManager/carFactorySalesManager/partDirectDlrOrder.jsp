...
<head>
<title>配件委托订单提报</title>
</head>
<script language="javascript">
    //初始化查询TABLE
    var myPage;
    var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/queryPartDlrOrder.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_04%>;
    var title = null;
    var columns = [
    ...
    function modifyOrder(value) {
        disableAllClEl();
        window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/modifyDlrOrder.do?modifyFlag=direct&&orderId=" + value;
    }
    //作废
    ...
    function addOrder() {
        disableAllClEl();
        window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/addDirectOrder.do?";
...
<input id="ORDER_TYPE" name="ORDER_TYPE" type="hidden" value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_04%>" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt;配件采购管理&gt;配件委托订单提报</div>
        <div class="form-panel">
	        ...
	        <table border="0" class="table_query">
	            ...
	            <tr>
	                ...
	                <td width="20%" align="left"><input class="short_txt" id="SCREATE_DATE" name="SCREATE_DATE" value="${old}" style="width:80px"
