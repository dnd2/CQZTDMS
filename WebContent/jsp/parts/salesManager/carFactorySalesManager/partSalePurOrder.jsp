...
<head>
<title>销售采购订单提报</title>
</head>
<script language="javascript">
//初始化查询TABLE
var myPage;
var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/queryPartDlrOrder.json?ORDER_TYPE="+<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_12%>;
var title = null;
var columns = [
...
function modifyOrder(value) {
    disableAllClEl();
    window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/modifyDlrOrder.do?orderId=" + value;
}
//作废
...
function addOrder() {
    disableAllClEl();
    window.location.href = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/addSalePurOrder.do?";
...
<input id="ORDER_TYPE" name="ORDER_TYPE" type="hidden"  value="<%=Constant.CAR_FACTORY_SALES_MANAGER_ORDER_TYPE_12%>" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 配件管理 &gt;配件采购管理&gt;销售采购订单提报</div>
        <div class="form-panel">
	        ...
	        <table border="0" class="table_query">
	            <tr>
	                ...
	                <td width="20%" class="left"><input class="middle_txt" type="text" id="SELLER_NAME" name="SELLER_NAME"/>
	                </td>
	                </tr>
	            <tr>
	            <td width="10%"class="right">订单状态：</td>
	                ...
	                <td width="22%" class="left">
	                    ...
	                    <input class="time_ico" value=" " onclick="showcalendar(event, 'SCREATE_DATE', false);" type="button"/>
	                   	 至
	                    <input class="short_txt" id="ECREATE_DATE" name="ECREATE_DATE" 
	                    	datatype="1,is_date,10" value="${now}" style="width:80px"
	                ...
	                <td width="22%" class="left">
	                	<input class="short_txt" id="SSUBMIT_DATE" name="SSUBMIT_DATE" style="width:80px"
	                           atatype="1,is_date,10" maxlength="10" group="SSUBMIT_DATE,ESUBMIT_DATE"/>
	                    ...
	                    <input class="time_ico" value=" " onclick="showcalendar(event, 'ESUBMIT_DATE', false);" type="button"/>
	                </td>
	            </tr>
	            <tr>
