...
<script language="javascript">
    ...
    var url = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartOemDlrOrder/queryOemPartDlrOrder.json";
    ...
    var columns = [
        ...
        {header: "总金额(元)", dataIndex: 'ORDER_AMOUNT', align: 'right'},
    ...
    function exportEx() {
        ...
        fm.action = "<%=contextPath%>/parts/salesManager/carFactorySalesManager/PartDlrOrder/exportOemPartPlanExcel.do";
        fm.submit();
    }
...
<input name="ORDER_TYPE" id="ORDER_TYPE" type="hidden" value="${orderType}" />
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 配件管理 &gt;配件销售管理&gt;常规订单提报</div>
        <table border="0" class="table_query">
            ...
            <td width="10%" align="right">订单状态：</td>
                ...
                <td width="20%" align="left"><input class="short_txt" id="SCREATE_DATE" name="SCREATE_DATE"  value="${now}" style="width:80px"
