...
<head>
    ...
    <meta http-equiv="keywords" content="销售明细">
...
<body>
<div class="wbox">
    <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 报表管理&gt;配件报表&gt;本部销售报表&gt;销售明细</div>
    ...
    <script type="text/javascript">
        jQuery.noConflict();
        var myPage;
        var url = "<%=contextPath%>/report/partReport/partOderGoodsDetailReport/PartOderGoodsDetailAction/query.json";
        var title = null;
        var columns = [];
        function callBack(json) {
            ...
            if (ps.records != null) {
                columns = [
                    ...
                    {header: "出库日期", dataIndex: "SUBMIT_DATE", align: 'center'},
        ...
        jQuery(function () {
            ...
            jQuery(document).on('click', '#exportBtn', function () {
                fm.action = "<%=contextPath%>/report/partReport/partOderGoodsDetailReport/PartOderGoodsDetailAction/exportExcel.do";
                fm.submit();
            })
