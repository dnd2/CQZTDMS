	...
	<div class="wbox">
		<form name="fm" id="fm" method="post" enctype="multipart/form-data">
			...
			<div class="navigation">
				<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：配件管理 &gt; 配件零售领用管理 &gt; 配件零售单 &gt; 修改
			</div>
				...
				<div class="form-body">
					<table class="table_query">
						...
						<tr>
							...
							<td colspan="5">
								<textarea class="form-control align" style="width: 83.6%" id="remark" name="remark" cols="4" rows="4">${map.REMARK }</textarea>
							</td>
						</tr>
					</table>
				</div>
