...
<form method="post" name="fm" id="fm">
    <div style="width: 100%; min-height: 600px;">
        ...
        <div style="width: 100%; line-height: 25px;">
            ...
            <div style="width: 30%;">
                <c:choose><c:when
                        test="${'res' eq pageType}">零售</c:when><c:otherwise>领用</c:otherwise></c:choose>单号：${map.RETAIL_CODE}
            </div>
            <div style="width: 30%;"> 制单日期：${currDate}</div>
        </div>
        <div style="width: 100%; line-height: 25px;">
            <div style="width: 35%;margin-left: 1%;"><c:choose><c:when
                    test="${'res' eq pageType}">采购单位</c:when><c:otherwise>领用人</c:otherwise></c:choose>：${map.LINKMAN}</div>
            <div style="width: 30%;"> 联系电话：${map.TEL}</div>
            <div style="width: 30%;"> 用途：${map.PURPOSE}</div>
        </div>
        <div style="width: 100%; line-height: 25px;">
            <div style="width: 35%;margin-left: 1%;">备注：${map.REMARK}</div>
