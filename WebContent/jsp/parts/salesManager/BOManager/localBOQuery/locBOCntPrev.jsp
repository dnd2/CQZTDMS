...
<body>
  ...
  <table class="table_query">
       <tr>            
		...
		<td width="25%">
			<input id="checkSDate" class="middle_txt"
			...
			type="button" />至 
			<input id="checkEDate"
			class="middle_txt" name="checkEDate" datatype="1,is_date,10"
...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/parts/salesManager/BOManager/locBOQueAction/locBOCountSearch.json";
	var title = null;
	var columns = [
	...
	function exportLocBoCntExcel(){
		document.fm.action="<%=contextPath%>/parts/salesManager/BOManager/locBOQueAction/exportLocBoCountExcel.do";
