...
<head>
    ...
    <title>月度目标查询(供应中心)</title>
</head>
<body onload="dtlQuery();">
<form name="fm" method="post" enctype="multipart/form-data" id="fm">
    <div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif">当前位置&gt;配件管理&gt;服务商月度目标&gt;月度目标完成(中心)</div>
    <table class="table_query">
        ...
        <tr>
            ...
            <td width="30%"><input type="text" class="middle_txt" name="dealerCode" id="dealerCode" size="17" value=""/>
    ...
    <div style="width: 100%; height: 30px; float: left; " id="countDiv">
     ...
     <div style="width: 40%; height: 30px; line-height: 30px; float: left; text-align: right; background-color: #DAE0EE;">
...
<script type="text/javascript">
    ...
    function dtlQuery() {
        ...
        url = "<%=contextPath%>/parts/monthPlan/MonthPlanManager/planQueryGyzx.json";
        if (queryType == '0' || month == '') {
            ...
            columns = [
                ...
                {header: "供应中心代码", dataIndex: 'SELLER_CODE', align: 'center', style: 'width: 10%;'},
                {header: "供应中心名称", dataIndex: 'SELLER_NAME', align: 'center', style: 'text-align:left'},
                ...
                //{header: "供应中心已销售金额(万元/不含税)", dataIndex: 'GY_AMOUNT', align: 'center', style: 'width: 15%;'},
                //{header: "供应中心完成率", dataIndex: 'GY_RATIO', align: 'center', style: 'width: 15%;'},
    ...
    function collQuery() {
    	url = "<%=contextPath%>/parts/monthPlan/MonthPlanManager/planCountQueryGyzx.json";
    	var year = document.getElementById("year").value;
    	var month = document.getElementById("month").value;
    	var month2 = document.getElementById("month2").value;
    	var countDivObj = document.getElementById("countDiv");
    ...
    {
    	var url = "<%=contextPath%>/parts/monthPlan/MonthPlanManager/normalCountQueryGyzx.json";	
    ...
    {
    	var url = "<%=contextPath%>/parts/monthPlan/MonthPlanManager/countAmountQueryGyzx.json";	
		sendAjax(url,countResult,'fm');
    }
  ...
  //千分格式
    ...
    function downloadFile() {
        fm.action = '<%=contextPath%>/parts/monthPlan/MonthPlanManager/downloadDataGyzx.do';
        fm.submit();
    }
    function downloadFile1() {
        fm.action = '<%=contextPath%>/parts/monthPlan/MonthPlanManager/downloadDataGyzx1.do';
        fm.submit();
    }
</script>
</body>
