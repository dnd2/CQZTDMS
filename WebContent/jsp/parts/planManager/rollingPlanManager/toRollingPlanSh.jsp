        ...
        <table class="table_query" bordercolor="#DAE0EE">
            ...
            <tr>
                <td class="center" colspan="6">
                	...
                	<input type="button" class="normal_btn" onclick="shPass();" value="审核通过"/>&nbsp;
                </td>
            </tr>
        </table>
        </div>
       ...
       // autoAlertException();//输出错误信息
        ...
        function goback(){
        	if('${planTypes}'=='<%=Constant.PART_PURCHASE_PLAN_TYPE_01%>'){
        		location = '<%=contextPath%>/parts/planManager/PartPlanManager/toPartPlanValidationGys.do';
        	}else{
        ...
        function shPass(){
        	MyConfirm('确认审核通过计划?',function(){
        			var urlkey = "<%=contextPath%>/parts/planManager/PartPlanManager/shPlanByPlineId1.json";
