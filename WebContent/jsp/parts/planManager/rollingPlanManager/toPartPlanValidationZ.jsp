...
<div class="wbox">
    <form name='fm' id='fm' method="post" enctype="multipart/form-data">
        <div class="navigation">
            <img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：总部采购管理&gt; 采购计划管理 &gt; 周度需求计划审核
        </div>
...
<script type="text/javascript">
    ...
    //修改
    function edit(value){
    	location = "<%=contextPath%>/parts/planManager/PartPlanManager/toRollingPlanShZ.do?planId="+value+"&planTypes=<%=Constant.PART_PURCHASE_PLAN_TYPE_01%>";
    }
    //滚动计划提交
    ...
    function confirmUploadUpdate() {
    	var planYearImp = $('#planYearImp').val();
    	var planMonthImp = $('#planMonthImp').val();
    	if(planYearImp==''){
    		MyAlert('请选择计划年份');
    		return;
    	}
