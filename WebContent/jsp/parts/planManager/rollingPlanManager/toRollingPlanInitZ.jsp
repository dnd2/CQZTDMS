...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
        	//disableAllClEl();
            fm.action = "<%=contextPath%>/parts/planManager/PartPlanManager/addPurchasePlan.do";
            fm.submit();
        }
    </script>
</head>
...
<div class="wbox">
    <form name='fm' id='fm' method="post" enctype="multipart/form-data">
        <div class="navigation">
            <img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置：配件管理&gt; 采购计划管理 &gt; 周度需求计划编制
        </div>
        <input type="hidden" id="PLAN_TYPES" name="PLAN_TYPES" value="<%=Constant.PART_PURCHASE_PLAN_TYPE_04 %>" />
        ...
        <table class="table_query">
            ...
            <tr id="tr1">
                <td colspan="6" class="center">
                    ...
                    &nbsp;
                	<input  class="u-button" type="button" value="新 增" name="button1" onclick="add()">
                	&nbsp;
                    <input class="u-button"  style="width:120px;" type="button" value="导入周度计划" name="button5" onclick="showUpload('uploadDiv');">
                </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    var columns = [
             ...
             {header: "计划类型", dataIndex: 'PLAN_TYPES', align: 'center',renderer:getItemValue},
             {header: "计划明细个数", dataIndex: 'PLAN_NUMS', align: 'center'},
    ...
    //查看
    function view(value) {
        location = "<%=contextPath%>/parts/planManager/PartPlanManager/toRollingPlanSelect.do?planId="+value+"&planTypes=<%=Constant.PART_PURCHASE_PLAN_TYPE_04%>";
    }
    //修改
    function edit(value){
    	location = "<%=contextPath%>/parts/planManager/PartPlanManager/toRollingPlanEdit.do?planId="+value+"&planTypes=<%=Constant.PART_PURCHASE_PLAN_TYPE_04%>";
    }
    //滚动计划提交
