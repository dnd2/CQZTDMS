...
<div class="wbox">
    ...
    <form method="post" name="fm" id="fm" enctype="multipart/form-data">
        ...
        <table class="table_query" >
            ...
            <tr>
                ...
                <td width="22%">
                    <div align="left">
                        <input name="inBeginTime" id="t3" value="${old}" type="text" class="short_txt" datatype="1,is_date,10"
                               group="t3,t4">
                        <input name='button3' value=" " type='button' class='time_ico' title="点击选择时间"
                               onclick="showcalendar(event, 't3', false);"/>
                       至
                        <input name="inEndTime" id="t4" value="${now}" type="text" class="short_txt" datatype="1,is_date,10"
                               group="t3,t4">
                        <input name='button3' value=" " type='button' class='time_ico' title="点击选择时间"
            ...
            <tr>
                <td align="center" colspan="6"><input name="BtnQuery" id="queryBtn" type="button" class="normal_btn"
                    ...
                    &nbsp;<input name="button" type="button" class="normal_btn" onclick="exportPurchaseOrderExcel();"
                                 value="导出"/>&nbsp;&nbsp;    </td>
            </tr>
        </table>
    ...
    <script type="text/javascript">
        ...
        var myPage;
        var url = "<%=contextPath%>/parts/purchaseOrderManager/PurchaseOrderQuery/queryPurchaseOrderDetailInfo.json";
        var title = null;
        var columns = [
            ...
            {header: "采购员", dataIndex: 'BUYER', style: 'text-align:left'},
            {header: "配件类型", dataIndex: 'PART_TYPE', style: 'text-align:left', renderer: getItemValue},
            {header: "配件编码", dataIndex: 'PART_OLDCODE', style: 'text-align:left'},
            {header: "配件名称", dataIndex: 'PART_CNAME', style: 'text-align:left'},
            {header: "配件件号", dataIndex: 'PART_CODE', style: 'text-align:left'},
            {header: "包装单位", dataIndex: 'UNIT', style: 'text-align:left'},////
            {header: "订购数量", dataIndex: 'BUY_QTY', style: 'text-align:left'},
            {header: "已验货数量", dataIndex: 'CHECK_QTY', style: 'text-align:left'},
            ...
            {header: "结算金额", dataIndex: 'BAL_AMOUNT', style: 'text-align:right'},
        ...
        //导出
        function exportPurchaseOrderExcel() {
            fm.action = "<%=contextPath%>/parts/purchaseOrderManager/PurchaseOrderQuery/exportPurchaseOrderExcel.do";
            fm.target = "_self";
            fm.submit();
        }
    </script>
