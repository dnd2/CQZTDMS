...
<div class="wbox">
    <div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>&nbsp;当前位置： 报表管理&gt;配件报表&gt;配件销售报表&gt;物流到货及时率
    </div>
        ...
        <table class="table_query" width=100% border="0" align="center" cellpadding="1" cellspacing="1">
            ...
            <tr>
                <td colspan="6" align="center">
                    ...
                    <input type="checkbox" id="cb" name="cb" value="0" checked onclick="changeValue(this);"/>不显示补单和自提
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        var myPage;
        var url = "<%=contextPath%>/report/partReport/partStockReport/LogTimelyArrivalRateReport/query.json";
        var title = null;
            ...
            if (ps.records != null) {
                ...
                if (chk == 1) {//
                    columns = [
                        ...
                        {header: "承运物流-发运方式", dataIndex: 'TRANSPORT_ORG', align: 'center'},
//            {header: "发运方式", dataIndex: 'TRANS_TYPE', align: 'center'},
                        {header: "发运数量", dataIndex: 'TRCNT', align: 'center'},
                        {header: "及时到货数量", dataIndex: 'WLCNT', align: 'center'},
                    ...
                    columns = [
                        ...
                        {header: "要求到货时间", dataIndex: 'ARRIVE_DAYS', align: 'center'},
                        {header: "及时与否", dataIndex: 'WL', align: 'center', renderer: isJs}
                    ];
                }
                len = columns.length;
        ...
        function expPurOrderInExcel() {
            fm.action = "<%=contextPath%>/report/partReport/partStockReport/LogTimelyArrivalRateReport/expBoOrderIssueExcel.do";
            fm.target = "_self";
            fm.submit();
        }
