...
<div class="wbox">
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>&nbsp;当前位置：报表管理&gt;配件报表&gt;本部仓储报表&gt;配件待入库明细</div>
...
var myPage;
var url = "<%=contextPath%>/report/partReport/partStockReport/PurOrderInReport/queryPartsDInData.json";
...
var columns = [
    ...
    {header: "待入库数量", dataIndex: 'SPAREIN_QTY', style: 'text-align:left'},
    {header: "计划员", dataIndex: 'PLANER', style: 'text-align:left'},
    {header: "库管员", dataIndex: 'NAME', style: 'text-align:left'},//renderer: getItemValue
...
function expPurOrderInExcel() {
    fm.action = "<%=contextPath%>/report/partReport/partStockReport/PurOrderInReport/expPartsDInDataExcel.do";
    fm.target = "_self";
    fm.submit();
}
</script>
