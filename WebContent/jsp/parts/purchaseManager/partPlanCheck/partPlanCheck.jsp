...
<head>
    ...
    autoAlertException();//输出错误信息
        ...
        var url = "<%=contextPath%>/parts/purchaseManager/partPlanCheck/PartPlanCheck/queryPartPlanCheck.json";
        ...
        function myLink(value, meta, record) {
            return String.format("<a href=\"#\" onclick='check(\"" + value + "\")'>[审核]</a>");
        }


        function check(value) {
            window.location.href = "<%=contextPath%>/parts/purchaseManager/partPlanCheck/PartPlanCheck/partPlanView.do?planId=" + value;
        }
        ...
        function exportExcel() {
            fm.action = "<%=contextPath%>/parts/purchaseManager/partPlanCheck/PartPlanCheck/exportExcel.do";
            fm.submit();
        }
    </script>
</HEAD>
...
<form name="fm" id="fm" method="post" enctype="multipart/form-data">
    <div class="wbox">
        <div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置>配件管理>采购计划管理>计划审核</div>
        <table class="table_query" >
            ...
            <tr>
                ...
                <td width="20%" align="left">
                    ...
                    <input class="time_ico" value=" " onclick="showcalendar(event, 'SSUBMIT_DATE', false);" type="button"/>至
