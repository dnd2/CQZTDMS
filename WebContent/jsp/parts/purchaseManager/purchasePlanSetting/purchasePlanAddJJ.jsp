...
var columns = [
    ...
    {header: "<input type='checkbox'  name='ckbAll' id='ckbAll' onclick='selAll(this)'  />", dataIndex: 'PART_ID', align: 'center', renderer: seled},
...
function addPartDiv() {
    ...
    if($("PLAN_CYCLE").value==0){
    	MyAlert("订货提前期不能为0,请重新选择计划日期!");
    	return;
    } */
...
function changeDiv2(){
	$("t3").attachEvent('onpropertychange',function(o){
		if(o.propertyName=='value'){//如果是value属性才执行
			var t3 = $("t3").value;
			var partDiv = document.getElementById("partDiv");
		    var addPartViv = document.getElementById("addPartViv");
...
<div>
    <table class="table_query">
        ...
        <tr>
            ...
            <input type="hidden" name="planCode" value="${planCode}"/></td>
            <td width="10%"   align="right" >计划员:</td>
            <td align="left" width="20%">${name}
            <input type="hidden" name="planName" value="${name}"/></td>
        ...
        <tr>
            ...
            <td width="20%" align="left">
                ...
                <input name="beginTime2" id="t3" value="" type="text" readonly="readonly" class="short_txt" datatype="0,is_date,10">
            ...
            <td  width="20%" align="left">
                <script type="text/javascript">
                    genSelBoxExp("PLAN_TYPE", <%=Constant.PART_PURCHASE_PLAN_TYPE%>, "<%=Constant.PART_PURCHASE_PLAN_TYPE_02%>", false, "short_sel", "disabled=disabled", "false", '');
                </script>
                <font color="#FF000">*</font>
            </td>
            <td width="10%"   align="right">库房:</td>
            <td width="20%" align="left">
                <select name="wh_id" id="wh_id" class="short_sel" onchange="whChange(this.value)">
            ...
            <td width="20%" align="left">
                ...
                <input name="button" value=" " type="button" class="time_ico" title="点击选择时间" onclick="showcalendar(event, 't2', false);changeDiv1();" value="" />
            </td>
        </tr>
      <tr>
        ...
        <td width="10%"   align="right">总数量:</td>
            ...
            <td width="10%"   align="right">是否紧急入库:</td>
            <td width="20%" align="left">
               <script type="text/javascript">
                   genSelBoxExp("IS_URGENT_IN", <%=Constant.IF_TYPE%>, <%=Constant.IF_TYPE_NO%>, false, "short_sel", "", "false", '');
               </script>
            </td>
        </tr>
        <tr>
