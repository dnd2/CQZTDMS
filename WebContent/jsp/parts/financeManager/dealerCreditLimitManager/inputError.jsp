...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;销售主数据导入错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		window.location.href = '<%=contextPath%>/parts/financeManager/dealerCreditLimitManager/partDlrCrdLimitSetAction/partDealerAccQueryInit.do';
	}
	//失效按钮
	function btnDisable(){
