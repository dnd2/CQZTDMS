...
<script type="text/javascript">
	...
	var url = "<%=contextPath%>/parts/baseManager/activityPartSet/activityPartSetAction/queryPartsDialog.json";
	...
	function checkForm()
	{
		...
		btnDisable();
		var url = '<%=contextPath%>/parts/baseManager/activityPartSet/activityPartSetAction/insertActivityPartSet.json?parts='+parts;
