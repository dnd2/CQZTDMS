...
<script type="text/javascript">
	...
	function myCheckBox(value,meta,record){
		return String.format("<input type='checkbox' name='parts' value='"+record.data.PART_ID+"@@"+record.data.PART_CODE+"@@"+record.data.PART_OLDCODE+"@@"+record.data.PART_CNAME+"@@"+record.data.REPART_CNAME+"@@"+record.data.REPART_OLDCODE+"' />");
	}
