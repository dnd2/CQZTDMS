...
function myButton(value,metaDate,record){
	return String.format("<input type='button' name='delBtn' class='u-button' value='删除' onclick='del("+value+")'/>");
} 
function regionFun(){
	if($("YIELDLY").value==""){
		MyAlert("请先选择产地！");
...
{ 	
	if(checkData()==true){
		MyConfirm("确认添加该信息！",addLogistics);
	}
...
{ 
	...
	makeNomalFormCall("<%=contextPath%>/parts/baseManager/logisticsManage/LogisticsManage/addLogistics.json",addLogisticsBack,'fm','queryBtn'); 
}
...
<body>
	<div class="wbox">
		<div class="navigation">
			<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：配件管理 &gt; 基础信息管理 &gt; 配件基础信息维护 &gt; 物流商维护 &gt; 新增
		</div>
			...
			<div class="form-panel">
				...
				<div class="form-body">
					<table class="table_query">
						<tr>
							<td class="rigth" style="display: none">产地：</td>
						...
						<tr>
							...
							<td>
								<input type="text" class="middle_txt" name="LOGI_CODE" id="LOGI_CODE" />
								<span style="color: red">&nbsp;*</span>
							</td>
							<td class="right">物流商简称：</td>
							<td>
								<input type="text" class="middle_txt" name="LOGI_NAME" id="LOGI_NAME" />
								<span style="color: red">&nbsp;*</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="text" class="middle_txt" name="LOGI_FULL_NAME" id="LOGI_FULL_NAME" />
								<span style="color: red">&nbsp;*</span>
							</td>
							<td class="right">法人：</td>
							<td>
								<input type="text" class="middle_txt" name="CORPORATION" id="CORPORATION" />
							</td>
						</tr>
						<tr>
							<td class="right">联系人：</td>
							<td>
								<input type="text" class="middle_txt" name="CON_PER" id="CON_PER" />
							</td>
							<td class="right">联系人电话：</td>
							<td>
								<input type="text" class="middle_txt" name="CON_TEL" id="CON_TEL" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" class="middle_txt" style="width: 300px;" name="ADDRESS" id="ADDRESS" />
							</td>
						</tr>
						<tr>
							<td class="right">备注：</td>
							<td colspan="3">
								<textarea class="form-control" style="width: 80%;" rows="3" name="REMARK" id="REMARK"></textarea>
							</td>
						</tr>
						<tr />
						<tr>
