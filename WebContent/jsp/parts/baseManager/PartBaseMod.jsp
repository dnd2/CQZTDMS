...
// 	     if (submitForm('fm')) {
	         sendAjax('<%=contextPath%>/parts/baseManager/PartBaseQuery/partBaseMod.json', veiwParts, 'fm');
...
<!-- 				</td> -->
			...
			<tr>
				...
				<td colspan="5">
				<textarea id="REMARK" class="form-control remark" name="REMARK" cols="100" rows="4" maxlength="200"
