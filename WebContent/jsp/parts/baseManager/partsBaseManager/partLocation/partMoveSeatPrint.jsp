...
<table width="100%">
    <tr>
        <td align="center"><h1>配件移位单</h1></td>
    </tr>
</table>
<table class="main" cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td class="titleName">移库组织：</td>
        <td class="titleContent" colspan="4">&nbsp;${dataMap.org_name }</td>
        <td class="titleName">移库日期：</td>
        <td class="titleContent" colspan="4">&nbsp;${dataMap.create_date }</td>
    </tr>
    <tr>
        <td class="titleName">移入仓库：</td>
        <td class="titleContent" colspan="4">&nbsp;${dataMap.wh_name }</td>
        <td class="titleName">移出仓库：</td>
        <td class="titleContent" colspan="4">&nbsp;${dataMap.wh_name_2 }</td>
    </tr>
     <tr>
        <td class="list">备注：</td>
    ...
    <c:forEach items="${partList}" var="data">
        <tr>
            ...
            <td class="list">&nbsp;${data.PART_NUM }</td>
            <td class="list">&nbsp;${data.TOLOC_CODE }</td>
            <td class="list">&nbsp;${data.TOPART_NUM }</td>
        </tr>
    </c:forEach>
    ...
    <tr>
        ...
        <td class="list">${sumInQty.PART_NUM }</td>
        <td class="list">&nbsp;</td>
        <td class="list">${sumInQty.TOPART_NUM }</td>
    </tr>
</table>
<div>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
