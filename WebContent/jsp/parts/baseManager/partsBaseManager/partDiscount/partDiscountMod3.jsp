...
<body onload="__extQuery__(1);loadcalendar();showInfo();"> <!-- onunload='javascript:destoryPrototype();' -->
<div class="wbox">
			...
			<table class="table_edit">
				<tr>
					...
					<script type="text/javascript">
						genSelBoxExp("DISCOUNT_TYPE",<%=Constant.PART_DISCOUNT_TYPE%>,${po['DISCOUNT_TYPE'] },false,"short_sel u-select","disabled='disabled'","false",'');
					</script>
					</td>
					<td width="10%" class="table_query_right" align="right">有效日期：</td>
					<td width="35%">
							<input name="startDate" id="t1" value=' <fmt:formatDate value="${po['VALID_FROM'] }"/>' type="text" class="short_txt calendar-input-long" datatype="0,is_date,10" group="t1,t2">
							<input name='button3' type='button' class='time_ico' title="点击选择时间" value=" " />
							&nbsp;至&nbsp;
							<input name="endDate" id="t2" value='<fmt:formatDate value="${po['VALID_TO'] }"/>' type="text" class="short_txt calendar-input-long" datatype="0,is_date,10" group="t1,t2">
							<input name='button3' type='button' class='time_ico' title="点击选择时间" value=" " />
					</td>
				...
				<tr>
					...
					<td width="20%">
					<script type="text/javascript">
						genSelBoxExp("STATE",<%=Constant.STATUS%>,${po['STATE'] },false,"short_sel u-select","","false",'');
					</script>
					</td>
					<td  width="10%" class="table_query_right" align="right">配件：</td>
					<td  width="20%">
					<input class="middle_txt" type="text" name="PART_OLDCODE" id="PART_OLDCODE" datatype="1,is_null" readonly="readonly"/>
			...
			<table class="table_edit" width="100%">
				<tr>
					<td colspan="6" align="center">
						<input type="button" name="saveBtn" id="saveBtn" value="保存" onclick="updateDiscount();"  class="u-button"/>
						<input type="button" name="returnBtn" id="returnBtn" value="返 回"  onclick="javascript:goback();"  class="u-button u-cancel"/>
					</td>
				</tr>
			</table>
...
var columns = [
				...
				{header: "配件编码", dataIndex: 'DP_CODE', style: 'text-align: left;',renderer:InpurtText3},
				{header: "配件名称", dataIndex: 'DP_NAME', style: 'text-align: left;'},
