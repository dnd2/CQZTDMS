...
<form name="fm" id="fm" method="post"  enctype="multipart/form-data">
	...
	<table class="table_edit">
      ...
      <tr>
	       ...
	       <td width="10%" class="table_query_right" align="right">服务商类型：</td>
      		<td width="20%">
      		<select id="FIX_ID" name="FIX_ID">
	         <c:forEach items="${list}" var="fixType">
             <option value="${fixType.FIX_VALUE }" ${fixType.FIX_VALUE==po['DEALER_TYPE']?"selected":""}>${fixType.FIX_NAME }</option>
             </c:forEach>
	       </select>
	       </td>
          <td width="10%" class="table_query_right" align="right" >采购金额：</td>
          <td width="20%">  <input class="middle_txt" type="text" name="ORDER_AMOUNT" id="ORDER_AMOUNT" datatype="0,is_null" value="${po['ORDER_AMOUNT'] }"/> </td>
      </tr>
      <tr >
