...
//点击确认之后添加选中数据到配件销售人员区域范围设置表中
function doConfirmAdd(){
   var flag = doConfirmAddScope();
   if(!flag){
      MyAlert("请选择经销商!");
   }else{
    var url1 = "<%=contextPath%>/parts/baseManager/partsBaseManager/PartSalesScopeManager/addPartSalesScopeInfo.json";
...
<form method="post" name ="fm" id="fm" style="display:none">
  <table>
  <tr>
  <td>
	...
	<div id='pan' style="z-index: 3000;position:absolute;border:1px solid #5E7692;background: #FFFFFF; width: 715px;height: 379px;">
		<div id='myquery' style="z-index: 3001;position:absolute;border:1px solid #5E7692;width: 715px;height: 60px;">
			...
			<tr>
					...
					<td class="table_query_3Col_input" nowrap="nowrap">
						<input class="middle_txt" id="DRLCODE" datatype="1,is_noquotation,30" name="DRLCODE" onblur="isCloseDealerTreeDiv(event,this,'pan')" type="text" value="<%=inputCode %>"/>
					</td>
	    ...
	    <br />
	    	...
	    	<div id="sel">
	    	     ...
	    	     <input class="normal_btn" type="button" value="确认" onclick="doConfirmAdd();"/>
	    	</div>
	    	<script language="JavaScript">
	    	if(isMulti == "true")
