...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;趋势预测模型错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/baseManager/partsForecastManager/partsForecastQuery/partsForecastTrendInit.do";
		fm.submit();
	}
	//失效按钮
	function btnDisable(){
