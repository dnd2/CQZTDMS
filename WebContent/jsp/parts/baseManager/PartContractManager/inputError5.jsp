...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;采销协同批量修改错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/purchaseManager/scrollManager/SPConcert/SPConcertInit.do";
		fm.submit();
	}
	//失效按钮
	function btnDisable(){
