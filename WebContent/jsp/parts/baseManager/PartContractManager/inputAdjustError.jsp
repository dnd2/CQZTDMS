...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;任務調整金額错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/baseManager/articlesTask/TaskMoneyAdjust/TaskMoneyAdjustInit.do";
		fm.submit();
	}
	//失效按钮
	function btnDisable(){
