...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;备件需求预测错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/baseManager/partsForecastManager/PartNeedForecast/partNeedForecastInit.do";
		fm.submit();
	}
	//失效按钮
	function btnDisable(){
