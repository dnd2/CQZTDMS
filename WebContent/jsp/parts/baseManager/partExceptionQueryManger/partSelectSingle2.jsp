...
function selbyid(id, code, name){
	...
	var parentBox = parent || top;
	parentBox.frames['inIframe'].contentWindow.document.getElementById('PART_ID2').value = id;
	parentBox.frames['inIframe'].contentWindow.document.getElementById('PART_OLDCODE2').value = code;
	parentBox.frames['inIframe'].contentWindow.document.getElementById('PART_DATA2').value = name;
	_hide();
}
function returnBefore(){  
	var partOldcode = 'PART_OLDCODE2';
    var partCname = 'PART_DATA2';
    var partId = 'PART_ID2';
	...
	parentDocument = parent.frames['inIframe'].contentWindow;
...
<body onbeforeunload="returnBefore();">
	<div class="wbox">
		<div class="navigation">
			<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 基础信息管理 &gt; 配件基础信息维护 &gt; 设计变更维护 &gt; 选择配件
		</div>
		<form name='fm' id='fm'>
			...
			<div class="form-panel">
				...
				<div class="form-body">
					<table class="table_query">
						<tr>
							<td class="right" width="20%">配件编码：</td>
							<td width="30%">
