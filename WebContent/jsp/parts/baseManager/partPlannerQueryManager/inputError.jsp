...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/baseManager/partPlannerQueryManager/partPlannerQuery/partPlannerQueryInit.do";
		fm.submit();
	}
</script>
</head>
<body onload="autoAlertException();">
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;配件采购属性维护导入错误信息</div>
