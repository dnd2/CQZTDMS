...
<title>计划参数维护</title>
<style>ul.note-li{padding:10px}ul.note-li li{list-style-type: disc}ul.ch{margin-top:10px}</style>
</head>
...
<div class="wbox">
   ...
   <form name="fm" id="fm" method="post" enctype="multipart/form-data">
        <div class="form-panel">
            <h2><img src="/CQZTDMS/jmstyle/img/search-ico.png" class="panel-query-title"></h2>
            <div class="form-body">
