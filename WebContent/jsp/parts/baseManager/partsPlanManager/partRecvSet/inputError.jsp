...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;领用配件维护导入错误信息</div>
...
<script type="text/javascript">
	...
	function goBack(){
		btnDisable();
		fm.action = "<%=contextPath%>/parts/baseManager/partsPlanManager/partRecvSetAction/partRecvSetInit.do";
		fm.submit();
	}
	//失效按钮
	function btnDisable(){
