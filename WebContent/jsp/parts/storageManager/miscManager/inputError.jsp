...
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;杂项入库导入错误信息</div>
...
<script type="text/javascript">
	//返回
	function goBack(){
		var actionURL = "<%=contextPath%>/parts/storageManager/miscManager/MiscManager/MiscAddInit.do";
		fm.action = actionURL;
		fm.submit();
	}
</script>
