...
//返回
function goBack(){
	window.location.href = '<%=contextPath%>/parts/storageManager/miscManager/MiscManager/MiscMainInit.do';
}
</script>
</head>
<body>
	<div class="wbox">
		<div class="navigation">
			<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置:配件管理&gt;配件仓库管理&gt; 杂项入库(查看)
		</div>
		<form method="post" name="fm" id="fm">
			<div class="form-panel">
				<h2>
					<img class="nav" src="<%=contextPath%>/img/subNav.gif" /> 杂项入库单信息
				</h2>
				<div class="form-body">
