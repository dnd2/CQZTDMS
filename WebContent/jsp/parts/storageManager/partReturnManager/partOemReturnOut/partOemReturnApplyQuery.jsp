...
var myPage;
var url = "<%=contextPath%>/parts/storageManager/partReturnManager/PartOemReturnOutManager/queryPartOemReturnInfo.json";
var title = null;
var columns = [
...
function outPartReturn(value){
	window.location.href = '<%=contextPath%>/parts/storageManager/partReturnManager/PartOemReturnOutManager/queryPartOemReturnChkInit.do?returnId='+value;
}
...
<body>
	<div class="wbox">
		<div class="navigation">
			<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 配件管理&gt;配件仓库管理 >配件退货管理&gt;采购退货出库
		</div>
