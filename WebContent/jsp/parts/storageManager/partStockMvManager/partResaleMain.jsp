    ...
    <div class="wbox">
        <div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif"/>
            ...
            <input type="hidden" name="orderType" id="orderType"
                   value="<%=Constant.PART_SALE_STOCK_REMOVAL_TYPE_01 %>"/>
        </div>
        <table class="table_query">
            <th colspan="4"><img class="nav" src="<%=request.getContextPath()%>/img/subNav.gif"/> 查询条件</th>
            <tr>
                <td width="20%" align="right">零售单号：</td>
                <td width="30%">
                ...
                <td width="30%">
                    <script type="text/javascript">
                        genSelBoxExpStr("orderState", <%=Constant.PART_RESALE_RECEIVE_ORDER_TYPE%>, <%=Constant.PART_RESALE_RECEIVE_ORDER_TYPE_01%>, true, "short_sel", "onchange='__extQuery__(1)'", "false", "").toString();
                    </script>
                </td>
            </tr>
            <tr>
                <td width="20%" align="right">制单日期：</td>
                <td width="30%">
