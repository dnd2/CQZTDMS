...
function rejectOrderAction(value) {
    btnDisable();
    var url = "<%=contextPath%>/parts/storageManager/partStockMvManager/partStockMvAction/rejectMVorder.json?chgId=" + value + "&curPage=" + myPage.page;
...
<!-- 							<td> -->
<!-- 								<script type="text/javascript"> -->
<%--                         			genSelBoxExp("orderState", <%=Constant.PART_MV_STATUS%>, "<%=Constant.PART_MV_STATUS_02%>", true, "", "", "false", ""); --%>
<!-- 								</script> -->
<!-- 							</td> -->
						</tr>
						<tr>
