...
var url = "<%=contextPath%>/parts/storageManager/partStoInveManager/stockInvReqQueryAction/partStockDetailSearch.json";
...
var columns = [
			...
			{header: "批次号", dataIndex: 'BATCH_CODE'},
			...
			{header: "处理状态", dataIndex: 'IS_OVER', align:'center',renderer:handleState}
	      ];
...
function goBack(){
	btnDisable();
	//window.location = "<%=contextPath%>/parts/storageManager/partStoInveManager/stockInvReqQueryAction/stockInvReqQueryInit.do";
	...
	<div class="wbox">
		<form method="post" name="fm" id="fm">
			<div class="navigation">
				<img src="<%=request.getContextPath()%>/img/nav.gif" /> &nbsp;当前位置： 配件仓库管理&gt;库存盘点管理&gt;库存盘点调整查询&gt;查看
