...
// 		if(submitForm('fm')){
// 			if(confirm("确定新增？")){
				sendAjax('<%=contextPath%>/parts/storageManager/partStoInveManager/partBaseManager/validate.json?PART_CODE='+$("#PART_CODE").val(),showResult,'fm');
// 			}
// 		}
}
    ...
    function addPart(){
		sendAjax('<%=contextPath%>/parts/storageManager/partStoInveManager/partBaseManager/partBaseSave.json',veiwParts,'fm');
	}
