...
<body>
	<div class="navigation">
		<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 基础信息管理 &gt; 配件基础信息查询 &gt; 配件库存查询 &gt; 正常封存详情
	</div>
	<form name='fm' id='fm'>
			...
			<div class="form-body">
				<table class="table_query">
					<tr>
						...
						<td width="30%">
							<input class="long_txt" id="remark" name="remark" type="text" value="" />
						</td>
						<td width="20%" class="right">封存人：</td>
						<td width="30%">
							<input class="long_txt" id="fcName" name="fcName" type="text" value="" />
						</td>
					</tr>
					<tr>
