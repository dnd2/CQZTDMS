...
<body>
  ...
  <script type="text/javascript" >
	...
	var url = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockIOUProbAction/partStockIOUProbSearch.json";
	...
	function viewDetail(parms, option){
		btnDisable();
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockIOUProbAction/viewStockDeatilInint.do?changeId=" + parms + "&option=" + option;
	...
	function addNew(){
		...
		btnDisable();
		var actionURL = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockIOUProbAction/partStockAddInit.do";
	...
	function exportPartStockExcel(){
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockIOUProbAction/exportPartStockStatusExcel.do";
		document.fm.target="_self";
		document.fm.submit();
	}
