...
<body>
  ...
  <script type="text/javascript" >
	...
	var url = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockQuaProbAction/partStockQuaProbSearch.json";
	...
	function viewDetail(parms, option){
		btnDisable();
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockQuaProbAction/viewStockDeatilInint.do?changeId=" + parms + "&option=" + option;
	...
	function addNew(){
		...
		btnDisable();
		var actionURL = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockQuaProbAction/partStockAddInit.do";
	...
	function exportPartStockExcel(){
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockQuaProbAction/exportPartStockStatusExcel.do";
		document.fm.target="_self";
		document.fm.submit();
	}
