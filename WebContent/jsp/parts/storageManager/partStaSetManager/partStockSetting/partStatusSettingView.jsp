...
var url = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockSettingAction/partStockDetailSearch.json";
	...
	<div class="wbox">
		<form method="post" name="fm" id="fm">
			...
			<div class="navigation">
				<img src="<%=request.getContextPath()%>/img/nav.gif" /> &nbsp;当前位置： 配件仓库管理&gt;配件状态变更&gt;库存状态变更&gt;查看
			</div>
