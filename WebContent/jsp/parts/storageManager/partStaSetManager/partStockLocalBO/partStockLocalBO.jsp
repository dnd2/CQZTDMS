...
<body>
  ...
  <script type="text/javascript" >
	...
	var url = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockLocalBOAction/partStockLocalBOSearch.json";
	...
	function viewDetail(parms, option){
		btnDisable();
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockLocalBOAction/viewStockDeatilInint.do?changeId=" + parms + "&option=" + option;
	...
	function addNew(){
		...
		btnDisable();
		var actionURL = "<%=contextPath%>/parts/storageManager/partStaSetManager/partStockLocalBOAction/partStockAddInit.do";
	...
	function exportPartStockExcel(){
		document.fm.action="<%=contextPath%>/parts/storageManager/partStaSetManager/partStockLocalBOAction/exportPartStockStatusExcel.do";
		document.fm.target="_self";
		document.fm.submit();
	}
