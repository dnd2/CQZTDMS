...
function savePlan(){
	btnDisable();
	var url = "<%=contextPath%>/parts/storageManager/stockNumManager/StockNumApplyAction/saveStockNumApply.json";	
				...
				<div class="form-body">
					<table class="table_query">
						<tr>
							...
							<td>${changeCode}
								<input type="hidden" name="abjustmentCode" id="abjustmentCode" value="${changeCode}" />
							</td>
							<td class="right">调整类型：</td>
							<td>
								<script type="text/javascript">
									genSelBox("abjustmentType", <%=Constant.PART_ABJUSTMENT_TYPE%>,<%=Constant.PART_ABJUSTMENT_TYPE_01%>, true, "", "onchange=\"deleteAllTblRow(this)\"", "false");
								</script>
