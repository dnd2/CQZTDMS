...
function submitSure() {
	...
	var url = "<%=contextPath%>/zotye/service/baseInfo/FirstMaintenanceAction/firstMaintenaceInsert.json";
...
<body>
<div class="wbox">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理 &gt; 基础数据管理 &gt; 首保信息新增</div>
	...
	<table class="table_query" border="0">
		 <tr>
		 		...
		 		<td style="text-align: left">
		 			<input type="text" class="middle_txt" id="textMainMile" name="textMainMile" maxlength="8" onblur="chkVal(this.id) ;" value=""/>&nbsp;<font color="red">*</font>
		 		</td>
		 </tr>
		<tr>
			<td style="text-align: right">保养时间/天</td>
			<td style="text-align: left">
				<input type="text" class="middle_txt"  id="textMainDate" name="textMainDate" maxlength="8" onblur="chkVal(this.id) ;" value=""/>&nbsp;<font color="red">*</font>
			</td>
		</tr>
	</table>
	<br />
