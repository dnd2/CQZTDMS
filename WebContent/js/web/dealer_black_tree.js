 ...
 */
 ...
 var columns2 = [
				...
				{header: "代理商代码", dataIndex: 'dealerCode', align:'center'},
				{header: "代理商简称", dataIndex: 'dealerShortname', align:'center'}
		      ];
 ...
 function selectDealer(did,code,sname) {
	parentDocument.getElementById('DEALER_NAME').value = dlrName;
	parentDocument.getElementById('DEALER_ID').value = dlrId;
 	if($('DEPT_NAME') != null) {
 		$('DEPT_NAME').value = "";
 	}
 	if($('DEPT_ID') != null) {
