...
var areaId="<%=areaId%>";
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allDrlQuery.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType+"&isAllLevel=true";
...
{	var inputNames = document.getElementById("DEALER_NAME").value;
	...
	parentContainer.getAddressList();
}
	...
	<div id='pan' style="z-index: 3000;position:absolute;border:1px solid #5E7692;background: #FFFFFF; width: 715px;height: 379px;">
		<div id='myquery' style="z-index: 3001;position:absolute;border:1px solid #5E7692;width: 715px;height: 60px;">
			...
			<tr>
					...
					<td class="table_query_3Col_input" nowrap="nowrap" style="display: none">经销商类型：
					<script type="text/javascript">
		   	 			genSelBoxExp("dealerType",<%=Constant.DEALER_TYPE%>,"<%=Constant.DEALER_TYPE_DVS%>",true,"short_sel","","false",'');
					</script>	
					</td>
				</tr>
			<tr>
				<td class="table_query_3Col_label_5Letter" nowrap="nowrap">省份：</td>
				<td class="table_query_3Col_input" nowrap="nowrap">
