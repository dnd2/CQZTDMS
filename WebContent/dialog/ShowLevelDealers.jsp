...
var isMulti = "<%=isMulti%>";
var orgId = "<%=orgId%>";
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerNext/showNowNextQuery.json?COMMAND=1&ORGID="+orgId;
var tree_url = "<%=contextPath%>/sysmng/usemng/SgmDealerNext/initOrgTree.json?ORGID="+orgId;
function doInit()
{
	$('pan').setOpacity("0");
