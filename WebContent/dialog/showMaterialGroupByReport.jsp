...
var tree_url = "<%=ctx%>/materialGroup/MaterialGroupTree/materialGroupQueryByReport.json";
var inputId="<%=inputId%>";
...
var url = "<%=ctx%>/materialGroup/MaterialGroupTree/groupListQueryByReport.json";
//设置表格标题
var title= null;
//设置列名属性
