...
var url = "<%=ctx%>/materialGroup/MaterialGroupTree/groupListQuery_Sel111.json?area_id="+area_id;
//设置表格标题
var title= null;
//设置列名属性
...
function addMaterialGroupAction(groupId){
	if(area_id){
		fm.action = "<%=ctx%>/sysbusinesparams/businesparamsmanage/BusinessAreaManage/addMaterialGroup111.do?area_id="+area_id+"&groupId="+groupId;
		fm.submit();
