...
var areaId="<%=areaId%>";
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allDrlQuery.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType;
...
<!--				</td>-->
				...
				<td class="table_query_3Col_label_5Letter" nowrap="nowrap" style="display:none">区域：</td>
		...
		<div id='myquery1' style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 780px;top: 30px;height: 0px;">
    	...
    	<div id="drlv" style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 568px;height: 378px;  overflow-y: auto; overflow-x:hidden;">
	    <br />
	    	<table width="100%">
	    		<tr>
	    			<td>
