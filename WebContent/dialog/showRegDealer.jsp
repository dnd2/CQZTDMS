...
var areaId="<%=areaId%>";
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allRegDrlQuery.json?COMMAND=1&ORGID="+orgId+"&regCode="+regCode+"&AREA_ID="+areaId+"&isDealerType="+isDealerType;
