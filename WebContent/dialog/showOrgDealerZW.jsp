...
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allDrlQueryCon.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType+"&userId="+userId;
