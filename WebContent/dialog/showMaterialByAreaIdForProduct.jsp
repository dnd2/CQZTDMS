...
<body onunload='javascript:destoryPrototype()' onload="createModelTree(1);__extQuery__(1);" >
	<div id='dtree' class="dtree" style=" margin:2px;float:left;border-right:solid 1px;position:relative;">
...
var url = "<%=ctx%>/materialGroup/MaterialGroupTree/materialListQueryByAreaIdForProduct.json";
//设置表格标题
var title= null;
var page
//设置列名属性
var columns = [
				...
				{header: "物料代码",dataIndex: 'MATERIAL_CODE',width:"80px", style:'text-align:left;'},
