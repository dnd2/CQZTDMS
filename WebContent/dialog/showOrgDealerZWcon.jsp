...
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allDrlQueryZWCon.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType+"&userId="+userId;
