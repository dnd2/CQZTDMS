...
{	var inputNames = document.getElementById("DEALER_NAME").value;
	...
	{
		if(inputId&&inputId!='null'&&parentDocument.getElementById(inputId)){
			if (parent.$('inIframe')) 
			{
	...
	try{
		...
		//parentContainer.getModel(dealerCode,dealerId,dealerName);
 	}catch(e){
 	 	//MyAlert(e.message);
 		//window.close();
 	}
...
<body class="dealer-show-rel" onbeforeunload="test();"> <!-- onload="genLocSel('txt1','','','','','');doInit();" -->
<div class="wbox">	
	...
	<form id="fm" name="fm2">
		...
		<div id='pan' class="couple-panel">
				...
				<div class="form-panel">
					...
					<div class="form-body">
						<table class="table_info" border="0" style="height: 60px;" width="100%">
							<tr>
								<td class="table_query_3Col_label_5Letter right" nowrap="nowrap">经销商代码：</td>
								...
								<td class="table_query_3Col_label_5Letter right" nowrap="nowrap">经销商简称：</td>
								<td class="table_query_3Col_input" nowrap="nowrap">
			...
			<!--				</td>-->
								...
								<td class="btn-set" nowrap="nowrap" align="center">
									...
									<input name="button" type="button" class="u-button" onclick="_hide();" value="关 闭" />
