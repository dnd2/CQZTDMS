...
var areaId="<%=areaId%>";
var drlurl = "<%=contextPath%>/sysmng/usemng/SgmDealerSysUser/allDrlQueryForSCSJ.json?COMMAND=1&ORGID="+orgId+"&AREA_ID="+areaId+"&isDealerType="+isDealerType+"&inputId="+inputId;
...
{	var inputNames = document.getElementById("DEALER_NAME").value;
	...
	try{
		var dealerCode = document.getElementById("DEALER_CODE").value;
		var dealerId = document.getElementById("DEALER_IDS").value;
		var dealerName = document.getElementById("DEALER_NAME").value;
		parentContainer.getModel(dealerId,dealerCode,dealerName);
 	}catch(e){
 	 	//MyAlert(e.message);
 		window.close();
 	}
...
<form id="fm2" name="fm2">
	...
	<div id='pan' style="z-index: 3000;position:absolute;border:1px solid #5E7692;background: #FFFFFF; width: 780px;height: 440px;">
		<div id='myquery' style="z-index: 3001;position:absolute;border:1px solid #5E7692;width: 780px;height: 60px;">
...
<!--				</td>-->
		...
		<div id='myquery1' style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 780px;top: 5px;height: 0px;">
		<div id='dtree' class="dtree" style="z-index: 3000;position: absolute;overflow:auto;border:1px solid #5E7692;width: 210px;height: 410px;top: 30px;">
	        <script type="text/javascript">
	        	a = new dTree('a','dtree','false','false','true');
	        </script>
    	</div>
    	<div id="drlv" style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 568px;height: 410px;  overflow-y: auto; overflow-x:hidden;">
	    <br />
	    	<table width="100%">
	    		<tr>
	    			<td>
	    				<div id="_page2" style="display:none;"></div>
						<div id="myGrid2" style="overflow-y: auto"></div>
