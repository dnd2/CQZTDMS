...
<head>
	...
	<frameset id="orgFrame" cols="170,*"  framespacing="3" frameborder="1" borderCOLOR="#3A5B81" border=0>
		...
		<frame id="mainFrame" name="mainFrame" src="<%=contextPath %>/dialog/DiaOrgDealerRight.jsp" frameborder=0  leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin-right: 0px;margin-bottom: 0px;">		
	</frameset>
