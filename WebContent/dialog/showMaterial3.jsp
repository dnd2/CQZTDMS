...
var url = "<%=ctx%>/materialGroup/MaterialGroupTree/QueryColorName.json";
//设置表格标题
var title= null;
//设置列名属性
...
var columns = [
				...
				{header: "颜色",dataIndex: 'COLOR_NAME',  width:"10px",renderer:myLink}
//                 {header: "颜色",dataIndex: 'COLOR_NAME',  width:"10px"}
...
function myLink(value,meta,rec){
    ...
    {
    	return "<input type='radio' name='rd' value=\""+data.COLOR_NAME+"\"  onclick='setModel(\""+data.COLOR_NAME+"\")'>"+data.COLOR_NAME+"</input>";
    }
}
var setModel = function (COLOR_NAME){
