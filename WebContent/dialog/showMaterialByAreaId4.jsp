			...
			<tr>
			 ...
			 <td class="table_query_label" nowrap="nowrap">物料类型：</td>
			    <td class="table_query_input" nowrap="nowrap">
			    	<input type="hidden" name="mat_type" value="<%=Constant.MAT_TYPE_01%>"/>
			    	<script type="text/javascript">
				      	genSelBoxExp("mat_type1",<%=Constant.MAT_TYPE%>,<%=Constant.MAT_TYPE_01%>,false,"min_sel","disabled=true","false",'');
				    </script>
			    </td>
			    <%}else{ %>
