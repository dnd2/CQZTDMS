...
<%@page import="com.infodms.dms.dao.customerRelationships.ReviewManageDao" %>
<%@page import="java.util.List"%>
<%@page import="java.util.Map"%>
<%@ page import="com.infodms.dms.common.FileConstant"%>
<%@taglib uri="/jstl/cout" prefix="c"%>

<!-- created by andy.ten@tom.com 20100526 从题库中选择问题 -->
...
<script type="text/javascript" src="<%=contextPath %>/js/framecommon/examTree.js" charset="UTF-8"></script>
...
var areaId="<%=areaId%>";
var qrId="<%=qrId%>";
var drlurl = "<%=contextPath%>/customerRelationships/reviewmanage/ReviewManage/allDrlQuery.json?COMMAND=1&qrId="+qrId;
...
<form id="fm2" name="fm2">
	...
	<div id='pan' style="z-index: 3000;position:absolute;border:1px solid #5E7692;background: #FFFFFF; width: 715px;height: 379px;">
		<div id='myquery' style="z-index: 3001;position:absolute;border:1px solid #5E7692;width: 715px;height: 60px;">
			...
			<tr>
					<td class="table_query_3Col_label_5Letter" nowrap="nowrap">问题名称：</td>
					...
					<td class="table_query_3Col_input" nowrap="nowrap">
						<input class="middle_txt" id="DELSNAME" datatype="1,is_noquotation,30" name="DELSNAME" onblur="isCloseDealerTreeDiv(event,this,'pan')" type="hidden"/>
					</td>
				</tr>
			<tr>
				<td class="table_query_3Col_label_5Letter" nowrap="nowrap">题库：</td>
				<td class="table_query_3Col_input" nowrap="nowrap">
					<!--  --><select class="short_sel" id="txt1" name="downtown">
      				<option selected="selected" value="">-请选择-</option>
				   <% for(Map<String,Object> exam:examList){ %>
						<option value="<%=exam.get("EX_ID") %>" ><%=exam.get("EX_NAME") %></option>
				   <% } %>
				   </select>
				</td>
				<td class="table_query_3Col_label_5Letter" nowrap="nowrap">问题类型：</td>
				<td class="table_query_3Col_input" nowrap="nowrap">
					<script type="text/javascript">
		   	 			genSelBoxExp("dealerClass",<%=Constant.QD_QUE_TYPE%>,"",true,"short_sel","","false",'');
					</script>	
				</td>
				<td class="table_query_3Col_input" nowrap="nowrap"><input class="normal_btn" type="button" value="查 询" id="queryBtn2" onclick="getDrl(1)"/>
					<input class="normal_btn" type="hidden" value="重 置" onclick="requery2()"/></td>
			</tr>
			</table>
		</div>
		<div id='myquery1' style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 715px;top: 30px;height: 0px;">
		
    	<div id="drlv" style="z-index: 3000;position:absolute;border:1px solid #5E7692;width: 713px;height: 346px;  overflow-y: auto; overflow-x:hidden;">
	    <br />
	    	<table width="100%">
	    		<tr>
	    			<td>
	    	...
	    	<div id="sel">
	    	     ...
	    	     <input class="normal_btn" type="button" value="确认" onclick="doConfirm(<%=qrId%>)"/>
	    	</div>
	    	<script language="JavaScript">
	    	if(isMulti == "true")
