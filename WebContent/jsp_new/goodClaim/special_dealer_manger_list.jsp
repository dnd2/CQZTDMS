...
var myPage;
//查询路径
var url = "<%=contextPath%>/GoodClaimAction/specialServiceManagerList.json?query=true";
...
var columns = [
	...
	function myLink(value,meta,record){
		...
		var url="";
		if(20331002==status){
			var urlUpdate='<%=contextPath%>/GoodClaimAction/serviceManagerSpeInit.do?id='+value+'&special_type='+special_type+'&url=specialServiceManagerList';
