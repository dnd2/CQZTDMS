...
var myPage;
//查询路径
var url = "<%=contextPath%>/GoodClaimAction/specialClaimSettlementList.json?query=true";
...
<img src="../jsp_new/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;特殊费用管理&gt;善于索赔结算审核
</div>
<form name="fm" id="fm">
...
<table width=100% class="table_query">
	...
	<tr>
		...
		<td width="15%">
			<input name="dealerCode" id="dealerCode" onclick="showOrgDealer('dealerCode','dealerId','true','','true','','10771002');" type="text" class="middle_txt" readonly="readonly" />
