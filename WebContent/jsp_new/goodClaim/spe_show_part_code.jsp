...
<form name="fm" id="fm">
<input class="middle_txt" id="id" name="id" value="<%=id%>" maxlength="30" type="hidden"/>
<input class="middle_txt" id="id_name" name="id_name" value="<%=id_name%>" maxlength="30" type="hidden"/>
<!-- 查询条件 begin -->
<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	<tr>
        ...
        <td width="10%" style="text-align: right;" class="table_query_2Col_label_6Letter" nowrap="true">配件名称：</td>
      	<td width="15%" nowrap="true">
...
<script language="JavaScript" >
	...
	var url = "<%=contextPath%>/GoodClaimAction/queryPartCode.json";
	...
	function setData(v1,v2){
		...
		if (parent.$('inIframe')) {
			parentContainer.setPartCode(v1,v2,id,id_name);
 		} else {
			parent.setPartCode(v1,v2,id,id_name);
		}
 		_hide();
	}
