				...
				<tr>
   				...
   				<tr>
   				  <td nowrap="true" width="20%" >
						...
						<input  name="amount_old" type="hidden" class="middle_txt" value="30.0"/>
						<input  name="amount" class="middle_txt" value="30.0"/>
					</td>
					<td nowrap="true" width="20%" >
						...
						<c:if test="${t.IS_AGREE==1 }">
							<span>是</span>
							<input type="radio" name="is_agree" onclick="checkYes();" style='display:none' checked="checked" value="1"/>是
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_agree" onclick="checkNo();" style='display:none' value="0"/>否
						</c:if>
						<c:if test="${t.IS_AGREE==0}">
							<span>否</span>
							<input type="radio" name="is_agree" onclick="checkYes();" style='display:none' value="1"/>是
							&nbsp;&nbsp;&nbsp;
							<input type="radio" name="is_agree" onclick="checkNo();" style='display:none' checked="checked" value="0"/>否
						</c:if>
					</td>
