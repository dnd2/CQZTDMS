...
<script type="text/javascript">
	...
	function expotData(){
	   fm.action="<%=contextPath%>/ClearTransferAction/clearTransferExport.do";
       fm.submit();
	}
</script>
</head>
...
<img src="<%=contextPath%>/img/nav.gif" />&nbsp;当前位置：售后服管理&gt;索赔结算管理&gt;服务站结算转账明细
</div>
...
<script type="text/javascript" >
	var myPage;
	var url = "<%=contextPath%>/ClearTransferAction/clearTransferQuery.json";
	var title = null;
	var columns = [
		...
		{header: "结算总额", dataIndex: 'TOTAL_SETTLEMENT', align:'center'},
		...
		{header: "保养费", dataIndex: 'MAINTENANCE_AMOUNT', align:'center'},
