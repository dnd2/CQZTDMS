	...
	<table border="0" id="tab_2" cellpadding="1" cellspacing="1" class="table_edit" width="100%" style="text-align: center;">
		...
		<tr>
				...
				<td nowrap="true" width="30%" >
					<textarea style="font-weight: bold;" name="trouble_reason" id="trouble_reason" rows="4" cols="35" readonly="readonly">${t.TROUBLE_REASON }</textarea>
				</td>
				<td nowrap="true" width="30%" >
					<textarea style="font-weight: bold;" name="trouble_desc" id="trouble_desc" rows="4" cols="35" readonly="readonly">${t.TROUBLE_DESC }</textarea>
				</td>
 ...
 <div style="text-align: center;"  id="is_out">
			...
			<table id="accessories"  border="1" cellpadding="1" cellspacing="1" class="table_edit" width="80%" style="text-align: center;">
					...
					<tr>
						...
						<td nowrap="true" width="10%" >
							<input type="text" id="qt006Pass" name="qt006Pass" onblur="SumTotal(this)" class ="short_txt" value="${o.QT006_PASS }" readonly="readonly" ></input>
						</td>
						<td nowrap="true" width="10%" >
							<input type="text" id="qt007Pass" name="qt007Pass" onblur="SumTotal(this)" class ="short_txt" value="${o.QT007_PASS }" readonly="readonly"></input>
						</td>
						<td nowrap="true" width="10%" >
							<input type="text" id="qt008Pass" name="qt008Pass" onblur="SumTotal(this)" class ="short_txt" value="${o.QT008_PASS }" readonly="readonly"></input>
						</td>
						<td nowrap="true" width="10%" >
							<input type="text" id="qt009Pass" name="qt009Pass" onblur="SumTotal(this)" class ="short_txt" value="${o.QT009_PASS }" readonly="readonly"></input>
						</td>
						<td nowrap="true" width="10%" >
							<input type="text" id="qt001Pass" name="qt001Pass" onblur="SumTotal(this)" class ="short_txt" value="${o.QT001_PASS }" readonly="readonly"></input>
						</td>
					</tr>
			</table>
	</div>    
