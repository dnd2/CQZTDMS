	...
	<%	}%>
	   ...
	   <%  if(i == 0   ||  i % 2 == 0 ){%>
		...
		<%} %>
		  class="tab_printss" >
		<tr>
				<td align="center" width="76px" rowspan="3" nowrap="true" > <img src="<%=contextPath%>/img/chana/img.jpg"/> </td>
			...
			<tr>
				...
				<td align="center" width="35%" colspan="3" nowrap="true" style="padding:1px 1px 1px 1px;"><%=list_all.get(i).get("DEALER_SHORTNAME")%></td>
				<td  style="border: 0"> &nbsp; </td>
			...
			<tr>
				...
				<td align="center" width="35%" colspan="3" rowspan="2"><%=list_all.get(i).get("F_REASON") == null ? " "
			...
			<tr>
				...
				<td align="center" width="15%" colspan="1"nowrap="true">
				    <%=list_all.get(i).get("RO_CREATE_DATE") == null ? " ": list_all.get(i).get("RO_CREATE_DATE")%>
				</td>
				...
				<td align="center" width="15%" colspan="1" rowspan="4"nowrap="true"> 故障原因及处理结果</td>
				<td align="center" width="35%" colspan="3" rowspan="4"><%=list_all.get(i).get("F_REMARK") == null ? " ": list_all.get(i).get("F_REMARK")%></td>
			</tr>
			<tr>
