...
var myPage;
//查询路径
var url = "<%=contextPath%>/YsqAction/ysqEngineList.json?query=true";
...
var columns = [
	...
	function myLink1(value,meta,record){
		...
		var urlAudit="<%=contextPath%>/YsqAction/ysqEngineAudit.do?id="+value+"&vin="+vin+"&createBy="+createBy;
		if(res==9){//有维护件 无800
...
<img src="../jsp_new/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;索赔预授权管理&gt;预授权发动机部查询</div>
</div>
<form name="fm" id="fm">
<!-- 查询条件 begin -->
<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	...
	<tr>
		...
		<td width="15%">
			<script type="text/javascript">
         	genSelBoxExp("status",<%=Constant.STATUS_YSQ%>,"<%=Constant.STATUS_YSQ_03%>",true,"short_sel","","false",'93461001');
         	 </script>
		</td>
