...
var myPage;
//查询路径
var url = "<%=contextPath%>/YsqAction/ysqTechList.json?query=true";
...
var columns = [
		...
		function link_end(value,meta,record){
		 ...
		 function myLink1(value,meta,record){
				...
				var urlAudit="<%=contextPath%>/YsqAction/ysqTechAudit.do?id="+value+"&vin="+vin+"&createBy="+createBy;
				if(res==9 && isEnd!=-1){//有维护件 无800
					if(status==93461002){
				...
				if(res==10 && isEnd!=-1){//无维护件 无800
					if(status==93461002){
						url+="<a href='"+urlAudit+"'>[审核]</a>";
					}
				}
				if(res==6 && isEnd!=-1){//无维护件 有800 
					if(status==93461002){
						url+="<a href='"+urlAudit+"'>[审核]</a>";
					}
				}
...
<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	<tr>
		<td width="12.5%"></td>
		<td width="10%" class="table_query_2Col_label_6Letter" nowrap="true">预授权申请号：</td>
		<td width="15%">
	...
	<tr>
        ...
        <td width="10%" class="table_query_2Col_label_6Letter" nowrap="true" >服务商代码：</td>
      	<td width="15%" colspan="2">
      	   <input class="short_txt" id="dealerCode"  name="dealerCode" type="text"/>
	...
	<tr>
		<td width="12.5%"></td>
        <td width="10%" class="table_query_2Col_label_6Letter" nowrap="true">服务商名称：</td>
      	<td width="15%">
        	<input id="dealer_name" name="dealer_name" type="text"  class="middle_txt"/>
      	</td>
        ...
        <td width="10%" class="table_query_2Col_label_6Letter" nowrap="true">
        </td>
		<td width="12.5%"></td>
