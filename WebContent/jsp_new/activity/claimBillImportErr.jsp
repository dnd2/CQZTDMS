...
<title>服务活动导入列表</title>

</head>
<body onload="autoAlertException();">
<div class=navigation><img src="<%=request.getContextPath()%>/img/nav.gif">&nbsp;服务活动导入列表</div>
...
<script type="text/javascript">
	...
	function importDo()
	{
		...
		fm.action = '<%=contextPath%>/ActivityAction/claimBillImport.do';
	    fm.submit();
	}
</script>
</body>
