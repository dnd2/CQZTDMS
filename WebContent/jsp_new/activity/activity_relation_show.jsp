...
<script type="text/javascript" >
	...
	var url = '<%=contextPath%>/ActivityAction/relationShow.json?query=true';
	var title = null;//头标
	var columns = [
	...
	function myRadioCheck(value,metaDate,record){
		...
		var str="<input type='radio' name='checkId' onclick='checkRadio(\""+subject_id+"\",\""+activity_type+"\",\""+subject_no+"\",\""+subject_name+"\");' />";
		return String.format(str);
	}
	function checkRadio(subject_id,activity_type,subject_no,subject_name){
		if (parent.$('inIframe')) {
			parentContainer.relationShowBack(subject_id,activity_type,subject_no,subject_name);
		}else{
			parent.relationShowBack(subject_id,activity_type,subject_no,subject_name);
		}
		_hide();
	}
</script>
