...
<script language="JavaScript">
    ...
    function importFileUpload(){
    	...
    	var fileName = document.FRM.uploadFile.value;
		if(fileName==""){
			MyAlert("您没有选择要上传的文件！");
			return false;
		}
		...
		FRM.action = "<%=contextPath%>/ActivityAction/excelOperateRerRule.do?activityId="+activityId+"&flag="+flag+"&activitycode="+activitycode;
		FRM.submit();
	}
</script>
</head>
...
<body>
 ...
 <form enctype="multipart/form-data" method="post"  name="FRM" target="_self" id="FRM">
	 ...
	 <input type="hidden" name="activitycode" id="activitycode" value="<%=request.getAttribute("activitycode") %>"/>
...
<table class="table_query">
    ...
    <tr> 
	    ...
	    <td>
	    	...
	    	<input type="button" value="返回" name="button2" class="normal_btn" onclick="history.go(-1);">
	    </td>
    </tr>
</table>
</form>
