...
var myPage;
//查询路径
var url = "<%=contextPath%>/SpecialAction/TechnologyTracking.json?type=query";
...
var columns = [
	...
	function myLink(value,meta,record){
		...
		if(20331009==status||20331010==status){
			var urlUpdate='<%=contextPath%>/SpecialAction/CancelAudit.json?id='+value+'&special_type='+special_type+'&url=specialClaimSettlementList';
