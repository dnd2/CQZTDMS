...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;特殊费用管理&gt;索赔号明细页</div>
 <table class="table_info" width="75%">
   <tr>
    ...
    <tr>
      <td>服务站联系人：${map.DEALER_CONTACT }</td>
      <td>服务站联系电话：${map.DEALER_PHONE }</td>
      <td>索赔单号：${map.CLAIM_NO }</td>    
    </tr> 
    <tr>
      <td>&nbsp;&nbsp;&nbsp;供应商代码：${map.SUPPLY_CODE_DEALER }</td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         VIN：${map.VIN }</td>
    </tr>  
  </table>
