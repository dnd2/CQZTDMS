...
var myPage;
//查询路径
var url = "<%=contextPath%>/SpecialAction/specialServiceManagerList.json?query=true";
...
var columns = [
	...
	function myLink(value,meta,record){
		...
		var url="";
		if(20331002==status){
			var urlUpdate='<%=contextPath%>/SpecialAction/serviceManagerSpeInit.do?id='+value+'&special_type='+special_type+'&url=specialServiceManagerList';
