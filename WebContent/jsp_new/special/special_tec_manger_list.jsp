...
var myPage;
//查询路径
var url = "<%=contextPath%>/SpecialAction/specialTecSupportList.json?query=true";
...
var columns = [
	...
	function myLink(value,meta,record){
		...
		var apply_money=record.data.APPLY_MONEY;
		var url="";
		if(20331007==status || (20331005==status && apply_money<800)){
			var urlUpdate='<%=contextPath%>/SpecialAction/serviceManagerSpeInit.do?id='+value+'&special_type='+special_type+'&url=specialTecSupportList';
