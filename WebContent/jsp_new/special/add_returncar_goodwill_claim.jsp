...
//保存和提报操作
  function sureInsert(view){
    ...
    if(!$("#APPLY_REMARK").val()){
     ...
     var inserturl='<%=contextPath%>/SpecialAction/sureInsert.json?&view='+view;
...
<div class="navigation"><img src="<%=request.getContextPath()%>/img/nav.gif" />&nbsp;当前位置： 售后服务管理&gt;特殊费用管理&gt;善意索赔费用申请</div>
 <table class="table_info" width="75%">
    <tr>
       <th colspan="6"><img class="nav" src="<%=contextPath%>/img/subNav.gif" />基本信息</th>
    </tr>
    <tr>
      <td>申报单位代码：<input type="text" id="DEALER_CODE" name="DEALER_CODE" readonly="readonly" value="${mp.DEALER_CODE}"/> </td>
      <td>&nbsp;&nbsp;&nbsp;申报单位名称：<input id="DEALER_NAME" name="DEALER_NAME" type="text" readonly="readonly" value="${mp.DEALER_NAME}"/> </td>
      <td>结算费用类型： 
    ...
    <tr>
      <td>
        申请单号：<input value="..." type="button" onclick="selecapply_no();"/>&nbsp;&nbsp;<input type="text" id="appno" name="appno" readonly="readonly" />
      </td>
      <td>申报金额（元）：<input id="APPLY_MONEY" name="APPLY_MONEY" type="text" readonly="readonly" /></td>
      <td>结算厂家：
    ...
    <tr>
      <td>服务站联系人：<input id="DEALER_CONTACT" name="DEALER_CONTACT" readonly="readonly" type="text" /></td>
      <td>服务站联系电话：<input id="DEALER_PHONE" name="DEALER_PHONE" type="text" readonly="readonly" /></td>
      <td>索赔单号：<input id="CLAIM_NO" name="CLAIM_NO" type="text" readonly="readonly" /></td>    
    </tr> 
    <tr>
      <td>&nbsp;&nbsp;&nbsp;供应商代码：<input id="TEC_SUPPLY_CODE" name="supply_code_dealer" readonly="readonly" type="text"/></td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         VIN：<input id="VIN" name="VIN" type="text"  /></td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;车型：<input id="MODEL_NAME" name="MODEL_NAME" readonly="readonly" type="text"/></td>
    </tr>   
  </table>
  <table>
    <tr>
