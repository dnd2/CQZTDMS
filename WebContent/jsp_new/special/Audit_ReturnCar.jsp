...
<script type="text/javascript">
  ...
  function Audit(view){
     ...
     var updateturl='<%=contextPath%>/SpecialAction/AuditReturncarAndgoodwill.json?&view='+view;
  ...
  function selecapp(apply_no,ID){
	var special_type =  $("#special_type").val();
     OpenHtmlWindow('<%=contextPath%>/SpecialAction/queryByapplyno.do?apply_no='+apply_no+"&ID="+ID+"&special_type="+special_type,800,400);
  }
  //索赔单号
  function selecCLAIMNO(CLAIM_NO){
        var str='<%=contextPath%>/SpecialAction/queryByCLAIMNO.json?CLAIM_NO='+CLAIM_NO;
