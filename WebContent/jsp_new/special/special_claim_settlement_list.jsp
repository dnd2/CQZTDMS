...
var myPage;
//查询路径
var url = "<%=contextPath%>/SpecialAction/specialClaimSettlementList.json?query=true";
...
<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	<tr>
		<td width="10%" class="table_query_2Col_label_5Letter" nowrap="true">服务站名称：</td>
		...
		<td width="12.5%" class="table_query_2Col_label_5Letter">大区：</td>
		<td width="12.5%">
