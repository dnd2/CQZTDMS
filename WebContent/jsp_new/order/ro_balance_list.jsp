...
var columns = [
	      ...
	      function myLink(value,meta,record){
	    	  ...
	    	  var printUrl = "<%=contextPath%>/OrderAction/roBalancePrint.do?type=1&id="+value;
	    	  var is_app=record.data.IS_APP;
		      if(record.data.RO_STATUS=="11591001" ){//未结算
	    	  	return String.format(
	    	    	  "<a href='"+urlView+"' onclick=''>[明细]</a>&nbsp;&nbsp;"+
	    	    	  "<a href='"+printUrl+"' target='_blank' onclick=''>[打印]</a>&nbsp;&nbsp;"+"<a href='"+urlView+"&view=balance"+"' onclick=''>[结算]</a>");
		      }else if(record.data.RO_STATUS=="11591002"){//已结算
		    	  var str="";
		      	  str+="<a href='"+urlView+"' onclick=''>[明细]</a>&nbsp;&nbsp;";
		      	  str+="<a href='"+printUrl+"' target='_blank' onclick=''>[打印]</a>&nbsp;&nbsp;";
		      	  if(is_app==0){
		      		 str+="<a href='"+urlView+"&view=cancelbalance"+"' onclick=''>[取消结算]</a>";
		      	  }
		    	  return String.format(str);
			  }else if(record.data.RO_STATUS=="11591003"){//废弃
		    	  return String.format("<a href='"+urlView+"' onclick=''>[明细]</a>&nbsp;&nbsp;"+
		    	    	  "<a href='"+printUrl+"' target='_blank' onclick=''>[打印]</a>");
			  }else if(record.data.RO_STATUS=="11591004"){//取消结算待审核
		    	  return String.format("<a href='"+urlView+"' onclick=''>[明细]</a>&nbsp;&nbsp;"+
		    	    	  "<a href='"+printUrl+"' target='_blank' onclick=''>[打印]</a>");
			  }
	      }
...
<img src="../jsp_new/img/nav.gif" />&nbsp;当前位置：售后服务管理&gt;维修工单管理&gt;维修工单结算
</div>
<form name="fm" id="fm">
<!-- 查询条件 begin -->
