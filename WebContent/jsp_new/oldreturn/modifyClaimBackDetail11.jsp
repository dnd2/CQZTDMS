  ...
  <table class="table_edit">
          ...
          <tr bgcolor="F3F4F8">
            ...
            <td align="left">
             ...
             <td align="right" nowrap="nowrap" >申报运费：</td>
            <td align="left" style="display: none">
              <input type="text" name="price" id="price" class="short_txt" datatype="1,isMoney,7"  value="<%=detailBean.getPrice()==null ? 0.0:detailBean.getPrice()  %>"/>
            </td>
          </tr>
          <tr bgcolor="F3F4F8">
