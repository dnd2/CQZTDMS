...
var columns = [
				...
				{header: "清单号",dataIndex: 'RETURN_NO',align:'center'},
  				...
  				{header: "申请时间", dataIndex: 'AUDIT_DATE', align:'center',renderer:formatDate3},
  				{header: "审核时间", dataIndex: 'APPLY_DATE', align:'center',renderer:formatDate3},
  				{header: "申请人", dataIndex: ' USER_NAME', align:'center'},
	    ...
	    function myLink(value,meta,record){
	    	...
	    	var urlView="<%=contextPath%>/OldReturnAction/oldPartApplyInit.do?id="+value+"&type=view";
...
<table width=100% border="0" align="center" cellpadding="1" cellspacing="1" class="table_query">
	...
	<tr>
		...
		<td width="10%" class="table_query_2Col_label_5Letter" nowrap="true">状态：</td>
      	<td width="15%" nowrap="true">
      		<script type="text/javascript">
         		genSelBoxExp("status",<%=Constant.STATUS_OLD_PART%>,"",true,"short_sel","","false",'');
         	 </script>
      	</td>
