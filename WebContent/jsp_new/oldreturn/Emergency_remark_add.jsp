...
<script type="text/javascript">
   function addsure(){
	 ...
	 var id =$("#id").val().trim();
	 var url =  "<%=contextPath%>/OldReturnAction/addRemark.json?type=addsure&id="+id;
	 if(""==remark){
       MyAlert("提示：请填写备注！");
       return;
	 }
...
<body onload="doInit();">
<div class="navigation"><img src="<%=contextPath%>/img/nav.gif"/>&nbsp;当前位置： 售后服务管理&gt;索赔旧件管理 &gt;紧急调件备注增加</div>
  <form id="fm" name="fm">
