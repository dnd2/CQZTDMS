...
<table width='100%'>
	<tr>
		<td  nowrap="nowrap"><a href="" target="_blank"></a>
			<iframe id="upIframe" name="upIframe" src="<%=path%>/commonUploadIF2.jsp" width='100%' height=80  scrolling="no" style="overflow-x:hidden;overflow-y:visible;" frameborder="0"></iframe>
		</td>
	</tr>
</table>
...
<script type="text/javascript">
	function upload(){
		...
		$('fm').action = "<%=path %>/common/FileUploadAction2/fileUpload.do";
    	$("fm").submit();
	}
